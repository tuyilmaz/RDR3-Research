...
void func_1() // Position - 0xB5 Signature - 22 00 02 00 00 03
{
...
void func_2() // Position - 0xEE Signature - 22 00 08
{
	Vector3 vector;
	Vector3 vector2;
...
void func_3() // Position - 0x136 Signature - 22 00 02 00 00 86
{
...
int func_4() // Position - 0xA08 Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

BOOL func_5(BOOL bParam0, BOOL bParam1) // Position - 0xA16 Signature - 22 02 05
{
	int i;
...
void func_6() // Position - 0xAF6 Signature - 22 00 02 00 00 37
{
	FLOCK::_0xFB16F08F47B83B4C(joaat("SPECIES_BIRD_CROW"));
	return;
}

void func_7(Volume volParam0) // Position - 0xB07 Signature - 22 01 03 00 00 66 00 03 05 00 18 05 8B 03 00 50 01 00 66 00 6D
{
...
BOOL func_8() // Position - 0xB48 Signature - 22 00 02 00 00 2F
{
	return false;
}

void func_9(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xB51 Signature - 22 03 05 00 00 66 00 03 05 00 18 05 8B 03 00 50 03 00 66 00 66 01 6D 40
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_10(Volume volParam0) // Position - 0xBC4 Signature - 22 01 03 00 00 66 00 03 05 00 18 05 8B 03 00 50 01 00 66 00 21 FF 00
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0) // Position - 0xC0B Signature - 22 01 03 00 00 66 00 03 05 00 18 05 8B 03 00 50 01 00 66 00 21 FF 04
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xC4C Signature - 22 03 05 00 00 66 00 03 05 00 18 05 8B 03 00 50 03 00 66 00 66 01 25 00 10 30 6D 40
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_13(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xCCB Signature - 22 03 05 00 00 66 00 03 05 00 18 05 8B 03 00 50 03 00 66 00 66 01 25 00 10 30 6D 80
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_14(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xD41 Signature - 22 03 05 00 00 66 00 03 05 00 18 05 8B 03 00 50 03 00 66 00 66 01 6D E0
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_15(var uParam0, int iParam1) // Position - 0xDB7 Signature - 22 02 04
{
