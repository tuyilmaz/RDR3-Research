...
void func_1(var uParam0) // Position - 0x7B0 Signature - 22 01 03 00 00 66 00 62 39
{
	func_50(uParam0, 5);
	return;
}
...
BOOL func_45(int iParam0) // Position - 0x19A9 Signature - 22 01 03 00 00 66 00 62 1C
{
	return iParam0 != 5;
}
