...
void func_1() // Position - 0x59 Signature - 22 00 02 00 00 03
{
...
void func_2() // Position - 0x92 Signature - 22 00 02 00 00 86
{
...
int func_3() // Position - 0x208 Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x216 Signature - 22 02 05
{
	int i;
...
void func_5() // Position - 0x2F6 Signature - 22 00 08
{
	PersChar persChar;
	PersChar persChar2;
	PersChar persChar3;
...
void func_6() // Position - 0x42E Signature - 22 00 02 00 00 50
{
	return;
}

void func_7(Volume volParam0) // Position - 0x436 Signature - 22 01 03 00 00 66 00 03 05 00 03 05 8B 03 00 50 01 00 66 00 21 FF
{
...
void func_8(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x47D Signature - 22 03
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_9(Volume volParam0) // Position - 0x4F3 Signature - 22 01 03 00 00 66 00 03 05 00 03 05 8B 03 00 50 01 00 66 00 21 1F
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
BOOL func_10(int iParam0) // Position - 0x534 Signature - 22 01 06 00 00 66 00 09 39 2E 06 00 67 03 66 03 6D 1F 59 67 04 66 03 6D 1F 47 67 05 66 04 39
{
	int num;
	int num2;
	int offset;
...
void func_11(int iParam0) // Position - 0x5B3 Signature - 22 01 06 00 00 66 00 09 39 2E 06 00 67 03 66 03 6D 1F 59 67 04 66 03 6D 1F 47 67 05 66 04 87 26 00 80 76 63 01 66 05 03 08 00 08
{
	int num;
	int num2;
	int offset;
...
void func_12(int iParam0) // Position - 0x5E6 Signature - 22 01 06 00 00 66 00 09 39 2E 06 00 67 03 66 03 6D 1F 59 67 04 66 03 6D 1F 47 67 05 66 04 87 26 00 80 76 63 01 66 05 03 08 00 18
{
	int num;
	int num2;
	int offset;
...
void func_13(var uParam0, int iParam1) // Position - 0x619 Signature - 22 02 04 00 00 66 00 76
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_14(int iParam0, int iParam1) // Position - 0x62E Signature - 22 02 04 00 00 66 00 3C
{
	switch (iParam0)
	{
...
BOOL func_15(int iParam0) // Position - 0x1ED3 Signature - 22 01 04
{
	int num;
...
BOOL func_16(int iParam0) // Position - 0x1EF0 Signature - 22 01 03 00 00 66 00 37
{
...
int func_17(int iParam0) // Position - 0x1F07 Signature - 22 01 03 00 00 66 00 39
{
	return func_18(iParam0) + 30;
}

int func_18(int iParam0) // Position - 0x1F17 Signature - 22 01 03 00 00 66 00 14
{
	return iParam0 * 31;
}
