...
void func_1() // Position - 0x61 Signature - 22 00 02 00 00 03 01 00 25 8B
{
...
void func_2() // Position - 0x9A Signature - 22 00 02 00 00 86
{
...
void func_3() // Position - 0x139 Signature - 22 00 02 00 00 03 01 00 25 05
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_11() && !func_12())
...
int func_4() // Position - 0x27C Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

BOOL func_5(BOOL bParam0, BOOL bParam1) // Position - 0x28A Signature - 22 02 05
{
	int i;
...
void func_6() // Position - 0x36A Signature - 22 00 06
{
	PersChar persChar;
	PersChar persChar2;
	PersChar persChar3;
...
void func_7() // Position - 0x4D2 Signature - 22 00 02 00 00 50
{
	return;
}

void func_8() // Position - 0x4DA Signature - 22 00 02 00 00 54
{
...
void func_9(Volume volParam0) // Position - 0x4EC Signature - 22 01 03 00 00 66 00 03 05 00 0C 05 8B 03 00 50 01 00 66 00 21 FF 04
{
...
void func_10(Volume volParam0) // Position - 0x52D Signature - 22 01 03 00 00 66 00 03 05 00 0C 05 8B 03 00 50 01 00 66 00 21 FF 00
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
BOOL func_11() // Position - 0x574 Signature - 22 00 02 00 00 37 63
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_12() // Position - 0x585 Signature - 22 00 02 00 00 37 74
{
	return DLC::IS_DLC_PRESENT(joaat("dlc_ultimateedition"));
}

BOOL func_13(int iParam0) // Position - 0x596 Signature - 22 01 06 00 00 66 00 09 39 60 08 00 67 03 66 03 6D 1F 59 67 04 66 03 6D 1F 47 67 05 66 04 39
{
	int num;
	int num2;
	int offset;
...
void func_14(int iParam0) // Position - 0x615 Signature - 22 01 06 00 00 66 00 09 39 60 08 00 67 03 66 03 6D 1F 59 67 04 66 03 6D 1F 47 67 05 66 04 87 26 00 80 76 63 01 66 05 03 08 00 23
{
	int num;
	int num2;
	int offset;
...
void func_15(int iParam0) // Position - 0x648 Signature - 22 01 06 00 00 66 00 09 39 60 08 00 67 03 66 03 6D 1F 59 67 04 66 03 6D 1F 47 67 05 66 04 87 26 00 80 76 63 01 66 05 03 08 00 0D
{
	int num;
	int num2;
	int offset;
...
void func_16() // Position - 0x67B Signature - 22 00 02 00 00 37 9B
{
	func_20(-1745210725);
	func_20(-1096712211);
	func_20(-1941005496);
...
int func_17(int iParam0, int iParam1) // Position - 0x860 Signature - 22 02 04
{
	switch (iParam0)
	{
...
BOOL func_18(int iParam0) // Position - 0x2105 Signature - 22 01 04
{
	int num;
...
BOOL func_19(int iParam0) // Position - 0x2122 Signature - 22 01 03 00 00 66 00 37
{
...
void func_20(Hash hParam0) // Position - 0x2139 Signature - 22 01 03 00 00 66 00 03 05 00 11 8B
{
...
int func_21(int iParam0) // Position - 0x2151 Signature - 22 01 03 00 00 66 00 39
{
	return func_23(iParam0) + 30;
}

int func_22(Hash hParam0) // Position - 0x2161 Signature - 22 01 03 00 00 66 00 03 05 00 11 05
{
	if (!STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		return 1;
...
int func_23(int iParam0) // Position - 0x2189 Signature - 22 01 03 00 00 66 00 14
{
	return iParam0 * 31;
}

BOOL func_24() // Position - 0x2195 Signature - 22 00 02 00 00 39
{
	return func_25() == 4;
}

int func_25() // Position - 0x21A3 Signature - 22 00 02 00 00 85
{
	if (Global_1102813 <= 5)
