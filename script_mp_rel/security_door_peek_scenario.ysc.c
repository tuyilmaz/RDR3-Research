...
void func_6() // Position - 0x10C Signature - 22 00 03 00 00 70
{
	var unk;
...
void func_7() // Position - 0x256 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 03
{
	return;
}

void func_8() // Position - 0x25E Signature - 22 00 02 00 00 03
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x26A Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 13 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 0A 4B 03 39 24
{
	struct<2> eventData;
...
void func_10(int iParam0) // Position - 0x292 Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 13 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 0A 4B 03 39 2C
{
	struct<2> eventData;
...
void func_11(int iParam0) // Position - 0x2BA Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 13 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 0A 4B 03 39 34
{
	struct<2> eventData;
...
BOOL func_12(int iParam0) // Position - 0x2E2 Signature - 22 01 03 00 00 54
{
	return bLocal_18 && iParam0 != false;
}

void func_13(int iParam0) // Position - 0x2F1 Signature - 22 01 03 00 00 66 00 39 E2 02 00 05
{
	if (!func_12(iParam0))
		return;
...
void func_14() // Position - 0x310 Signature - 22 00 02 00 00 89
{
	func_31(&uLocal_23);
...
void func_15(int iParam0) // Position - 0x33E Signature - 22 01 03 00 00 66 00 4E
{
	iLocal_19 = iParam0;
	return;
}

Vector3 func_16() // Position - 0x34A Signature - 22 00 02 00 00 86 1F
{
	return 2710.57f, -1291.2f, 48.63f;
}

Vector3 func_17() // Position - 0x361 Signature - 22 00 02 00 00 86 14
{
	return -290.86f, 813.36f, 118.42f;
}

Vector3 func_18() // Position - 0x378 Signature - 22 00 02 00 00 86 F6
{
	return -281.07f, 815.24f, 118.42f;
}

Vector3 func_19(Ped pedParam0, var uParam1, var uParam2) // Position - 0x38F Signature - 22 03 0C
{
	int i;
	var unk;
	float num;
...
Hash func_20(int iParam0) // Position - 0x40B Signature - 22 01 03 00 00 66 00 3C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_21(var uParam0) // Position - 0x446 Signature - 22 01 03 00 00 66 00 76 09
{
	return func_34(*uParam0, 1);
}

void func_22(var uParam0, BOOL bParam1) // Position - 0x456 Signature - 22 02 04 00 00 66 01
{
...
BOOL func_23(var uParam0, float fParam1) // Position - 0x476 Signature - 22 02 04 00 00 66 00 39
{
	if (!func_21(uParam0))
		return false;
...
void func_24(var uParam0) // Position - 0x49D Signature - 22 01 03 00 00 66 00 73
{
	func_36(uParam0, 0f);
	return;
}

void func_25(BOOL bParam0) // Position - 0x4AC Signature - 22 01 03 00 00 66 00 39 E2 02 00 8B
{
	if (func_12(bParam0))
		return;
...
BOOL func_26() // Position - 0x4C7 Signature - 22 00 0A
{
	Entity entity;
...
void func_27(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x593 Signature - 22 06 0D
{
	float num;
	float num2;
	float num3;
...
void func_28(var uParam0) // Position - 0x924 Signature - 22 01 03 00 00 50 01 00 22 01 03 00 00 50 01 00 22 01 03 00 00 50
{
	return;
}

void func_29(var uParam0) // Position - 0x92C Signature - 22 01 03 00 00 50 01 00 22 01 03 00 00 50 01 00 22 01 03 00 00 66
{
	return;
}

void func_30(var uParam0) // Position - 0x934 Signature - 22 01 03 00 00 50 01 00 22 01 03 00 00 66
{
	return;
}

void func_31(var uParam0) // Position - 0x93C Signature - 22 01 03 00 00 66 00 76 03
{
	if (CAM::DOES_CAM_EXIST(*uParam0))
	{
...
float func_32(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x9E2 Signature - 22 05
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xA0A Signature - 22 03 05 00 00 66 00 73
{
...
BOOL func_34(int iParam0, int iParam1) // Position - 0xA34 Signature - 22 02 04 00 00 66 00 66
{
	return iParam0 && iParam1 != false;
}

float func_35(var uParam0) // Position - 0xA43 Signature - 22 01 03 00 00 66 00 39 46
{
	if (!func_21(uParam0))
		return uParam0->f_1;
...
void func_36(var uParam0, float fParam1) // Position - 0xA78 Signature - 22 02 04 00 00 39
{
...
BOOL func_37(Hash hParam0) // Position - 0xA9E Signature - 22 01 03 00 00 66 00 2F
{
	return hParam0 != 0;
}

Entity func_38(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xAAA Signature - 22 03 06
{
	Entity entity;
...
Vector3 func_39() // Position - 0xAEF Signature - 22 00 02 00 00 86 BC
{
	return 0.537029f, 0.426005f, 1.6552f;
}

Vector3 func_40() // Position - 0xB06 Signature - 22 00 02 00 00 86 12
{
	return -7.766f, 0f, 175.2488f;
}

void func_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, float fParam14, BOOL bParam15, int iParam16, int iParam17) // Position - 0xB19 Signature - 22 12
{
	uParam0->f_1 = { uParam1 };
	uParam0->f_4 = { uParam4 };
	uParam0->f_7 = fParam7;
...
BOOL func_42(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xC1A Signature - 22 06 08
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

Vector3 func_43(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0xC43 Signature - 22 07
{
	return ({ 1f - fParam6, 1f - fParam6, 1f - fParam6 } * uParam0) + ({ fParam6, fParam6, fParam6 } * uParam3);
}

float func_44(float fParam0, float fParam1, float fParam2) // Position - 0xC5E Signature - 22 03 05 00 00 66 00 66
{
	if (fParam0 > fParam2)
		return fParam2;
...
BOOL func_45(var uParam0) // Position - 0xC85 Signature - 22 01 03 00 00 66 00 76 11
{
	return func_34(*uParam0, 2);
}

float func_46() // Position - 0xC95 Signature - 22 00 03 00 00 03
{
...
void func_47(var uParam0, int iParam1) // Position - 0xCC7 Signature - 22 02 04 00 00 66 00 76 66 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_48(var uParam0, int iParam1) // Position - 0xCD8 Signature - 22 02 04 00 00 66 00 76 66 00
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

Entity func_49(Hash hParam0, int iParam1) // Position - 0xCED Signature - 22 02 05
{
...
Hash func_50(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD23 Signature - 22 03 05 00 00 66 00 03
{
...
BOOL func_51(Hash hParam0) // Position - 0xDC7 Signature - 22 01 03 00 00 66 00 39 9E
{
	if (func_37(hParam0))
