...
int func_1(int iParam0) // Position - 0x162 Signature - 22 01 03 00 00 66 00 3C 23
{
	switch (iParam0)
	{
...
void func_2(var uParam0, int iParam1) // Position - 0x33D Signature - 22 02 04 00 00 66 01
{
	*uParam0 = iParam1;
	return;
}

int func_3(Ped pedParam0, int iParam1) // Position - 0x34A Signature - 22 02 05 00 00 66 00 4B
{
	int weaponHash;
...
int func_4(var uParam0) // Position - 0x361 Signature - 22 01 03 00 00 66 00 76
{
	return *uParam0;
}

void func_5(int iParam0) // Position - 0x36C Signature - 22 01 04
{
	int num;
...
void func_6(int iParam0) // Position - 0x3AF Signature - 22 01 03 00 00 66 00 2F 39
{
	!func_17(iParam0, 0);
	return;
}

void func_7(int iParam0, int iParam1) // Position - 0x3C2 Signature - 22 02 06 00 00 37
{
	var statId;
...
BOOL func_8(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9) // Position - 0x3F4 Signature - 22 0A
{
	int num;
	BOOL flag;
	BOOL flag2;
...
void func_9(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x459 Signature - 22 03 07 00 00 66 00 39
{
	int num;
	int num2;
...
void func_10(int iParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x4CF Signature - 22 04 06 00 00 66 00
{
	if (!func_25(iParam0))
		return;
...
int func_11(int iParam0) // Position - 0x4F6 Signature - 22 01 03 00 00 66 00 3C 35
{
	switch (iParam0)
	{
		case 1:
...
void func_12(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x88C Signature - 22 03 07 00 00 66 00 4B
{
	int num;
	int num2;
...
void func_13() // Position - 0x8EC Signature - 22 00 02 00 00 03 00
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

int func_14(int iParam0) // Position - 0x8F8 Signature - 22 01 03 00 00 66 00 3C 28
{
	switch (iParam0)
	{
		case 2:
...
Hash func_15(Hash hParam0, BOOL bParam1) // Position - 0xBB3 Signature - 22 02 05 00 00 66 00 2F
{
	Hash hash;
...
int func_16(const char* sParam0, char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0xBE1 Signature - 22 09
{
	int num;
	var unk13;
	int num2;
...
BOOL func_17(Hash hParam0, int iParam1) // Position - 0xC44 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 26
{
	if (hParam0 == 0)
		return false;
...
struct<2> func_18(int iParam0, int iParam1) // Position - 0xC5E Signature - 22 02 06 00 00 66 00 67
{
	int num;
...
struct<2> func_19(int iParam0) // Position - 0xC74 Signature - 22 01 05
{
	var unk;
...
void func_20(var uParam0, var uParam1, int iParam2) // Position - 0xC86 Signature - 22 03 05 00 00 4B
{
...
BOOL func_21(int iParam0) // Position - 0xCA3 Signature - 22 01 03 00 00 66 00 39 78 0E 00 05 8B 04 00 2F 50 01 01 66 00 42
{
	if (!func_25(iParam0))
		return false;
...
Hash func_22(int iParam0) // Position - 0xCC1 Signature - 22 01 03 00 00 66 00 39 78 0E 00 05 8B 04 00 2F 50 01 01 66 00 3C
{
	if (!func_25(iParam0))
		return 0;
...
BOOL func_23(Hash hParam0) // Position - 0xDF0 Signature - 22 01 34
{
...
void func_24(int iParam0, BOOL bParam1) // Position - 0xE52 Signature - 22 02 04 00 00 66 00 39 78 0E 00 05 8B 03 00 50 02 00 66 00 87
{
	if (!func_25(iParam0))
		return;
...
BOOL func_25(int iParam0) // Position - 0xE78 Signature - 22 01 03 00 00 66 00 2F 77
{
	return !(iParam0 <= 0);
}

void func_26(int iParam0, BOOL bParam1) // Position - 0xE85 Signature - 22 02 04 00 00 66 00 39 78 0E 00 05 8B 03 00 50 02 00 66 00 39
{
	if (!func_25(iParam0))
		return;
...
BOOL func_27(int iParam0) // Position - 0xEC8 Signature - 22 01 03 00 00 66 00 39 78 0E 00 05 8B 04 00 2F 50 01 01 66 00 09
{
	if (!func_25(iParam0))
		return false;
...
void func_28(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEE6 Signature - 22 03 05 00 00 66 00
{
	if (!func_25(iParam0))
		return;
...
BOOL func_29(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF48 Signature - 22 03 05 00 00 5D
{
...
void func_30(BOOL bParam0, int iParam1) // Position - 0x10BE Signature - 22 02 04 00 00 03 01 00 12
{
...
int func_31(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1104 Signature - 22 05 39
{
	BOOL flag;
	int acquireCostsCount;
	int num;
...
void func_32(int iParam0, var uParam1, var uParam2) // Position - 0x11F6 Signature - 22 03 06
{
	int num;
...
BOOL func_33(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1212 Signature - 22 04 06 00 00 66 01
{
...
BOOL func_34(int iParam0, int iParam1) // Position - 0x12B4 Signature - 22 02 04 00 00 66 00 5D
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

void func_35(int iParam0, int iParam1) // Position - 0x12CD Signature - 22 02 05 00 00 66 00 5D
{
	int address;
...
Hash func_36(int iParam0, BOOL bParam1) // Position - 0x12F1 Signature - 22 02 04 00 00 66 00 3C
{
	switch (iParam0)
	{
...
void func_37(const char* sParam0, char* sParam1, Hash hParam2) // Position - 0x138C Signature - 22 03 05 00 00 37
{
...
BOOL func_38(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x13BD Signature - 22 03 05 00 00 66 02
{
	if (bParam2)
		if (!func_25(iParam0))
			return false;
...
BOOL func_39(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x1400 Signature - 22 03 13 00 00 66 00 2F
{
	var unk;
	int num;
	int i;
...
BOOL func_40(int iParam0) // Position - 0x14C5 Signature - 22 01 03 00 00 66 00 39 78 0E 00 05 8B 04 00 2F 50 01 01 66 00 11
{
	if (!func_25(iParam0))
		return false;
...
int func_41(BOOL bParam0, int iParam1) // Position - 0x14E3 Signature - 22 02 04 00 00 03 01 00 10
{
...
BOOL func_42(int iParam0) // Position - 0x1539 Signature - 22 01 03 00 00 66 00 3C 0D
{
	switch (iParam0)
	{
		case 1:
...
void func_43(int iParam0) // Position - 0x15A6 Signature - 22 01 03 00 00 66 00 3C 1F
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_44() // Position - 0x17AC Signature - 22 00 02 00 00 85
{
	if (Global_1048576)
		return true;
...
struct<2> func_45(int iParam0) // Position - 0x1804 Signature - 22 01 03 00 00 11
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_46(var uParam0, var uParam1) // Position - 0x1818 Signature - 22 02 04 00 00 66 00 39 91
{
	if (!func_67(uParam0))
		return false;
...
int func_47(var uParam0, var uParam1) // Position - 0x184C Signature - 22 02 04 00 00 66 00 50
{
	return uParam0;
}

void func_48(int iParam0, int iParam1) // Position - 0x1856 Signature - 22 02 04 00 00 66 00 27
{
	iParam0->f_2 = iParam0->f_2 || iParam1;
	return;
}

BOOL func_49() // Position - 0x1869 Signature - 22 00 02 00 00 09
{
	return true;
}

int func_50() // Position - 0x1888 Signature - 22 00 02 00 00 5D 17 00 18 27 0E
{
	return Global_1572887.f_14;
}

BOOL func_51(Hash hParam0, int iParam1) // Position - 0x1896 Signature - 22 02 13
{
	BOOL flag;
	int num;
	var unk;
...
void func_52(int iParam0, BOOL bParam1) // Position - 0x18FF Signature - 22 02 06 00 00 66 00 4B
{
	int num;
	int num2;
...
BOOL func_53(int iParam0, int iParam1) // Position - 0x192C Signature - 22 02 04 00 00 66 00 87
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_54(int iParam0) // Position - 0x1944 Signature - 22 01 03 00 00 66 00 42
{
...
BOOL func_55(int iParam0) // Position - 0x195B Signature - 22 01 07
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_56(int iParam0) // Position - 0x1A27 Signature - 22 01 03 00 00 5D
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_57() // Position - 0x1A3A Signature - 22 00 02 00 00 39
{
	if (!func_66())
		return false;
...
Hash func_58(Hash hParam0) // Position - 0x1A55 Signature - 22 01 03 00 00 66 00 50
{
	return hParam0;
}

BOOL func_59(Hash hParam0, Any anParam1, BOOL bParam2) // Position - 0x1A5F Signature - 22 03 13 00 00 66 00 11
{
	var unk;
	int num;
	int i;
...
BOOL func_60(Hash hParam0) // Position - 0x1AED Signature - 22 01 03 00 00 66 00 37
{
...
BOOL func_61(Hash hParam0, Hash hParam1) // Position - 0x1B08 Signature - 22 02 04 00 00 66 00 2F 39
{
	if (!func_17(hParam0, 0))
...
int func_62(Hash hParam0, BOOL bParam1) // Position - 0x1B49 Signature - 22 02 0B
{
	var unk;
...
BOOL func_63(int iParam0, var uParam1) // Position - 0x1BA1 Signature - 22 02 E0
{
	var unk;
	int num;
	Hash unlockHash;
...
BOOL func_64(Hash hParam0, int iParam1, var uParam2, var uParam3) // Position - 0x1CEA Signature - 22 04 36 00 00 2F 66 03 32 66 02 76 6D 0A 8A 04 00 2F 50 04 01 66 00 2F
{
	var unk;
	int i;
...
BOOL func_65() // Position - 0x1D6E Signature - 22 00 02 00 00 5D 17 00 18 27 0A
{
	return !Global_1572887.f_10;
}

BOOL func_66() // Position - 0x1D7D Signature - 22 00 02 00 00 03 01
{
...
BOOL func_67(int iParam0) // Position - 0x1D91 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21
{
	switch (iParam0)
	{
		case 2:
...
int func_68(int iParam0) // Position - 0x1DD0 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 2E
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_69(Hash hParam0, int iParam1) // Position - 0x1E66 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 06
{
	if (hParam0 == 0)
		return false;
...
BOOL func_70(Hash hParam0, Any anParam1, var uParam2, var uParam3) // Position - 0x1E80 Signature - 22 04 36 00 00 2F 66 03 32 66 02 76 6D 0A 8A 04 00 2F 50 04 01 66 00 11
{
	var unk;
	int i;
...
BOOL func_71(Hash hParam0, Hash hParam1) // Position - 0x1F04 Signature - 22 02 04 00 00 66 00 11
{
	if (!func_69(hParam0, 2))
		return 0;
...
int func_72(Hash hParam0, BOOL bParam1) // Position - 0x1F3A Signature - 22 02 05 00 00 66 00 11
{
	int num;
...
BOOL func_73(Hash hParam0, var uParam1, Any anParam2) // Position - 0x1F73 Signature - 22 03 07 00 00 66 00 03
{
	int i;
	int num;
