...
void func_1(int iParam0) // Position - 0x4B Signature - 22 01 04 00 00 66 00 89
{
	int i;
...
void func_2() // Position - 0xC3 Signature - 22 00 02 00 00 09
{
	iLocal_76 = 1;
...
BOOL func_3(int iParam0) // Position - 0x105 Signature - 22 01 03 00 00 2F
{
	return false;
}

void func_4() // Position - 0x10E Signature - 22 00 03
{
	int i;
...
BOOL func_5(Ped pedParam0, int iParam1) // Position - 0x27E Signature - 22 02 05
{
	int num;
...
void func_6(Entity eParam0) // Position - 0x37D Signature - 22 01 04 00 00 66 00 03
{
	Blip blipFromEntity;
...
void func_7(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3A0 Signature - 22 04 06 00 00 66 00
{
...
Vector3 func_8(int iParam0, BOOL bParam1) // Position - 0x40E Signature - 22 02 08
{
...
ePedType func_9(int iParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4, float fParam5, float fParam6, float fParam7) // Position - 0x46E Signature - 22 08 0A
{
	if (!func_18(iParam0))
		return 0;
...
BOOL func_10() // Position - 0x4A8 Signature - 22 00 05
{
	float num;
	float num2;
	var unk;
...
void func_11(int iParam0) // Position - 0x4EE Signature - 22 01 07 00 00 66 00 89 2C 63 0A 27 07
{
	var unk;
	int i;
...
void func_12(int iParam0) // Position - 0x5D5 Signature - 22 01 07 00 00 66 00 89 2C 63 0A 27 06
{
	int i;
	Vector3 vector;
	...
	if (!MAP::DOES_BLIP_EXIST(uLocal_44[iParam0 /*10*/].f_8))
		uLocal_44[iParam0 /*10*/].f_8 = MAP::_BLIP_ADD_FOR_VOLUME(-1282792512, uLocal_44[iParam0 /*10*/].f_9);
...
BOOL func_13(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x6E8 Signature - 22 04 06 00 00 66 02
{
...
void func_14(int iParam0) // Position - 0x71E Signature - 22 01 04 00 00 70
{
	int i;
...
BOOL func_15(int iParam0, int iParam1) // Position - 0x7A9 Signature - 22 02 04 00 00 66 00 66
{
	return iParam0 && iParam1 != false;
}

void func_16(Blip* pblParam0) // Position - 0x7B8 Signature - 22 01 03 00 00 66 00 76
{
...
BOOL func_17(int iParam0) // Position - 0x7D0 Signature - 22 01 03 00 00 66 00 2F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_18(int iParam0) // Position - 0x7E6 Signature - 22 01 03 00 00 66 00 08
{
	return iParam0 > -1 && iParam0 < 16;
}

Hash func_19(int iParam0) // Position - 0x7FC Signature - 22 01 04 00 00 66 00 39
{
	int num;
...
BOOL func_20(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, int iParam7, float fParam8, float fParam9, float fParam10, int iParam11) // Position - 0x83F Signature - 22 0C
{
	int num;
...
Vector3 func_21(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x964 Signature - 22 05 0B
{
	var unk;
	float endRange;
...
Ped func_22(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x9AC Signature - 22 0D
{
	Ped ped;
...
int func_23() // Position - 0x9EC Signature - 22 00 02 00 00 5D
{
	return Global_1893611.f_2;
}

int func_24(int iParam0) // Position - 0x9FA Signature - 22 01 03 00 00 66 00 39
{
	if (!func_17(iParam0))
		return 0;
...
void func_25(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, float fParam7, float fParam8, float fParam9, int iParam10) // Position - 0xA1A Signature - 22 0B
{
	int num;
	int num2;
...
void func_26(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1828 Signature - 22 05 07
{
	switch (iParam1)
	{
		case 0:
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1FE8 Signature - 22 03 05 00 00 66 00 73
{
...
Vector3 func_28(float fParam0, var uParam1, var uParam2) // Position - 0x2012 Signature - 22 03 07
{
	float num;
	float num2;
...
Vector3 func_29(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2051 Signature - 22 04 07 00 00 66 03
{
	float num;
...
void func_30(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2088 Signature - 22 08 0B
{
	BOOL flag;
...
float func_31(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x2152 Signature - 22 04 07 00 00 66 00
{
	float num;
...
int func_32(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2177 Signature - 22 04 07 00 00 39
{
	int num;
...
int func_33(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x21C5 Signature - 22 03 05 00 00 1D
{
	return func_38(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

void func_34(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x21DB Signature - 22 03 05 00 00 66 00 03
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_35(Ped pedParam0, BOOL bParam1) // Position - 0x2220 Signature - 22 02 04 00 00 66 00 03
{
...
void func_36(Ped pedParam0, int iParam1) // Position - 0x2265 Signature - 22 02 04 00 00 66 01
{
	if (iParam1 == 1)
...
int func_37(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x228C Signature - 22 04 0B
{
	int num;
	int num2;
	int num3;
...
int func_38(Hash hParam0) // Position - 0x2343 Signature - 22 01 03 00 00 66 00 3C
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x23FD Signature - 22 03 06
{
	int num;
...
int func_40(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x2438 Signature - 22 07
{
	if (fParam0 < fParam3)
