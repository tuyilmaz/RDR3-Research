...
void main() // Position - 0x0 Signature - 22 00 3C
{
	int idOfThisThread;
...
int func_1() // Position - 0xF6 Signature - 22 00 02 00 00 5D 17
{
	return Global_1572887.f_14;
}

void func_2(var uParam0, BOOL bParam1) // Position - 0x104 Signature - 22 02 04 00 00 66 00 27 31
{
...
int func_3(var uParam0) // Position - 0x1E7 Signature - 22 01 03 00 00 2F 50
{
	return 0;
}

int func_4(var uParam0) // Position - 0x1F0 Signature - 22 01 14
{
	int i;
	var unk;
...
BOOL func_5(var uParam0) // Position - 0x299 Signature - 22 01 03 00 00 03
{
...
BOOL func_6(var uParam0) // Position - 0x2C5 Signature - 22 01 03 00 00 66 00 27 39
{
	switch (uParam0->f_57)
	{
		case 0:
...
BOOL func_7(var uParam0, int iParam1) // Position - 0x3F0 Signature - 22 02 04 00 00 66 00 27 38 66 01 69
{
	return uParam0->f_56 && iParam1 != false;
}

BOOL func_8(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x401 Signature - 22 08 0A
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_9() // Position - 0x456 Signature - 22 00 02 00 00 5D AC
{
	return Global_1900460.f_67;
}

BOOL func_10(var uParam0) // Position - 0x464 Signature - 22 01 0D 00 00 86
{
	var unk;
	var unk4;
	var unk7;
...
void func_11(var uParam0, int iParam1) // Position - 0x6D7 Signature - 22 02 04 00 00 66 01 66
{
	uParam0->f_57 = iParam1;
	return;
}

BOOL func_12(var uParam0) // Position - 0x6E5 Signature - 22 01 03 00 00 66 00 27 27 2F
{
...
BOOL func_13(var uParam0) // Position - 0x73F Signature - 22 01 03 00 00 66 00 27 27 03
{
...
BOOL func_14(var uParam0) // Position - 0x7C2 Signature - 22 01 07 00 00 86
{
	float num;
	Vector3 vector;
...
BOOL func_15(int iParam0, var uParam1) // Position - 0x8EE Signature - 22 02 04 00 00 66 00 3C 04
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_16(var uParam0) // Position - 0x95B Signature - 22 01 03 00 00 66 00 80 0E
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_14)))
	{
...
BOOL func_17(var uParam0) // Position - 0x9BE Signature - 22 01 03 00 00 66 00 80 34
{
...
void func_18(var uParam0) // Position - 0xA7A Signature - 22 01 03 00 00 73
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_19(var uParam0) // Position - 0xA90 Signature - 22 01 04 00 00 2F
{
	BOOL flag;
...
BOOL func_20(var uParam0) // Position - 0xB11 Signature - 22 01 03 00 00 2F 66
{
	if (func_15(0, uParam0))
	{
		if (!func_7(uParam0, 256))
...
BOOL func_21(var uParam0) // Position - 0xE2D Signature - 22 01 08
{
...
void func_22(var uParam0, int iParam1) // Position - 0xF0B Signature - 22 02 04 00 00 66 00 27 38 66 01 30
{
	uParam0->f_56 = uParam0->f_56 || iParam1;
	return;
}

int func_23(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xF1E Signature - 22 03 05 00 00 1D
{
	return func_36(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

Vector3 func_24(var uParam0) // Position - 0xF34 Signature - 22 01 07 00 00 66
{
...
Ped func_25(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0xF7C Signature - 22 0D
{
	Ped ped;
...
void func_26(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0xFBC Signature - 22 03 05 00 00 66 00 03 05 00 20 05
{
...
void func_27(var uParam0, BOOL bParam1) // Position - 0xFF8 Signature - 22 02 04 00 00 66 01 8B
{
	if (bParam1)
	{
	}
...
BOOL func_28(var uParam0) // Position - 0x101E Signature - 22 01 03 00 00 66 00 76 09
{
	return func_38(*uParam0, 1);
}

void func_29(var uParam0) // Position - 0x102E Signature - 22 01 03 00 00 66 00 73
{
	func_39(uParam0, 0f);
	return;
}

BOOL func_30(var uParam0, float fParam1) // Position - 0x103D Signature - 22 02 04 00 00 66 00 39
{
	if (!func_28(uParam0))
		return false;
...
void func_31(var uParam0) // Position - 0x1064 Signature - 22 01 0D 00 00 66
{
	int pedBoneIndex;
	int pedBoneIndex2;
	int boneIndex;
...
void func_32(var uParam0) // Position - 0x10EA Signature - 22 01 0E
{
	int pedBoneIndex;
	int num;
	var unk;
...
void func_33(var uParam0) // Position - 0x11A9 Signature - 22 01 05
{
	int ropeType;
	float length;
...
void func_34(var uParam0) // Position - 0x1290 Signature - 22 01 07 00 00 2F
{
	Hash scenarioHash;
	Vector3 vector;
...
void func_35(var uParam0) // Position - 0x131C Signature - 22 01 04 00 00 5D
{
	int i;
...
int func_36(Hash hParam0) // Position - 0x139A Signature - 22 01 03 00 00 66 00 3C
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
void func_37(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x1454 Signature - 22 08 0B
{
	BOOL flag;
...
BOOL func_38(int iParam0, int iParam1) // Position - 0x151E Signature - 22 02 04 00 00 66 00 66
{
	return iParam0 && iParam1 != false;
}

void func_39(var uParam0, float fParam1) // Position - 0x152D Signature - 22 02 04 00 00 39
{
...
float func_40(var uParam0) // Position - 0x1553 Signature - 22 01 03 00 00 66 00 39
{
	if (!func_28(uParam0))
		return uParam0->f_1;
...
int func_41(int iParam0, int iParam1) // Position - 0x1588 Signature - 22 02 04 00 00 66 00 3C 05
{
	switch (iParam0)
	{
		case joaat("p_carcasshangmed01a"):
...
void func_42(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x161A Signature - 22 03 05 00 00 66 00 03 05 00 20 8B
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_43(Ped pedParam0, BOOL bParam1) // Position - 0x165F Signature - 22 02 04 00 00 66 00 03
{
...
void func_44(Ped pedParam0, int iParam1) // Position - 0x16A4 Signature - 22 02 04 00 00 66 01 09
{
	if (iParam1 == 1)
...
float func_45() // Position - 0x16CB Signature - 22 00 03
{
...
void func_46(var uParam0, int iParam1) // Position - 0x16FD Signature - 22 02 04 00 00 66 00 76 66 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_47(var uParam0, int iParam1) // Position - 0x170E Signature - 22 02 04 00 00 66 00 76 66 00
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_48(var uParam0) // Position - 0x1723 Signature - 22 01 03 00 00 66 00 76 11
{
