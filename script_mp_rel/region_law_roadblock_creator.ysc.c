...
void func_1() // Position - 0xD2 Signature - 22 00 05 00 00 54 80
{
	int taskSequenceId;
	int i;
	int seat;
...
BOOL func_2(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1A9 Signature - 22 04 29
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_3() // Position - 0x2DE Signature - 22 00 02 00 00 39 83
{
...
BOOL func_4() // Position - 0x32E Signature - 22 00 02 00 00 09
{
	return func_20(1, 255);
}

BOOL func_5() // Position - 0x33D Signature - 22 00 02 00 00 85
{
	return Global_1893611 & 2 != 0;
}

void func_6() // Position - 0x34D Signature - 22 00 07
{
	int num;
	BOOL flag;
	int i;
...
int func_7() // Position - 0x5D2 Signature - 22 00 02 00 00 39 CD
{
	return func_33(func_32(func_15()));
}

void func_8(int iParam0, int iParam1) // Position - 0x5E6 Signature - 22 02 04 00 00 66 00 39 6B
{
	if (func_34(iParam0))
...
BOOL func_9(Ped pedParam0, int iParam1) // Position - 0x5FF Signature - 22 02 05 00 00 66 00 2F
{
	int num;
...
void func_10(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6FE Signature - 22 04 06 00 00 66 00 76
{
...
void func_11(Vector3 vParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0x76C Signature - 22 05 13
{
...
BOOL func_12(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7E5 Signature - 22 03 05 00 00 5D
{
...
int func_13() // Position - 0x883 Signature - 22 00 02 00 00 5D 9E
{
	return Global_1939102.f_4;
}

BOOL func_14(int iParam0, BOOL bParam1) // Position - 0x891 Signature - 22 02 04 00 00 66 00 39 70 12 00 05 8B 04 00 2F 50 02 01 66
{
	if (!func_38(iParam0))
		return false;
...
int func_15() // Position - 0x8CD Signature - 22 00 02 00 00 5D C6
{
	return Global_1896646.f_41;
}

BOOL func_16(int iParam0, BOOL bParam1) // Position - 0x8DB Signature - 22 02 04 00 00 66 00 39 CA 12 00 05 8B 04 00 2F 50 02 01 66
{
	if (!func_40(iParam0))
		return false;
...
int func_17() // Position - 0x917 Signature - 22 00 02 00 00 5D EB
{
	return Global_1893611.f_2;
}

BOOL func_18(int iParam0) // Position - 0x925 Signature - 22 01 03 00 00 66 00 39 22
{
	if (!func_42(iParam0))
		return false;
...
BOOL func_19() // Position - 0x946 Signature - 22 00 03 00 00 39
{
	int num;
...
BOOL func_20(int iParam0, int iParam1) // Position - 0x9BC Signature - 22 02 05 00 00 66 00 67
{
	int num;
...
float func_21(var uParam0) // Position - 0xA30 Signature - 22 01 03 00 00 66 00 39 34
{
	if (!func_48(uParam0))
		return 0f;
...
void func_22(var uParam0) // Position - 0xA62 Signature - 22 01 03 00 00 66 00 73
{
	func_51(uParam0, 0f);
	return;
}

void func_23() // Position - 0xA71 Signature - 22 00 03 00 00 2F
{
	int i;
...
BOOL func_24(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, float fParam7, float fParam8, float fParam9, float fParam10, int iParam11) // Position - 0xBC0 Signature - 22 0C
{
	int num;
...
void func_25(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0xCE5 Signature - 22 08 0A
{
	if (!func_34(iParam0))
	{
...
void func_26(var uParam0, int iParam1, BOOL bParam2) // Position - 0xD19 Signature - 22 03 05 00 00 2F
{
	uParam0->f_2 = 0;
...
void func_27() // Position - 0xD54 Signature - 22 00 05 00 00 54 1C
{
	float num;
...
void func_28() // Position - 0xE14 Signature - 22 00 13
{
...
void func_29(Vector3 vParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0xF65 Signature - 22 08 16
{
	var offsetFromCoordAndHeadingInWorldCoords;
	var offsetFromCoordAndHeadingInWorldCoords2;
	Vector3 vector;
...
BOOL func_30() // Position - 0xFFB Signature - 22 00 02 00 00 2F
{
...
float func_31(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3) // Position - 0x101C Signature - 22 04 06 00 00 66 00 03
{
...
int func_32(int iParam0) // Position - 0x1064 Signature - 22 01 03 00 00 66 00 3C 11
{
	switch (iParam0)
	{
		case 0:
...
int func_33(int iParam0) // Position - 0x111F Signature - 22 01 03 00 00 66 00 39 70
{
	if (!func_38(iParam0))
		return 0;
...
BOOL func_34(int iParam0) // Position - 0x116B Signature - 22 01 03 00 00 66 00 76 2F
{
	if (*iParam0 == 0)
		return false;
...
BOOL func_35(int iParam0, int iParam1) // Position - 0x1183 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 07
{
	return iParam0 && iParam1 != false;
}

Vector3 func_36(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6) // Position - 0x1192 Signature - 22 07 0C 00 00 66 00 66 03 34
{
	float num;
...
Vector3 func_37(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6) // Position - 0x1201 Signature - 22 07 0C 00 00 66 00 66 03 31
{
	float num;
...
BOOL func_38(int iParam0) // Position - 0x1270 Signature - 22 01 03 00 00 66 00 08 20 6A 8B 05
{
	return iParam0 > -1 && iParam0 < 6;
}

BOOL func_39(int iParam0, int iParam1) // Position - 0x1285 Signature - 22 02 04 00 00 66 00 39 70 12 00 05 8B 04 00 2F 50 02 01 5D
{
	if (!func_38(iParam0))
		return false;
...
BOOL func_40(int iParam0) // Position - 0x12CA Signature - 22 01 03 00 00 66 00 08 20 6A 8B 06
{
	return iParam0 > -1 && iParam0 < 17;
}

BOOL func_41(int iParam0, BOOL bParam1) // Position - 0x12E0 Signature - 22 02 04 00 00 66 00 39 CA 12 00 05 8B 04 00 2F 50 02 01 5D
{
	if (!func_40(iParam0))
		return false;
...
BOOL func_42(int iParam0) // Position - 0x1322 Signature - 22 01 03 00 00 66 00 2F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_43(int iParam0, BOOL bParam1) // Position - 0x1338 Signature - 22 02 04 00 00 5D
{
	if (Global_1572887.f_14 == -1)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1369 Signature - 22 03 05 00 00 66 00 73
{
...
BOOL func_45(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1393 Signature - 22 07 09 00 00 66 00 03
{
...
BOOL func_46(Any* panParam0, int iParam1, int iParam2) // Position - 0x13EE Signature - 22 03 07 00 00 66
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_47() // Position - 0x1425 Signature - 22 00 02 00 00 5D DD
{
	return Global_1102813.f_3672;
}

BOOL func_48(var uParam0) // Position - 0x1434 Signature - 22 01 03 00 00 66 00 76 09
{
	return func_64(*uParam0, 1);
}

BOOL func_49(var uParam0) // Position - 0x1444 Signature - 22 01 03 00 00 66 00 76 11
{
	return func_64(*uParam0, 2);
}

float func_50() // Position - 0x1454 Signature - 22 00 03 00 00 03
{
...
void func_51(var uParam0, float fParam1) // Position - 0x1486 Signature - 22 02 04 00 00 39
{
...
void func_52(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6, float fParam7, float fParam8, float fParam9, int iParam10) // Position - 0x14AC Signature - 22 0B
{
	int num;
	int num2;
...
void func_53(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x22BA Signature - 22 05 07
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_54(float fParam0, var uParam1, var uParam2) // Position - 0x2A7A Signature - 22 03 07 00 00 1D
{
	float num;
	float num2;
...
int func_55(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2AB9 Signature - 22 05 0E
{
	var groundZ;
	int num;
	BOOL flag;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x2BBD Signature - 22 0D
{
	Ped ped;
...
void func_57(Entity eParam0, ItemSet isParam1) // Position - 0x2BFD Signature - 22 02 04 00 00 66 01 03
{
...
struct<4> func_58(var uParam0) // Position - 0x2C30 Signature - 22 01 09
{
	var unk;
	int randomIntInRange;
	int i;
...
float func_59(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x2C8A Signature - 22 06 08 00 00 66 03
{
	return MISC::GET_HEADING_FROM_VECTOR_2D(fParam3 - uParam0, fParam3.f_1 - uParam0.f_1);
}

Vector3 func_60(float fParam0) // Position - 0x2CA4 Signature - 22 01 03 00 00 66 00 03
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Hash func_61(int iParam0) // Position - 0x2CBA Signature - 22 01 08
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_62(Hash hParam0) // Position - 0x2D28 Signature - 22 01 04
{
	int i;
...
float func_63(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x2D53 Signature - 22 06 08 00 00 73
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x2D71 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02
{
	return iParam0 && iParam1 != false;
}

void func_65(var uParam0, int iParam1) // Position - 0x2D80 Signature - 22 02 04 00 00 66 00 76 66 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_66(var uParam0, int iParam1) // Position - 0x2D91 Signature - 22 02 04 00 00 66 00 76 66 00
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_67(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x2DA6 Signature - 22 04 07 00 00 66
{
	float num;
...
int func_68(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2DCB Signature - 22 04 07 00 00 39
{
	int num;
...
int func_69(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x2E19 Signature - 22 03 05 00 00 1D
{
	return func_74(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

BOOL func_70(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x2E2F Signature - 22 06 08 00 00 66 00
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

void func_71(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2E58 Signature - 22 08 0B
{
	BOOL flag;
...
struct<2> func_72(Player plParam0) // Position - 0x2F22 Signature - 22 01 05
{
	var gamerHandle;
...
int func_73(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2F36 Signature - 22 04 0B
{
	int num;
	int num2;
	int num3;
...
int func_74(Hash hParam0) // Position - 0x2FED Signature - 22 01 03 00 00 66 00 3C 10
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
void func_75(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x30A7 Signature - 22 03 05 00 00 66 00 03
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_76(Ped pedParam0, BOOL bParam1) // Position - 0x30EC Signature - 22 02 04 00 00 66 00 03
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_77(Ped pedParam0, int iParam1) // Position - 0x3131 Signature - 22 02 04 00 00 66 01 09
{
	if (iParam1 == 1)
...
int func_78(var uParam0, var uParam1, var uParam2) // Position - 0x3158 Signature - 22 03 06
{
	int num;
...
int func_79(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x3193 Signature - 22 07 09 00 00 66 00 66
{
	if (fParam0 < fParam3)
