...
void main() // Position - 0x0 Signature - 22 00 08
{
	var unk;
	int i;
	BOOL flag;
...
void func_1() // Position - 0x11B Signature - 22 00 02 00 00 03
{
...
void func_2() // Position - 0x154 Signature - 22 00 02 00 00 2F
{
...
void func_3() // Position - 0x1C2 Signature - 22 00 02 00 00 86
{
...
int func_4() // Position - 0x2DA Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

void func_5(var uParam0) // Position - 0x2E8 Signature - 22 01 03 00 00 03
{
...
BOOL func_6(BOOL bParam0, BOOL bParam1) // Position - 0x32F Signature - 22 02 05 00 00 5D
{
	int i;
...
void func_7() // Position - 0x40F Signature - 22 00 02 00 00 39
{
	func_14();
	return;
}

void func_8(Volume volParam0) // Position - 0x41B Signature - 22 01 03 00 00 66 00 03
{
...
Volume func_9(Volume volParam0) // Position - 0x45C Signature - 22 01 03 00 00 6D
{
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x542 Signature - 22 03 05 00 00 66 00 03 05 00 25 05 8B 03 00 50 03 00 66 00 66 01 6D 80
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x5AC Signature - 22 03 05 00 00 66 00 03 05 00 25 05 8B 03 00 50 03 00 66 00 66 01 6D 40
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x61F Signature - 22 03 05 00 00 66 00 03 05 00 25 05 8B 03 00 50 03 00 66 00 66 01 25
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_13(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x69E Signature - 22 04
{
	Ped ped;
...
void func_14() // Position - 0x73C Signature - 22 00 02 00 00 54
{
...
void func_15(var uParam0, int iParam1) // Position - 0x753 Signature - 22 02 04 00 00 66 00 76 66
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_16(var uParam0, var uParam1) // Position - 0x768 Signature - 22 02 04 00 00 66 00 66
{
...
BOOL func_17(var uParam0, var uParam1) // Position - 0x788 Signature - 22 02 05 00 00 66 01
{
	BOOL flag;
...
int func_18(var uParam0) // Position - 0x88D Signature - 22 01 04
{
	int num;
...
void func_19(var uParam0) // Position - 0x9DA Signature - 22 01 23
{
	var unk;
...
int func_20(var uParam0) // Position - 0xA19 Signature - 22 01 03 00 00 09
{
	*uParam0 = 1;
...
BOOL func_21(Ped pedParam0, var uParam1) // Position - 0xA5E Signature - 22 02 05 00 00 66 00
{
...
BOOL func_22(var uParam0, var uParam1) // Position - 0xC1E Signature - 22 02 04 00 00 66 00 76 3C
{
	switch (*uParam0)
	{
		case 3:
...
int func_23(var uParam0) // Position - 0xC60 Signature - 22 01 07 00 00 66 00 27 12
{
	BOOL flag;
	int num;
	int num2;
...
int func_24(var uParam0) // Position - 0xE3C Signature - 22 01 05
{
	BOOL flag;
...
int func_25(var uParam0) // Position - 0x12B4 Signature - 22 01 07 00 00 66 00 27 06
{
	BOOL flag;
	BOOL flag2;
	int relationshipBetweenGroups;
...
void func_26(var uParam0) // Position - 0x16DC Signature - 22 01 09
{
	var unk;
...
var func_27(var uParam0) // Position - 0x1706 Signature - 22 01 03 00 00 66 00 50
{
	return uParam0;
}
