...
void func_3() // Position - 0x3BD Signature - 22 00 02 00 00 6F 08 FF 39 9C 0D 00 8B 03 00 50 00 00 4D
{
	if (func_34(8, 255))
		return;
...
BOOL func_4(var uParam0) // Position - 0x3D8 Signature - 22 01 03 00 00 66 00 76 09 39 FA
{
...
void func_6(var uParam0, Any* panParam1) // Position - 0x3FE Signature - 22 02 09 00 00 66 01
{
	Vehicle vehicle;
	Player player;
	Entity vehicleOwner;
...
BOOL func_7(var uParam0, var uParam1) // Position - 0x491 Signature - 22 02 04 00 00 09 09
{
...
BOOL func_16() // Position - 0x763 Signature - 22 00 02 00 00 39 EA
{
...
BOOL func_18(var uParam0) // Position - 0x7AF Signature - 22 01 03 00 00 66 00 39 DB
{
	if (func_55(uParam0))
		return true;
...
void func_19() // Position - 0x7EC Signature - 22 00 02 00 00 6F 08 FF 39 9C 0D 00 8B 03 00 50 00 00 1D 39 A7
{
	if (func_34(8, 255))
		return;
...
void func_20() // Position - 0x806 Signature - 22 00 02 00 00 6F 08 FF 39 9C 0D 00 8B 03 00 50 00 00 1D 39 B6
{
	if (func_34(8, 255))
		return;
...
BOOL func_22(var uParam0, Any* panParam1) // Position - 0x8B7 Signature - 22 02 04 00 00 09 50
{
	return true;
}

void func_23(var uParam0) // Position - 0x8C0 Signature - 22 01 03 00 00 50
{
	return;
}

void func_24(var uParam0) // Position - 0x8C8 Signature - 22 01 04 00 00 2F 67 03 66
{
	int i;
...
BOOL func_25(Vehicle veParam0) // Position - 0x94A Signature - 22 01 03 00 00 66 00 03 05 00 75
{
...
void func_26(Vehicle veParam0, BOOL bParam1) // Position - 0x98E Signature - 22 02 06 00 00 66 00 39
{
...
BOOL func_27(var uParam0, Entity eParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x9E6 Signature - 22 05 08 00 00 66 01
{
	int i;
...
void func_28(int iParam0) // Position - 0xB16 Signature - 22 01 04 00 00 03 01 00 6A 67 03 66 03 5D AB AD 13 63 13 27 0A 66 03
{
	int num;
...
void func_29() // Position - 0xB46 Signature - 22 00 02 00 00 6D 61
{
	func_67(97);
	func_67(98);
	func_67(99);
...
BOOL func_30() // Position - 0xB92 Signature - 22 00 02 00 00 5D F8
{
	return Global_1149432.f_5568.f_132;
}

void func_31(int iParam0, Player plParam1, Player plParam2, BOOL bParam3) // Position - 0xBA3 Signature - 22 04 11
{
	BOOL flag;
	Player bitIndex;
	var value;
...
void func_32(Hash hParam0, int iParam1, char* sParam2) // Position - 0xD26 Signature - 22 03 07 00 00 66 00 09
{
	int cashBalance;
	int num;
...
void func_33() // Position - 0xD8A Signature - 22 00 02 00 00 2F
{
	Global_1149432.f_5568.f_132 = 0;
	return;
}

BOOL func_34(int iParam0, int iParam1) // Position - 0xD9C Signature - 22 02 04 00 00 66 01 6D
{
	if (iParam1 == 255)
...
void func_35(int iParam0, int iParam1) // Position - 0xDD6 Signature - 22 02 0D
{
	int eventData;
	var value;
	Player player;
...
BOOL func_36(int iParam0, int iParam1) // Position - 0xEFA Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 05 00 00 5D
{
	return iParam0 && iParam1 != false;
}

BOOL func_37(BOOL bParam0, BOOL bParam1) // Position - 0xF09 Signature - 22 02 05 00 00 5D 17
{
	int i;
...
BOOL func_38(var uParam0, var uParam1) // Position - 0xFE9 Signature - 22 02 04 00 00 2F 50 02 01 22 01
{
	return false;
}

void func_39(var uParam0) // Position - 0xFF2 Signature - 22 01 04 00 00 2F 67 03 6D
{
	BOOL flag;
...
void func_40(var uParam0) // Position - 0x108F Signature - 22 01 06 00 00 66 00 27
{
	Player player;
	Any gangId;
	Any gangId2;
...
BOOL func_41(var uParam0, var uParam1) // Position - 0x11D0 Signature - 22 02 04 00 00 2F 50 02 01 22 02
{
	return false;
}

BOOL func_42(var uParam0, var uParam1) // Position - 0x11D9 Signature - 22 02 04 00 00 66 00 76 6D
{
...
BOOL func_43() // Position - 0x1250 Signature - 22 00 02 00 00 5D 0C CE 1D 27 01 37 B1 DE 6E 01 1C 6A 8B 0D 00 5D 0C CE 1D 27 01 37 46 B6 C9 78 1C 69 50
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_44(var uParam0) // Position - 0x1275 Signature - 22 01 03 00 00 66 00 73
{
	func_87(uParam0, 0f);
	return;
}

BOOL func_45(var uParam0, int iParam1) // Position - 0x1284 Signature - 22 02 04 00 00 66 00 39 D8
{
	if (!func_4(uParam0))
		return false;
...
void func_46(var uParam0, int iParam1) // Position - 0x12AB Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 01 03 00 00 09
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_47(var uParam0) // Position - 0x12C0 Signature - 22 01 03 00 00 09 50 01 01 22 01
{
	return true;
}

BOOL func_48(var uParam0) // Position - 0x12C9 Signature - 22 01 07 00 00 66 00 39 13
{
	int expected;
	var actual;
	int i;
...
BOOL func_49(var uParam0) // Position - 0x13E1 Signature - 22 01 03 00 00 09 50 01 01 22 00
{
	return true;
}

BOOL func_50() // Position - 0x13EA Signature - 22 00 03 00 00 39 E6
{
	int i;
...
BOOL func_51(BOOL bParam0) // Position - 0x1421 Signature - 22 01 03 00 00 39 F7
{
	if (func_91())
		return false;
...
void func_52(int iParam0, var uParam1, var uParam2) // Position - 0x14F9 Signature - 22 03 06 00 00 66 00 67
{
	int num;
...
BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1515 Signature - 22 04 06 00 00 66 01
{
	if (iParam1 < 0 || iParam1 > 32)
		return false;
...
void func_54(int iParam0, int iParam1) // Position - 0x15B7 Signature - 22 02 05 00 00 66 00 5D
{
	int address;
...
BOOL func_55(var uParam0) // Position - 0x15DB Signature - 22 01 03 00 00 2F 50
{
	return false;
}

void func_56(var uParam0) // Position - 0x15E4 Signature - 22 01 03 00 00 66 00 27 02
{
...
void func_57(var uParam0) // Position - 0x165B Signature - 22 01 03 00 00 66 00 39 2C
{
	func_105(uParam0);
	return;
}

void func_58(var uParam0) // Position - 0x1669 Signature - 22 01 07 00 00 66 00 27 03 67
{
...
void func_59(var uParam0) // Position - 0x1858 Signature - 22 01 07 00 00 66 00 39 D5
{
	Vehicle vehicle;
	Ped ped;
	var unk;
...
void func_60(var uParam0) // Position - 0x18E3 Signature - 22 01 0B 00 00 66 00 27
{
	Vehicle vehicle;
	Ped ped;
...
void func_61(int iParam0) // Position - 0x19A7 Signature - 22 01 03 00 00 11 66 00 39
{
	func_35(2, iParam0);
	return;
}

void func_62(int iParam0) // Position - 0x19B6 Signature - 22 01 03 00 00 1D
{
	func_35(3, iParam0);
	return;
}

BOOL func_63(var uParam0, var uParam1, var uParam2) // Position - 0x19C5 Signature - 22 03 05 00 00 2F 50
{
	return 0;
}

BOOL func_64(var uParam0, var uParam1, var uParam2) // Position - 0x19CE Signature - 22 03 06 00 00 66 02
{
	int num;
...
int func_65(Vehicle veParam0, int iParam1) // Position - 0x1B1B Signature - 22 02 05 00 00 66 00 66 01 03 09 00 0E 67 04 66 04 03 05 00 15
{
...
BOOL func_66(Vehicle veParam0) // Position - 0x1B3B Signature - 22 01 04 00 00 66 00 03
{
...
void func_67(int iParam0) // Position - 0x1B56 Signature - 22 01 05 00 00 66 00 39
{
	int num;
	int offset;
...
struct<4> func_68() // Position - 0x1B8A Signature - 22 00 06
{
	var unk;
...
BOOL func_69(Player plParam0, BOOL bParam1) // Position - 0x1B96 Signature - 22 02 04 00 00 85
{
	if (Global_1048576)
		return true;
...
BOOL func_70(Player plParam0, Player plParam1) // Position - 0x1C26 Signature - 22 02 05 00 00 66 01 03 05 00 54
{
	Player bitIndex;
...
BOOL func_71(int iParam0) // Position - 0x1C9A Signature - 22 01 03 00 00 66 00 3C 05 00 07 00 00 00 1B 00 09 00 00 00 25
{
	switch (iParam0)
	{
		case 7:
...
int func_72(int iParam0) // Position - 0x1CE1 Signature - 22 01 03 00 00 66 00 3C 05 00 07 00 00 00 1B 00 09 00 00 00 26
{
	switch (iParam0)
	{
		case 7:
...
void func_73(Any* panParam0, var uParam1) // Position - 0x1D2A Signature - 22 02 04 00 00 4B
{
...
float func_74(Player plParam0, BOOL bParam1) // Position - 0x1D6A Signature - 22 02 05 00 00 5D F8 89 11 78 C0 15 05 8B 04 00 73
{
	Player player;
...
BOOL func_75(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1E0A Signature - 22 03 06 00 00 5D
{
	Player player;
...
int func_76(Hash hParam0, BOOL bParam1, Hash hParam2) // Position - 0x1ED3 Signature - 22 03 05 00 00 66 00 2F
{
...
BOOL func_77(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1EF7 Signature - 22 03 07 00 00 66 00 2F
{
	int num;
	BOOL flag;
...
int func_78(Hash hParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, Hash hParam5) // Position - 0x1F26 Signature - 22 06 4F
{
	int cashBalance;
	int goldBarBalance;
	var unk;
...
void func_79(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2116 Signature - 22 03 06 00 00 66 00 39
{
	char* str;
...
int func_80(int iParam0) // Position - 0x215B Signature - 22 01 03 00 00 66 00 6D
{
	if (iParam0 == 255)
...
BOOL func_81(int iParam0) // Position - 0x21A2 Signature - 22 01 03 00 00 6D
{
...
BOOL func_82(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x21BA Signature - 22 02 04 00 00 66 00 03
{
...
BOOL func_83(var uParam0) // Position - 0x2213 Signature - 22 01 03 00 00 66 00 76 6D 40
{
	return func_8(*uParam0, 64);
}

void func_84(var uParam0, BOOL bParam1) // Position - 0x2224 Signature - 22 02 04 00 00 66 01 6A
{
...
void func_85(var uParam0, var uParam1) // Position - 0x2244 Signature - 22 02 04 00 00 50
{
	return;
}

void func_86(var uParam0) // Position - 0x224C Signature - 22 01 03 00 00 66 00 39 29 07 00 8B 07 00 6D 46
{
	if (func_14(uParam0))
		func_17(70, true);
...
void func_87(var uParam0, float fParam1) // Position - 0x2264 Signature - 22 02 04 00 00 39
{
...
float func_88(var uParam0) // Position - 0x228A Signature - 22 01 03 00 00 66 00 39 D8
{
	if (!func_4(uParam0))
		return uParam0->f_1;
...
Ped func_89(Vehicle veParam0, int iParam1) // Position - 0x22BF Signature - 22 02 05 00 00 66 00 66 01 03 09 00 0E 67 04 66 04 03 05 00 75
{
	Ped pedInDraftHarness;
...
BOOL func_90() // Position - 0x22E6 Signature - 22 00 02 00 00 5D 12
{
	return Global_1904402.f_8872 != -1;
}

BOOL func_91() // Position - 0x22F7 Signature - 22 00 03 00 00 09
{
	int currentMessage;
...
BOOL func_92(Any* panParam0, int iParam1, int iParam2) // Position - 0x2317 Signature - 22 03 07 00 00 66 01
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

BOOL func_93() // Position - 0x234E Signature - 22 00 02 00 00 5D 77
{
	return Global_1072759.f_28644.f_23.f_3 != 0;
}

BOOL func_94() // Position - 0x2363 Signature - 22 00 02 00 00 39 5E
{
	if (!func_141())
		return false;
...
BOOL func_95() // Position - 0x237E Signature - 22 00 02 00 00 5D 3A
{
	return Global_1896762.f_352;
}

BOOL func_96() // Position - 0x238D Signature - 22 00 03 00 00 39 5E
{
	BOOL num;
...
BOOL func_97(int iParam0, int iParam1) // Position - 0x23B4 Signature - 22 02 04 00 00 66 00 87
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_98(int iParam0) // Position - 0x23CC Signature - 22 01 03 00 00 66 00 42
{
...
BOOL func_99(int iParam0) // Position - 0x23E3 Signature - 22 01 07 00 00 66 00 5D
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_100(int iParam0, int iParam1) // Position - 0x24AF Signature - 22 02 04 00 00 66 00 5D
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_101(int iParam0) // Position - 0x24C8 Signature - 22 01 03 00 00 5D
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_102(int iParam0) // Position - 0x24DB Signature - 22 01 03 00 00 42
{
...
int func_103(var uParam0) // Position - 0x24F2 Signature - 22 01 03 00 00 66 00 37 00
{
	return func_142(uParam0, 1086324736, 1094713344, 1077936128, 1090519040);
}

void func_104(var uParam0) // Position - 0x2514 Signature - 22 01 03 00 00 66 00 39 29 07 00 8B 07 00 6D 0F
{
	if (func_14(uParam0))
		func_35(15, 3);
...
void func_105(var uParam0) // Position - 0x252C Signature - 22 01 07 00 00 66 00 39 29
{
...
BOOL func_106(BOOL bParam0, BOOL bParam1) // Position - 0x26C6 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01
{
	return bParam0 && bParam1 != false;
}

BOOL func_107(var uParam0) // Position - 0x26D5 Signature - 22 01 0F
{
	Vehicle vehicle;
	Ped ped;
	var unk;
...
BOOL func_108(Vehicle veParam0, Ped pedParam1, var uParam2) // Position - 0x2847 Signature - 22 03 0A
{
	Ped pedInTransportSeat;
	int seatIndex;
	int i;
...
void func_109(Vehicle veParam0) // Position - 0x28B8 Signature - 22 01 0D 00 00 66 00 03 05 00 75 05 8B 03 00 50 01 00 66 00 2F
{
	Ped ped;
	var unk;
	var args;
...
void func_110(Ped pedParam0, Ped pedParam1) // Position - 0x293F Signature - 22 02 06 00 00 66 01
{
...
BOOL func_111(var uParam0, var uParam1) // Position - 0x2987 Signature - 22 02 04 00 00 66 00 27 02
{
...
void func_112(var uParam0) // Position - 0x299F Signature - 22 01 03 00 00 66 00 76 42 39 F6 04 00 05 8B 07 00 66 00 42
{
	if (!func_8(*uParam0, 4))
		func_13(uParam0, 4);
...
void func_113(var uParam0) // Position - 0x29BA Signature - 22 01 03 00 00 66 00 76 42 39 F6 04 00 05 8B 07 00 66 00 11
{
	if (!func_8(*uParam0, 4))
		func_13(uParam0, 2);
...
void func_114(var uParam0, var uParam1) // Position - 0x29D5 Signature - 22 02 04 00 00 66 00 80
{
	if (func_4(&(uParam0->f_13)))
		func_5(&(uParam0->f_13));
...
void func_115(var uParam0, var uParam1, BOOL bParam2) // Position - 0x2A4D Signature - 22 03 0C
{
	Vehicle vehicle;
	Player player;
	Ped ped;
...
void func_116(var uParam0, var uParam1) // Position - 0x2AF8 Signature - 22 02 09 00 00 03
{
	Player player;
	Ped ped;
	Vehicle vehicle;
...
BOOL func_117(int iParam0) // Position - 0x2B61 Signature - 22 01 03 00 00 66 00 08 77
{
...
BOOL func_118(var uParam0, var uParam1) // Position - 0x2B80 Signature - 22 02 04 00 00 66 00 39 D0
{
	if (!func_157(uParam0))
		return false;
...
struct<2> func_119() // Position - 0x2BB4 Signature - 22 00 02 00 00 5D 2C
{
...
BOOL func_120(Player plParam0, BOOL bParam1) // Position - 0x2BFF Signature - 22 02 05 00 00 5D F8 89 11 78 C0 15 05 8B 04 00 2F
{
	Player player;
...
void func_121(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x2C7B Signature - 22 08 0A 00 00 50
{
	return;
}

BOOL func_122(Hash hParam0, int iParam1) // Position - 0x2C83 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 3C
{
	if (hParam0 == 0)
		return false;
...
int func_123(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x2C9D Signature - 22 06 29
{
	var unk;
	int num;
	int i;
...
BOOL func_124(int iParam0) // Position - 0x2D8D Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 39
{
	if (iParam0 < 0)
		return false;
...
int func_125(Hash hParam0) // Position - 0x2DBA Signature - 22 01 0A 00 00 66 00 2F 39 83 2C 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 1D 05 8B 04 00 2F 50 01 01 4B 03 27 02
{
	var unk;
...
BOOL func_126() // Position - 0x2DE5 Signature - 22 00 02 00 00 03 01 00 42
{
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_127(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x2E01 Signature - 22 06 09 00 00 2F 66 03 32 66 02 76 6D 0F 8A 04 00 2F 50 06 01 66 00 2F
{
	int i;
...
int func_128(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2E91 Signature - 22 04 0D 00 00 2F
{
...
BOOL func_129(BOOL bParam0) // Position - 0x2F53 Signature - 22 01 03 00 00 39 6E 41 00 08 15 04
{
	if (func_167() == -1)
		return true;
...
BOOL func_130(Hash hParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x2F71 Signature - 22 05 11 00 00 66 00 2F
{
	int num;
	var unk;
	var unk6;
...
BOOL func_131(Hash hParam0) // Position - 0x2FE9 Signature - 22 01 03 00 00 66 00 3C 04
{
	switch (hParam0)
	{
		case -1551258934:
...
int func_132(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x3016 Signature - 22 03 06 00 00 66 00 2F
{
	int num;
...
void func_133(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x3080 Signature - 22 12
{
	int i;
...
char* func_134(int iParam0) // Position - 0x30FE Signature - 22 01 03 00 00 66 00 3C 1F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_135(int iParam0) // Position - 0x32A2 Signature - 22 01 03 00 00 66 00 5D 1F
{
	return func_184(Global_1290271.f_11.f_755[iParam0]);
}

int func_136(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x32BB Signature - 22 06 18
{
	int num;
	var unk13;
	int num2;
...
float func_137() // Position - 0x32F6 Signature - 22 00 03 00 00 03
{
...
void func_138(var uParam0, int iParam1) // Position - 0x3328 Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 02
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_139(var uParam0, int iParam1) // Position - 0x3339 Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 01 03 00 00 66
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_140(var uParam0) // Position - 0x334E Signature - 22 01 03 00 00 66 00 76 11
{
	return func_36(*uParam0, 2);
}

BOOL func_141() // Position - 0x335E Signature - 22 00 02 00 00 03 01 00 5C
{
...
int func_142(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x3372 Signature - 22 05 10
{
	var unk;
	var unk2;
	Vector3 vector;
...
void func_143(var uParam0) // Position - 0x34AB Signature - 22 01 03 00 00 66 00 27 01
{
	if (MAP::DOES_BLIP_EXIST(uParam0->f_1))
...
BOOL func_144(Player plParam0, BOOL bParam1) // Position - 0x34C6 Signature - 22 02 07 00 00 66 00 6D
{
	Player bitIndex;
	int playerTeam;
	int playerTeam2;
...
Hash func_145(Hash hParam0) // Position - 0x35C8 Signature - 22 01 03 00 00 66 00 03 05 00 9B
{
...
Hash func_146(Hash hParam0, BOOL bParam1) // Position - 0x3606 Signature - 22 02 05 00 00 66 00 2F
{
	Hash hash;
...
char* func_147(int iParam0) // Position - 0x3634 Signature - 22 01 0B 00 00 66 00 08
{
	var unk;
...
int* func_148(Player plParam0) // Position - 0x3688 Signature - 22 01 03 00 00 66 00 5D 92 96 13 17
{
	return Global_1283730[plParam0 /*2*/];
}

BOOL func_149(Player plParam0) // Position - 0x3698 Signature - 22 01 03 00 00 66 00 5D 92 96 13 63
{
	return Global_1283730[plParam0 /*2*/].f_1;
}

int func_150(int* piParam0) // Position - 0x36AA Signature - 22 01 03 00 00 66 00 08 20
{
...
BOOL func_151(int* piParam0, Vehicle veParam1) // Position - 0x3BC7 Signature - 22 02 0A
{
	int num;
	var unk;
	float num2;
...
struct<2> func_152(Player plParam0) // Position - 0x3C69 Signature - 22 01 05 00 00 66 00 4B
{
	var gamerHandle;
...
BOOL func_153(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3C7D Signature - 22 04 32
{
	var clanDesc;
	var clanDesc2;
...
BOOL func_154(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x3CD9 Signature - 22 04 06 00 00 66 00 27
{
	if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam0->f_3))
		return false;
...
void func_155(int iParam0) // Position - 0x3D26 Signature - 22 01 04 00 00 03 01 00 6A 67 03 66 03 5D AB AD 13 63 13 27 0A 66 00
{
	int num;
...
void func_156(Vehicle veParam0) // Position - 0x3D4B Signature - 22 01 0D 00 00 66 00 03 05 00 75 05 8B 03 00 50 01 00 66 00 03
{
	Ped ped;
	var unk;
	var args;
...
BOOL func_157(int iParam0) // Position - 0x3DD0 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21
{
	switch (iParam0)
	{
		case 2:
...
int func_158(int iParam0) // Position - 0x3E0F Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 2E
{
	switch (iParam0)
	{
		case 2:
...
struct<2> func_159(int iParam0) // Position - 0x3EA5 Signature - 22 01 03 00 00 11 66 00 5D
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_160() // Position - 0x3EB9 Signature - 22 00 02 00 00 5D 0C CE 1D 27 01 37 B1 DE 6E 01 1C 6A 8B 0D 00 5D 0C CE 1D 27 01 37 46 B6 C9 78 1C 69 8B
{
...
BOOL func_161(int iParam0) // Position - 0x3EE6 Signature - 22 01 04 00 00 66 00 3C
{
	int i;
...
BOOL func_162(Hash hParam0, Hash hParam1) // Position - 0x3FD8 Signature - 22 02 04 00 00 66 00 2F 39 83 2C 00 05 8B 04
{
	if (!func_122(hParam0, 0))
		return false;
...
BOOL func_163(Hash hParam0) // Position - 0x4026 Signature - 22 01 03 00 00 66 00 37 11
{
...
BOOL func_164(Hash hParam0, Hash hParam1) // Position - 0x4041 Signature - 22 02 04 00 00 66 00 2F 39 83 2C 00 05 8B 0F
{
	if (!func_122(hParam0, 0))
...
int func_165(Hash hParam0, BOOL bParam1) // Position - 0x4082 Signature - 22 02 0B
{
	var unk;
...
int func_166(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x40DA Signature - 22 04 27
{
	var unk;
	int num;
	int i;
...
int func_167() // Position - 0x416E Signature - 22 00 02 00 00 5D 17 00 18 27
{
	return Global_1572887.f_14;
}

BOOL func_168(int iParam0) // Position - 0x417C Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 66 00 2F
{
	if (iParam0 < 0)
		return false;
...
int func_169() // Position - 0x419F Signature - 22 00 02 00 00 39 6E
{
	if (func_167() == 0)
...
void func_170(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x41BA Signature - 22 04 2B 00 00 66 02 76 6D 0F 8A 06 00 50 04 00 68 16 00 66 03 66 02 76 20 6A 05 8B 05 00 66 03 09 35 30 8B 03 00 50 04 00 4B 0D 6A 80 01 6D 0A 3D 41 41 66 00 4B 0D 03 09 00 9A
{
	int i;
	int j;
	int k;
...
Hash func_171(Hash hParam0, int iParam1) // Position - 0x4390 Signature - 22 02 07 00 00 66 00 2F
{
	int num;
	var unk;
	Hash hash;
...
int func_172(Hash hParam0, BOOL bParam1) // Position - 0x440A Signature - 22 02 18
{
	var unk;
	int num;
	int num2;
...
int func_173(Hash hParam0, int iParam1) // Position - 0x4469 Signature - 22 02 04 00 00 66 01 2F
{
	if (iParam1 == 0)
		return 0;
...
int func_174(BOOL bParam0) // Position - 0x4495 Signature - 22 01 03 00 00 39 6E 41 00 08 15 17
{
	if (func_167() == -1)
	{
...
struct<4> func_175(Hash hParam0, BOOL bParam1) // Position - 0x44D6 Signature - 22 02 09 00 00 66 00
{
	var unk;
...
BOOL func_176(Hash hParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x44FB Signature - 22 05 6A
{
	int num;
	var unk;
	int num2;
...
struct<5> func_177(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x4613 Signature - 22 03 2F
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_178(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x4987 Signature - 22 07 0D
{
	var outGuid;
...
BOOL func_179(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x49B8 Signature - 22 07 3A
{
	var unk;
	int num;
	var unk15;
...
BOOL func_180(Hash hParam0, Any* panParam1) // Position - 0x4AD6 Signature - 22 02 05 00 00 66 00 66 01 03 09 00 A7
{
	BOOL flag;
	...
	if (hParam0 == joaat("use"))
		if (func_225(panParam1->f_8, hParam0, flag, 2048) || func_225(panParam1->f_8, hParam0, flag, 32768) || func_225(panParam1->f_8, hParam0, flag, 65536))
			return false;
	else if (hParam0 == 1168099063)
		if (func_225(panParam1->f_8, hParam0, flag, 4) || func_225(panParam1->f_8, hParam0, flag, 256) || func_225(panParam1->f_8, hParam0, flag, 65536) || func_225(panParam1->f_8, hParam0, flag, 131072))
			return false;
	else if (hParam0 == joaat("spend"))
		if (func_225(panParam1->f_8, hParam0, flag, true) || func_225(panParam1->f_8, hParam0, flag, 8) || func_225(panParam1->f_8, hParam0, flag, 65536) || func_225(panParam1->f_8, hParam0, flag, 32))
			return false;
	else if (hParam0 == joaat("Sell"))
		if (func_225(panParam1->f_8, hParam0, flag, true) || func_225(panParam1->f_8, hParam0, flag, 16) || func_225(panParam1->f_8, hParam0, flag, 2) || func_225(panParam1->f_8, hParam0, flag, 65536))
			return false;
	else if (func_225(panParam1->f_8, hParam0, flag, 8) || func_225(panParam1->f_8, hParam0, flag, 4096) || func_225(panParam1->f_8, hParam0, flag, 256) || func_225(panParam1->f_8, hParam0, flag, 65536))
		return false;

	return true;
}

BOOL func_181(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x4CAC Signature - 22 03 05 00 00 66 00 66
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_182(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x4CC3 Signature - 22 03 05 00 00 66 00 8B 21
{
	if (bParam0)
	{
...
int func_183(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x4D0C Signature - 22 03 05 00 00 66 00 8B 0E
{
	if (bParam0)
	{
		func_226(iParam1, 1, 0, 0);
...
BOOL func_184(int iParam0) // Position - 0x4D28 Signature - 22 01 03 00 00 66 00 2F 15 04 00 2F 50 01 01 66 00 03 05 00 1B
{
	if (iParam0 == 0)
		return false;
...
Vector3 func_185(var uParam0) // Position - 0x4D42 Signature - 22 01 07 00 00 66 00 27 03 25
{
	int _int;
	var unk;
...
BOOL func_186(var uParam0) // Position - 0x4D82 Signature - 22 01 03 00 00 66 00 27 03
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_3))
		return false;
...
BOOL func_187(var uParam0, var uParam1, int iParam2) // Position - 0x4DCE Signature - 22 03 06 00 00 2F
{
	Ped playerPed;
...
BOOL func_188(var uParam0, int iParam1) // Position - 0x4E3E Signature - 22 02 06 00 00 66 00 27
{
	Ped playerPed;
	int num;
...
BOOL func_189(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3* pvParam4) // Position - 0x4ECD Signature - 22 05 08 00 00 66 00
{
	var unk;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4F32 Signature - 22 03 05 00 00 66 00 73
{
...
int func_191(var uParam0, int iParam1) // Position - 0x4F5C Signature - 22 02 04 00 00 66 00 27 03
{
...
Hash func_192(Hash hParam0, BOOL bParam1) // Position - 0x4FB0 Signature - 22 02 04 00 00 66 00 3C
{
	switch (hParam0)
	{
...
void func_193() // Position - 0x5052 Signature - 22 00 02 00 00 6D 31
{
...
int func_194(int iParam0) // Position - 0x5091 Signature - 22 01 03 00 00 66 00 3C 07 00 FF
{
	switch (iParam0)
	{
		case -1:
...
char* func_195(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5104 Signature - 22 08 0A 00 00 4B 00 4B
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

Vector3 func_196(Player plParam0) // Position - 0x5118 Signature - 22 01 03 00 00 66 00 03 05 00 8B
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

float func_197(int* piParam0) // Position - 0x512C Signature - 22 01 04 00 00 66 00 39 AA
{
	int num;
...
float func_198(Vehicle veParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x5196 Signature - 22 05 07 00 00 66 00 03 05 00 75
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return 0f;
...
BOOL func_199(float fParam0, var uParam1, var uParam2) // Position - 0x51BE Signature - 22 03 06 00 00 66 00 03
{
	BOOL flag;
...
BOOL func_200(int iParam0) // Position - 0x5213 Signature - 22 01 03 00 00 66 00 09
{
...
BOOL func_201() // Position - 0x523B Signature - 22 00 02 00 00 5D 17 00 18 80
{
...
BOOL func_202(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x5266 Signature - 22 03 05 00 00 66 00 39
{
	if (!func_231(iParam0))
		return false;
...
Hash func_203(Hash hParam0) // Position - 0x529E Signature - 22 01 03 00 00 66 00 50
{
	return hParam0;
}

BOOL func_204(Hash hParam0, Hash hParam1) // Position - 0x52A8 Signature - 22 02 04 00 00 66 00 11
{
...
int func_205(Hash hParam0, BOOL bParam1) // Position - 0x52DE Signature - 22 02 05 00 00 66 00 11
{
	int num;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_206(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5317 Signature - 22 06 09 00 00 2F 66 03 32 66 02 76 6D 0F 8A 04 00 2F 50 06 01 66 00 39
{
	int i;
...
int func_207(Hash hParam0) // Position - 0x53A6 Signature - 22 01 0A 00 00 66 00 2F 39 83 2C 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 1D 05 8B 04 00 2F 50 01 01 4B 03 27 01
{
	var unk;
...
void func_208(Hash hParam0, var uParam1, var uParam2) // Position - 0x53D1 Signature - 22 03 05 00 00 2F 66
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_209(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x55DD Signature - 22 07 1B
{
	Hash hash;
...
struct<4> func_210(BOOL bParam0) // Position - 0x56BB Signature - 22 01 04 00 00 66 00 39 95 44 00 67 03 66 03 11 15
{
	int num;
...
void func_211(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x575C Signature - 22 05 07 00 00 4B
{
...
BOOL func_212(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x5777 Signature - 22 04 06 00 00 66 03
{
...
int func_213(int iParam0) // Position - 0x579C Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 66 00 03
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_214(Hash hParam0, int iParam1) // Position - 0x57BD Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 94
{
	if (hParam0 == 0)
		return false;
...
BOOL func_215(Hash hParam0) // Position - 0x57D7 Signature - 22 01 03 00 00 66 00 03 05 00 C8
{
...
BOOL func_216(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x57ED Signature - 22 06 08
{
	*uParam1 = 0;
...
struct<17> func_217(Hash hParam0, var uParam1) // Position - 0x585A Signature - 22 02 15
{
	var unk;
...
struct<4> func_218(BOOL bParam0) // Position - 0x58AD Signature - 22 01 04 00 00 5D
{
	int num;
...
int func_219(Hash hParam0, BOOL bParam1) // Position - 0x594D Signature - 22 02 04 00 00 66 00 39 A6
{
...
BOOL func_220(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5984 Signature - 22 05 07 00 00 66 00 42
{
	return func_236(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_221(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x599F Signature - 22 03 09 00 00
{
	var unk;
...
struct<4> func_222(BOOL bParam0) // Position - 0x59C0 Signature - 22 01 04 00 00 66 00 39 95 44 00 67 03 66 03 11 0B
{
	int num;
...
BOOL func_223(Hash hParam0, int iParam1) // Position - 0x5A2A Signature - 22 02 08
{
	Hash hash;
	int num;
	int i;
...
BOOL func_224(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x5A97 Signature - 22 08 0A 00 00 4B 00 66
{
	return func_239(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_225(var uParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5AAD Signature - 22 04 06 00 00 66 02
{
	if (func_106(bParam2, bParam3))
		return true;

	return false;
}

void func_226(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5AC5 Signature - 22 04 07 00 00 66 00 08 15 03 00 50 04 00 2F
{
	int i;
...
Vector3 func_227(int iParam0) // Position - 0x5B63 Signature - 22 01 08
{
	float num;
	int value;
	int value2;
...
int func_228(Entity eParam0, Ped pedParam1, int iParam2) // Position - 0x5BBF Signature - 22 03 08
{
	var entityCoords;
...
BOOL func_229(Player plParam0, Entity eParam1, Vector3* pvParam2, float* pfParam3) // Position - 0x5BDF Signature - 22 04 0D 00 00 66
{
	Ped playerPed;
...
BOOL func_230(var uParam0, int iParam1) // Position - 0x5CA2 Signature - 22 02 04 00 00 66 00 66 01 39
{
...
BOOL func_231(int iParam0) // Position - 0x5CC0 Signature - 22 01 03 00 00 66 00 2F 15 04 00 2F 50 01 01 66 00 03 05 00 AD
{
	if (iParam0 == 0)
		return false;
...
BOOL func_232(int iParam0, Hash hParam1) // Position - 0x5CD8 Signature - 22 02 E0
{
	var unk;
	int num;
	Hash unlockHash;
...
void func_233(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x5E21 Signature - 22 04 2B 00 00 66 02 76 6D 0F 8A 06 00 50 04 00 68 16 00 66 03 66 02 76 20 6A 05 8B 05 00 66 03 09 35 30 8B 03 00 50 04 00 4B 0D 6A 80 01 6D 0A 3D 41 41 66 00 4B 0D 03 09 00 7E
{
	int i;
	int j;
	int k;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_234(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x5FF7 Signature - 22 04 07 00 00 2F 66
{
	int i;
...
int func_235() // Position - 0x610E Signature - 22 00 02 00 00 37
{
...
int func_236(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x612B Signature - 22 09 10
{
...
BOOL func_237(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x61AA Signature - 22 04 07 00 00 2F 39
{
	int inventoryId;
...
BOOL func_238(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x61EF Signature - 22 03 05 00 00 66 02
{
...
BOOL func_239(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x6222 Signature - 22 05 07 00 00 66 00 03 05 00 B1
{
...
void func_240(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x625C Signature - 22 04 07 00 00 66 00 08 15 03 00 50 04 00 5D
{
	int i;
...
int func_241(Entity eParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x6338 Signature - 22 05 11 00 00 66 00 03
{
	var entityCoords;
...
BOOL func_242(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3* pvParam6, float* pfParam7) // Position - 0x63C7 Signature - 22 08 13
{
	Vector3 vector;
	Vector3 vector2;
	var unk5;
...
BOOL func_243(Any* panParam0) // Position - 0x6451 Signature - 22 01 03 00 00 66 00 39 B8
{
...
int func_244(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x646D Signature - 22 04 06 00 00 66 00 39
{
...
void func_245(int iParam0) // Position - 0x64A0 Signature - 22 01 03 00 00 08
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
float func_246(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x64C3 Signature - 22 06 09 00 00 73
{
	float num;
...
BOOL func_247(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x652A Signature - 22 09 0B
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

float func_248(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x6553 Signature - 22 07 0C
{
	float num;
	float num2;
	float num3;
...
BOOL func_249(Any* panParam0) // Position - 0x65B8 Signature - 22 01 03 00 00 66 00 76 2F
{
...
BOOL func_250(Hash hParam0) // Position - 0x65EE Signature - 22 01 03 00 00 66 00 03 05 00 2B
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

void func_251(var uParam0) // Position - 0x65FC Signature - 22 01 03 00 00 2F 66
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
