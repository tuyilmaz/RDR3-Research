...
void func_1() // Position - 0x4B Signature - 22 00 02 00 00 86
{
...
int func_2() // Position - 0x2B6 Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

BOOL func_3(BOOL bParam0, BOOL bParam1) // Position - 0x2C4 Signature - 22 02 05
{
	int i;
...
void func_4() // Position - 0x3A4 Signature - 22 00 02 00 00 39
{
	func_6();
...
void func_5() // Position - 0x429 Signature - 22 00 02 00 00 2F 39
{
	func_10(false);
	return;
}

void func_6() // Position - 0x436 Signature - 22 00 05
{
	int eventData;
	int i;
...
BOOL func_7() // Position - 0x475 Signature - 22 00 02 00 00 87 BC 65 27 C3
{
	return Global_26044.f_195;
}

int func_8() // Position - 0x482 Signature - 22 00 02 00 00 70
{
	return Global_26044;
}

BOOL func_9() // Position - 0x48D Signature - 22 00 02 00 00 2F 87
{
	return Global_26044.f_1[0 /*19*/].f_17 != 0;
}

void func_10(BOOL bParam0) // Position - 0x4A1 Signature - 22 01 03 00 00 66 00 8B
{
	if (bParam0)
	{
...
void func_11(char* sParam0) // Position - 0x4C5 Signature - 22 01 05
{
	float num;
	float num2;
...
void func_12() // Position - 0x631 Signature - 22 00 02 00 00 87 BC 65 27 C2
{
...
BOOL func_13(int iParam0, eEventType eetParam1) // Position - 0x65E Signature - 22 02 06
{
	int i;
	int num;
...
float func_14(float fParam0, float fParam1, float fParam2) // Position - 0x6E9 Signature - 22 03
{
	return ((1f - fParam2) * fParam0) + (fParam2 * fParam1);
}

void func_15(float fParam0) // Position - 0x6FE Signature - 22 01 03 00 00 66 00 76
{
...
void func_16(int iParam0) // Position - 0x72B Signature - 22 01 03 00 00 50
{
	return;
}

char* func_17(int iParam0) // Position - 0x733 Signature - 22 01 03 00 00 66 00 3C
{
	switch (iParam0)
	{
		case -1009774763:
...
char* func_18(int iParam0) // Position - 0x791 Signature - 22 01 03 00 00 66 00 03
{
