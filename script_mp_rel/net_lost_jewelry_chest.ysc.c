...
void func_1(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x8E Signature - 22 04 06 00 00 1D
{
...
int func_2() // Position - 0x2D8 Signature - 22 00 02 00 00 5D 17
{
	return Global_1572887.f_14;
}

struct<2> func_3(int iParam0) // Position - 0x2E6 Signature - 22 01 03 00 00 11
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_4(int iParam0, var uParam1) // Position - 0x2FA Signature - 22 02 04 00 00 66 00 50
{
	return iParam0;
}

void func_5(var uParam0) // Position - 0x304 Signature - 22 01 03 00 00 66 00 80 5F
{
...
BOOL func_6(var uParam0) // Position - 0x349 Signature - 22 01 03 00 00 03
{
...
BOOL func_7() // Position - 0x363 Signature - 22 00 02 00 00 2F
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x36C Signature - 22 01 04 00 00 66 00 39 BB
{
	BOOL flag;
...
int func_9(var uParam0, var uParam1, var uParam2) // Position - 0x505 Signature - 22 03 07 00 00 4B 00 27 01 67 06 66 06 03 05 00 1E 8B 0C 00 66 06 03 05 00 30 03 05 00 34 67 05 66 05 3C 1A 00 01 00 00 00 99 00 02 00 00 00 9A
{
	int num;
	int scenario;
...
int func_10(var uParam0, var uParam1, var uParam2) // Position - 0x696 Signature - 22 03 07 00 00 4B 00 27 01 67 06 66 06 03 05 00 1E 8B 0C 00 66 06 03 05 00 30 03 05 00 34 67 05 66 05 3C 1A 00 01 00 00 00 99 00 02 00 00 00 9E
{
	int num;
	int scenario;
...
char* func_11(var uParam0, var uParam1, var uParam2) // Position - 0x880 Signature - 22 03 07 00 00 4B 00 27 01 67 06 66 06 03 05 00 1E 8B 0C 00 66 06 03 05 00 30 03 05 00 34 67 05 66 05 3C 1A 00 01 00 00 00 99 00 02 00 00 00 9B
{
	int num;
	int scenario;
...
int func_12(var uParam0) // Position - 0xA44 Signature - 22 01 04 00 00 08
{
	int num;
...
void func_13(var uParam0) // Position - 0xBFA Signature - 22 01 03 00 00 66 00 39 87
{
	func_23(uParam0);
...
int func_14(Entity eParam0, Entity eParam1, int iParam2) // Position - 0xC11 Signature - 22 03 08
{
	int i;
	var src;
...
int func_15(var uParam0) // Position - 0xCBB Signature - 22 01 03 00 00 66 00 27 03
{
	return uParam0->f_3;
}

void func_16(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xCC7 Signature - 22 08 0F
{
	BOOL flag;
	BOOL flag2;
	float num;
...
float func_17(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xEF3 Signature - 22 05 07 00 00 66 00 03 05 00 40
{
...
void func_18(var uParam0) // Position - 0xF1B Signature - 22 01 03 00 00 25
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
void func_19(var uParam0, int iParam1) // Position - 0xF61 Signature - 22 02 04 00 00 66 01 66 00 6C
{
	uParam0->f_3 = iParam1;
	return;
}

BOOL func_20(var uParam0) // Position - 0xF6F Signature - 22 01 03 00 00 66 00 80 0E
{
...
Entity func_21(var uParam0) // Position - 0xF94 Signature - 22 01 05
{
	int i;
	Entity unk;
...
int func_22(Entity eParam0, Entity eParam1, int iParam2) // Position - 0xFD7 Signature - 22 03 06
{
	int i;
...
void func_23(var uParam0) // Position - 0x1087 Signature - 22 01 03 00 00 66 00 27 04
{
	if (uParam0->f_4 != -1)
	{
...
void func_24(int iParam0, int iParam1) // Position - 0x10BD Signature - 22 02 04 00 00 66 00 39 57
{
	if (func_34(iParam0))
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x10D6 Signature - 22 03 05 00 00 66 00 73
{
...
BOOL func_26(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1100 Signature - 22 03 05 00 00 66 00 27
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_27() // Position - 0x11FF Signature - 22 00 02 00 00 6D 59
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_28(var uParam0, int iParam1) // Position - 0x1214 Signature - 22 02 04 00 00 66 01 66 00 32
{
	*uParam0 = iParam1;
	return;
}

void func_29(int iParam0) // Position - 0x1221 Signature - 22 01 03 00 00 66 00 2F 23
{
	if (iParam0 <= 0)
		return;
...
void func_30(var uParam0) // Position - 0x1248 Signature - 22 01 03 00 00 66 00 73
{
	func_39(uParam0, 0f);
	return;
}

float func_31(var uParam0) // Position - 0x1257 Signature - 22 01 03 00 00 66 00 39 BA
{
	if (!func_40(uParam0))
		return uParam0->f_1;
...
int func_32(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6) // Position - 0x128C Signature - 22 07 0B
{
	Volume volume;
	int num;
...
BOOL func_33(Entity eParam0) // Position - 0x12BD Signature - 22 01 13
{
	int num;
	var unk5;
	Hash entityModel;
...
BOOL func_34(int iParam0) // Position - 0x1357 Signature - 22 01 03 00 00 66 00 76 2F
{
	if (*iParam0 == 0)
		return false;
...
int func_35(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x136F Signature - 22 04 0D 00 00 2F
{
...
BOOL func_36(BOOL bParam0) // Position - 0x1431 Signature - 22 01 03 00 00 66 00 8B
{
	if (bParam0)
...
BOOL func_37() // Position - 0x1461 Signature - 22 00 02 00 00 39
{
	return func_53() != -1;
}

BOOL func_38() // Position - 0x146F Signature - 22 00 02 00 00 5D 0C
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_39(var uParam0, float fParam1) // Position - 0x1494 Signature - 22 02 04 00 00 39
{
...
BOOL func_40(var uParam0) // Position - 0x14BA Signature - 22 01 03 00 00 66 00 76 09
{
	return func_56(*uParam0, 1);
}

BOOL func_41(var uParam0) // Position - 0x14CA Signature - 22 01 03 00 00 66 00 76 11
{
	return func_56(*uParam0, 2);
}

float func_42() // Position - 0x14DA Signature - 22 00 03
{
...
int func_43(var uParam0, var uParam1, Volume volParam2, int iParam3) // Position - 0x150C Signature - 22 04 0D 00 00 09
{
	ItemSet itemSet;
...
void func_44(Volume volParam0) // Position - 0x15C7 Signature - 22 01 03 00 00 66 00 03 05 00 26
{
...
int func_45() // Position - 0x15DE Signature - 22 00 02 00 00 6D 2F
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

BOOL func_46(Hash hParam0, int iParam1) // Position - 0x15F3 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 2D
{
	if (hParam0 == 0)
		return false;
...
int func_47(Hash hParam0) // Position - 0x160D Signature - 22 01 0A 00 00 66 00 2F 39 F3 15 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 31 05 8B 04 00 2F 50 01 01 4B 03 27 02
{
	var unk;
...
Hash func_48(Hash hParam0, int iParam1) // Position - 0x1638 Signature - 22 02 07
{
	int num;
	var unk;
	Hash hash;
...
int func_49(Hash hParam0, BOOL bParam1) // Position - 0x16B2 Signature - 22 02 18
{
	var unk;
	int num;
	int num2;
...
int func_50(Hash hParam0, int iParam1) // Position - 0x1711 Signature - 22 02 04 00 00 66 01 2F
{
	if (iParam1 == 0)
		return 0;
...
int func_51(BOOL bParam0) // Position - 0x173D Signature - 22 01 03 00 00 39
{
	if (func_2() == -1)
	{
...
struct<4> func_52(Hash hParam0, BOOL bParam1) // Position - 0x177E Signature - 22 02 09
{
	var unk;
...
int func_53() // Position - 0x17A3 Signature - 22 00 02 00 00 5D F4
{
	return Global_1149172.f_137;
}

void func_54(var uParam0, int iParam1) // Position - 0x17B1 Signature - 22 02 04 00 00 66 00 76 66 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_55(var uParam0, int iParam1) // Position - 0x17C2 Signature - 22 02 04 00 00 66 00 76 66 00
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_56(int iParam0, int iParam1) // Position - 0x17D7 Signature - 22 02 04 00 00 66 00 66
{
	return iParam0 && iParam1 != false;
}

BOOL func_57(Hash hParam0, Hash hParam1) // Position - 0x17E6 Signature - 22 02 04 00 00 66 00 2F 39
{
	if (!func_46(hParam0, 0))
...
void func_58(Hash hParam0, var uParam1, var uParam2) // Position - 0x1827 Signature - 22 03 05 00 00 2F
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_59(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1A33 Signature - 22 07 1B
{
	Hash hash;
...
struct<4> func_60(BOOL bParam0) // Position - 0x1B11 Signature - 22 01 04 00 00 66 00 39 3D 17 00 67 03 66 03 11 15
{
	int num;
...
void func_61(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1BB2 Signature - 22 05 07 00 00 4B
{
...
BOOL func_62(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x1BCD Signature - 22 04 06 00 00 66 03
{
...
int func_63(int iParam0) // Position - 0x1BF2 Signature - 22 01 03 00 00 66 00 2F 8A
{
	if (iParam0 < 0)
		return 0;
...
Hash func_64(Hash hParam0) // Position - 0x1C13 Signature - 22 01 03 00 00 66 00 50
{
	return hParam0;
}

BOOL func_65(Hash hParam0, int iParam1) // Position - 0x1C1D Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 2E
{
	if (hParam0 == 0)
		return false;
...
struct<5> func_66(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x1C37 Signature - 22 03 2F
{
	var unk;
	int num;
	var unk6;
	...
	switch (num)
	{
		...
		case joaat("DOG"):
			...
			{
				unk = { func_67(joaat("kit_camp"), unk, 1084182731, bParam1) };
				unk.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(hParam0, joaat("kit_camp"));
			}
			else if (func_75(hParam0, -1483207246))
			{
				unk = { func_67(joaat("WARDROBE"), unk, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (iParam2 && func_70(hParam0, true))
			{
				...
				if (!func_71(hParam0, &unk, 1728382685, false, false))
					unk.f_4 = 1728382685;
				else if (!func_71(hParam0, &unk, -649335959, false, false))
					unk.f_4 = -649335959;
				else if (func_72(hParam0, &unk6, 1728382685))
					unk.f_4 = 1728382685;
				else
					unk.f_4 = -649335959;
			}
...
struct<4> func_67(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x1FAB Signature - 22 07 0D
{
	var outGuid;
...
BOOL func_68(Hash hParam0, Hash hParam1) // Position - 0x1FDC Signature - 22 02 04 00 00 66 00 11
{
...
struct<4> func_69(BOOL bParam0) // Position - 0x2012 Signature - 22 01 04 00 00 5D
{
	int num;
	...
	if (Global_1572887.f_14 == 0)
	{
		...
		if (num == 2)
		{
			if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1292143))
				Global_1292143 = { func_67(joaat("character"), func_77(), -1591664384, bParam0) };
		...
		else if (num == 3)
		{
			if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&(Global_1292143.f_12)))
				Global_1292143.f_12 = { func_67(joaat("character"), func_77(), -1591664384, false) };
		
			return Global_1292143.f_12;
		}
	}

	return func_67(joaat("character"), func_77(), -1591664384, bParam0);
}

int func_70(Hash hParam0, BOOL bParam1) // Position - 0x20B2 Signature - 22 02 04 00 00 66 00 39 8F
{
...
BOOL func_71(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x20E9 Signature - 22 05 07 00 00 66 00 42
{
	return func_79(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_72(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x2104 Signature - 22 03 09
{
	var unk;
...
struct<4> func_73(BOOL bParam0) // Position - 0x2125 Signature - 22 01 04 00 00 66 00 39 3D 17 00 67 03 66 03 11 0B
{
	int num;
...
int func_74(Hash hParam0) // Position - 0x218F Signature - 22 01 0A 00 00 66 00 2F 39 F3 15 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 31 05 8B 04 00 2F 50 01 01 4B 03 27 01
{
	var unk;
...
BOOL func_75(Hash hParam0, int iParam1) // Position - 0x21BA Signature - 22 02 08
{
	Hash hash;
	int num;
	int i;
	...
	for (i = 0; i < fitsSlotCount; i = i + 1)
	{
		if (ITEMDATABASE::_ITEMDATABASE_GET_FITS_SLOT_INFO(num, i, &hash))
			if (func_81(hParam0, iParam1, hash))
				return true;
	}
...
BOOL func_76(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x2227 Signature - 22 08 0A
{
	return func_82(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

struct<4> func_77() // Position - 0x223D Signature - 22 00 06
{
	var unk;
...
int func_78() // Position - 0x2249 Signature - 22 00 02 00 00 37
{
...
int func_79(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2266 Signature - 22 09
{
...
BOOL func_80(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x22E5 Signature - 22 04 07
{
	int inventoryId;
...
BOOL func_81(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x232A Signature - 22 03 05 00 00 66 02
{
...
BOOL func_82(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x235D Signature - 22 05 07 00 00 66 00 03 05 00 5B
{
...
int func_83(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2397 Signature - 22 04 06 00 00 66 00
{
...
BOOL func_84(Hash hParam0) // Position - 0x23CA Signature - 22 01 03 00 00 66 00 03 05 00 5C
{
