...
BOOL func_38(int iParam0) // Position - 0xAE7 Signature - 22 01 03 00 00 85 EB E4 1C 66
{
	return Global_1893611 && iParam0 != false;
}

void func_39(int iParam0) // Position - 0xAF8 Signature - 22 01 03 00 00 85 EB E4 1C 85
{
...
void func_79(int iParam0) // Position - 0x2635 Signature - 22 01 03 00 00 6D 81
{
...
void func_99(int iParam0, int iParam1) // Position - 0x3FF6 Signature - 22 02 04 00 00 66 00 66 01 13
{
...
void func_101(int iParam0, int iParam1) // Position - 0x405F Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 02 04
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_102(int iParam0, int iParam1) // Position - 0x4070 Signature - 22 02 04 00 00 66 00 5D B8 0C 10 80 5C 63 4B 27 31
{
...
BOOL func_105(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x40C1 Signature - 22 04 06 00 00 66 00 25 6D
{
	return func_163(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_106(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x40E1 Signature - 22 04 06 00 00 66 00 25 81
{
...
int func_114(int iParam0) // Position - 0x4D41 Signature - 22 01 08
{
	int i;
	var gamerHandle;
	int bountyData;
...
BOOL func_117(int iParam0, int iParam1) // Position - 0x4F45 Signature - 22 02 04 00 00 66 00 39 B7
{
	if (!func_10(iParam0))
		return false;
...
int func_119() // Position - 0x4FCC Signature - 22 00 02 00 00 85 E9
{
	return Global_1902569;
}

int func_120(int iParam0) // Position - 0x4FD8 Signature - 22 01 03 00 00 66 00 6D 0C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_121(int iParam0) // Position - 0x4FEB Signature - 22 01 03 00 00 66 00 4D
{
...
void func_149(var uParam0) // Position - 0x58BC Signature - 22 01 0C
{
	var unk;
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x59AE Signature - 22 02 04 00 00 66 00 5D B8 0C 10 80 5C 63 4B 27 01
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_154(int iParam0, int iParam1) // Position - 0x59C7 Signature - 22 02 04 00 00 66 00 66 01 39
{
	func_153(iParam0, iParam1);
...
void func_181(int iParam0, int iParam1) // Position - 0x634D Signature - 22 02 04 00 00 66 00 39 F1
{
	if (!func_218(iParam0))
		return;
...
BOOL func_190(var uParam0, int iParam1, int iParam2) // Position - 0x653A Signature - 22 03 08 00 00 66 01 6D 1F 59 67 05 66 01 6D 1F 47 67 06 66 05 66 00 17 01 66 06 03 09 00 21 67 07 66 05 66 00 63 01 66 06 03 08 00 56
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_197(var uParam0, int iParam1, int iParam2) // Position - 0x6630 Signature - 22 03 08 00 00 66 01 6D 1F 59 67 05 66 01 6D 1F 47 67 06 66 05 66 00 17 01 66 06 03 09 00 21 67 07 66 05 66 00 63 01 66 06 03 08 00 20
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_200(int iParam0, int iParam1) // Position - 0x6687 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01
{
	return iParam0 && iParam1 != false;
}
...
void func_211(var uParam0, int iParam1) // Position - 0x720C Signature - 22 02 04 00 00 66 00 76 66 00
{
...
BOOL func_221(var uParam0, int iParam1, int iParam2) // Position - 0x734F Signature - 22 03 07
{
