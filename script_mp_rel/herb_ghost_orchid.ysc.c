...
void func_1(var uParam0) // Position - 0x7B0 Signature - 22 01 03 00 00 66 00 6D 11 39
{
	func_50(uParam0, 17);
	return;
}
...
int func_125(int iParam0) // Position - 0x4728 Signature - 22 01 03 00 00 66 00 6D 11 03
{
