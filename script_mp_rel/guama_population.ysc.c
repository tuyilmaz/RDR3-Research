...
void func_2() // Position - 0x8B Signature - 22 00 02 00 00 86
{
...
int func_3() // Position - 0x20D Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x21B Signature - 22 02
{
	int i;
...
void func_5() // Position - 0x2FB Signature - 22 00 02 00 00 50
{
	return;
}

void func_6(Volume volParam0) // Position - 0x303 Signature - 22 01 03 00 00 66 00 03 05 00 12 05 8B 03 00 50 01 00 66 00 6D
{
...
void func_7(Volume volParam0) // Position - 0x344 Signature - 22 01 03 00 00 66 00 03 05 00 12 05 8B 03 00 50 01 00 66 00 21
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
