...
BOOL func_38(BOOL bParam0) // Position - 0xA38 Signature - 22 01 03 00 00 85 EB E4 1C 66
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xA49 Signature - 22 01 03 00 00 85 EB E4 1C 85
{
...
Hash func_94(int iParam0) // Position - 0x3895 Signature - 22 01 08
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
BOOL func_97(int iParam0, BOOL bParam1) // Position - 0x3A99 Signature - 22 02 04 00 00 66 00 39 B7
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_99() // Position - 0x3B20 Signature - 22 00 02 00 00 85 E9
{
	return Global_1902569;
}

int func_100(BOOL bParam0) // Position - 0x3B2C Signature - 22 01 03 00 00 66 00 6D 0C
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 12) & 31;
}

int func_101(BOOL bParam0) // Position - 0x3B3F Signature - 22 01 03 00 00 66 00 4D
{
...
BOOL func_111(int iParam0, BOOL bParam1) // Position - 0x3EFC Signature - 22 02 04 00 00 39 04 0D 00 08 72 04
{
	if (func_45() != -1)
		return false;
...
void func_121(int iParam0, BOOL bParam1) // Position - 0x4645 Signature - 22 02 04 00 00 39 04 0D 00 08 72 03 00 50 02 00 66 00 39 93 2B 00 05 8B 03 00 50 02 00 66 00 87 AB 26 17 02 66 00
{
	if (func_45() != -1)
		return;
...
void func_139(int iParam0, BOOL bParam1) // Position - 0x4E0F Signature - 22 02 04 00 00 66 00 39 5B
{
	if (!func_171(iParam0))
		return;
...
BOOL func_150(int iParam0, BOOL bParam1) // Position - 0x505E Signature - 22 02 04 00 00 66 00 5D B8 0C 10 80 5C 63 4B 27 31
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL func_151(int iParam0, BOOL bParam1) // Position - 0x5077 Signature - 22 02 04 00 00 66 00 5D B8 0C 10 80 5C 63 4B 27 01
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && bParam1 != false;
}

void func_152(int iParam0, BOOL bParam1) // Position - 0x5090 Signature - 22 02 04 00 00 66 00 66 01 39
{
...
void func_163(int iParam0, int iParam1) // Position - 0x5260 Signature - 22 02 04 00 00 66 00 76 66 00
{
...
BOOL func_175(BOOL bParam0, BOOL bParam1) // Position - 0x53C3 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01
{
