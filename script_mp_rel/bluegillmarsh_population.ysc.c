...
void func_1() // Position - 0x6C Signature - 22 00 02 00 00 03
{
...
void func_2() // Position - 0xA5 Signature - 22 00 02 00 00 2F
{
...
int func_3() // Position - 0x27A Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x288 Signature - 22 02 05
{
	int i;
...
void func_5() // Position - 0x368 Signature - 22 00 02 00 00 86
{
	ENTITY::REMOVE_MODEL_HIDE(3366.87f, -680.8071f, 41.6795f, 1f, joaat("ann_jail_main_door_01"), 0);
	return;
}

void func_6(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x38A Signature - 22 03
{
...
void func_7(Volume volParam0) // Position - 0x409 Signature - 22 01
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_8(var uParam0, int iParam1) // Position - 0x44A Signature - 22 02 04
{
