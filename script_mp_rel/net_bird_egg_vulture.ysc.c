...
int func_1() // Position - 0xB1 Signature - 22 00 02 00 00 5D 17
{
	return Global_1572887.f_14;
}

struct<2> func_2(int iParam0) // Position - 0xBF Signature - 22 01 03 00 00 11
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_3(int iParam0, var uParam1) // Position - 0xD3 Signature - 22 02 04 00 00 66 00 50
{
	return iParam0;
}

void func_4(var uParam0) // Position - 0xDD Signature - 22 01 05 00 00 2F
{
	int num;
	int i;
...
void func_5(var uParam0, int iParam1, int iParam2, Hash hParam3, int iParam4, int iParam5, int iParam6) // Position - 0x189 Signature - 22 07 09
{
	*uParam0 = 5;
...
BOOL func_6(var uParam0) // Position - 0x1CD Signature - 22 01 03 00 00 03 01 00 96
{
...
BOOL func_7() // Position - 0x1E7 Signature - 22 00 02 00 00 2F
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x1F0 Signature - 22 01 03 00 00 66 00 27 04 3C
{
	switch (uParam0->f_4)
	{
		case 0:
...
int func_9(var uParam0) // Position - 0x221 Signature - 22 01 07 00 00 66 00 27
{
	var unk;
...
void func_10(BOOL bParam0) // Position - 0x272 Signature - 22 01 03 00 00 66 00 8B 09
{
	if (bParam0)
		func_21(0, 6);
	else
...
void func_11(var uParam0) // Position - 0x28F Signature - 22 01 03 00 00 66 00 27 07
{
...
int func_12(var uParam0) // Position - 0x2AA Signature - 22 01 04 00 00 2F 67 03 66 03 62 8A 94
{
	int i;
...
int func_13(Object obParam0, Object obParam1, int iParam2) // Position - 0x350 Signature - 22 03 08
{
	int i;
	var src;
...
BOOL func_14(int iParam0, int iParam1) // Position - 0x3FA Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 04
{
	return iParam0 && iParam1 != false;
}

void func_15(int iParam0, int iParam1) // Position - 0x409 Signature - 22 02 04 00 00 66 00 66 01 39 90
{
	func_23(iParam0, iParam1);
	return;
}

void func_16(var uParam0) // Position - 0x419 Signature - 22 01 03 00 00 66 00 39 A5
{
	func_24(uParam0);
...
void func_17(var uParam0) // Position - 0x430 Signature - 22 01 05 00 00 66
{
	BOOL flag;
	int i;
...
void func_18(var uParam0) // Position - 0x89A Signature - 22 01 07 00 00 66 00 39
{
	BOOL flag;
	int i;
...
BOOL func_19(var uParam0) // Position - 0xB6D Signature - 22 01 03 00 00 66 00 27 04 2F
{
	if (uParam0->f_4 == 0)
...
int func_20(int iParam0, Any anParam1) // Position - 0xBBC Signature - 22 02 10
{
	var unk;
...
void func_21(int iParam0, int iParam1) // Position - 0xBE5 Signature - 22 02 04 00 00 66 00 66 01 39 13
{
...
void func_22(int iParam0, int iParam1, BOOL bParam2) // Position - 0xC29 Signature - 22 03 05 00 00 66 00 66
{
...
void func_23(int iParam0, int iParam1) // Position - 0xC90 Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 01
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_24(var uParam0) // Position - 0xCA5 Signature - 22 01 03 00 00 66 00 27 04 08
{
	if (uParam0->f_4 != -1)
	{
...
void func_25(int iParam0, int iParam1) // Position - 0xCD8 Signature - 22 02 04 00 00 66 00 39 45
{
	if (func_58(iParam0))
...
int _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0xCF1 Signature - 22 01 03 00 00 66 00 27 01
{
	return uParam0->f_1;
}

void func_27(var uParam0) // Position - 0xCFD Signature - 22 01 03 00 00 66 00 76 39
{
	if (func_59(*uParam0))
	{
...
BOOL func_28(var uParam0) // Position - 0xD6D Signature - 22 01 08
{
	var unk;
...
void func_29(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xDB3 Signature - 22 08 0F
{
	BOOL flag;
	BOOL flag2;
	float num;
...
BOOL func_30(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7) // Position - 0xFDC Signature - 22 08 0A 00 00 66 06
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
int func_31(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x1031 Signature - 22 06 18
{
	int num;
	var unk13;
	int num2;
...
float func_32(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x106C Signature - 22 05 07 00 00 66 00 03 05 00 19
{
...
void func_33(var uParam0) // Position - 0x1094 Signature - 22 01 03 00 00 6D
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
void func_34(Object obParam0, BOOL bParam1) // Position - 0x10D7 Signature - 22 02 04 00 00 66 00 03
{
	if (ENTITY::DOES_ENTITY_EXIST(obParam0))
		if (!bParam1)
...
void func_35(var uParam0, int iParam1) // Position - 0x1149 Signature - 22 02 04 00 00 66 01 66 00 6C
{
	uParam0->f_1 = iParam1;
	return;
}

void func_36(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x1157 Signature - 22 08 0A 00 00 66 00
{
	if (!func_58(iParam0))
	{
...
void func_37(var uParam0) // Position - 0x118B Signature - 22 01 03 00 00 54 24 2F
{
...
BOOL func_38(var uParam0) // Position - 0x11A1 Signature - 22 01 03 00 00 54 24 03
{
...
BOOL func_39(var uParam0) // Position - 0x11C2 Signature - 22 01 03 00 00 54 26
{
	if (!ENTITY::DOES_ENTITY_EXIST(obLocal_38))
...
void func_40(var uParam0) // Position - 0x11F3 Signature - 22 01 04 00 00 2F 67 03 66 03 62 8A DA
{
	int i;
...
int func_41(Object obParam0, Object obParam1, int iParam2) // Position - 0x12DE Signature - 22 03 06 00 00 66 00 03
{
	int i;
...
BOOL func_42() // Position - 0x138E Signature - 22 00 02 00 00 54
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_38))
...
void func_43(var uParam0, var uParam1, Any anParam2) // Position - 0x13AB Signature - 22 03 20 00 00 2F 6D 08 39 18 21 00 67 05 4B 06 6A 80 04 09 3D 41 41 6D 2A
{
	var unk;
	int num;
	int num2;
...
void func_44(var uParam0, var uParam1, Any anParam2) // Position - 0x144D Signature - 22 03 20 00 00 2F 6D 08 39 18 21 00 67 05 4B 06 6A 80 04 09 3D 41 41 6D 2B
{
	var unk;
	int num;
	int num2;
...
void func_45(var uParam0) // Position - 0x14EF Signature - 22 01 0F
{
	var entityCoords;
	var unk3;
...
int func_46(var uParam0, var uParam1) // Position - 0x1606 Signature - 22 02 06 00 00 2F
{
	int num;
	int i;
...
void func_47(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1642 Signature - 22 04 06 00 00 66 00 27
{
	if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_7))
	{
...
void func_48(var uParam0) // Position - 0x1679 Signature - 22 01 03 00 00 54 28 03 05 00 A2
{
	TASK::_REQUEST_HERB_COMPOSITE_ASSET(hLocal_40);
	return;
}

BOOL func_49(var uParam0) // Position - 0x1688 Signature - 22 01 03 00 00 54 28 03 05 00 0E
{
...
BOOL func_50(var uParam0) // Position - 0x169E Signature - 22 01 04 00 00 70
{
	var unk;
...
int func_51(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6) // Position - 0x16E0 Signature - 22 07 0B
{
	Volume volume;
	int num;
...
int func_52(var uParam0) // Position - 0x1711 Signature - 22 01 03 00 00 03 01 00 13
{
...
int func_53(var uParam0) // Position - 0x1754 Signature - 22 01 03 00 00 66 00 27 0D
{
	if (func_14(Global_1222327[*uParam0 /*251*/][uParam0->f_13], 2))
		return 1;
...
void func_54(var uParam0, int iParam1) // Position - 0x1778 Signature - 22 02 06 00 00 66 01
{
	BOOL flag;
	int i;
...
int func_55(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x18A4 Signature - 22 05 17
{
	var unk;
	int num;
...
BOOL func_56(int iParam0, int iParam1) // Position - 0x1913 Signature - 22 02 04 00 00 66 00 5D 77
{
	return MISC::IS_BIT_SET(Global_1072759.f_22475.f_417[iParam0 /*12*/], iParam1);
}

void func_57() // Position - 0x192F Signature - 22 00 02 00 00 5D 77
{
	SCRIPTS::_SET_ALL_PLAYER_BITS(&(Global_1072759.f_21353.f_260));
	return;
}

BOOL func_58(int iParam0) // Position - 0x1945 Signature - 22 01 03 00 00 66 00 76 2F 15
{
	if (*iParam0 == 0)
		return false;
...
BOOL func_59(Entity eParam0) // Position - 0x195D Signature - 22 01 04 00 00 66 00 03
{
	Hash entityModel;
...
BOOL func_60() // Position - 0x19B3 Signature - 22 00 03 00 00 70
{
...
void func_61(int iParam0, BOOL bParam1) // Position - 0x19F3 Signature - 22 02 06 00 00 66 00
{
	int num;
	int num2;
...
struct<5> func_62(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1A20 Signature - 22 03 2F
{
	var unk;
	int num;
	var unk6;
...
BOOL func_63(Hash hParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x1D94 Signature - 22 07 25
{
	var unk;
	var unk5;
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1EC8 Signature - 22 03 05 00 00 66 00 73
{
...
BOOL func_65(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1EF2 Signature - 22 03 05 00 00 66 00 27
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_66() // Position - 0x1FF1 Signature - 22 00 02 00 00 6D 59
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_67(var uParam0, int iParam1) // Position - 0x2006 Signature - 22 02 04 00 00 66 01 66 00 32
{
	*uParam0 = iParam1;
	return;
}

void func_68(int iParam0) // Position - 0x2013 Signature - 22 01 03 00 00 66 00 2F 23
{
	if (iParam0 <= 0)
		return;
...
void func_69(var uParam0) // Position - 0x203A Signature - 22 01 03 00 00 66 00 73
{
	func_110(uParam0, 0f);
	return;
}

float func_70(var uParam0) // Position - 0x2049 Signature - 22 01 03 00 00 66 00 39 BD
{
	if (!func_111(uParam0))
		return uParam0->f_1;
...
BOOL func_71(Entity eParam0) // Position - 0x207E Signature - 22 01 13
{
	int num;
	var unk5;
	Hash entityModel;
...
var func_72(BOOL bParam0, int iParam1) // Position - 0x2118 Signature - 22 02 04 00 00 73
{
	return func_73(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), bParam0, iParam1);
}

var func_73(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x2136 Signature - 22 0C
{
	var value;
	Player bitIndex;
	int i;
...
void func_75(Any* panParam0, int* piParam1) // Position - 0x2563 Signature - 22 02 04 00 00 66 01 03
{
...
BOOL func_76(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2594 Signature - 22 05 0E
{
	var groundZ;
	int num;
	BOOL flag;
...
int func_77(var uParam0, var uParam1, Volume volParam2, int iParam3) // Position - 0x2698 Signature - 22 04 0D 00 00 09
{
	ItemSet itemSet;
...
void func_78(Volume volParam0) // Position - 0x2753 Signature - 22 01 03 00 00 66 00 03 05 00 9E
{
...
void func_79(var uParam0, var uParam1, int iParam2) // Position - 0x276A Signature - 22 03 20 00 00 66
{
	var value;
	int num;
	int num2;
...
void func_80(var uParam0) // Position - 0x282F Signature - 22 01 03 00 00 66 00 37 22
{
...
void func_81(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x2867 Signature - 22 11
{
	int i;
	var unk;
...
Hash func_82(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x291D Signature - 22 04 07 00 00 37
{
	Hash weaponHash;
...
BOOL func_83(Hash hParam0) // Position - 0x295F Signature - 22 01 03 00 00 66 00 03 05 00 20
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

void func_84(int iParam0, var uParam1, var uParam2) // Position - 0x296D Signature - 22 03 06 00 00 66 00 67
{
	int num;
...
BOOL func_85(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x2989 Signature - 22 04 06 00 00 66 01
{
...
void func_86(int iParam0, int iParam1) // Position - 0x2A2B Signature - 22 02 05 00 00 66 00 5D
{
	int address;
...
struct<4> func_87(BOOL bParam0) // Position - 0x2A4F Signature - 22 01 04 00 00 5D 17 00 18 27 0E
{
	int num;
...
int func_88(Hash hParam0) // Position - 0x2AEF Signature - 22 01 0A 00 00 66 00 2F 39 01 2E 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 66 05 8B 04 00 2F 50 01 01 4B 03 27 02
{
	var unk;
...
struct<4> func_89(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x2B1A Signature - 22 07 0D
{
	var outGuid;
...
struct<4> func_90(BOOL bParam0) // Position - 0x2B4B Signature - 22 01 04 00 00 66 00 39 C2 34 00 67 03 66 03 11 15
{
	int num;
...
BOOL func_91(Hash hParam0, BOOL bParam1) // Position - 0x2BEC Signature - 22 02 04 00 00 66 00 39 C9
{
...
BOOL func_92(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2C23 Signature - 22 05 07 00 00 66 00 42
{
	return func_105(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_93(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x2C3E Signature - 22 03 09
{
	var unk;
...
struct<4> func_94(BOOL bParam0) // Position - 0x2C5F Signature - 22 01 04 00 00 66 00 39 C2 34 00 67 03 66 03 11 0B
{
	int num;
...
int func_95(Hash hParam0) // Position - 0x2CC9 Signature - 22 01 0A 00 00 66 00 2F 39 01 2E 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 66 05 8B 04 00 2F 50 01 01 4B 03 27 01
{
	var unk;
...
BOOL func_96(Hash hParam0, int iParam1) // Position - 0x2CF4 Signature - 22 02 08
{
	Hash hash;
	int num;
	int i;
...
BOOL func_97(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x2D61 Signature - 22 08 0A 00 00 4B
{
	return func_137(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_98(var uParam0) // Position - 0x2D77 Signature - 22 01 03 00 00 66 00 76 2F 39
{
...
BOOL func_99(Hash hParam0, int iParam1) // Position - 0x2E01 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 1E
{
	if (hParam0 == 0)
		return false;
...
Hash func_100(Hash hParam0) // Position - 0x2E1B Signature - 22 01 03 00 00 66 00 50
{
	return hParam0;
}

BOOL func_101(Hash hParam0, int iParam1) // Position - 0x2E25 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 08
{
	if (hParam0 == 0)
		return false;
...
int func_102(Hash hParam0, int iParam1) // Position - 0x2E3F Signature - 22 02 04 00 00 66 01 2F
{
	if (iParam1 == 0)
		return 0;
...
BOOL func_103(Hash hParam0) // Position - 0x2E6B Signature - 22 01 03 00 00 66 00 39 EF
{
	return func_88(hParam0) == joaat("WEAPON");
}

int func_104(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2E7F Signature - 22 04 06 00 00 66 00 2F
{
	if (!func_99(hParam0, 0))
	{
		if (func_101(func_100(hParam0), 2))
...
int func_105(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2EF3 Signature - 22 09
{
...
int func_106(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2F72 Signature - 22 04 0D 00 00 2F
{
...
BOOL func_107(BOOL bParam0) // Position - 0x3034 Signature - 22 01 03 00 00 66 00 8B 0D
{
	if (bParam0)
...
BOOL func_108() // Position - 0x3064 Signature - 22 00 02 00 00 39 EF
{
	return func_142() != -1;
}

BOOL func_109() // Position - 0x3072 Signature - 22 00 02 00 00 5D 0C CE 1D 27 01 37
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_110(var uParam0, float fParam1) // Position - 0x3097 Signature - 22 02 04 00 00 39
{
...
BOOL func_111(var uParam0) // Position - 0x30BD Signature - 22 01 03 00 00 66 00 76 09
{
	return func_145(*uParam0, 1);
}

BOOL func_112(var uParam0) // Position - 0x30CD Signature - 22 01 03 00 00 66 00 76 11
{
	return func_145(*uParam0, 2);
}

float func_113() // Position - 0x30DD Signature - 22 00 03 00 00 03
{
...
int func_114() // Position - 0x310F Signature - 22 00 02 00 00 6D 2F
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

int func_115() // Position - 0x3124 Signature - 22 00 02 00 00 5D FD
{
	return Global_1051645.f_12;
}

char* func_116() // Position - 0x3132 Signature - 22 00 02 00 00 6D 99
{
	return "unnamed";
}

BOOL func_117(int iParam0) // Position - 0x313D Signature - 22 01 04 00 00 2F 67 03 66 00
{
	int num;
...
BOOL func_118(int iParam0) // Position - 0x31CC Signature - 22 01 03 00 00 5D 17
{
...
int func_119(int iParam0) // Position - 0x31EA Signature - 22 01 03 00 00 66 00 6D
{
	if (iParam0 == 255)
...
BOOL func_120(Player plParam0) // Position - 0x3235 Signature - 22 01 03 00 00 03 01 00 43
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
int func_121(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x327A Signature - 22 16 18
{
	if (!func_149(uParam0))
		return 0;
...
BOOL func_122(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x32AA Signature - 22 06 08
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

var func_123(int iParam0) // Position - 0x32D3 Signature - 22 01 16
{
	var memberHandles;
	var value;
	int gangMembers;
...
int func_124() // Position - 0x332C Signature - 22 00 02 00 00 5D 0C CE 1D 27 01 50
{
	return Global_1953292.f_1;
}

BOOL func_125(Any anParam0) // Position - 0x333A Signature - 22 01 03 00 00 66 00 76 2F 0B
{
...
BOOL func_126(int iParam0, int iParam1) // Position - 0x3380 Signature - 22 02 04 00 00 66 00 87
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_127(int iParam0) // Position - 0x3398 Signature - 22 01 03 00 00 66 00 42
{
...
BOOL func_128(int iParam0) // Position - 0x33AF Signature - 22 01 07 00 00 66 00 5D
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_129(int iParam0, int iParam1) // Position - 0x347B Signature - 22 02 04 00 00 66 00 5D 12
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_130(int iParam0) // Position - 0x3494 Signature - 22 01 03 00 00 5D 00
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_131() // Position - 0x34A7 Signature - 22 00 02 00 00 39 5B
{
	if (!func_150())
		return false;
...
int func_132(BOOL bParam0) // Position - 0x34C2 Signature - 22 01 03 00 00 39
{
	if (func_1() == -1)
	{
...
struct<4> func_133() // Position - 0x3503 Signature - 22 00 06
{
	var unk;
...
int func_134() // Position - 0x350F Signature - 22 00 02 00 00 37
{
...
BOOL func_135(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x352C Signature - 22 04 07 00 00 2F
{
	int inventoryId;
...
BOOL func_136(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x3571 Signature - 22 03 05 00 00 66 02
{
...
BOOL func_137(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x35A4 Signature - 22 05 07 00 00 66 00 03 05 00 5C
{
...
BOOL func_138(Hash hParam0) // Position - 0x35DE Signature - 22 01 03 00 00 66 00 37 11
{
	return func_152(hParam0, 1279601681);
}

Hash func_139(Hash hParam0, int iParam1) // Position - 0x35F1 Signature - 22 02 07
{
	int num;
	var unk;
	Hash hash;
...
int func_140(Hash hParam0, BOOL bParam1) // Position - 0x366B Signature - 22 02 18
{
	var unk;
	int num;
	int num2;
...
struct<4> func_141(Hash hParam0, BOOL bParam1) // Position - 0x36CA Signature - 22 02 09
{
	var unk;
...
int func_142() // Position - 0x36EF Signature - 22 00 02 00 00 5D F4
{
	return Global_1149172.f_137;
}

void func_143(var uParam0, int iParam1) // Position - 0x36FD Signature - 22 02 04 00 00 66 00 76 66 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_144(var uParam0, int iParam1) // Position - 0x370E Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 02
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_145(int iParam0, int iParam1) // Position - 0x3723 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 05
{
	return iParam0 && iParam1 != false;
}

BOOL func_146(int iParam0, int iParam1) // Position - 0x3732 Signature - 22 02 05 00 00 66 00 67
{
	int num;
...
BOOL func_147(Player plParam0) // Position - 0x37A6 Signature - 22 01 03 00 00 5D 77
{
...
void func_148(Player plParam0) // Position - 0x37C3 Signature - 22 01 04 00 00 5D 17 00 18 27 11 2F 1C 6A 05 8B 09 00 5D 17 00 18 27 0E 2F 1C 30 8B 03 00 50 01 00 66 00 67 03 66 03 2F 35 6A 05 8B 06 00 66 03 6D 20 7E 30 8B 03 00 50 01 00 66 03 5D 32
{
	Player player;
...
BOOL func_149(var uParam0) // Position - 0x3846 Signature - 22 01 03 00 00 66 00 76 6D
{
	if (*uParam0 >= 40)
		return false;
...
BOOL func_150() // Position - 0x385B Signature - 22 00 02 00 00 03
{
...
int func_151(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x386F Signature - 22 04 06 00 00 66 00 39
{
...
BOOL func_152(Hash hParam0, Hash hParam1) // Position - 0x38A2 Signature - 22 02 04 00 00 66 00 2F 39
{
	if (!func_99(hParam0, 0))
...
void func_153(Hash hParam0, var uParam1, var uParam2) // Position - 0x38E3 Signature - 22 03 05 00 00 2F
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_154(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3AEF Signature - 22 07 1B
{
	Hash hash;
...
void func_155(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x3BCD Signature - 22 05 07 00 00 4B
{
...
BOOL func_156(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x3BE8 Signature - 22 04 06 00 00 66 03
{
...
int func_157(int iParam0) // Position - 0x3C0D Signature - 22 01 03 00 00 66 00 2F 8A
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_158(Any* panParam0, int iParam1, int iParam2) // Position - 0x3C2E Signature - 22 03 07
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_159() // Position - 0x3C65 Signature - 22 00 02 00 00 5D DD
{
	return Global_1102813.f_3672;
}

void func_160(Player plParam0) // Position - 0x3C74 Signature - 22 01 04 00 00 5D 17 00 18 27 11 2F 1C 6A 05 8B 09 00 5D 17 00 18 27 0E 2F 1C 30 8B 03 00 50 01 00 66 00 67 03 66 03 2F 35 6A 05 8B 06 00 66 03 6D 20 7E 30 8B 03 00 50 01 00 66 03 5D 77
{
	Player player;
...
void func_161(Player plParam0) // Position - 0x3CE0 Signature - 22 01 03 00 00 66 00 5D
{
...
BOOL func_162(Hash hParam0) // Position - 0x3D1B Signature - 22 01 03 00 00 66 00 03 05 00 2B
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_163(Hash hParam0, Hash hParam1) // Position - 0x3D29 Signature - 22 02 04 00 00 66 00 11
{
