...
void func_1(int iParam0) // Position - 0x59 Signature - 22 01 03 00 00 66
{
	iParam0 = iParam0;
...
BOOL func_2() // Position - 0x94 Signature - 22 00 02 00 00 39
{
	if (func_5() != -1)
...
void func_3(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, Hash hParam5) // Position - 0xAF Signature - 22 06
{
...
void func_4(int iParam0) // Position - 0x148 Signature - 22 01 03 00 00 37
{
...
int func_5() // Position - 0x1AE Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

void func_6() // Position - 0x1BC Signature - 22 00 02 00 00 03
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_7(BOOL bParam0, BOOL bParam1) // Position - 0x1C8 Signature - 22 02 05
{
	int i;
...
Hash func_8(int iParam0, BOOL bParam1) // Position - 0x2A8 Signature - 22 02 04 00 00 66
{
	switch (iParam0)
	{
		case 0:
...
void func_9(int iParam0, BOOL bParam1) // Position - 0xA6D Signature - 22 02 04 00 00 5D
{
