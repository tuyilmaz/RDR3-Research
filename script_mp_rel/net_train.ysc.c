...
void main() // Position - 0x0 Signature - 22 00 02 00 00 89
{
...
void func_1(var uParam0) // Position - 0x3A Signature - 22 01 04 00 00 03 01 00 01
{
	int gameTimer;
...
void func_2(var uParam0, var uParam1) // Position - 0xA3 Signature - 22 02 04 00 00 11
{
	*uParam0 = { *uParam1 };
	return;
}

BOOL func_3(var uParam0) // Position - 0xB3 Signature - 22 01 03 00 00 2F
{
...
void func_4(var uParam0, var uParam1, var uParam2) // Position - 0xD8 Signature - 22 03 05 00 00 03
{
...
void func_5(var uParam0, var uParam1) // Position - 0xFB Signature - 22 02 05 00 00 03
{
	int i;
...
void func_6(int iParam0, int iParam1) // Position - 0x18A Signature - 22 02 04 00 00 03
{
...
int func_7() // Position - 0x1A7 Signature - 22 00 05
{
	int scriptStatus;
	int gameTimer;
	int timeoutTime;
...
BOOL func_8() // Position - 0x2B8 Signature - 22 00 02 00 00 5D 17 00 18 27 0A
{
...
void func_9() // Position - 0x2E6 Signature - 22 00 02 00 00 03
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

int func_10(int iParam0, int iParam1, char* sParam2) // Position - 0x2F2 Signature - 22 03 05 00 00 09 50 03 01 22 03
{
	return 1;
}

int func_11(int iParam0, int iParam1, char* sParam2) // Position - 0x2FB Signature - 22 03 05 00 00 09 50 03 01 22 01
{
	return 1;
}

void func_12(BOOL bParam0) // Position - 0x304 Signature - 22 01 0D
{
	int num;
	var unk;
	int num2;
...
BOOL func_13(BOOL bParam0, BOOL bParam1) // Position - 0x3CD Signature - 22 02 05 00 00 5D
{
	int i;
...
void func_14(var uParam0, var uParam1, var uParam2) // Position - 0x4AD Signature - 22 03 05 00 00 66 00 76 3C
{
	switch (*uParam0)
	{
		case 0:
...
void func_15(var uParam0, var uParam1, var uParam2) // Position - 0x515 Signature - 22 03 05 00 00 66 00 76 42
{
...
void func_16(var uParam0, var uParam1) // Position - 0x598 Signature - 22 02 05 00 00 66 01
{
	Vehicle train;
...
void func_17(Hash hParam0) // Position - 0x610 Signature - 22 01 06
{
...
int func_18() // Position - 0x64E Signature - 22 00 02 00 00 5D 17 00 18 27 0E
{
	return Global_1572887.f_14;
}

BOOL func_19() // Position - 0x65C Signature - 22 00 02 00 00 5D FD 0B 10 27 08
{
	return Global_1051645.f_8;
}

void func_20(var uParam0, var uParam1) // Position - 0x66A Signature - 22 02 04 00 00 66 00 66 01 09
{
	func_33(uParam0, uParam1, 1);
	return;
}

void func_21(var uParam0, var uParam1) // Position - 0x67B Signature - 22 02 04 00 00 66 01 27 01 39 FD 0C 00 8B
{
...
void func_22(var uParam0, var uParam1) // Position - 0x697 Signature - 22 02 0C
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
void func_23(var uParam0, var uParam1, var uParam2) // Position - 0x7D2 Signature - 22 03 07 00 00 66 00
{
	Player player;
	int i;
...
void func_24(var uParam0, var uParam1) // Position - 0x883 Signature - 22 02 04 00 00 66 00 27 01
{
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(uParam0->f_1))
...
void func_25(var uParam0, int iParam1) // Position - 0x8A0 Signature - 22 02 04 00 00 66 00 27 02
{
...
void func_26(var uParam0, var uParam1) // Position - 0x8B7 Signature - 22 02 04 00 00 66 00 76 2F
{
	if (*uParam0 > 0)
		func_25(uParam1, 1);
...
void func_27(var uParam0, var uParam1) // Position - 0x8CD Signature - 22 02 04 00 00 66 01 27 01 39 FD 0C 00 6A
{
...
void func_28(var uParam0, var uParam1) // Position - 0x8F1 Signature - 22 02 11
{
	Vehicle train;
		...
		else if (VEHICLE::_HAS_TRAIN_LOADED(train))
		{
			...
			if (func_50(uParam1->f_1))
			{
				if (MAP::DOES_BLIP_EXIST(func_51(*uParam1)))
				{
					...
					MAP::_BLIP_SET_STYLE(uParam1->f_3, -399496385);
				}
				else
				{
					uParam1->f_3 = MAP::BLIP_ADD_FOR_ENTITY(-399496385, train);
				}
			
				MAP::SET_BLIP_SPRITE(uParam1->f_3, joaat("blip_ambient_train"), true);
			
				if (!func_52(*uParam1, 16))
					MAP::BLIP_REMOVE_MODIFIER(uParam1->f_3, -1186550032);
				else
					MAP::BLIP_ADD_MODIFIER(uParam1->f_3, -1186550032);
...
void func_29(var uParam0, var uParam1, var uParam2) // Position - 0xB3D Signature - 22 03 05 00 00 66 00 66
{
	if (func_45(uParam0, uParam2))
	{
		func_25(uParam2, 4);
...
void func_30(var uParam0, var uParam1) // Position - 0xBBE Signature - 22 02 04 00 00 66 00 66 01 39 98
{
	func_16(uParam0, uParam1);
...
void func_31(var uParam0) // Position - 0xBDC Signature - 22 01 0A 00 00 2F
{
	Entity entity;
...
int func_32(int iParam0, BOOL bParam1) // Position - 0xC9C Signature - 22 02 1C
{
	var unk;
...
void func_33(var uParam0, var uParam1, int iParam2) // Position - 0xCE8 Signature - 22 03 05 00 00 66 00 76 66
{
	if (*uParam0 != iParam2)
		*uParam0 = iParam2;
...
BOOL func_34(Hash hParam0) // Position - 0xCFD Signature - 22 01 07
{
	BOOL num;
	Hash trainModelFromTrainConfigByCarIndex;
	int numCarsFromTrainConfig;
...
Vector3 func_35(int iParam0) // Position - 0xD4E Signature - 22 01 03 00 00 1D
{
	return Global_1148506.f_2[iParam0 /*18*/].f_3;
}

BOOL func_36(int iParam0) // Position - 0xD64 Signature - 22 01 03 00 00 66 00 5D 5A 86 11 80 02 63 12 27 06
{
	return Global_1148506.f_2[iParam0 /*18*/].f_6;
}

BOOL func_37(var uParam0) // Position - 0xD78 Signature - 22 01 03 00 00 66 00 39 FF 14 00 8B 04 00 09 50 01 01 2F 50 01 01 22 0A
{
	if (func_69(uParam0))
		return 1;
...
BOOL func_38(var uParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0xD8E Signature - 22 0A
{
	int i;
	int numCarsFromTrainConfig;
	BOOL flag;
...
float func_39(int iParam0) // Position - 0xE45 Signature - 22 01 03 00 00 66 00 39 FF 14 00 8B 08
{
	if (func_69(iParam0))
		return 4.5f;
...
float func_40(int iParam0) // Position - 0xEA7 Signature - 22 01 03 00 00 66 00 39 FF 14 00 8B 04 00 7C
{
	if (func_69(iParam0))
		return 5f;
...
BOOL func_41(int iParam0) // Position - 0xEC1 Signature - 22 01 03 00 00 66 00 39 FF 14 00 8B 04 00 09 50 01 01 09
{
	if (func_69(iParam0))
		return true;
...
BOOL func_42(int iParam0) // Position - 0xED7 Signature - 22 01 03 00 00 66 00 39 FF 14 00 8B 04 00 09 50 01 01 2F 50 01 01 22 01
{
	if (func_69(iParam0))
		return true;
...
BOOL func_43(int iParam0) // Position - 0xEED Signature - 22 01 03 00 00 66 00 3C 02 00 EE D3 2D D4 0D 00 39 24 8B EB 03 00 68 08 00 2F 50 01 01 2F 50 01 01 09 50 01 01 22 01
{
	switch (iParam0)
	{
		case -735194130:
...
BOOL func_44(int iParam0) // Position - 0xF12 Signature - 22 01 03 00 00 66 00 3C 01
{
	switch (iParam0)
	{
		case -343202759:
...
BOOL func_45(var uParam0, var uParam1) // Position - 0xF2D Signature - 22 02 04 00 00 09
{
	if (func_71(1))
		return true;
...
BOOL func_46(var uParam0) // Position - 0xFAF Signature - 22 01 05
{
	int i;
	int num;
...
void func_47(var uParam0, var uParam1) // Position - 0xFF3 Signature - 22 02 08
{
	Vehicle train;
	int trainCarriageTrailerNumber;
	int num;
...
BOOL func_48(var uParam0, int iParam1, int iParam2) // Position - 0x10A1 Signature - 22 03 05 00 00 66 02 2F 35 6A 05 8B 06 00 66 02 6D 20 7E 30 8B 04
{
...
void func_49(int iParam0, Vehicle veParam1) // Position - 0x10CB Signature - 22 02 04 00 00 66 01 66 00 5D 6B 88 11 80 02 63 2B 6C 02
{
	Global_1149035.f_2[iParam0 /*43*/].f_2 = veParam1;
	return;
}

BOOL func_50(int iParam0) // Position - 0x10E1 Signature - 22 01 03 00 00 66 00 39 FF 14 00 8B 04 00 2F
{
	if (func_69(iParam0))
		return false;
...
Blip func_51(int iParam0) // Position - 0x1113 Signature - 22 01 03 00 00 66 00 5D 6B
{
	return Global_1149035.f_2[iParam0 /*43*/].f_6;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x1127 Signature - 22 02 05 00 00 2F 67 04 2F
{
	int i;
...
void func_53(int iParam0, var uParam1) // Position - 0x116E Signature - 22 02 04 00 00 66 01 66 00 5D 6B 88 11 80 02 63 2B 6C 06
{
	Global_1149035.f_2[iParam0 /*43*/].f_6 = uParam1;
	return;
}

BOOL func_54(int iParam0) // Position - 0x1184 Signature - 22 01 03 00 00 66 00 3C 02 00 EE D3 2D D4 0D 00 39 24 8B EB 03 00 68 08 00 2F 50 01 01 2F 50 01 01 09 50 01 01 22 02
{
	switch (iParam0)
	{
		case -735194130:
...
void func_55(int iParam0, int iParam1) // Position - 0x11A9 Signature - 22 02 04 00 00 66 01 66 00 5D 6B 88 11 80 02 63 2B 6C 05
{
	Global_1149035.f_2[iParam0 /*43*/].f_5 = iParam1;
	return;
}

BOOL func_56(var uParam0) // Position - 0x11BF Signature - 22 01 03 00 00 09
{
	return true;
}

void func_57(int iParam0, int iParam1, Entity eParam2) // Position - 0x11C8 Signature - 22 03 05 00 00 66 02 66 01 66 00 5D 6B 88 11 80 02 63 2B 80 0C 64
{
	Global_1149035.f_2[iParam0 /*43*/].f_12[iParam1 /*2*/] = eParam2;
	return;
}

void func_58(int iParam0, int iParam1, Volume volParam2) // Position - 0x11E2 Signature - 22 03 05 00 00 66 02 66 01 66 00 5D 6B 88 11 80 02 63 2B 80 0C 63
{
	Global_1149035.f_2[iParam0 /*43*/].f_12[iParam1 /*2*/].f_1 = volParam2;
	return;
}

void func_59(int iParam0, int iParam1) // Position - 0x11FE Signature - 22 02 04 00 00 66 00 03
{
...
BOOL func_60(var uParam0, var uParam1) // Position - 0x1232 Signature - 22 02 06
{
	Vehicle vehicle;
	Ped driverOfVehicle;
...
void func_61(var uParam0, int iParam1, int iParam2) // Position - 0x1272 Signature - 22 03 05 00 00 66 02 2F 35 6A 05 8B 06 00 66 02 6D 20 7E 30 8B 03
{
	if (iParam2 < 0 || iParam2 >= 32)
		return;
...
void func_62() // Position - 0x12AB Signature - 22 00 1A
{
	int num;
	int i;
	float num2;
...
BOOL func_63(var uParam0) // Position - 0x1385 Signature - 22 01 0A 00 00 66
{
	Entity entity;
	Vector3 entityCoords;
	float num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1427 Signature - 22 03 05 00 00 66 00 73
{
...
BOOL func_65(int iParam0, BOOL bParam1) // Position - 0x1451 Signature - 22 02 04 00 00 39
{
	if (!func_82())
		return false;
...
void func_66(int iParam0) // Position - 0x148C Signature - 22 01 03 00 00 5D 32
{
	Global_1149035.f_2[iParam0 /*43*/].f_10 = Global_1295666.f_16 + 60;
	return;
}

var func_67(int iParam0, int iParam1) // Position - 0x14A8 Signature - 22 02 04 00 00 73
{
	return func_84(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

int func_68(Any* panParam0, var uParam1) // Position - 0x14C6 Signature - 22 02 04 00 00 4B
{
...
BOOL func_69(int iParam0) // Position - 0x14FF Signature - 22 01 03 00 00 66 00 3C 05
{
	switch (iParam0)
	{
		case -1865722934:
...
BOOL func_70(Hash hParam0) // Position - 0x1532 Signature - 22 01 03 00 00 66 00 2F
{
	if (hParam0 == 0)
		return true;
...
BOOL func_71(int iParam0) // Position - 0x1551 Signature - 22 01 03 00 00 5D 6B
{
	return func_73(Global_1149035.f_1, iParam0);
}

int func_72(int iParam0) // Position - 0x1565 Signature - 22 01 03 00 00 66 00 5D 5A 86 11 80 02 63 12 27 01
{
	return Global_1148506.f_2[iParam0 /*18*/].f_1;
}

BOOL func_73(BOOL bParam0, int iParam1) // Position - 0x1579 Signature - 22 02 04 00 00 66 00 66 01 69
{
	return bParam0 && iParam1 != false;
}

void func_74(var uParam0, var uParam1, int iParam2, Entity eParam3) // Position - 0x1588 Signature - 22 04 17
{
	Vector3 entityCoords;
	float radius;
	Hash hashKey;
...
void func_75(BOOL bParam0, int iParam1) // Position - 0x16AD Signature - 22 02 04 00 00 66 00 66 01 39 82
{
	func_85(bParam0, iParam1);
	return;
}

int func_76(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, Hash hParam10, BOOL bParam11, BOOL bParam12, int iParam13, BOOL bParam14, BOOL bParam15) // Position - 0x16BD Signature - 22 10
{
	Volume volume;
	int num;
...
Hash func_77() // Position - 0x171B Signature - 22 00 02 00 00 5D 9E
{
	return Global_1939102.f_26;
}

void func_78(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x1729 Signature - 22 07
{
...
BOOL func_79(var uParam0, int iParam1) // Position - 0x180D Signature - 22 02 04 00 00 66 00 27 14 66 01 39 79 15 00 50
{
	return func_73(uParam0->f_20, iParam1);
}

void func_80(var uParam0, int iParam1) // Position - 0x181F Signature - 22 02 04 00 00 66 00 27 14 66 01 39 79 15 00 05
{
...
BOOL func_81(int iParam0) // Position - 0x183F Signature - 22 01 04 00 00 03 01 00 87
{
	int frameCount;
...
BOOL func_82() // Position - 0x187B Signature - 22 00 02 00 00 1D
{
...
void func_83(int iParam0, int iParam1) // Position - 0x18CC Signature - 22 02 04 00 00 66 00 5D 5A
{
...
var func_84(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x18EF Signature - 22 0C 1A
{
	var value;
	Player bitIndex;
	int i;
...
void func_85(BOOL bParam0, int iParam1) // Position - 0x1C82 Signature - 22 02 04 00 00 66 00 76 66
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

int func_86(var uParam0, var uParam1, int iParam2, Volume volParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, Hash hParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0x1C93 Signature - 22 0C 16
{
	ItemSet itemSet;
...
void func_87(Volume volParam0) // Position - 0x1DA7 Signature - 22 01 03 00 00 66 00 03
{
...
BOOL func_88(Ped pedParam0, BOOL bParam1) // Position - 0x1DBE Signature - 22 02 05 00 00 66 00 2F
{
	BOOL flag;
...
int func_89() // Position - 0x1EBD Signature - 22 00 02 00 00 5D FD 0B 10 27 0C
{
	return Global_1051645.f_12;
}

char* func_90() // Position - 0x1ECB Signature - 22 00 02 00 00 6D
{
	return "unnamed";
}

BOOL func_91(int iParam0) // Position - 0x1ED6 Signature - 22 01 04 00 00 2F
{
	int num;
...
BOOL func_92(int iParam0) // Position - 0x1F65 Signature - 22 01 03 00 00 5D 17
{
...
int func_93(int iParam0) // Position - 0x1F83 Signature - 22 01 03 00 00 66 00 6D
{
	if (iParam0 == 255)
...
BOOL func_94(Player plParam0) // Position - 0x1FCE Signature - 22 01 03 00 00 03
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_95(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x2013 Signature - 22 06
{
...
BOOL func_96(Ped pedParam0, var uParam1) // Position - 0x208B Signature - 22 02 05 00 00 2F 67 04 66
{
	int i;
...
BOOL func_97(int iParam0, int iParam1) // Position - 0x20B7 Signature - 22 02 05 00 00 66 00 67
{
	int num;
...
BOOL func_98(Player plParam0) // Position - 0x212B Signature - 22 01 03 00 00 5D 77
{
...
void func_99(Player plParam0) // Position - 0x2148 Signature - 22 01 04 00 00 5D 17 00 18 27 11 2F 1C 6A 05 8B 09 00 5D 17 00 18 27 0E 2F 1C 30 8B 03 00 50 01 00 66 00 67 03 66 03 2F 35 6A 05 8B 06 00 66 03 6D 20 7E 30 8B 03 00 50 01 00 66 03 5D 32
{
	Player player;
...
int func_100(Ped pedParam0, BOOL bParam1) // Position - 0x21CB Signature - 22 02 04 00 00 66 00 5D EB
{
	return func_105(pedParam0, Global_1893611.f_2, bParam1);
}

BOOL func_101(Any* panParam0, int iParam1, int iParam2) // Position - 0x21E1 Signature - 22 03 07 00 00 66 01 6D
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_102() // Position - 0x2218 Signature - 22 00 02 00 00 5D DD
{
	return Global_1102813.f_3672;
}

void func_103(Player plParam0) // Position - 0x2227 Signature - 22 01 04 00 00 5D 17 00 18 27 11 2F 1C 6A 05 8B 09 00 5D 17 00 18 27 0E 2F 1C 30 8B 03 00 50 01 00 66 00 67 03 66 03 2F 35 6A 05 8B 06 00 66 03 6D 20 7E 30 8B 03 00 50 01 00 66 03 5D 77
{
	Player player;
...
void func_104(Player plParam0) // Position - 0x2293 Signature - 22 01 03 00 00 66 00 5D 77
{
...
int func_105(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x22CE Signature - 22 03 07 00 00 66 01 08
{
	var unk;
	var unk2;
...
BOOL func_106(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2300 Signature - 22 05
{
	BOOL flag;
...
int func_107(Ped pedParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x29C0 Signature - 22 04 09
{
...
Hash func_108(int iParam0) // Position - 0x2A3A Signature - 22 01 03 00 00 66 00 39 78 2A 00 05 8B 04 00 2F 50 01 01 66 00 5D A7 E5 1C 17
{
	if (!func_110(iParam0))
		return 0;
...
PersChar func_109(int iParam0) // Position - 0x2A58 Signature - 22 01 03 00 00 66 00 39 78 2A 00 05 8B 04 00 2F 50 01 01 66 00 5D A7 E5 1C 63
{
	if (!func_110(iParam0))
		return 0;
...
BOOL func_110(int iParam0) // Position - 0x2A78 Signature - 22 01 03 00 00 66 00 08
{
