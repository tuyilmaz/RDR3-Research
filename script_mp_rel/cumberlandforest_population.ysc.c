...
void func_1() // Position - 0x5A Signature - 22 00 02 00 00 03
{
...
void func_2() // Position - 0x93 Signature - 22 00 02 00 00 86
{
...
void func_3() // Position - 0x1C4 Signature - 22 00 02 00 00 6D
{
...
void func_4() // Position - 0x470 Signature - 22 00 02 00 00 37
{
	func_12(160425541, 1);
...
int func_5() // Position - 0x48C Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

BOOL func_6(BOOL bParam0, BOOL bParam1) // Position - 0x49A Signature - 22 02 05
{
	int i;
...
void func_7() // Position - 0x57A Signature - 22 00 02 00 00 54
{
	LAW::_REMOVE_GUARD_ZONE(sLocal_22);
	return;
}

void func_8(Volume volParam0) // Position - 0x588 Signature - 22 01 03 00 00 66 00 03 05 00 08 05 8B 03 00 50 01 00 66 00 21
{
...
void func_9(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x5CF Signature - 22 03 05 00 00 66 00 03 05 00 08 05 8B 03 00 50 03 00 66 00 66 01 25
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x64E Signature - 22 03 05 00 00 66 00 03 05 00 08 05 8B 03 00 50 03 00 66 00 66 01 6D
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0) // Position - 0x6C4 Signature - 22 01 03 00 00 66 00 03 05 00 08 05 8B 03 00 50 01 00 66 00 6D
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12(Hash hParam0, int iParam1) // Position - 0x705 Signature - 22 02 04 00 00 66 00 09
{
	func_14(hParam0, true, 0, false, false, 0, false, false);
	return;
}

void func_13(var uParam0, int iParam1) // Position - 0x71A Signature - 22 02 04 00 00 66 00 76
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_14(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x72F Signature - 22 08
{
...
Hash func_15(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7BA Signature - 22 03 05 00 00 66 00 03 05 00 29
{
...
BOOL func_16(Hash hParam0) // Position - 0x85E Signature - 22 01 03 00 00 66 00 39
{
	if (func_22(hParam0))
...
void func_17(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x879 Signature - 22 04
{
	if (func_16(hParam0))
	{
...
void func_18(Hash hParam0, BOOL bParam1) // Position - 0x8B1 Signature - 22 02 04 00 00 66 00 39 5E 08 00 8B 1D 00 66 00 03 05 00 20 11
{
	if (func_16(hParam0))
...
void func_19(Hash hParam0, BOOL bParam1) // Position - 0x8DF Signature - 22 02 04 00 00 66 00 39 5E 08 00 8B 1D 00 66 00 03 05 00 20 09
{
	if (func_16(hParam0))
...
void func_20(Hash hParam0, BOOL bParam1) // Position - 0x90D Signature - 22 02 04 00 00 66 00 39 5E 08 00 8B 1D 00 66 00 03 05 00 20 2F
{
	if (func_16(hParam0))
...
BOOL func_21() // Position - 0x93B Signature - 22 00 02 00 00 09
{
	return true;
}

BOOL func_22(Hash hParam0) // Position - 0x944 Signature - 22 01 03 00 00 66 00 2F
{
	return hParam0 != 0;
}
