...
void func_1() // Position - 0x56 Signature - 22 00 02 00 00 03
{
...
void func_2() // Position - 0x8F Signature - 22 00 02 00 00 2F
{
...
void func_3() // Position - 0x830 Signature - 22 00 02 00 00 50 00 00 22 00
{
	return;
}

int func_4() // Position - 0x838 Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

BOOL func_5(BOOL bParam0, BOOL bParam1) // Position - 0x846 Signature - 22 02 05
{
	int i;
...
void func_6() // Position - 0x926 Signature - 22 00 02 00 00 50 00 00 22 01
{
	return;
}

void func_7(Volume volParam0) // Position - 0x92E Signature - 22 01 03 00 00 66 00 03 05 00 03 05 8B 03 00 50 01 00 66 00 6D
{
...
void func_8(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x96F Signature - 22 03 05 00 00 66 00 03 05 00 03 05 8B 03 00 50 03 00 66 00 66 01 25
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_9(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x9EE Signature - 22 03 05 00 00 66 00 03 05 00 03 05 8B 03 00 50 03 00 66 00 66 01 6D 40
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xA61 Signature - 22 03 05 00 00 66 00 03 05 00 03 05 8B 03 00 50 03 00 66 00 66 01 6D E0
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0) // Position - 0xAD7 Signature - 22 01 03 00 00 66 00 03 05 00 03 05 8B 03 00 50 01 00 66 00 21
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12(var uParam0, int iParam1) // Position - 0xB18 Signature - 22 02 04
{
