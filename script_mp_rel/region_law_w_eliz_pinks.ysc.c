...
void func_1(BOOL bParam0) // Position - 0x6F Signature - 22 01 04
{
	int i;
...
BOOL func_2(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x17B Signature - 22 04 29
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_3() // Position - 0x2B0 Signature - 22 00 02 00 00 39 2B
{
...
BOOL func_4() // Position - 0x300 Signature - 22 00 02 00 00 09
{
	return func_19(1, 255);
}

BOOL func_5() // Position - 0x30F Signature - 22 00 02 00 00 5D 9E 96 1D 27 38
{
...
void func_6() // Position - 0x325 Signature - 22 00 16
{
	BOOL flag;
	BOOL flag2;
	var unk;
...
BOOL func_7(Ped pedParam0, int iParam1) // Position - 0x779 Signature - 22 02 05 00 00 66 00 2F
{
	int num;
...
void func_8(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x878 Signature - 22 04 06 00 00 66 00 76
{
...
float func_9(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8E6 Signature - 22 04 06 00 00 66 00 03 05 00 14
{
...
void func_10(Ped* ppedParam0) // Position - 0x92E Signature - 22 01 03 00 00 66 00 76 03
{
	if (!ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		return;
...
BOOL func_11(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x98D Signature - 22 03 05 00 00 5D
{
...
int func_12() // Position - 0xA2B Signature - 22 00 02 00 00 5D 9E 96 1D 27 04
{
	return Global_1939102.f_4;
}

BOOL func_13(int iParam0, BOOL bParam1) // Position - 0xA39 Signature - 22 02 04 00 00 66 00 39 CF 11 00 05 8B 04 00 2F 50 02 01 66
{
	if (!func_39(iParam0))
		return false;
...
int func_14() // Position - 0xA75 Signature - 22 00 02 00 00 5D C6
{
	return Global_1896646.f_41;
}

BOOL func_15(int iParam0, BOOL bParam1) // Position - 0xA83 Signature - 22 02 04 00 00 66 00 39 29 12 00 05 8B 04 00 2F 50 02 01 66
{
	if (!func_41(iParam0))
		return false;
...
int func_16() // Position - 0xABF Signature - 22 00 02 00 00 5D EB
{
	return Global_1893611.f_2;
}

BOOL func_17(int iParam0) // Position - 0xACD Signature - 22 01 03 00 00 66 00 39 81
{
	if (!func_43(iParam0))
		return false;
...
BOOL func_18() // Position - 0xAEE Signature - 22 00 03 00 00 39
{
	int num;
...
BOOL func_19(int iParam0, int iParam1) // Position - 0xB64 Signature - 22 02 05 00 00 66 00 67
{
	int num;
...
BOOL func_20(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0xBD8 Signature - 22 04 06 00 00 66 02
{
...
void func_21(var uParam0) // Position - 0xC0E Signature - 22 01 03 00 00 66 00 73
{
	func_49(uParam0, 0f);
	return;
}

BOOL func_22(int iParam0) // Position - 0xC1D Signature - 22 01 06
{
	int num;
	int num2;
	int offset;
...
void func_23(int iParam0, BOOL bParam1) // Position - 0xC47 Signature - 22 02 06
{
	int num;
	int num2;
...
float func_24(var uParam0) // Position - 0xC74 Signature - 22 01 03 00 00 66 00 39 9B
{
	if (!func_53(uParam0))
		return 0f;
...
BOOL func_25() // Position - 0xCA6 Signature - 22 00 02 00 00 2F
{
...
BOOL func_26(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, float fParam7, int iParam8, float fParam9, float fParam10, int iParam11) // Position - 0xCC7 Signature - 22 0C
{
	int num;
...
BOOL func_27(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDEC Signature - 22 06 12
{
	var unk;
	var unk6;
...
BOOL func_28(Volume volParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xE39 Signature - 22 04 06 00 00 66 00 03 05 00 7A
{
...
int func_29(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xE59 Signature - 22 03 05 00 00 1D
{
	return func_59(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

void func_30(var uParam0, int iParam1, BOOL bParam2) // Position - 0xE6F Signature - 22 03 05 00 00 2F
{
	uParam0->f_2 = 0;
...
void func_31() // Position - 0xEAA Signature - 22 00 02 00 00 1D
{
...
void func_32(int iParam0) // Position - 0xEEB Signature - 22 01 03 00 00 1D
{
	if (!CAM::IS_SPHERE_VISIBLE(uLocal_26, 5f))
	{
...
void func_33(int iParam0) // Position - 0xF38 Signature - 22 01 03 00 00 66 00 89
{
...
int func_34(Ped pedParam0, Ped pedParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0xFC4 Signature - 22 05 07 00 00 66 00
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return 0;
...
Vector3 func_35(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x1009 Signature - 22 05 0B
{
	var unk;
	float endRange;
...
int func_36(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1051 Signature - 22 05 0E
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_37(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1155 Signature - 22 07 09 00 00 66 01
{
...
BOOL func_38(int iParam0, int iParam1) // Position - 0x11C0 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01
{
	return iParam0 && iParam1 != false;
}

BOOL func_39(int iParam0) // Position - 0x11CF Signature - 22 01 03 00 00 66 00 08 20 6A 8B 05
{
	return iParam0 > -1 && iParam0 < 6;
}

BOOL func_40(int iParam0, int iParam1) // Position - 0x11E4 Signature - 22 02 04 00 00 66 00 39 CF 11 00 05 8B 04 00 2F 50 02 01 5D
{
	if (!func_39(iParam0))
		return false;
...
BOOL func_41(int iParam0) // Position - 0x1229 Signature - 22 01 03 00 00 66 00 08 20 6A 8B 06
{
	return iParam0 > -1 && iParam0 < 17;
}

BOOL func_42(int iParam0, BOOL bParam1) // Position - 0x123F Signature - 22 02 04 00 00 66 00 39 29 12 00 05 8B 04 00 2F 50 02 01 5D
{
	if (!func_41(iParam0))
		return false;
...
BOOL func_43(int iParam0) // Position - 0x1281 Signature - 22 01 03 00 00 66 00 2F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_44(int iParam0, BOOL bParam1) // Position - 0x1297 Signature - 22 02 04 00 00 5D
{
	if (Global_1572887.f_14 == -1)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x12C8 Signature - 22 03 05 00 00 66 00 73
{
...
BOOL func_46(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x12F2 Signature - 22 07 09 00 00 66 00 03
{
...
BOOL func_47(Any* panParam0, int iParam1, int iParam2) // Position - 0x134D Signature - 22 03 07 00 00 66
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_48() // Position - 0x1384 Signature - 22 00 02 00 00 5D DD
{
	return Global_1102813.f_3672;
}

void func_49(var uParam0, float fParam1) // Position - 0x1393 Signature - 22 02 04 00 00 39
{
...
void func_50(int iParam0, var uParam1, var uParam2) // Position - 0x13B9 Signature - 22 03 06 00 00 66
{
	int num;
...
BOOL func_51(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x13D5 Signature - 22 04 06 00 00 66 01
{
	if (iParam1 < 0 || iParam1 > 32)
		return false;
...
void func_52(int iParam0, int iParam1) // Position - 0x1477 Signature - 22 02 05 00 00 66 00 5D
{
	int address;
...
BOOL func_53(var uParam0) // Position - 0x149B Signature - 22 01 03 00 00 66 00 76 09
{
	return func_72(*uParam0, 1);
}

BOOL func_54(var uParam0) // Position - 0x14AB Signature - 22 01 03 00 00 66 00 76 11
{
	return func_72(*uParam0, 2);
}

float func_55() // Position - 0x14BB Signature - 22 00 03 00 00 03
{
...
void func_56(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6, int iParam7, float fParam8, float fParam9, int iParam10) // Position - 0x14ED Signature - 22 0B
{
	int num;
	int num2;
...
void func_57(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x22FB Signature - 22 05 07 00 00 66 01
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_58(float fParam0, var uParam1, var uParam2) // Position - 0x2ABB Signature - 22 03 07 00 00 1D
{
	float num;
	float num2;
...
int func_59(Hash hParam0) // Position - 0x2AFA Signature - 22 01 03 00 00 66 00 3C
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
Ped func_60(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x2BB4 Signature - 22 0D
{
	Ped ped;
...
Vector3 func_61(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2BF4 Signature - 22 04 07 00 00 66 03
{
	float num;
...
BOOL func_62(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x2C2B Signature - 22 06 08 00 00 66
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

float func_63(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x2C54 Signature - 22 06 08 00 00 73
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_64(var uParam0, int iParam1) // Position - 0x2C72 Signature - 22 02 04 00 00 66 00 76 66 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_65(var uParam0, int iParam1) // Position - 0x2C83 Signature - 22 02 04 00 00 66 00 76 66 00
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_66(int iParam0, int iParam1) // Position - 0x2C98 Signature - 22 02 04 00 00 66 00 87
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_67(int iParam0) // Position - 0x2CB0 Signature - 22 01 03 00 00 66 00 42
{
...
BOOL func_68(int iParam0) // Position - 0x2CC7 Signature - 22 01 07
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_69(int iParam0, int iParam1) // Position - 0x2D93 Signature - 22 02 04 00 00 66 00 5D
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_70(int iParam0) // Position - 0x2DAC Signature - 22 01 03 00 00 5D
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_71() // Position - 0x2DBF Signature - 22 00 02 00 00 39 26
{
	if (!func_76())
		return false;
...
BOOL func_72(int iParam0, int iParam1) // Position - 0x2DDA Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 04
{
	return iParam0 && iParam1 != false;
}

float func_73(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x2DE9 Signature - 22 04 07 00 00 66 00
{
	float num;
...
int func_74(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2E0E Signature - 22 04 07 00 00 39
{
	int num;
...
void func_75(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2E5C Signature - 22 08
{
	BOOL flag;
...
BOOL func_76() // Position - 0x2F26 Signature - 22 00 02 00 00 03
{
...
int func_77(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2F3A Signature - 22 04 0B
{
	int num;
	int num2;
	int num3;
...
void func_78(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2FF1 Signature - 22 03 05 00 00 66 00 03
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_79(Ped pedParam0, BOOL bParam1) // Position - 0x3036 Signature - 22 02 04 00 00 66 00 03
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_80(Ped pedParam0, int iParam1) // Position - 0x307B Signature - 22 02 04 00 00 66 01
{
	if (iParam1 == 1)
...
int func_81(var uParam0, var uParam1, var uParam2) // Position - 0x30A2 Signature - 22 03 06 00 00 1D
{
	int num;
...
int func_82(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x30DD Signature - 22 07 09 00 00 66 00 66
{
	if (fParam0 < fParam3)
