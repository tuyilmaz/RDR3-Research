...
void main() // Position - 0x0 Signature - 22 00 1D
{
	int num;
...
BOOL func_1(var uParam0, Any* panParam1) // Position - 0x187 Signature - 22 02 06 00 00 03
{
...
void func_2(var uParam0, char* sParam1) // Position - 0x24A Signature - 22 02 05 00 00 66 01 03 05 00 41
{
	BOOL flag;
...
void func_3() // Position - 0x3BD Signature - 22 00 02 00 00 6F 08 FF 39 C8 0D 00 8B 03 00 50 00 00 4D
{
	if (func_34(8, 255))
		return;
...
BOOL func_4(var uParam0) // Position - 0x3D8 Signature - 22 01 03 00 00 66 00 76 09 39 26
{
	return func_36(*uParam0, 1);
}

void func_5(var uParam0) // Position - 0x3E8 Signature - 22 01 03 00 00 73
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_6(var uParam0, Any* panParam1) // Position - 0x3FE Signature - 22 02 09 00 00 66 01 03
{
	Vehicle vehicle;
	Player player;
	Entity vehicleOwner;
...
BOOL func_7(var uParam0, var uParam1) // Position - 0x491 Signature - 22 02 04 00 00 09
{
...
BOOL func_8(int iParam0, int iParam1) // Position - 0x4F6 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 05 00 00 66
{
	return iParam0 && iParam1 != false;
}

BOOL func_9(var uParam0, var uParam1) // Position - 0x505 Signature - 22 02 05 00 00 66 00 39
{
	BOOL flag;
...
void func_10(var uParam0, char* sParam1) // Position - 0x60D Signature - 22 02 04 00 00 66 01 03
{
	if (MISC::IS_STRING_NULL_OR_EMPTY_OR_SPACES(sParam1))
	{
	}
...
BOOL func_11(var uParam0) // Position - 0x655 Signature - 22 01 03 00 00 66 00 76 6D 10
{
...
BOOL func_12(var uParam0) // Position - 0x6F1 Signature - 22 01 04 00 00 09 67 03 66 00 39 FB
{
	BOOL num;
...
void func_13(var uParam0, int iParam1) // Position - 0x718 Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_14(var uParam0) // Position - 0x729 Signature - 22 01 03 00 00 66 00 76 09 39 F6
{
	return func_8(*uParam0, 1);
}

BOOL func_15(int iParam0) // Position - 0x739 Signature - 22 01 06 00 00 66 00 67
{
	int num;
	int num2;
	int offset;
...
BOOL func_16() // Position - 0x763 Signature - 22 00 02 00 00 39 38
{
...
void func_17(int iParam0, BOOL bParam1) // Position - 0x782 Signature - 22 02 06 00 00 66 00 4B
{
	int num;
	int num2;
...
BOOL func_18(var uParam0) // Position - 0x7AF Signature - 22 01 03 00 00 66 00 39 29 17
{
	if (func_55(uParam0))
		return true;
...
void func_19() // Position - 0x7EC Signature - 22 00 02 00 00 6F 08 FF 39 C8 0D 00 8B 03 00 50 00 00 1D 39 C6
{
	if (func_34(8, 255))
		return;
...
void func_20() // Position - 0x806 Signature - 22 00 02 00 00 6F 08 FF 39 C8 0D 00 8B 03 00 50 00 00 1D 39 D5
{
	if (func_34(8, 255))
		return;
...
BOOL func_21(var uParam0, var uParam1) // Position - 0x820 Signature - 22 02 0E
{
	int numberOfEvents;
	BOOL flag;
	struct<6> eventData;
...
BOOL func_22(var uParam0, Any* panParam1) // Position - 0x8B7 Signature - 22 02 04 00 00 25
{
	uParam0->f_26 = 851;
	return true;
}

void func_23(var uParam0) // Position - 0x8C7 Signature - 22 01 03 00 00 89
{
...
void func_24(var uParam0) // Position - 0x8F4 Signature - 22 01 04 00 00 2F 67 03 66 03 4D
{
	int i;
...
BOOL func_25(Vehicle veParam0) // Position - 0x976 Signature - 22 01 03 00 00 66 00 03 05 00 75
{
...
void func_26(Vehicle veParam0, BOOL bParam1) // Position - 0x9BA Signature - 22 02 06 00 00 66 00 39
{
...
BOOL func_27(var uParam0, Entity eParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xA12 Signature - 22 05 08 00 00 66 01
{
	int i;
...
void func_28(int iParam0) // Position - 0xB42 Signature - 22 01 04 00 00 03 01 00 6A 67 03 66 03 5D AB AD 13 63 13 27 0A 66 03
{
	int num;
...
void func_29() // Position - 0xB72 Signature - 22 00 02 00 00 6D 61
{
	func_69(97);
	func_69(98);
	func_69(99);
...
BOOL func_30() // Position - 0xBBE Signature - 22 00 02 00 00 5D F8
{
	return Global_1149432.f_5568.f_132;
}

void func_31(int iParam0, Player plParam1, Player plParam2, BOOL bParam3) // Position - 0xBCF Signature - 22 04 11
{
	BOOL flag;
	Player bitIndex;
	var value;
...
void func_32(Hash hParam0, int iParam1, char* sParam2) // Position - 0xD52 Signature - 22 03 07 00 00 66 00 09
{
	int cashBalance;
	int num;
...
void func_33() // Position - 0xDB6 Signature - 22 00 02 00 00 2F
{
	Global_1149432.f_5568.f_132 = 0;
	return;
}

BOOL func_34(int iParam0, int iParam1) // Position - 0xDC8 Signature - 22 02 04 00 00 66 01 6D
{
	if (iParam1 == 255)
...
void func_35(int iParam0, int iParam1) // Position - 0xE02 Signature - 22 02 0D
{
	int eventData;
	var value;
	Player player;
...
BOOL func_36(int iParam0, int iParam1) // Position - 0xF26 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 05 00 00 5D
{
	return iParam0 && iParam1 != false;
}

BOOL func_37(BOOL bParam0, BOOL bParam1) // Position - 0xF35 Signature - 22 02 05 00 00 5D 17
{
	int i;
...
BOOL func_38(var uParam0, var uParam1) // Position - 0x1015 Signature - 22 02 04 00 00 2F
{
	return false;
}

void func_39(var uParam0) // Position - 0x101E Signature - 22 01 04 00 00 2F 67 03 6D
{
	BOOL flag;
...
void func_40(var uParam0) // Position - 0x10BB Signature - 22 01 06 00 00 66 00 27
{
	Player player;
	Any gangId;
	Any gangId2;
...
BOOL func_41(var uParam0, var uParam1) // Position - 0x11FC Signature - 22 02 04 00 00 66 00 39 9D
{
	func_85(uParam0);
	return false;
}

BOOL func_42(var uParam0, var uParam1) // Position - 0x120B Signature - 22 02 04 00 00 66 00 76 6D
{
...
BOOL func_43() // Position - 0x1282 Signature - 22 00 02 00 00 5D 0C CE 1D 27 01 37 B1 DE 6E 01 1C 6A 8B 0D 00 5D 0C CE 1D 27 01 37 46 B6 C9 78 1C 69 50
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_44(var uParam0) // Position - 0x12A7 Signature - 22 01 03 00 00 66 00 73
{
	func_90(uParam0, 0f);
	return;
}

BOOL func_45(var uParam0, int iParam1) // Position - 0x12B6 Signature - 22 02 04 00 00 66 00 39 D8
{
	if (!func_4(uParam0))
		return false;
...
void func_46(var uParam0, int iParam1) // Position - 0x12DD Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 01 03 00 00 09
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_47(var uParam0) // Position - 0x12F2 Signature - 22 01 03 00 00 09
{
	return true;
}

BOOL func_48(var uParam0) // Position - 0x12FB Signature - 22 01 07 00 00 66 00 39 72
{
	int expected;
	var actual;
	int i;
...
BOOL func_49(var uParam0) // Position - 0x1413 Signature - 22 01 04 00 00 09 67 03 66 00 39 29
{
	BOOL flag;
...
BOOL func_50() // Position - 0x1538 Signature - 22 00 03 00 00 39 C8
{
	int i;
...
BOOL func_51(BOOL bParam0) // Position - 0x156F Signature - 22 01 03 00 00 39 D9
{
	if (func_96())
		return false;
...
void func_52(int iParam0, var uParam1, var uParam2) // Position - 0x1647 Signature - 22 03 06 00 00 66 00 67
{
	int num;
...
BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1663 Signature - 22 04 06 00 00 66 01
{
	if (iParam1 < 0 || iParam1 > 32)
		return false;
...
void func_54(int iParam0, int iParam1) // Position - 0x1705 Signature - 22 02 05 00 00 66 00 5D
{
	int address;
...
BOOL func_55(var uParam0) // Position - 0x1729 Signature - 22 01 05 00 00 66 00 39 29
{
...
void func_56(var uParam0) // Position - 0x1903 Signature - 22 01 03 00 00 66 00 27 02
{
...
void func_57(var uParam0) // Position - 0x197A Signature - 22 01 03 00 00 66 00 39 49
{
	func_127(uParam0);
	return;
}

void func_58(var uParam0) // Position - 0x1988 Signature - 22 01 07 00 00 66 00 27 03 67
{
...
void func_59(var uParam0) // Position - 0x1B77 Signature - 22 01 07 00 00 66 00 39 F2
{
	Vehicle vehicle;
	Ped ped;
	var unk;
...
void func_60(var uParam0) // Position - 0x1C02 Signature - 22 01 0B 00 00 66 00 27
{
	Vehicle vehicle;
	Ped ped;
...
void func_61(int iParam0) // Position - 0x1CC6 Signature - 22 01 03 00 00 11 66 00 39
{
	func_35(2, iParam0);
	return;
}

void func_62(int iParam0) // Position - 0x1CD5 Signature - 22 01 03 00 00 1D
{
	func_35(3, iParam0);
	return;
}

BOOL func_63(var uParam0, var uParam1, var uParam2) // Position - 0x1CE4 Signature - 22 03 05 00 00 2F 50
{
	return 0;
}

BOOL func_64(var uParam0, var uParam1, var uParam2) // Position - 0x1CED Signature - 22 03 06 00 00 66 02
{
	int num;
...
void func_65(Volume volParam0) // Position - 0x1E3A Signature - 22 01 03 00 00 66 00 03 05 00 31
{
...
void func_66(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1E51 Signature - 22 03 06 00 00 66 01
{
	int num;
...
int func_67(Vehicle veParam0, int iParam1) // Position - 0x1EA5 Signature - 22 02 05 00 00 66 00 66 01 03 09 00 79 67 04 66 04 03 05 01
{
...
BOOL func_68(Vehicle veParam0) // Position - 0x1EC5 Signature - 22 01 04 00 00 66 00 03 05 00 A1
{
...
void func_69(int iParam0) // Position - 0x1EE0 Signature - 22 01 05 00 00 66 00 39 3B
{
	int num;
	int offset;
...
struct<4> func_70() // Position - 0x1F14 Signature - 22 00 06
{
	var unk;
...
BOOL func_71(Player plParam0, BOOL bParam1) // Position - 0x1F20 Signature - 22 02 04 00 00 85
{
	if (Global_1048576)
		return true;
	...
	if (!func_142(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;
...
BOOL func_72(Player plParam0, Player plParam1) // Position - 0x1FB0 Signature - 22 02 05 00 00 66 01 03 05 00 54
{
	Player bitIndex;
...
BOOL func_73(int iParam0) // Position - 0x2024 Signature - 22 01 03 00 00 66 00 3C 05 00 07 00 00 00 1B 00 09 00 00 00 25
{
	switch (iParam0)
	{
		case 7:
...
int func_74(int iParam0) // Position - 0x206B Signature - 22 01 03 00 00 66 00 3C 05 00 07 00 00 00 1B 00 09 00 00 00 26
{
	switch (iParam0)
	{
		case 7:
...
void func_75(Any* panParam0, var uParam1) // Position - 0x20B4 Signature - 22 02 04 00 00 4B
{
...
float func_76(Player plParam0, BOOL bParam1) // Position - 0x20F4 Signature - 22 02 05 00 00 5D F8 89 11 78 C0 15 05 8B 04 00 73
{
	Player player;
...
BOOL func_77(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2194 Signature - 22 03 06 00 00 5D
{
	Player player;
...
int func_78(Hash hParam0, BOOL bParam1, Hash hParam2) // Position - 0x225D Signature - 22 03 05 00 00 66 00 2F
{
...
BOOL func_79(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x2281 Signature - 22 03 07 00 00 66 00 2F
{
	int num;
	BOOL flag;
...
int func_80(Hash hParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, Hash hParam5) // Position - 0x22B0 Signature - 22 06 4F
{
	int cashBalance;
	int goldBarBalance;
	var unk;
...
void func_81(int iParam0, int iParam1, BOOL bParam2) // Position - 0x24A0 Signature - 22 03 06 00 00 66 00 39
{
	char* str;
...
int func_82(int iParam0) // Position - 0x24E5 Signature - 22 01 03 00 00 66 00 6D
{
	if (iParam0 == 255)
...
BOOL func_83(int iParam0) // Position - 0x252C Signature - 22 01 03 00 00 6D
{
...
BOOL func_84(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x2544 Signature - 22 02 04 00 00 66 00 03
{
...
void func_85(var uParam0) // Position - 0x259D Signature - 22 01 09
{
...
BOOL func_86(var uParam0) // Position - 0x2672 Signature - 22 01 03 00 00 66 00 76 6D 40
{
	return func_8(*uParam0, 64);
}

void func_87(var uParam0, BOOL bParam1) // Position - 0x2683 Signature - 22 02 04 00 00 66 01 6A
{
...
void func_88(var uParam0, var uParam1) // Position - 0x26A3 Signature - 22 02 04 00 00 50
{
	return;
}

void func_89(var uParam0) // Position - 0x26AB Signature - 22 01 03 00 00 66 00 39 29 07 00 8B 07 00 6D 46
{
	if (func_14(uParam0))
		func_17(70, true);
...
void func_90(var uParam0, float fParam1) // Position - 0x26C3 Signature - 22 02 04 00 00 39
{
...
float func_91(var uParam0) // Position - 0x26E9 Signature - 22 01 03 00 00 66 00 39 D8
{
	if (!func_4(uParam0))
		return uParam0->f_1;
...
Ped func_92(Vehicle veParam0, int iParam1) // Position - 0x271E Signature - 22 02 05 00 00 66 00 66 01 03 09 00 79 67 04 66 04 03 05 00
{
	Ped pedInDraftHarness;
...
BOOL func_93() // Position - 0x2745 Signature - 22 00 03 00 00 03 01 00 DA
{
...
void func_94(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2794 Signature - 22 03 05 00 00 66 00 03
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return;
...
BOOL func_95() // Position - 0x27C8 Signature - 22 00 02 00 00 5D 12
{
	return Global_1904402.f_8872 != -1;
}

BOOL func_96() // Position - 0x27D9 Signature - 22 00 03 00 00 09
{
	int currentMessage;
...
BOOL func_97(Any* panParam0, int iParam1, int iParam2) // Position - 0x27F9 Signature - 22 03 07 00 00 66 01
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

BOOL func_98() // Position - 0x2830 Signature - 22 00 02 00 00 5D 77
{
	return Global_1072759.f_28644.f_23.f_3 != 0;
}

BOOL func_99() // Position - 0x2845 Signature - 22 00 02 00 00 39 BB
{
	if (!func_170())
		return false;
...
BOOL func_100() // Position - 0x2860 Signature - 22 00 02 00 00 5D 3A
{
	return Global_1896762.f_352;
}

BOOL func_101() // Position - 0x286F Signature - 22 00 03 00 00 39 BB
{
	BOOL num;
...
BOOL func_102(int iParam0, int iParam1) // Position - 0x2896 Signature - 22 02 04 00 00 66 00 87
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_103(int iParam0) // Position - 0x28AE Signature - 22 01 03 00 00 66 00 42
{
...
BOOL func_104(int iParam0) // Position - 0x28C5 Signature - 22 01 07 00 00 66 00 5D
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x2991 Signature - 22 02 04 00 00 66 00 5D 12
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_106(int iParam0) // Position - 0x29AA Signature - 22 01 03 00 00 5D
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_107(int iParam0) // Position - 0x29BD Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 66 00 6D
{
	if (iParam0 < 0)
		return false;
...
BOOL func_108(var uParam0) // Position - 0x29FC Signature - 22 01 04 00 00 66 00 39 29
{
	Ped ped;
...
BOOL func_109() // Position - 0x2A81 Signature - 22 00 02 00 00 6D E6
{
...
int func_110(char* sParam0, Hash hParam1, Volume volParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, Hash hParam12, int iParam13) // Position - 0x2AA1 Signature - 22 0E
{
	int i;
	int num;
...
BOOL func_111() // Position - 0x2B61 Signature - 22 00 02 00 00 5D 1C 9B 1D 27 02 6A
{
	return Global_1940252.f_2 || Global_1940252 == 1;
}

BOOL func_112(BOOL bParam0) // Position - 0x2B7B Signature - 22 01 03 00 00 66 00 8B
{
	if (bParam0)
...
BOOL func_113(int iParam0) // Position - 0x2BAB Signature - 22 01 03 00 00 66 00 5D 1C 9B 1D 27
{
...
BOOL func_114(int iParam0) // Position - 0x2BC3 Signature - 22 01 04 00 00 2F 67 03 66 03 6D
{
	int i;
...
void func_115() // Position - 0x2BF3 Signature - 22 00 02 00 00 37 15
{
...
void func_116(int iParam0) // Position - 0x2C12 Signature - 22 01 03 00 00 66 00 5D 1C 9B 1D 6C
{
	Global_1940252.f_40 = iParam0;
	return;
}

BOOL func_117(int iParam0, BOOL bParam1) // Position - 0x2C22 Signature - 22 02 09 00 00 66 01 6A
{
	int num;
	int gameTimer;
	float progress;
...
void func_118(BOOL bParam0, int iParam1) // Position - 0x2D1C Signature - 22 02 04 00 00 66 00 8B
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
BOOL func_119() // Position - 0x2D3E Signature - 22 00 02 00 00 5D 1C 9B 1D 27 02 50
{
	return Global_1940252.f_2;
}

Hash func_120(Entity eParam0) // Position - 0x2D4C Signature - 22 01 04 00 00 66 00 03 05 00 75
{
	Hash hash;
...
BOOL func_121() // Position - 0x2D9F Signature - 22 00 02 00 00 39 D9
{
	return func_176() || func_177();
}

BOOL func_122(Hash hParam0) // Position - 0x2DB5 Signature - 22 01 03 00 00 66 00 3C 02
{
	switch (hParam0)
	{
...
BOOL func_123(Hash hParam0) // Position - 0x2DD6 Signature - 22 01 03 00 00 66 00 39 FF
{
...
BOOL func_124(int iParam0) // Position - 0x2DF8 Signature - 22 01 03 00 00 42
{
...
int func_125(var uParam0) // Position - 0x2E0F Signature - 22 01 03 00 00 66 00 37 00
{
	return func_181(uParam0, 1086324736, 1094713344, 1077936128, 1090519040);
}

void func_126(var uParam0) // Position - 0x2E31 Signature - 22 01 03 00 00 66 00 39 29 07 00 8B 07 00 6D 0F
{
	if (func_14(uParam0))
		func_35(15, 3);
...
void func_127(var uParam0) // Position - 0x2E49 Signature - 22 01 07 00 00 66 00 39 29
{
...
BOOL func_128(BOOL bParam0, BOOL bParam1) // Position - 0x2FE3 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01
{
	return bParam0 && bParam1 != false;
}

BOOL func_129(var uParam0) // Position - 0x2FF2 Signature - 22 01 0F
{
	Vehicle vehicle;
	Ped ped;
	var unk;
...
BOOL func_130(Vehicle veParam0, Ped pedParam1, var uParam2) // Position - 0x3164 Signature - 22 03 0A
{
	Ped pedInTransportSeat;
	int seatIndex;
	int i;
...
void func_131(Vehicle veParam0) // Position - 0x31D5 Signature - 22 01 0D 00 00 66 00 03 05 00 75 05 8B 03 00 50 01 00 66 00 2F
{
	Ped ped;
	var unk;
	var args;
...
void func_132(Ped pedParam0, Ped pedParam1) // Position - 0x325C Signature - 22 02 06 00 00 66 01
{
...
BOOL func_133(var uParam0, var uParam1) // Position - 0x32A4 Signature - 22 02 04 00 00 66 00 27 02
{
...
void func_134(var uParam0) // Position - 0x32BC Signature - 22 01 03 00 00 66 00 76 42 39 F6 04 00 05 8B 07 00 66 00 42
{
	if (!func_8(*uParam0, 4))
		func_13(uParam0, 4);
...
void func_135(var uParam0) // Position - 0x32D7 Signature - 22 01 03 00 00 66 00 76 42 39 F6 04 00 05 8B 07 00 66 00 11
{
	if (!func_8(*uParam0, 4))
		func_13(uParam0, 2);
...
void func_136(var uParam0, var uParam1) // Position - 0x32F2 Signature - 22 02 04 00 00 66 00 80
{
	if (func_4(&(uParam0->f_13)))
		func_5(&(uParam0->f_13));
...
void func_137(var uParam0, var uParam1, BOOL bParam2) // Position - 0x336A Signature - 22 03 0C
{
	Vehicle vehicle;
	Player player;
	Ped ped;
...
void func_138(var uParam0, var uParam1) // Position - 0x3415 Signature - 22 02 09 00 00 03
{
	Player player;
	Ped ped;
	Vehicle vehicle;
...
int func_139(int iParam0) // Position - 0x347E Signature - 22 01 03 00 00 66 00 50 01 01 22 01
{
	return iParam0;
}

void func_140(int iParam0) // Position - 0x3488 Signature - 22 01 03 00 00 66 00 39 DD
{
	if (!func_196(iParam0))
		return;
...
BOOL func_141(int iParam0) // Position - 0x353B Signature - 22 01 03 00 00 66 00 08 77
{
...
BOOL func_142(var uParam0, var uParam1) // Position - 0x355A Signature - 22 02 04 00 00 66 00 39 EC
{
	if (!func_197(uParam0))
		return false;
...
struct<2> func_143() // Position - 0x358E Signature - 22 00 02 00 00 5D 2C
{
...
BOOL func_144(Player plParam0, BOOL bParam1) // Position - 0x35D9 Signature - 22 02 05 00 00 5D F8 89 11 78 C0 15 05 8B 04 00 2F
{
	Player player;
...
void func_145(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x3655 Signature - 22 08 0A 00 00 50
{
	return;
}

BOOL func_146(Hash hParam0, int iParam1) // Position - 0x365D Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 E0
{
	if (hParam0 == 0)
		return false;
...
int func_147(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x3677 Signature - 22 06 29
{
	var unk;
	int num;
	int i;
...
BOOL func_148(int iParam0) // Position - 0x3767 Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 39
{
	if (iParam0 < 0)
		return false;
...
int func_149(Hash hParam0) // Position - 0x3794 Signature - 22 01 0A 00 00 66 00 2F 39 5D 36 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 37 05 8B 04 00 2F 50 01 01 4B 03 27 02
{
	var unk;
...
BOOL func_150() // Position - 0x37BF Signature - 22 00 02 00 00 03 01 00 F4
{
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_151(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x37DB Signature - 22 06 09 00 00 2F 66 03 32 66 02 76 6D 0F 8A 04 00 2F 50 06 01 66 00 2F
{
	int i;
...
int func_152(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x386B Signature - 22 04 0D 00 00 2F
{
...
BOOL func_153(BOOL bParam0) // Position - 0x392D Signature - 22 01 03 00 00 39 88 6C 00 08 15 04
{
	if (func_207() == -1)
		return true;
...
BOOL func_154(Hash hParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x394B Signature - 22 05 11 00 00 66 00 2F
{
	int num;
	var unk;
	var unk6;
...
BOOL func_155(Hash hParam0) // Position - 0x39C3 Signature - 22 01 03 00 00 66 00 3C 04
{
	switch (hParam0)
	{
		case -1551258934:
...
int func_156(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x39F0 Signature - 22 03 06 00 00 66 00 2F
{
	int num;
...
void func_157(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x3A5A Signature - 22 12
{
	int i;
...
char* func_158(int iParam0) // Position - 0x3AD8 Signature - 22 01 03 00 00 66 00 3C 1F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_159(int iParam0) // Position - 0x3C7D Signature - 22 01 03 00 00 66 00 5D 1F
{
	return func_224(Global_1290271.f_11.f_755[iParam0]);
}

int func_160(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x3C96 Signature - 22 06 18
{
	int num;
	var unk13;
	int num2;
...
float func_161() // Position - 0x3CD1 Signature - 22 00 03 00 00 03 01 00 B5
{
...
void func_162(var uParam0, int iParam1) // Position - 0x3D03 Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 02
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_163(var uParam0, int iParam1) // Position - 0x3D14 Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 01 03 00 00 66
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_164(var uParam0) // Position - 0x3D29 Signature - 22 01 03 00 00 66 00 76 11
{
	return func_36(*uParam0, 2);
}

BOOL func_165(Vehicle veParam0) // Position - 0x3D39 Signature - 22 01 03 00 00 66 00 03 05 00 EE
{
...
void func_166(BOOL bParam0) // Position - 0x3D58 Signature - 22 01 15
{
	int num;
	int num2;
	int i;
...
int func_167() // Position - 0x3E0F Signature - 22 00 02 00 00 5D 1F B0 13 18 2E 03 78 18
{
	return Global_1290271.f_814.f_280;
}

int func_168(Player plParam0, BOOL bParam1) // Position - 0x3E21 Signature - 22 02 05 00 00 66 00 03
{
	Player player;
...
void func_169(Vehicle veParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3E61 Signature - 22 04 08
{
	float num;
	float num2;
...
BOOL func_170() // Position - 0x3EBB Signature - 22 00 02 00 00 03 01 00 2E
{
...
BOOL func_171(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3ECF Signature - 22 07 0C 00 00 1D
{
	float screenX;
	float screenY;
...
BOOL func_172(int iParam0, int iParam1) // Position - 0x3F19 Signature - 22 02 04 00 00 66 00 2F 8A 04
{
	if (iParam0 < 0)
		return false;
...
Hash func_174(var uParam0) // Position - 0x4255 Signature - 22 01 04 00 00 66 00 76
{
	Ped pedIndexFromEntityIndex;
...
Hash func_175(Entity eParam0) // Position - 0x427B Signature - 22 01 04 00 00 2F 67 03 66 00
{
...
BOOL func_176() // Position - 0x42D9 Signature - 22 00 02 00 00 5D 1F B0 13 18 2E 03 78 1C
{
	return Global_1290271.f_814.f_284;
}

BOOL func_177() // Position - 0x42EB Signature - 22 00 02 00 00 5D 1F B0 13 18 2E 03 78 1B
{
	return Global_1290271.f_814.f_283 != -1;
}

int func_178(Hash hParam0) // Position - 0x42FF Signature - 22 01 03 00 00 66 00 3C F3
{
	switch (hParam0)
	{
...
BOOL func_179(int iParam0) // Position - 0x5E58 Signature - 22 01 03 00 00 66 00 2F 1C
{
	return iParam0 != 0;
}

int func_180(Hash hParam0) // Position - 0x5E64 Signature - 22 01 03 00 00 66 00 39 0D
{
	if (func_228(hParam0))
		return 1;
...
int func_181(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x5E7F Signature - 22 05 10
{
	var unk;
	var unk2;
	Vector3 vector;
...
void func_182(var uParam0) // Position - 0x5FB8 Signature - 22 01 03 00 00 66 00 27 01
{
	if (MAP::DOES_BLIP_EXIST(uParam0->f_1))
...
BOOL func_183(Player plParam0, BOOL bParam1) // Position - 0x5FD3 Signature - 22 02 07 00 00 66 00 6D
{
	Player bitIndex;
	int playerTeam;
	int playerTeam2;
...
Hash func_184(Hash hParam0) // Position - 0x60D5 Signature - 22 01 03 00 00 66 00 03 05 00 C5
{
...
Hash func_185(Hash hParam0, BOOL bParam1) // Position - 0x6113 Signature - 22 02 05 00 00 66 00 2F
{
	Hash hash;
...
char* func_186(int iParam0) // Position - 0x6141 Signature - 22 01 0B 00 00 66 00 08
{
	var unk;
...
int func_187(Player plParam0) // Position - 0x6195 Signature - 22 01 03 00 00 66 00 5D 92 96 13 17
{
	return Global_1283730[plParam0 /*2*/];
}

BOOL func_188(Player plParam0) // Position - 0x61A5 Signature - 22 01 03 00 00 66 00 5D 92 96 13 63
{
	return Global_1283730[plParam0 /*2*/].f_1;
}

int func_189(int iParam0) // Position - 0x61B7 Signature - 22 01 03 00 00 66 00 08 20
{
...
BOOL func_190(int iParam0, Vehicle veParam1) // Position - 0x66D4 Signature - 22 02 0A
{
	int num;
	var unk;
	float num2;
...
struct<2> func_191(Player plParam0) // Position - 0x6776 Signature - 22 01 05 00 00 66 00 4B 03
{
	var gamerHandle;
...
BOOL func_192(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x678A Signature - 22 04 32
{
	var clanDesc;
	var clanDesc2;
...
BOOL func_193(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x67E6 Signature - 22 04 06 00 00 66 00 27
{
	if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam0->f_3))
		return false;
...
void func_194(int iParam0) // Position - 0x6833 Signature - 22 01 04 00 00 03 01 00 6A 67 03 66 03 5D AB AD 13 63 13 27 0A 66 00
{
	int num;
...
void func_195(Vehicle veParam0) // Position - 0x6858 Signature - 22 01 0D 00 00 66 00 03 05 00 75 05 8B 03 00 50 01 00 66 00 03
{
	Ped ped;
	var unk;
	var args;
...
BOOL func_196(int iParam0) // Position - 0x68DD Signature - 22 01 03 00 00 66 00 11
{
	return func_172(iParam0, 2);
}

BOOL func_197(int iParam0) // Position - 0x68EC Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21
{
	switch (iParam0)
	{
		case 2:
...
int func_198(int iParam0) // Position - 0x692B Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 2E
{
	switch (iParam0)
	{
		case 2:
...
struct<2> func_199(int iParam0) // Position - 0x69C1 Signature - 22 01 03 00 00 11 66 00 5D
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_200() // Position - 0x69D5 Signature - 22 00 02 00 00 5D 0C CE 1D 27 01 37 B1 DE 6E 01 1C 6A 8B 0D 00 5D 0C CE 1D 27 01 37 46 B6 C9 78 1C 69 8B
{
...
BOOL func_201(int iParam0) // Position - 0x6A02 Signature - 22 01 04 00 00 66 00 3C
{
	int i;
...
BOOL func_202(Hash hParam0, Hash hParam1) // Position - 0x6AF4 Signature - 22 02 04 00 00 66 00 2F 39 5D 36 00 05 8B 04
{
	if (!func_146(hParam0, 0))
		return false;
...
BOOL func_203(Hash hParam0) // Position - 0x6B40 Signature - 22 01 03 00 00 66 00 37 11
{
...
BOOL func_204(Hash hParam0, Hash hParam1) // Position - 0x6B5B Signature - 22 02 04 00 00 66 00 2F 39 5D 36 00 05 8B 0F
{
	if (!func_146(hParam0, 0))
...
int func_205(Hash hParam0, BOOL bParam1) // Position - 0x6B9C Signature - 22 02 0B
{
	var unk;
...
int func_206(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6BF4 Signature - 22 04 27
{
	var unk;
	int num;
	int i;
	...
	if (!func_260(iParam0, hParam1, &unk, &num, bParam2, bParam3))
	{
		!bParam2;
		return 0;
	}
...
int func_207() // Position - 0x6C88 Signature - 22 00 02 00 00 5D 17 00 18 27
{
	return Global_1572887.f_14;
}

BOOL func_208(int iParam0) // Position - 0x6C96 Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 66 00 2F
{
	if (iParam0 < 0)
		return false;
...
int func_209() // Position - 0x6CB9 Signature - 22 00 02 00 00 39 88
{
	if (func_207() == 0)
...
void func_210(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x6CD4 Signature - 22 04 2B 00 00 66 02 76 6D 0F 8A 06 00 50 04 00 68 16 00 66 03 66 02 76 20 6A 05 8B 05 00 66 03 09 35 30 8B 03 00 50 04 00 4B 0D 6A 80 01 6D 0A 3D 41 41 66 00 4B 0D 03 09 00 38
{
	int i;
	int j;
	int k;
...
Hash func_211(Hash hParam0, int iParam1) // Position - 0x6EAA Signature - 22 02 07 00 00 66 00 2F
{
	int num;
	var unk;
	Hash hash;
...
int func_212(Hash hParam0, BOOL bParam1) // Position - 0x6F24 Signature - 22 02 18
{
	var unk;
	int num;
	int num2;
	...
	unk = { func_263(hParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };
...
int func_213(Hash hParam0, int iParam1) // Position - 0x6F83 Signature - 22 02 04 00 00 66 01 2F
{
	if (iParam1 == 0)
		return 0;
...
int func_214(BOOL bParam0) // Position - 0x6FAF Signature - 22 01 03 00 00 39 88 6C 00 08 15 17
{
	if (func_207() == -1)
	{
...
struct<4> func_215(Hash hParam0, BOOL bParam1) // Position - 0x6FF0 Signature - 22 02 09 00 00 66 00
{
	var unk;
...
BOOL func_216(Hash hParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x7015 Signature - 22 05 6A
{
	int num;
	var unk;
	int num2;
...
struct<5> func_217(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x712D Signature - 22 03 2F
{
	var unk;
	int num;
	var unk6;
	...
	switch (num)
	{
		...
		case joaat("DOG"):
			...
			{
				unk = { func_218(joaat("kit_camp"), unk, 1084182731, bParam1) };
				unk.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(hParam0, joaat("kit_camp"));
			}
			else if (func_276(hParam0, -1483207246))
			{
				unk = { func_218(joaat("WARDROBE"), unk, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (iParam2 && func_272(hParam0, true))
			{
				...
				if (!func_273(hParam0, &unk, 1728382685, false, false))
					unk.f_4 = 1728382685;
				else if (!func_273(hParam0, &unk, -649335959, false, false))
					unk.f_4 = -649335959;
				else if (func_274(hParam0, &unk6, 1728382685))
					unk.f_4 = 1728382685;
				else
					unk.f_4 = -649335959;
			}
...
struct<4> func_218(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x74A1 Signature - 22 07 0D
{
	var outGuid;
...
BOOL func_219(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x74D2 Signature - 22 07 3A
{
	var unk;
	int num;
	var unk15;
...
BOOL func_220(Hash hParam0, Any* panParam1) // Position - 0x75F0 Signature - 22 02 05 00 00 66 00 66 01 03 09 00 26
{
	BOOL flag;
	...
	if (hParam0 == joaat("use"))
		if (func_278(panParam1->f_8, hParam0, flag, 2048) || func_278(panParam1->f_8, hParam0, flag, 32768) || func_278(panParam1->f_8, hParam0, flag, 65536))
			return false;
	else if (hParam0 == 1168099063)
		if (func_278(panParam1->f_8, hParam0, flag, 4) || func_278(panParam1->f_8, hParam0, flag, 256) || func_278(panParam1->f_8, hParam0, flag, 65536) || func_278(panParam1->f_8, hParam0, flag, 131072))
			return false;
	else if (hParam0 == joaat("spend"))
		if (func_278(panParam1->f_8, hParam0, flag, true) || func_278(panParam1->f_8, hParam0, flag, 8) || func_278(panParam1->f_8, hParam0, flag, 65536) || func_278(panParam1->f_8, hParam0, flag, 32))
			return false;
	else if (hParam0 == joaat("Sell"))
		if (func_278(panParam1->f_8, hParam0, flag, true) || func_278(panParam1->f_8, hParam0, flag, 16) || func_278(panParam1->f_8, hParam0, flag, 2) || func_278(panParam1->f_8, hParam0, flag, 65536))
			return false;
	else if (func_278(panParam1->f_8, hParam0, flag, 8) || func_278(panParam1->f_8, hParam0, flag, 4096) || func_278(panParam1->f_8, hParam0, flag, 256) || func_278(panParam1->f_8, hParam0, flag, 65536))
		return false;

	return true;
}

BOOL func_221(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x77C6 Signature - 22 03 05 00 00 66 00 66 01
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_222(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x77DD Signature - 22 03 05 00 00 66 00 8B 21
{
	if (bParam0)
	{
...
int func_223(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x7826 Signature - 22 03 05 00 00 66 00 8B 0E
{
	if (bParam0)
	{
		func_279(iParam1, 1, 0, 0);
...
BOOL func_224(int iParam0) // Position - 0x7842 Signature - 22 01 03 00 00 66 00 2F 15 04 00 2F 50 01 01 66 00 03 05 00 BB
{
	if (iParam0 == 0)
		return false;
...
void func_225(BOOL bParam0) // Position - 0x785C Signature - 22 01 04 00 00 03 01 00 DA
{
	Player player;
...
BOOL func_226(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x78AB Signature - 22 05 07 00 00 66 04
{
...
BOOL func_227(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x78D2 Signature - 22 04 06 00 00 66 02 2F
{
	if (iParam2 < 0)
		return false;
...
BOOL func_228(Hash hParam0) // Position - 0x790D Signature - 22 01 06 00 00 66 00 39
{
	int i;
	int num;
	Hash hash;
...
int func_229(int iParam0, BOOL bParam1) // Position - 0x794F Signature - 22 02 08 00 00 03
{
	Player player;
	Player player2;
	int num;
...
int func_230(Hash hParam0) // Position - 0x7A05 Signature - 22 01 05 00 00 66 00 4B 04
{
	int num;
	Any any;

	if (func_282(hParam0, &any))
		hParam0 = any;
...
int func_231(int iParam0) // Position - 0x7A5E Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 66 00 03
{
	if (iParam0 < 0)
		return 0;
...
int func_232(BOOL bParam0) // Position - 0x7A7F Signature - 22 01 03 00 00 66 00 5D 67
{
	return bParam0 ? Global_1901671.f_701.f_30 : Global_1901671.f_701.f_29;
}

int func_233(Player plParam0, BOOL bParam1) // Position - 0x7A9F Signature - 22 02 04 00 00 66 01 66
{
	return bParam1 ? Global_1289643[plParam0 /*19*/].f_1 : Global_1289643[plParam0 /*19*/];
}

float func_234(BOOL bParam0, int iParam1) // Position - 0x7ABF Signature - 22 02 05 00 00 66 01 73
{
	float num;
...
void func_235(int iParam0, BOOL bParam1) // Position - 0x7B17 Signature - 22 02 04 00 00 66 00 5D A6 C8 1D 63 17 27 03 03 05 00 B1 8B 3F
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_236(int iParam0, BOOL bParam1) // Position - 0x7B6F Signature - 22 02 04 00 00 66 00 5D A6 C8 1D 63 17 27 03 03 05 00 B1 8B 10
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_237(int iParam0, int iParam1) // Position - 0x7B98 Signature - 22 02 04 00 00 66 00 2F 8A 03
{
	if (iParam0 < 0)
		return;
...
Hash func_238(Ped pedParam0) // Position - 0x7BC0 Signature - 22 01 0A 00 00 66 00 03
{
	Ped pedAttached;
...
Vector3 func_239(var uParam0) // Position - 0x7C93 Signature - 22 01 07 00 00 66 00 27 03 25
{
	int _int;
	var unk;
...
BOOL func_240(var uParam0) // Position - 0x7CD3 Signature - 22 01 03 00 00 66 00 27 03
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_3))
		return false;
...
BOOL func_241(var uParam0, var uParam1, int iParam2) // Position - 0x7D1F Signature - 22 03 06 00 00 2F
{
	Ped playerPed;
...
BOOL func_242(var uParam0, int iParam1) // Position - 0x7D8F Signature - 22 02 06 00 00 66 00 27
{
	Ped playerPed;
	int num;
...
BOOL func_243(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3* pvParam4) // Position - 0x7E1E Signature - 22 05 08 00 00 66 00
{
	var unk;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7E83 Signature - 22 03 05 00 00 66 00 73
{
...
int func_245(var uParam0, int iParam1) // Position - 0x7EAD Signature - 22 02 04 00 00 66 00 27 03
{
...
Hash func_246(Hash hParam0, BOOL bParam1) // Position - 0x7F01 Signature - 22 02 04 00 00 66 00 3C 07
{
	switch (hParam0)
	{
...
void func_247() // Position - 0x7FA3 Signature - 22 00 02 00 00 6D 31
{
...
int func_248(int iParam0) // Position - 0x7FE2 Signature - 22 01 03 00 00 66 00 68
{
	switch (iParam0)
	{
		case -1:
...
char* func_249(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x806C Signature - 22 08 0A 00 00 4B 00 4B
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

Vector3 func_250(Player plParam0) // Position - 0x8080 Signature - 22 01 03 00 00 66 00 03 05 00 8B
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

float func_251(int iParam0) // Position - 0x8094 Signature - 22 01 04 00 00 66 00 39 B7
{
	int num;
...
float func_252(Vehicle veParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x80FE Signature - 22 05 07 00 00 66 00 03 05 00 75
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return 0f;
...
BOOL func_253(float fParam0, var uParam1, var uParam2) // Position - 0x8126 Signature - 22 03 06 00 00 66 00 03
{
	BOOL flag;
...
BOOL func_254(int iParam0) // Position - 0x817B Signature - 22 01 03 00 00 66 00 09
{
...
BOOL func_255() // Position - 0x81A3 Signature - 22 00 02 00 00 5D 17 00 18 80
{
...
BOOL func_256(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x81CE Signature - 22 03 05 00 00 66 00 39
{
	if (!func_292(iParam0))
		return false;
	...
	if (bParam2)
		return !func_293(iParam0, hParam1);

	return true;
}

Hash func_257(Hash hParam0) // Position - 0x8206 Signature - 22 01 03 00 00 66 00 50 01 01 22 02
{
	return hParam0;
}

BOOL func_258(Hash hParam0, Hash hParam1) // Position - 0x8210 Signature - 22 02 04 00 00 66 00 11
{
...
int func_259(Hash hParam0, BOOL bParam1) // Position - 0x8246 Signature - 22 02 05 00 00 66 00 11
{
	int num;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_260(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x827F Signature - 22 06 09 00 00 2F 66 03 32 66 02 76 6D 0F 8A 04 00 2F 50 06 01 66 00 39
{
	int i;
	...
	*uParam3 = ITEMDATABASE::_0xF540239F9937033B(iParam0, hParam1);
	...
	if (bParam5)
		func_294(iParam0, hParam1, uParam2, *uParam3);

	return true;
}

int func_261(Hash hParam0) // Position - 0x830E Signature - 22 01 0A 00 00 66 00 2F 39 5D 36 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 37 05 8B 04 00 2F 50 01 01 4B 03 27 01
{
	var unk;
...
void func_262(Hash hParam0, var uParam1, var uParam2) // Position - 0x8339 Signature - 22 03 05 00 00 2F 66
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_263(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8545 Signature - 22 07 1B
{
	Hash hash;
...
struct<4> func_264(BOOL bParam0) // Position - 0x8623 Signature - 22 01 04 00 00 66 00 39 AF 6F 00 67 03 66 03 11 15
{
	int num;
...
void func_265(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x86C4 Signature - 22 05 07 00 00 4B
{
...
BOOL func_266(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x86DF Signature - 22 04 06 00 00 66 03
{
...
BOOL func_267(Hash hParam0, int iParam1) // Position - 0x8704 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 32
{
	if (hParam0 == 0)
		return false;
...
BOOL func_268(Hash hParam0) // Position - 0x871E Signature - 22 01 03 00 00 66 00 03 05 00 2F
{
...
BOOL func_269(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x8734 Signature - 22 06 08
{
	*uParam1 = 0;
...
struct<17> func_270(Hash hParam0, var uParam1) // Position - 0x87A1 Signature - 22 02 15
{
	var unk;
...
struct<4> func_271(BOOL bParam0) // Position - 0x87F4 Signature - 22 01 04 00 00 5D
{
	int num;
	...
	if (Global_1572887.f_14 == 0)
	{
		...
		if (num == 2)
		{
			if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1292143))
				Global_1292143 = { func_218(joaat("character"), func_70(), -1591664384, bParam0) };
		...
		else if (num == 3)
		{
			if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&(Global_1292143.f_12)))
				Global_1292143.f_12 = { func_218(joaat("character"), func_70(), -1591664384, false) };
		
			return Global_1292143.f_12;
		}
	}

	return func_218(joaat("character"), func_70(), -1591664384, bParam0);
}

int func_272(Hash hParam0, BOOL bParam1) // Position - 0x8894 Signature - 22 02 04 00 00 66 00 39 0E
{
...
BOOL func_273(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x88CB Signature - 22 05 07 00 00 66 00 42
{
	return func_297(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_274(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x88E6 Signature - 22 03 09 00 00
{
	var unk;
...
struct<4> func_275(BOOL bParam0) // Position - 0x8907 Signature - 22 01 04 00 00 66 00 39 AF 6F 00 67 03 66 03 11 0B
{
	int num;
...
BOOL func_276(Hash hParam0, int iParam1) // Position - 0x8971 Signature - 22 02 08 00 00 66
{
	Hash hash;
	int num;
	int i;
	...
	for (i = 0; i < fitsSlotCount; i = i + 1)
	{
		if (ITEMDATABASE::_ITEMDATABASE_GET_FITS_SLOT_INFO(num, i, &hash))
			if (func_299(hParam0, iParam1, hash))
				return true;
	}
...
BOOL func_277(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x89DE Signature - 22 08 0A 00 00 4B 00 66
{
	return func_300(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_278(var uParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x89F4 Signature - 22 04 06 00 00 66 02 66
{
	if (func_128(bParam2, bParam3))
		return true;

	return false;
}

void func_279(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8A0C Signature - 22 04 07 00 00 66 00 08 15 03 00 50 04 00 2F
{
	int i;
...
BOOL func_280(Hash hParam0) // Position - 0x8AAA Signature - 22 01 03 00 00 66 00 2F 39
{
	if (!func_146(hParam0, 0))
		return false;
...
int func_281(int iParam0, int iParam1) // Position - 0x8AD8 Signature - 22 02 04 00 00 66 00 3C 4D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_282(Any anParam0, var uParam1) // Position - 0x8F29 Signature - 22 02 04 00 00 66 00 39 FC
{
	*uParam1 = func_302(anParam0);
	return *uParam1 != 0;
}

var func_283(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8F3F Signature - 22 03 05 00 00 66 00 8B 08 00 66 01 50 03 01 68 05 00 66 02 50 03 01 22 03
{
	if (bParam0)
		return uParam1;
...
int func_284(float fParam0, float fParam1, float fParam2) // Position - 0x8F56 Signature - 22 03 05 00 00 66 00 66 02
{
	if (fParam0 > fParam2)
		return fParam2;
...
var func_285(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8F7D Signature - 22 03 05 00 00 66 00 8B 08 00 66 01 50 03 01 68 05 00 66 02 50 03 01 22 01
{
	if (bParam0)
		return uParam1;
...
int func_286(Ped pedParam0) // Position - 0x8F94 Signature - 22 01 05 00 00 11
{
	int num;
	int pedQuality;
...
int func_287(int iParam0) // Position - 0x8FEA Signature - 22 01 03 00 00 66 00 3C BA 00 CA
{
	switch (iParam0)
	{
		case joaat("PROVISION_ANIMAL_CARCASS_CHICKEN_PERFECT"):
...
Vector3 func_288(int iParam0) // Position - 0x9A27 Signature - 22 01 08
{
	float num;
	int value;
	int value2;
...
int func_289(Entity eParam0, Ped pedParam1, int iParam2) // Position - 0x9A83 Signature - 22 03 08
{
	var entityCoords;
...
BOOL func_290(Player plParam0, Entity eParam1, Vector3* pvParam2, float* pfParam3) // Position - 0x9AA3 Signature - 22 04 0D 00 00 66
{
	Ped playerPed;
...
BOOL func_291(var uParam0, int iParam1) // Position - 0x9B66 Signature - 22 02 04 00 00 66 00 66 01 39
{
...
BOOL func_292(int iParam0) // Position - 0x9B84 Signature - 22 01 03 00 00 66 00 2F 15 04 00 2F 50 01 01 66 00 03 05 00 DD
{
	if (iParam0 == 0)
		return false;
...
BOOL func_293(int iParam0, Hash hParam1) // Position - 0x9B9C Signature - 22 02 E0
{
	var unk;
	int num;
	Hash unlockHash;
...
void func_294(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x9CE5 Signature - 22 04 2B 00 00 66 02 76 6D 0F 8A 06 00 50 04 00 68 16 00 66 03 66 02 76 20 6A 05 8B 05 00 66 03 09 35 30 8B 03 00 50 04 00 4B 0D 6A 80 01 6D 0A 3D 41 41 66 00 4B 0D 03 09 00 A7
{
	int i;
	int j;
	int k;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_295(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x9EBB Signature - 22 04 07 00 00 2F 66
{
	int i;
...
int func_296() // Position - 0x9FD2 Signature - 22 00 02 00 00 37 20
{
...
int func_297(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x9FEF Signature - 22 09 10
{
...
BOOL func_298(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0xA06E Signature - 22 04 07 00 00 2F 39
{
	int inventoryId;
...
BOOL func_299(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xA0B3 Signature - 22 03 05 00 00 66 02
{
...
BOOL func_300(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xA0E6 Signature - 22 05 07 00 00 66 00 03 05 00 A9
{
...
void func_301(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA120 Signature - 22 04 07 00 00 66 00 08 15 03 00 50 04 00 5D
{
	int i;
...
int func_302(int iParam0) // Position - 0xA1FC Signature - 22 01 03 00 00 66 00 3C BA 00 82
{
	switch (iParam0)
	{
		case joaat("PROVISION_SKINNED_CARCASS_OWL_HIGH_QUALITY"):
...
int func_303(Entity eParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xAC38 Signature - 22 05 11 00 00 66 00 03
{
	var entityCoords;
...
BOOL func_304(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3* pvParam6, float* pfParam7) // Position - 0xACC7 Signature - 22 08 13
{
	Vector3 vector;
	Vector3 vector2;
	var unk5;
...
BOOL func_305(Any* panParam0) // Position - 0xAD51 Signature - 22 01 03 00 00 66 00 39 B8
{
...
int func_306(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAD6D Signature - 22 04 06 00 00 66 00 39
{
...
void func_307(int iParam0) // Position - 0xADA0 Signature - 22 01 03 00 00 08
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
float func_308(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xADC3 Signature - 22 06 09 00 00 73
{
	float num;
...
BOOL func_309(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0xAE2A Signature - 22 09 0B
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

float func_310(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0xAE53 Signature - 22 07 0C 00 00 66
{
	float num;
	float num2;
	float num3;
...
BOOL func_311(Any* panParam0) // Position - 0xAEB8 Signature - 22 01 03 00 00 66 00 76 2F
{
...
BOOL func_312(Hash hParam0) // Position - 0xAEEE Signature - 22 01 03 00 00 66 00 03 05 01
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

void func_313(var uParam0) // Position - 0xAEFC Signature - 22 01 03 00 00 2F
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
