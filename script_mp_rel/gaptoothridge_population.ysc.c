...
void func_1() // Position - 0x8D Signature - 22 00 02 00 00 03 01 00 11
{
...
void func_2() // Position - 0xC6 Signature - 22 00 02 00 00 2F 04
{
...
int func_3() // Position - 0x243 Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x251 Signature - 22 02 05
{
	int i;
...
BOOL func_5() // Position - 0x331 Signature - 22 00 02 00 00 03 01 00 12
{
...
BOOL func_6() // Position - 0x345 Signature - 22 00 02 00 00 2F 39
{
	return func_14(func_13(0));
}

void func_7(Hash hParam0, BOOL bParam1, float fParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x356 Signature - 22 08
{
...
void func_8() // Position - 0x3E1 Signature - 22 00 02 00 00 50
{
	return;
}

void func_9(Volume volParam0) // Position - 0x3E9 Signature - 22 01 03 00 00 66 00 03 05 00 24 05 8B 03 00 50 01 00 66 00 21 FF
{
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x430 Signature - 22 03 05 00 00 66 00 03 05 00 24 05 8B 03 00 50 03 00 66 00 66 01 25
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x4AF Signature - 22 03 05 00 00 66 00 03 05 00 24 05 8B 03 00 50 03 00 66 00 66 01 6D
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12(Volume volParam0) // Position - 0x522 Signature - 22 01 03 00 00 66 00 03 05 00 24 05 8B 03 00 50 01 00 66 00 21 1F
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
struct<2> func_13(int iParam0) // Position - 0x563 Signature - 22 01 03 00 00 11
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_14(var uParam0, var uParam1) // Position - 0x577 Signature - 22 02 04 00 00 11
{
	return func_23(uParam0, 9, 12);
}

Hash func_15(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x58A Signature - 22 03 05 00 00 66 00 03 05 00 08
{
...
BOOL func_16(Hash hParam0) // Position - 0x62E Signature - 22 01 03 00 00 66 00 39
{
	if (func_24(hParam0))
...
void func_17(Hash hParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x649 Signature - 22 04 06
{
	if (func_16(hParam0))
	{
...
void func_18(Hash hParam0, BOOL bParam1) // Position - 0x681 Signature - 22 02 04 00 00 66 00 39 2E 06 00 8B 1D 00 66 00 03 05 00 17 11
{
	if (func_16(hParam0))
...
void func_19(Hash hParam0, BOOL bParam1) // Position - 0x6AF Signature - 22 02 04 00 00 66 00 39 2E 06 00 8B 1D 00 66 00 03 05 00 17 09
{
	if (func_16(hParam0))
...
void func_20(Hash hParam0, BOOL bParam1) // Position - 0x6DD Signature - 22 02 04 00 00 66 00 39 2E 06 00 8B 1D 00 66 00 03 05 00 17 2F
{
	if (func_16(hParam0))
...
BOOL func_21() // Position - 0x70B Signature - 22 00 02 00 00 09
{
	return true;
}

void func_22(var uParam0, int iParam1) // Position - 0x714 Signature - 22 02 04 00 00 66 00 76
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_23(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x729 Signature - 22 04 07
{
	int num;
...
BOOL func_24(Hash hParam0) // Position - 0x764 Signature - 22 01 03 00 00 66 00 2F
{
	return hParam0 != 0;
}

BOOL func_25(var uParam0, var uParam1) // Position - 0x770 Signature - 22 02 04 00 00 66 00 39 BE
{
	if (!func_27(uParam0))
		return false;
...
int func_26(int iParam0, var uParam1) // Position - 0x7A4 Signature - 22 02 04 00 00 66 00 11
{
	if (iParam0 == 2)
...
BOOL func_27(int iParam0) // Position - 0x7BE Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21
{
	switch (iParam0)
	{
		case 2:
...
int func_28(int iParam0) // Position - 0x7FD Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 2E
{
	switch (iParam0)
	{
		case 2:
...
int func_29(var uParam0, var uParam1) // Position - 0x893 Signature - 22 02 07
{
	var unk;
...
BOOL func_30(int iParam0, var uParam1, Any* panParam2) // Position - 0x8BF Signature - 22 03 05 00 00 11
{
	if (!func_25(iParam0))
		return false;
...
void func_31(Any* panParam0) // Position - 0x9CA Signature - 22 01 03 00 00 2F
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
