...
BOOL func_1(var uParam0, var uParam1, var uParam2) // Position - 0x8F Signature - 22 03 05
{
...
BOOL func_2(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xB0 Signature - 22 06
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_3(BOOL bParam0, BOOL bParam1) // Position - 0x115 Signature - 22 02 05
{
	int i;
...
BOOL func_4(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1F5 Signature - 22 05
{
...
BOOL func_5(var uParam0, var uParam1) // Position - 0x22B Signature - 22 02 04 00 00 66 00 76 3C 01 00 00 00 00 00 03 00 68 09 00 66 01 39 8A
{
	switch (*uParam0)
	{
		case 0:
...
int func_6(var uParam0, var uParam1) // Position - 0x24C Signature - 22 02 04 00 00 66 00 76 3C 01 00 00 00 00 00 03 00 68 09 00 66 01 39 D2
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_7(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x26D Signature - 22 04
{
	if (*uParam3)
	{
	}
...
BOOL func_8(var uParam0) // Position - 0x28A Signature - 22 01 04
{
...
int func_9(var uParam0) // Position - 0x2D2 Signature - 22 01 03
{
	if (*uParam0)
	{
	}
...
void func_10(Hash hParam0, var uParam1, var uParam2) // Position - 0x2E4 Signature - 22 03 06
{
	int playbackMode;
