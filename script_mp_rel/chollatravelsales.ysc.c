...
BOOL func_38(int iParam0) // Position - 0xA9A Signature - 22 01 03 00 00 85 EB E4 1C 66
{
	return Global_1893611 && iParam0 != false;
}

void func_39(int iParam0) // Position - 0xAAB Signature - 22 01 03 00 00 85 EB E4 1C 85
{
...
int func_112(int iParam0) // Position - 0x4CC6 Signature - 22 01 08
{
	int i;
	var gamerHandle;
	int bountyData;
...
BOOL func_115(int iParam0, int iParam1) // Position - 0x4ECA Signature - 22 02 04 00 00 66 00 39 B7
{
	if (!func_10(iParam0))
		return false;
...
void func_147(var uParam0) // Position - 0x5841 Signature - 22 01 0C
{
	var unk;
...
BOOL func_188(var uParam0, int iParam1, int iParam2) // Position - 0x64BF Signature - 22 03 08 00 00 66 01 6D 1F 59 67 05 66 01 6D 1F 47 67 06 66 05 66 00 17 01 66 06 03 09 00 69 67 07 66 05 66 00 63 01 66 06 03 08 00 47
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_195(var uParam0, int iParam1, int iParam2) // Position - 0x65B5 Signature - 22 03 08 00 00 66 01 6D 1F 59 67 05 66 01 6D 1F 47 67 06 66 05 66 00 17 01 66 06 03 09 00 69 67 07 66 05 66 00 63 01 66 06 03 08 00 21
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_198(int iParam0, int iParam1) // Position - 0x660C Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01
{
	return iParam0 && iParam1 != false;
}
...
void func_209(var uParam0, int iParam1) // Position - 0x7191 Signature - 22 02 04 00 00 66 00 76 66 00
{
...
BOOL func_219(var uParam0, int iParam1, int iParam2) // Position - 0x72D4 Signature - 22 03 07
{
