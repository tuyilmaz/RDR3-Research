...
void func_1(int iParam0) // Position - 0x3A Signature - 22 01 03 00 00 6D 20
{
	func_7(32, iParam0);
	func_8();
	func_9();
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_13, 12, 41);
	func_10(NETWORK::_NETWORK_GET_SIZE_OF_HOST_BROADCAST_DATA_STORAGE(&iLocal_13), 12, "m_hostData");
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&uLocal_25, 65, 42);
	func_11(NETWORK::_NETWORK_GET_SIZE_OF_PLAYER_BROADCAST_DATA_STORAGE(&uLocal_25[0 /*2*/]), 65, "m_clientData");
	func_12(false);
...
void func_2(Any* panParam0) // Position - 0x95 Signature - 22 01 03 00 00 54 0D 4D
{
	if (iLocal_13 == 6)
		return;
...
BOOL func_3() // Position - 0xBB Signature - 22 00 02 00 00 2F
{
	if (func_16(false, false))
		return true;
	else if (func_17(uLocal_90.f_9, 0, 1))
		return true;
	else if (!func_18())
		return true;
	else if (!func_19(uLocal_90.f_12))
		return true;
	else if (!func_21(func_20(uLocal_90.f_12), uLocal_90.f_9))
		return true;
	else if (uLocal_90.f_8 == 6)
		return true;

	return false;
}

void func_4() // Position - 0x135 Signature - 22 00 02 00 00 03 01 00 19 8B 04
{
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		func_22();
...
void func_5() // Position - 0x14C Signature - 22 00 02 00 00 03 01 00 19 8B 08
{
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		func_24();
...
void func_6() // Position - 0x16B Signature - 22 00 02 00 00 03 00
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_7(int iParam0, int iParam1) // Position - 0x177 Signature - 22 02 04 00 00 03 01 00 54
{
...
int func_8() // Position - 0x194 Signature - 22 00 05 00 00 03
{
	int scriptStatus;
	int gameTimer;
	int timeoutTime;
...
void func_9() // Position - 0x2A5 Signature - 22 00 02 00 00 50 00 00 22 03 05 00 00 09
{
	return;
}

int func_10(int iParam0, int iParam1, char* sParam2) // Position - 0x2AD Signature - 22 03 05 00 00 09 50 03 01 22 03
{
	return 1;
}

int func_11(int iParam0, int iParam1, char* sParam2) // Position - 0x2B6 Signature - 22 03 05 00 00 09 50 03 01 22 01
{
	return 1;
}

void func_12(BOOL bParam0) // Position - 0x2BF Signature - 22 01 0D
{
	int num;
	var unk;
	int num2;
...
void func_13(Any* panParam0) // Position - 0x388 Signature - 22 01 25
{
	Player player;
	BOOL flag;
	int num;
	...
	player = 255;
	MISC::COPY_SCRIPT_STRUCT(&uLocal_90, panParam0, 5);
	num = func_30(&flag, uLocal_90.f_1, uLocal_90.f_2);
	...
	unk.f_26 = -1;
	unk.f_28 = 2;
	func_31(&unk, uLocal_90.f_1, uLocal_90.f_2, uLocal_90.f_3, player);
	uLocal_90.f_9 = { func_32(unk.f_5, 8) };
	uLocal_90.f_14 = unk.f_5;
	uLocal_90.f_15 = { unk.f_11 };
	uLocal_90.f_18 = unk.f_7;
	func_33();
	func_34();
	return;
}

void func_14() // Position - 0x443 Signature - 22 00 02 00 00 39 91
{
	func_35();
	return;
}

void func_15() // Position - 0x44F Signature - 22 00 02 00 00 50 00 00 22 02 05 00 00 5D
{
	return;
}

BOOL func_16(BOOL bParam0, BOOL bParam1) // Position - 0x457 Signature - 22 02 05 00 00 5D
{
	int i;
...
BOOL func_17(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x537 Signature - 22 04 06 00 00 5D
{
...
BOOL func_18() // Position - 0x660 Signature - 22 00 02 00 00 03 01 00 60
{
...
BOOL func_19(int iParam0) // Position - 0x674 Signature - 22 01 03 00 00 66 00 2F 7E
{
	return iParam0 >= 0 && iParam0 < 71;
}

struct<2> func_20(int iParam0) // Position - 0x68A Signature - 22 01 03 00 00 11 66 00 5D
{
	return Global_1219595.f_1[iParam0 /*10*/].f_4;
}

BOOL func_21(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6A0 Signature - 22 04 06 00 00 66 00 66
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

void func_22() // Position - 0x6BB Signature - 22 00 02 00 00 54 0D 62 23
{
	if (iLocal_13 <= 5)
		func_40();
...
void func_23() // Position - 0x723 Signature - 22 00 02 00 00 39 B4
{
	func_47();
	func_48();
...
void func_24() // Position - 0x797 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 39 4D
{
	return;
}

void func_25() // Position - 0x79F Signature - 22 00 02 00 00 39 4D
{
	if (func_56())
...
void func_26() // Position - 0x7C9 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 89
{
	return;
}

void func_27() // Position - 0x7D1 Signature - 22 00 02 00 00 89 5A 27 0C
{
	if (uLocal_90.f_12 != -1)
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_GET_NUM_PARTICIPANTS() <= 1)
			func_58(uLocal_90.f_12, 4);

	func_59();

	if (func_60(64))
		func_61(iLocal_13.f_6);

	func_62();
	return;
}

int func_28() // Position - 0x81B Signature - 22 00 02 00 00 5D 17 00 18 27 0E
{
	return Global_1572887.f_14;
}

BOOL func_29() // Position - 0x829 Signature - 22 00 02 00 00 5D FD
{
	return Global_1051645.f_8;
}

int func_30(var uParam0, var uParam1, int iParam2) // Position - 0x837 Signature - 22 03 3E
{
	var unk;
	int num;
	int num2;
...
void func_31(Any* panParam0, int iParam1, int iParam2, int iParam3, Player plParam4) // Position - 0x926 Signature - 22 05 27
{
	var src;
	int i;
...
struct<2> func_32(var uParam0, int iParam1) // Position - 0xC4C Signature - 22 02 06 00 00 4B
{
	int num;
...
void func_33() // Position - 0xD72 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 11
{
	return;
}

void func_34() // Position - 0xD7A Signature - 22 00 02 00 00 11 03
{
	NETWORK::RESERVE_NETWORK_MISSION_PEDS(2);
	func_104(&(uLocal_90.f_19.f_9));
	return;
}

void func_35() // Position - 0xD91 Signature - 22 00 02 00 00 50 00 00 22 02 04
{
	return;
}

BOOL func_36(int iParam0, var uParam1) // Position - 0xD99 Signature - 22 02 04 00 00 66 00 39 4C
{
	if (!func_105(iParam0))
		return false;
...
BOOL func_37(int iParam0) // Position - 0xDCD Signature - 22 01 03 00 00 5D 17
{
...
BOOL func_38(int iParam0, int iParam1) // Position - 0xDEE Signature - 22 02 04 00 00 5D 77
{
...
BOOL func_39() // Position - 0xE2A Signature - 22 00 02 00 00 85
{
	if (Global_1048576)
		return true;
...
void func_40() // Position - 0xE82 Signature - 22 00 02 00 00 50 00 00 22 00 22
{
	return;
}

void func_41() // Position - 0xE8A Signature - 22 00 22 00 00 89
{
	Player player;
	var unk;

	player = Global_1207480.f_231.f_1066[uLocal_90.f_12 /*17*/].f_5;
	unk.f_10 = 1106247680;
	unk.f_15 = 4;
	unk.f_20 = 4;
	unk.f_26 = -1;
	...
	iLocal_13.f_6 = func_108(GANG::NETWORK_GET_GANG_LEADER(GANG::NETWORK_GET_GANG_ID(player)));
	func_109(256);

	if (func_110(iLocal_13.f_6))
	{
		func_111(5);
		func_107(6);
	}
...
void func_42() // Position - 0xF27 Signature - 22 00 22 00 00 4B
{
	var unk;
	BOOL flag;
	...
	unk.f_26 = -1;
	unk.f_28 = 2;
	func_31(&unk, uLocal_90.f_1, uLocal_90.f_2, -1, 255);
	...
	{
		MISC::CLEAR_AREA(uLocal_90.f_15, unk.f_10, 2442122);
		func_107(2);
	}
	else if (flag)
	{
	...
	if (!func_113(iLocal_13.f_3.f_2))
	{
		func_114(&(iLocal_13.f_3.f_2));
	}
	else if (func_115(iLocal_13.f_3.f_2) > 45000)
	{
		func_111(4);
		func_107(6);
	}
...
void func_43() // Position - 0xFE4 Signature - 22 00 02 00 00 09 6D
{
	if (func_116(1, 255))
	{
		if (!func_117(1))
...
void func_44() // Position - 0x1017 Signature - 22 00 03 00 00 11
{
	BOOL flag;
...
void func_45() // Position - 0x1061 Signature - 22 00 02 00 00 39 07
{
	func_123();
	func_124();
	func_125();

	if (func_126() || iLocal_13.f_2 != 0)
	{
		func_127();
		func_107(5);
	}
...
void func_46() // Position - 0x1091 Signature - 22 00 02 00 00 42 6D FF 39 57 79 00 8B
{
	if (func_116(4, 255))
	{
		if (func_128())
...
void func_47() // Position - 0x10B4 Signature - 22 00 02 00 00 25 00 01
{
	if (!func_117(256))
		return;
	...
	if (func_117(512))
	{
		if (func_60(64) && func_108(PLAYER::PLAYER_ID()) == iLocal_13.f_6)
		{
			func_61(iLocal_13.f_6);
			func_129(64);
		}
	...
	{
		if (func_108(PLAYER::PLAYER_ID()) == iLocal_13.f_6)
		{
			func_130(iLocal_13.f_6, 1, true);
			func_131(64);
		}
	}
	else if (func_108(PLAYER::PLAYER_ID()) != iLocal_13.f_6)
	{
		func_61(iLocal_13.f_6);
		func_129(64);
	}
...
void func_48() // Position - 0x114A Signature - 22 00 02 00 00 70
{
	if (!Global_13)
...
void func_49() // Position - 0x1183 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 54
{
	return;
}

void func_50() // Position - 0x118B Signature - 22 00 02 00 00 54 0D 4D 15 08 00 4D 39 3F 7C 00 68 0F
{
	if (iLocal_13 == 6)
	{
		func_134(6);
...
void func_51() // Position - 0x11B0 Signature - 22 00 02 00 00 54 0D 4D 15 08 00 4D 39 3F 7C 00 68 0B
{
	if (iLocal_13 == 6)
		func_134(6);
	else if (iLocal_13 > 1)
...
void func_52() // Position - 0x11D1 Signature - 22 00 04 00 00 09 6D
{
	BOOL flag;
	int num;
	...
	if (!func_116(1, 255))
	{
		...
		else
		{
			...
			if (!func_113(uLocal_90.f_11))
				func_114(&(uLocal_90.f_11));
		
			if (func_115(uLocal_90.f_11) >= num)
				func_134(6);
		}
	}
	else if (iLocal_13 > 2)
	{
		func_137(&(uLocal_90.f_11));
		func_138();
		func_134(3);
	}
...
void func_53() // Position - 0x1254 Signature - 22 00 05 00 00 11
{
	int num;
	int num2;
	int num3;
	...
	if (!func_116(2, 255))
	{
		...
		else
		{
			...
			if (func_141(uLocal_90.f_11) >= num3)
				func_134(6);
		}
	}
	else if (iLocal_13 > 3)
...
void func_54() // Position - 0x12DD Signature - 22 00 02 00 00 54 0D 62 75
{
	if (iLocal_13 >= 5)
	{
		func_146();
...
void func_55() // Position - 0x1313 Signature - 22 00 02 00 00 42 6D FF 39 57 79 00 05
{
	if (!func_116(4, 255))
	{
		if (func_154())
...
BOOL func_56() // Position - 0x134D Signature - 22 00 02 00 00 42 39
{
	return func_117(4) || NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_GET_NUM_PARTICIPANTS() <= 1;
}

void func_57() // Position - 0x136F Signature - 22 00 02 00 00 50 00 00 22 02 05 00 00 03
{
	return;
}

void func_58(int iParam0, int iParam1) // Position - 0x1377 Signature - 22 02 05 00 00 03
{
	Player playerIndex;
...
void func_59() // Position - 0x13A7 Signature - 22 00 04 00 00 09 39
{
	int num;
	BOOL flag;
	...
	func_157(uLocal_90.f_9, num, 0, 255, 0);
	func_131(4);

	if (flag)
	{
		func_158(uLocal_90.f_1, uLocal_90.f_2);
	
		if (!func_60(256))
		{
			if (num == 1)
				func_159(uLocal_90.f_18, 1);
			else
				func_159(uLocal_90.f_18, 0);
		
			func_131(256);
		}
	
		func_160(uLocal_90.f_18);
	}
	else
	{
		func_159(uLocal_90.f_18, 2);
	}

	return;
}

BOOL func_60(int iParam0) // Position - 0x1476 Signature - 22 01 03 00 00 89 5A 27 07
{
	return func_161(uLocal_90.f_7, iParam0);
}

void func_61(int iParam0) // Position - 0x1488 Signature - 22 01 04 00 00 66 00 39 6D 81 00 05 8B 03
{
	Player player;
...
void func_62() // Position - 0x14BC Signature - 22 00 05 00 00 39
{
	BOOL flag;
	int i;
	Entity entity;
	...
	PED::REMOVE_RELATIONSHIP_GROUP(uLocal_90.f_19.f_7);
	PED::REMOVE_RELATIONSHIP_GROUP(uLocal_90.f_19.f_8);
	return;
}

void func_63(var uParam0, var uParam1) // Position - 0x1537 Signature - 22 02 04 00 00 11 66
{
	uParam0->f_9 = 2;
...
int func_64(var uParam0) // Position - 0x155A Signature - 22 01 05 00 00 66 00 39
{
	int num;
	int i;
	...
	num = func_165(uParam0, uParam0->f_9);
...
struct<15> func_65(int iParam0) // Position - 0x15BB Signature - 22 01 12
{
	var unk;
...
void func_66(Any* panParam0, int iParam1) // Position - 0x1625 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0A 66 00 32 42 66 00 6C 01 0D
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 4;
	panParam0->f_2 = 7;
	func_166(panParam0, iParam1);
...
void func_67(Any* panParam0, int iParam1) // Position - 0x17D7 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 14 66 00 32 11
{
	panParam0->f_6 = 1;
	*panParam0 = 20;
	panParam0->f_1 = 2;
...
void func_68(Any* panParam0, int iParam1) // Position - 0x1B84 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 15 66 00 32 6D
{
	panParam0->f_6 = 1;
	*panParam0 = 21;
	panParam0->f_1 = 8;
	...
	{
		case 0:
			func_169(panParam0, 2);
			func_169(panParam0, 3);
			func_169(panParam0, 5);
		...
		case 2:
			func_169(panParam0, 0);
			func_169(panParam0, 1);
			func_169(panParam0, 2);
			func_169(panParam0, 3);
			func_169(panParam0, 5);
		...
		case 3:
			...
			func_169(panParam0, 2);
			func_169(panParam0, 3);
			func_169(panParam0, 4);
			func_169(panParam0, 5);
			func_169(panParam0, 7);
...
void func_69(Any* panParam0, int iParam1) // Position - 0x214A Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0B 66 00 32 09 66 00 6C 01 11
{
	panParam0->f_6 = 1;
	*panParam0 = 11;
	panParam0->f_1 = 1;
...
void func_70(Any* panParam0, int iParam1) // Position - 0x236F Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0F
{
	panParam0->f_6 = 1;
	*panParam0 = 15;
	panParam0->f_1 = 3;
...
void func_71(Any* panParam0, int iParam1) // Position - 0x263C Signature - 22 02 04 00 00 09 66 00 6C 06 6D 10
{
	panParam0->f_6 = 1;
	*panParam0 = 16;
	panParam0->f_1 = 2;
	panParam0->f_2 = 8;
	func_170(panParam0, iParam1);
...
void func_72(Any* panParam0, int iParam1, int iParam2) // Position - 0x2949 Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0A 66 00 32 6D
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 12;
	...
	switch (iParam1)
	{
		case 0:
			...
			func_169(panParam0, 1);
			func_169(panParam0, 2);
			func_169(panParam0, 9);
			func_169(panParam0, 10);
			func_169(panParam0, 11);
			func_171(panParam0, iParam2);
...
void func_73(Any* panParam0, int iParam1) // Position - 0x2D4E Signature - 22 02 04 00 00 09 66 00 6C 06 6D 15 66 00 32 09
{
	panParam0->f_6 = 1;
	*panParam0 = 21;
	panParam0->f_1 = 1;
...
void func_74(Any* panParam0, int iParam1) // Position - 0x3129 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0A 66 00 32 42 66 00 6C 01 09
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 4;
...
void func_75(Any* panParam0, int iParam1, int iParam2) // Position - 0x331C Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0C
{
	panParam0->f_6 = 1;
	*panParam0 = 12;
	panParam0->f_1 = 4;
...
void func_76(Any* panParam0, int iParam1) // Position - 0x3574 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 14 66 00 32 09
{
	panParam0->f_6 = 1;
	*panParam0 = 20;
	panParam0->f_1 = 1;
...
void func_77(Any* panParam0, int iParam1) // Position - 0x3922 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 09
{
	panParam0->f_6 = 1;
	*panParam0 = 9;
	panParam0->f_1 = 2;
...
void func_78(Any* panParam0, int iParam1, Player plParam2) // Position - 0x3AEA Signature - 22 03 05 00 00 09 66 00 6C 06 09
{
	panParam0->f_6 = 1;
	*panParam0 = 1;
	panParam0->f_1 = 6;
	...
	switch (iParam1)
	{
		case 0:
			...
			panParam0->f_11 = { func_174(func_108(plParam2)) };
			break;
	}
...
void func_79(Any* panParam0, int iParam1, int iParam2) // Position - 0x3B59 Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0A 66 00 32 62
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 5;
...
void func_80(Any* panParam0, int iParam1) // Position - 0x3D53 Signature - 22 02 04 00 00 09 66 00 6C 06 09
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 1;
	*panParam0 = 12;
...
void func_81(Any* panParam0, int iParam1, int iParam2) // Position - 0x3F9E Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0F
{
	panParam0->f_6 = 1;
	*panParam0 = 15;
	panParam0->f_1 = 2;
...
void func_94(Any* panParam0, int iParam1, int iParam2) // Position - 0x68F3 Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0A 66 00 32 1D
{
	...
	*panParam0 = 10;
	...
	func_184(panParam0, iParam1, iParam2);
...
void func_100(Any* panParam0, int iParam1, int iParam2) // Position - 0x745A Signature - 22 03 06 00 00 66 01 3C
{
	...
	*panParam0 = func_187(num);
	panParam0->f_1 = 0;
	panParam0->f_6 = 2;
	func_172(panParam0, 32);

	if (iParam2 != -1)
	{
		panParam0->f_9 = func_189(func_188(num), iParam2);
		panParam0->f_15[0] = func_190(func_188(num), iParam2);
		panParam0->f_5 = func_191(num, iParam2);
		panParam0->f_11 = { func_192(num, iParam2) };
	}
...
void func_104(var uParam0) // Position - 0x7711 Signature - 22 01 03 00 00 66 00 2F 39 73
{
	...
	func_199(uParam0, true, true, true);
	return;
}
...
void func_107(int iParam0) // Position - 0x779D Signature - 22 01 03 00 00 54 0D 66
{
...
void func_109(int iParam0) // Position - 0x77E0 Signature - 22 01 03 00 00 66 00 39 80
{
	if (!func_117(iParam0))
		func_201(&(iLocal_13.f_1), iParam0);

	return;
}

BOOL func_110(int iParam0) // Position - 0x77FC Signature - 22 01 03 00 00 66 00 39 6D 81 00 05 8B 04 00 2F 50 01 01 66 00 39 DB 8E 00 6A
{
	if (!func_162(iParam0))
		return false;

	return func_202(iParam0) && Global_1141332[iParam0 /*27*/].f_18.f_1 != 0;
}

void func_111(int iParam0) // Position - 0x782B Signature - 22 01 03 00 00 89 0D 27 02
{
...
BOOL func_112(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31) // Position - 0x7842 Signature - 22 20 2C
{
	...
	if (_IS_NULL_VECTOR(uLocal_90.f_15))
	{
		*uParam31 = 1;
		return false;
	}
	...
	{
		if (VOLUME::DOES_VOLUME_COLLIDE_WITH_ANY_VOLUME_LOCK(uLocal_90.f_15, uParam0.f_10, false, 0, 0))
		{
...
BOOL func_113(int iParam0) // Position - 0x7926 Signature - 22 01 03 00 00 66 00 2F 1C
{
	return iParam0 != 0;
}

void func_114(int iParam0) // Position - 0x7932 Signature - 22 01 03 00 00 5D 32 C5 13 27 10 66 00 32
{
	*iParam0 = Global_1295666.f_16;
	return;
}

int func_115(var uParam0) // Position - 0x7943 Signature - 22 01 03 00 00 5D 32 C5 13 27 10 66 00 10
{
	return (Global_1295666.f_16 - uParam0) * 1000;
}

BOOL func_116(int iParam0, int iParam1) // Position - 0x7957 Signature - 22 02 04 00 00 66 01 6D
{
	if (iParam1 == 255)
		if (!func_206(&iParam1))
			return false;

	return func_161(uLocal_25[iParam1 /*2*/], iParam0);
}

BOOL func_117(int iParam0) // Position - 0x7980 Signature - 22 01 03 00 00 89 0D 27 01
{
	return func_161(iLocal_13.f_1, iParam0);
}

BOOL func_118() // Position - 0x7992 Signature - 22 00 02 00 00 09 50 00 01 22 00 02
{
	return true;
}

void func_119() // Position - 0x799B Signature - 22 00 02 00 00 50 00 00 22 00 05
{
	return;
}

BOOL func_120() // Position - 0x79A3 Signature - 22 00 05 00 00 09
{
	BOOL num;
	BOOL flag;
	int i;
...
BOOL func_121() // Position - 0x79F6 Signature - 22 00 03 00 00 09 50 00 01 22 00
{
	return true;
}

void func_122() // Position - 0x79FF Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 6D
{
	return;
}

void func_123() // Position - 0x7A07 Signature - 22 00 02 00 00 6D 20 39 80 79 00 05
{
...
void func_124() // Position - 0x7A8B Signature - 22 00 03 00 00 66
{
	BOOL flag;
...
void func_125() // Position - 0x7ACB Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 39 2B
{
	return;
}

BOOL func_126() // Position - 0x7AD3 Signature - 22 00 02 00 00 39 2B
{
	if (func_211())
		return true;
...
void func_127() // Position - 0x7B0F Signature - 22 00 02 00 00 50 00 00 22 00 03 00 00 2F
{
	return;
}

BOOL func_128() // Position - 0x7B17 Signature - 22 00 03 00 00 2F 39 9F 90 00 67 02 66 02 03 05 00 6A
{
	Ped ped;

	ped = func_215(0);

	if (!ENTITY::DOES_ENTITY_EXIST(ped) || ENTITY::IS_ENTITY_DEAD(ped) && ENTITY::_IS_ENTITY_FULLY_LOOTED(ped))
		return true;

	return false;
}

void func_129(int iParam0) // Position - 0x7B4C Signature - 22 01 03 00 00 66 00 39 76 14 00 8B
{
	if (func_60(iParam0))
		func_216(&(uLocal_90.f_7), iParam0);

	return;
}

int func_130(int iParam0, int iParam1, BOOL bParam2) // Position - 0x7B67 Signature - 22 03 07 00 00 66 00
{
	int num;
	Player player;
	...
	if (bParam2)
		func_218(&(Global_1144526[player /*83*/].f_70.f_1), 1);
	else
		func_219(&(Global_1144526[player /*83*/].f_70.f_1), 1);

	return 1;
}

void func_131(int iParam0) // Position - 0x7BDA Signature - 22 01 03 00 00 66 00 39 76 14 00 05
{
	if (!func_60(iParam0))
		func_201(&(uLocal_90.f_7), iParam0);

	return;
}

void func_132(int iParam0) // Position - 0x7BF6 Signature - 22 01 03 00 00 03 01 00 B8 89
{
	if (func_161(uLocal_25[NETWORK::PARTICIPANT_ID_TO_INT() /*2*/], iParam0))
		func_216(&uLocal_25[NETWORK::PARTICIPANT_ID_TO_INT() /*2*/], iParam0);

	return;
}

void func_133(int iParam0) // Position - 0x7C1D Signature - 22 01 03 00 00 66 00 6D FF
{
	if (!func_116(iParam0, 255))
		func_201(&uLocal_25[NETWORK::PARTICIPANT_ID_TO_INT() /*2*/], iParam0);

	return;
}

void func_134(int iParam0) // Position - 0x7C3F Signature - 22 01 03 00 00 89 5A 27 08
{
	if (uLocal_90.f_8 != iParam0)
		uLocal_90.f_8 = iParam0;

	return;
}

BOOL func_135() // Position - 0x7C56 Signature - 22 00 05 00 00 6D
{
	char* textDatabase;
	BOOL num;
	int i;
...
BOOL func_136() // Position - 0x7CAB Signature - 22 00 03 00 00 2F 67
{
	BOOL flag;
...
void func_137(var uParam0) // Position - 0x7CB9 Signature - 22 01 03 00 00 2F 66 00 32 50
{
	*uParam0 = 0;
	return;
}

void func_138() // Position - 0x7CC5 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 09
{
	return;
}

int func_139() // Position - 0x7CCD Signature - 22 00 02 00 00 09 50 00 01 22 00 03
{
	return 1;
}

int func_140() // Position - 0x7CD6 Signature - 22 00 03 00 00 09 50 00 01 22 01
{
	return 1;
}

int func_141(int iParam0) // Position - 0x7CDF Signature - 22 01 03 00 00 66 00 5D 32
{
	return (iParam0 - Global_1295666.f_16) * 1000;
}

void func_142() // Position - 0x7CF3 Signature - 22 00 02 00 00 09 39
{
	if (!func_60(1))
	{
		func_222(uLocal_90.f_9);
		func_131(1);
	}
...
void func_143() // Position - 0x7D13 Signature - 22 00 02 00 00 50 00 00 22 00 04
{
	return;
}

void func_144() // Position - 0x7D1B Signature - 22 00 04 00 00 2F 67
{
	int i;
	Ped ped;
	...
	{
		if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_13.f_7.f_2[i]))
			uLocal_90.f_19.f_2[i /*2*/].f_1 = NETWORK::NET_TO_PED(iLocal_13.f_7.f_2[i]);
	}

	ped = func_215(0);
	PED::SET_PED_CONFIG_FLAG(ped, 458, true);
	func_223(ped, func_215(1), true, -1, true);
	ENTITY::_SET_ENTITY_CARRYING_FLAG(func_215(1), 9, false);
	return;
}

void func_145() // Position - 0x7D8C Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 50 00 00 22 00 03 00 00 1D
{
	return;
}

void func_146() // Position - 0x7D94 Signature - 22 00 02 00 00 50 00 00 22 00 03 00 00 1D
{
	return;
}

void func_147() // Position - 0x7D9C Signature - 22 00 03 00 00 1D
{
	float num;
	...
	if (func_225(uLocal_90.f_1, 600))
	{
		num = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false, false), uLocal_90.f_15);
...
void func_148() // Position - 0x7E24 Signature - 22 00 02 00 00 39 55
{
	func_226();
	func_227();
	return;
...
void func_149() // Position - 0x7E34 Signature - 22 00 02 00 00 39 65
{
	if (func_228())
		func_133(8);
	else
...
void func_150() // Position - 0x7E52 Signature - 22 00 02 00 00 39 A2
{
	func_229();
	func_230(iLocal_13.f_7);
	func_231();

	switch (uLocal_90.f_19)
	{
		case 0:
			func_232();
			break;
...
void func_151() // Position - 0x7E8E Signature - 22 00 02 00 00 6F 08
{
	if (!func_116(8, 255))
		func_133(16);
	else
...
void func_152() // Position - 0x7EB0 Signature - 22 00 03 00 00 08
{
	int i;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		{
			uLocal_90.f_5 = uLocal_90.f_5 || uLocal_25[i /*2*/];
			uLocal_90.f_6 = uLocal_90.f_6 && uLocal_25[i /*2*/];
		}
	}
...
void func_153() // Position - 0x7F00 Signature - 22 00 02 00 00 25 00 04
{
...
BOOL func_154() // Position - 0x7F40 Signature - 22 00 03 00 00 2F 39 9F 90 00 67 02 66 02 37
{
	Ped ped;

	ped = func_215(0);

	if (func_235(ped, -1665583462, true, false) && !func_236())
		TASK::TASK_MOVE_IN_TRAFFIC(ped, 1f, 0, 0);

	if (func_237(ped, -1665583462))
		PED::SET_PED_KEEP_TASK(ped, true);

	return true;
}

void func_155() // Position - 0x7F88 Signature - 22 00 02 00 00 50 00 00 22 03 05 00 00 66
{
	return;
}

BOOL func_156(int iParam0, Player plParam1, int iParam2) // Position - 0x7F90 Signature - 22 03 05 00 00 66 01 03
{
...
void func_157(var uParam0, var uParam1, int iParam2, int iParam3, Player plParam4, int iParam5) // Position - 0x7FB8 Signature - 22 06 18
{
	int deedType;
	Hash deedHash;
	int data;
	...
	deedType = func_239(func_238(uParam0));
	deedHash = func_240(uParam0);
	str = "";
	data.f_1 = iParam3;
	data = 0;
	data.f_2 = 0;
	...
	if (func_28() == 0)
	{
		...
		str = func_241(Global_265213.f_122484.f_80.f_22);
		func_242(uParam0, &data, iParam2);
	}
...
void func_158(int iParam0, var uParam1) // Position - 0x8088 Signature - 22 02 05 00 00 66 00 66 01 39 76
{
	int num;

	num = func_243(iParam0, uParam1);
...
void func_159(int iParam0, int iParam1) // Position - 0x80A9 Signature - 22 02 04 00 00 66 00 5D 06
{
	...
	{
		case 0:
			Global_1260806.f_3357[iParam0] = func_245(iParam0);
			break;
	
		case 1:
			Global_1260806.f_3357[iParam0] = func_246(iParam0);
			break;
	
		case 2:
			Global_1260806.f_3357[iParam0] = func_247(iParam0);
			break;
	}
...
void func_160(int iParam0) // Position - 0x8116 Signature - 22 01 06 00 00 39
{
	var statId;
	int value;
...
BOOL func_161(int iParam0, int iParam1) // Position - 0x815E Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01
{
	return iParam0 && iParam1 != false;
}

BOOL func_162(int iParam0) // Position - 0x816D Signature - 22 01 03 00 00 66 00 2F 35
{
...
void func_163(int iParam0) // Position - 0x818C Signature - 22 01 03 00 00 66 00 89 5A 80 13 80 02 17
{
	if (!MAP::DOES_BLIP_EXIST(uLocal_90.f_19.f_2[iParam0 /*2*/]))
		return;

	MAP::REMOVE_BLIP(&uLocal_90.f_19.f_2[iParam0 /*2*/]);
	return;
}

BOOL func_164(var uParam0) // Position - 0x81B7 Signature - 22 01 03 00 00 11 66 00 2D
{
	if (func_36(*uParam0))
		return true;
...
int func_165(var uParam0, int iParam1) // Position - 0x81FB Signature - 22 02 0B
{
	int num;
	int num2;
	BOOL flag;
...
void func_166(Any* panParam0, int iParam1) // Position - 0x835A Signature - 22 02 04 00 00 66 01 3C 0A
{
	switch (iParam1)
	{
		case 0:
...
void func_167(Any* panParam0) // Position - 0x840F Signature - 22 01 04 00 00 2F 67 03 66 03 66 00 27 02
{
	int i;

	for (i = 0; i <= panParam0->f_2 - 1; i = i + 1)
	{
		func_253(panParam0, i);
	}

	return;
}

void func_168(Any* panParam0) // Position - 0x8436 Signature - 22 01 04 00 00 2F 67 03 66 03 66 00 27 01
{
	int i;

	for (i = 0; i <= panParam0->f_1 - 1; i = i + 1)
	{
		func_169(panParam0, i);
	}

	return;
}

void func_169(Any* panParam0, int iParam1) // Position - 0x845D Signature - 22 02 04 00 00 66 00 80 03
{
	MISC::SET_BIT(&(panParam0->f_3), iParam1);
	return;
}

void func_170(Any* panParam0, int iParam1) // Position - 0x846F Signature - 22 02 04 00 00 66 01 3C 10
{
	switch (iParam1)
	{
		case 0:
...
void func_171(Any* panParam0, int iParam1) // Position - 0x8500 Signature - 22 02 04 00 00 66 01 3C 0C
{
	switch (iParam1)
	{
		case 0:
			func_253(panParam0, 0);
			break;
	
		case 1:
		case 2:
			func_253(panParam0, 1);
			func_253(panParam0, 2);
			break;
...
void func_172(Any* panParam0, int iParam1) // Position - 0x85A1 Signature - 22 02 04 00 00 66 00 80 19
{
	func_218(&(panParam0->f_25), iParam1);
	return;
}

void func_173(Any* panParam0, int iParam1) // Position - 0x85B3 Signature - 22 02 04 00 00 66 01 3C 04
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_174(int iParam0) // Position - 0x860E Signature - 22 01 03 00 00 66 00 39 6D 81 00 05 8B 06
{
	if (!func_162(iParam0))
		return 0f, 0f, 0f;
...
void func_175(Any* panParam0, int iParam1) // Position - 0x8632 Signature - 22 02 04 00 00 66 01 3C 05
{
	switch (iParam1)
	{
		case 0:
...
void func_176(Any* panParam0, int iParam1) // Position - 0x868A Signature - 22 02 04 00 00 66 01 3C 02
{
	switch (iParam1)
	{
		case 0:
...
void func_177(Any* panParam0, int iParam1) // Position - 0x86D7 Signature - 22 02 04 00 00 66 01 3C 0F 00 00 00 00 00 57 00 01 00 00 00 51 00 02 00 00 00 4B
{
	switch (iParam1)
	{
		case 0:
...
void func_178(Any* panParam0, int iParam1) // Position - 0x876F Signature - 22 02 04 00 00 66 01 3C 0D
{
	switch (iParam1)
	{
		case 0:
...
void func_179(Any* panParam0, int iParam1) // Position - 0x87FA Signature - 22 02 04 00 00 66 01 3C 14 00 00 00 00 00 75 00 01 00 00 00 6F 00 02 00 00 00 69 00 03 00 00 00 63 00 04 00 00 00 5D 00 05 00 00 00 68
{
	switch (iParam1)
	{
		case 0:
...
void func_180(Any* panParam0, int iParam1) // Position - 0x88C6 Signature - 22 02 04 00 00 66 01 3C 0F 00 00 00 00 00 57 00 01 00 00 00 51 00 02 00 00 00 5C
{
	switch (iParam1)
	{
		case 0:
...
void func_181(Any* panParam0, int iParam1) // Position - 0x8985 Signature - 22 02 04 00 00 66 01 3C 14 00 00 00 00 00 75 00 01 00 00 00 6F 00 02 00 00 00 69 00 03 00 00 00 63 00 04 00 00 00 5D 00 05 00 00 00 57
{
	switch (iParam1)
	{
		case 0:
...
void func_182(Any* panParam0, int iParam1) // Position - 0x8A3E Signature - 22 02 04 00 00 66 01 3C 19
{
	switch (iParam1)
	{
		case 0:
...
void func_183(Any* panParam0, int iParam1, int iParam2) // Position - 0x8B26 Signature - 22 03 05 00 00 66 01 3C 0A 00 00 00 00 00 39 00 01 00 00 00 33 00 02 00 00 00 2D 00 03 00 00 00 27 00 04 00 00 00 21 00 05 00 00 00 2C 00 06 00 00 00 26 00 07 00 00 00 20 00 08 00 00 00 1A 00 09 00 00 00 14 00 68 30
{
	switch (iParam1)
	{
		case 0:
...
void func_184(Any* panParam0, int iParam1, int iParam2) // Position - 0x8BB3 Signature - 22 03 05 00 00 66 01 3C 0A 00 00 00 00 00 39 00 01 00 00 00 33 00 02 00 00 00 2D 00 03 00 00 00 27 00 04 00 00 00 21 00 05 00 00 00 2C 00 06 00 00 00 26 00 07 00 00 00 20 00 08 00 00 00 1A 00 09 00 00 00 14 00 68 29
{
	switch (iParam1)
	{
		case 0:
...
void func_185(Any* panParam0, int iParam1) // Position - 0x8C39 Signature - 22 02 04 00 00 66 01 3C 01
{
	switch (iParam1)
	{
		case 0:
...
int func_186(int iParam0) // Position - 0x8C6D Signature - 22 01 03 00 00 66 00 5D 06
{
	return Global_1260806.f_3432[iParam0];
}

int func_187(int iParam0) // Position - 0x8C80 Signature - 22 01 03 00 00 66 00 08 15 04 00 08
{
	if (iParam0 == -1)
		return -1;
...
int func_188(int iParam0) // Position - 0x8C9C Signature - 22 01 03 00 00 66 00 08 15 04 00 2F 50 01 01 66 00 5D F6 FF 12 17
{
	if (iParam0 == -1)
		return 0;
...
var func_189(int iParam0, int iParam1) // Position - 0x8CB6 Signature - 22 02 0A 00 00 4B
{
	var unk;
	var unk2;

	if (func_263(&unk2, iParam0) && func_264(&unk2, iParam1))
		func_265(unk2, 1099008783, &unk, false);

	return unk;
}

int func_190(int iParam0, int iParam1) // Position - 0x8CE9 Signature - 22 02 0A 00 00 2F
{
	int num;
	var unk;
	...
	if (func_263(&unk, iParam0) && func_264(&unk, iParam1))
		func_265(unk, -1052341598, &num, false);

	return num;
}

int func_191(int iParam0, int iParam1) // Position - 0x8D1F Signature - 22 02 05 00 00 66 00 08 15 04
{
	int num;
...
Vector3 func_192(int iParam0, int iParam1) // Position - 0x8D46 Signature - 22 02 05 00 00 66 00 08 15 06
{
	int num;
...
void func_193(var uParam0, BOOL bParam1) // Position - 0x8D73 Signature - 22 02 04 00 00 66 01 8B 0E 00 66 00 80 02 25 00 40
{
	if (bParam1)
...
void func_194(var uParam0, BOOL bParam1) // Position - 0x8D99 Signature - 22 02 04 00 00 66 01 8B 0E 00 66 00 80 02 25 00 08
{
	if (bParam1)
...
void func_195(var uParam0, BOOL bParam1) // Position - 0x8DBF Signature - 22 02 04 00 00 66 01 8B 0E 00 66 00 80 02 25 00 01
{
	if (bParam1)
...
void func_196(var uParam0, BOOL bParam1) // Position - 0x8DE5 Signature - 22 02 04 00 00 66 01 8B 0B
{
	if (bParam1)
	{
		func_201(uParam0, 16);
...
void func_197(var uParam0, BOOL bParam1) // Position - 0x8E10 Signature - 22 02 04 00 00 66 01 8B 0D
{
	if (bParam1)
...
void func_198(var uParam0, BOOL bParam1) // Position - 0x8E34 Signature - 22 02 04 00 00 66 01 8B 0C
{
	if (bParam1)
...
void func_199(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8E56 Signature - 22 04 06 00 00 66 01 05
{
	if (!bParam1)
...
BOOL func_200(int iParam0, int iParam1) // Position - 0x8EBB Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02
{
	return iParam0 && iParam1 != false;
}

void func_201(var uParam0, int iParam1) // Position - 0x8ECA Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_202(int iParam0) // Position - 0x8EDB Signature - 22 01 04 00 00 66 00 39 6D 81 00 05 8B 04
{
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x8F06 Signature - 22 03 05 00 00 66 00
{
...
void func_204(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31) // Position - 0x8F30 Signature - 22 20 22
{
...
int func_205(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x8F5B Signature - 22 1F
{
	var args;
...
BOOL func_206(var uParam0) // Position - 0x8F74 Signature - 22 01 03 00 00 03 01 00 B8 66
{
	*uParam0 = NETWORK::PARTICIPANT_ID_TO_INT();

	if (!func_268(*uParam0, true))
	{
		*uParam0 = 255;
		return false;
	}
...
BOOL func_207(int iParam0, var uParam1) // Position - 0x8F99 Signature - 22 02 05 00 00 09
{
	Ped ped;
	...
	if (!func_271(&iLocal_13.f_7.f_2[iParam0], func_220(iParam0), func_269(iParam0), func_270(iParam0), true, 0, true, true, true))
	{
		*uParam1 = 1;
		return false;
	}
...
void func_208() // Position - 0x8FFA Signature - 22 00 02 00 00 11 39 2B
{
	func_111(2);
	return;
}

BOOL func_209(int iParam0) // Position - 0x9007 Signature - 22 01 03 00 00 89 5A 27 05
{
	return func_161(uLocal_90.f_5, iParam0);
}

BOOL func_210(int iParam0) // Position - 0x9019 Signature - 22 01 03 00 00 89 5A 27 06
{
	return func_161(uLocal_90.f_6, iParam0);
}

BOOL func_211() // Position - 0x902B Signature - 22 00 03 00 00 89
{
	Ped ped;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(ped) || ENTITY::IS_ENTITY_DEAD(ped) && !PED::GET_PED_CONFIG_FLAG(ped, 11, true) && ENTITY::_IS_ENTITY_FULLY_LOOTED(ped))
		return true;

	return false;
}

void func_212() // Position - 0x907B Signature - 22 00 02 00 00 39 7F 95 00 8B 05
{
	if (func_236())
		func_272(1);
...
void func_213() // Position - 0x908F Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 50 00 00 22 01
{
	return;
}

void func_214() // Position - 0x9097 Signature - 22 00 02 00 00 50 00 00 22 01
{
	return;
}

Ped func_215(int iParam0) // Position - 0x909F Signature - 22 01 03 00 00 66 00 89 5A 80 13 80 02 63
{
	return uLocal_90.f_19.f_2[iParam0 /*2*/].f_1;
}

void func_216(var uParam0, int iParam1) // Position - 0x90B3 Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 01
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_217(int iParam0) // Position - 0x90C8 Signature - 22 01 03 00 00 66 00 39 6D 81 00 05 8B 04 00 2F 50 01 01 66 00 39 DB 8E 00 05
{
	if (!func_162(iParam0))
		return 0;
...
void func_218(var uParam0, int iParam1) // Position - 0x90F8 Signature - 22 02 04 00 00 66 00 66 01 39 F8
{
	func_273(uParam0, iParam1);
	return;
}

void func_219(var uParam0, int iParam1) // Position - 0x9108 Signature - 22 02 04 00 00 66 00 66 01 39 09
{
	func_274(uParam0, iParam1);
	return;
}

ePedType func_220(int iParam0) // Position - 0x9118 Signature - 22 01 03 00 00 66 00 3C 02 00 00
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_221(ePedType eptParam0) // Position - 0x9145 Signature - 22 01 03 00 00 66 00 2F 15
{
...
void func_222(var uParam0, var uParam1) // Position - 0x9164 Signature - 22 02 04 00 00 11 4B 00 2D 39 40
{
	if (func_240(uParam0) == 0)
	{
	}
	else if (!STATS::STATSTRACKER_IS_INITIALIZED(func_240(uParam0)))
	{
		STATS::_0x99230691875FC218(func_238(uParam0), func_240(uParam0), Global_34);
	}

	return;
}

int func_223(Ped pedParam0, Ped pedParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x91A7 Signature - 22 05 07 00 00 66 00 03 05 00 8F 8B
{
...
BOOL func_224() // Position - 0x91EC Signature - 22 00 02 00 00 6D 20 39 80 79 00 6A
{
	return func_117(32) || func_116(32, 255);
}

BOOL func_225(int iParam0, int iParam1) // Position - 0x9207 Signature - 22 02 07 00 00 66 00 2F
{
	var statId;
	int num;
	...
	statId = { func_275(iParam0, joaat("cooldown")) };
...
void func_226() // Position - 0x9255 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 50 00 00 22 00 03 00 00 09
{
	return;
}

void func_227() // Position - 0x925D Signature - 22 00 02 00 00 50 00 00 22 00 03 00 00 09
{
	return;
}

BOOL func_228() // Position - 0x9265 Signature - 22 00 03 00 00 09 67
{
	BOOL flag;

	flag = true;

	if (flag && !UNLOCK::UNLOCK_IS_UNLOCKED(uLocal_90.f_14))
		return false;

	if (func_276())
		return false;

	if (func_277(PLAYER::GET_PLAYER_INDEX()))
		return false;

	return true;
}

void func_229() // Position - 0x92A2 Signature - 22 00 02 00 00 39 7F 95 00 8B 03
{
	if (func_236())
		return;

	if (func_278(func_215(0), 0, &(uLocal_90.f_19.f_9), &(uLocal_90.f_19.f_41), 0, 0))
	{
		func_279(32);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID(), uLocal_90.f_19.f_8);
		func_280(false);
	}
...
void func_230(var uParam0) // Position - 0x92E8 Signature - 22 01 03 00 00 89 5A 27 13
{
	if (uLocal_90.f_19 != uParam0)
		uLocal_90.f_19 = uParam0;

	return;
}

void func_231() // Position - 0x92FF Signature - 22 00 03 00 00 2F 39 9F 90 00 67 02 66 02 03 05 00 8F
{
	Ped ped;

	ped = func_215(0);

	if (ENTITY::IS_ENTITY_DEAD(ped) && !PED::GET_PED_CONFIG_FLAG(ped, 11, true) && func_281(ped, Global_33) && !func_282(4))
	{
		func_283(807, false);
		func_284(joaat("PERSONA_HONOR_ACTION__NB_RIVAL_COLLECTOR_KILL"), PLAYER::GET_PLAYER_INDEX());
		func_279(4);
	}

	if (func_285(Global_33) == func_286(ped) && !func_282(8))
	{
		func_287(true);
		func_284(joaat("PERSONA_HONOR_ACTION__NB_RIVAL_COLLECTOR_LOOT"), PLAYER::GET_PLAYER_INDEX());
		func_279(8);
	}
...
void func_232() // Position - 0x938E Signature - 22 00 05 00 00 2F
{
	int i;
	Ped ped;
	Ped ped2;
	...
	for (i = 0; i <= 1; i = i + 1)
	{
		...
		if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_13.f_7.f_2[i]) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(ped) && PED::IS_PED_READY_TO_RENDER(ped))
		{
			switch (i)
			{
				case 0:
					...
					{
						func_279(1);
						PED::_EQUIP_META_PED_OUTFIT(ped, func_288());
						PED::_UPDATE_PED_VARIATION(ped, false, true, true, true, true);
					}
					break;
				...
				case 1:
					...
					{
						func_279(2);
						PED::_EQUIP_META_PED_OUTFIT(ped, -1793085205);
						func_289(ped, true);
	...
	{
		if (BUILTIN::VDIST(Global_34, ENTITY::GET_ENTITY_COORDS(ped2, false, false)) < 20f && !func_116(32, 255))
		{
			func_291();
			func_292();
		}
	
		if (!func_282(64) && func_235(ped2, -1665583462, true, false))
		{
			func_279(64);
			TASK::TASK_MOVE_IN_TRAFFIC(ped2, 1f, 0, 0);
		}
	}
...
void func_233() // Position - 0x94BD Signature - 22 00 02 00 00 6F 20
{
	if (!func_116(32, 255))
	{
		func_291();
...
BOOL func_234(Hash hParam0, int iParam1) // Position - 0x9511 Signature - 22 02 04 00 00 66 00 27 02 66 01 69
{
	return hParam0->f_2 && iParam1 != false;
}

BOOL func_235(Ped pedParam0, eScriptTaskHash esthParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9522 Signature - 22 04 06 00 00 66 00 03 05 00 6A 05 8B
{
	...
	if (!bParam3 && func_237(pedParam0, esthParam1))
		return false;
...
BOOL func_236() // Position - 0x957F Signature - 22 00 02 00 00 6D 40
{
	return func_117(64) || func_116(64, 255);
}

BOOL func_237(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x959A Signature - 22 02 05 00 00 66 00 66 01 09
{
...
int func_238(Any anParam0, var uParam1) // Position - 0x95C3 Signature - 22 02 04 00 00 66 00 50
{
	return anParam0;
}

int func_239(int iParam0) // Position - 0x95CD Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 29
{
	switch (iParam0)
	{
		case 2:
...
Hash func_240(var uParam0, var uParam1) // Position - 0x9640 Signature - 22 02 04 00 00 11 4B 00 2D 39 C6
{
	return func_293(uParam0);
}

char* func_241(var uParam0, var uParam1, var uParam2) // Position - 0x9650 Signature - 22 03 05 00 00 4B
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

void func_242(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x9664 Signature - 22 04 0D
{
	int num;
	int i;
	int num2;
...
int func_243(int iParam0, var uParam1) // Position - 0x9776 Signature - 22 02 26 00 00 4B 05
{
	int num;
	var unk;
	int num2;
...
void func_244(int iParam0) // Position - 0x97E0 Signature - 22 01 0B 00 00 11
{
	var unk;
...
var func_245(int iParam0) // Position - 0x97F9 Signature - 22 01 03 00 00 66 00 3C 01 00 02 00 00 00 03 00 68 0B 00 5D 67 04 1D 80 F5 27 3B
{
	switch (iParam0)
	{
		case 2:
...
var func_246(int iParam0) // Position - 0x9822 Signature - 22 01 03 00 00 66 00 3C 01 00 02 00 00 00 03 00 68 0B 00 5D 67 04 1D 80 F5 27 3D
{
	switch (iParam0)
	{
		case 2:
...
var func_247(int iParam0) // Position - 0x984B Signature - 22 01 03 00 00 66 00 3C 01 00 02 00 00 00 03 00 68 0B 00 5D 67 04 1D 80 F5 27 3C
{
	switch (iParam0)
	{
		case 2:
...
struct<2> func_248(int iParam0) // Position - 0x9874 Signature - 22 01 05 00 00 66 00 3C
{
	var unk;
	...
	{
		case 1:
			return func_299(joaat("mp_beat_manager_moonshiner_cooldown_timestamp"));
	
		case 2:
			return func_299(-1122351331);
	
		case 3:
			return func_299(1185140727);
...
int func_249(int iParam0) // Position - 0x98DC Signature - 22 01 03 00 00 66 00 3C 04 00 00 00 00 00 15 00 01 00 00 00 13 00 02 00 00 00 11
{
	switch (iParam0)
	{
		case 0:
...
int func_250(int iParam0) // Position - 0x9917 Signature - 22 01 03 00 00 66 00 3C 04 00 00 00 00 00 15 00 01 00 00 00 13 00 02 00 00 00 32
{
	switch (iParam0)
	{
		case 0:
...
void func_251(Any* panParam0) // Position - 0x99B3 Signature - 22 01 03 00 00 66 00 2F 39 5D 84 00 66 00 09
{
	func_169(panParam0, 0);
	func_169(panParam0, 1);
	func_169(panParam0, 3);
...
void func_252(Any* panParam0) // Position - 0x99D6 Signature - 22 01 03 00 00 66 00 39 36
{
	func_168(panParam0);
	func_300(panParam0, 0, 3);
	return;
}

void func_253(Any* panParam0, int iParam1) // Position - 0x99EC Signature - 22 02 04 00 00 66 00 80 04
{
	MISC::SET_BIT(&(panParam0->f_4), iParam1);
	return;
}

void func_254(Any* panParam0) // Position - 0x99FE Signature - 22 01 03 00 00 66 00 2F 39 5D 84 00 66 00 2F 39 EC 99 00 66 00 09 39 EC 99 00 66 00 42
{
	func_169(panParam0, 0);
	func_253(panParam0, 0);
	func_253(panParam0, 1);
	func_253(panParam0, 4);
	func_253(panParam0, 5);
	return;
}

void func_255(Any* panParam0) // Position - 0x9A29 Signature - 22 01 03 00 00 66 00 09 39 5D 84 00 66 00 11
{
	func_169(panParam0, 1);
	func_253(panParam0, 2);
	func_253(panParam0, 3);
	func_253(panParam0, 6);
	func_253(panParam0, 7);
	func_172(panParam0, 2);
	return;
}

void func_256(Any* panParam0) // Position - 0x9A5B Signature - 22 01 03 00 00 66 00 2F 39 5D 84 00 66 00 2F 39 EC 99 00 66 00 09 39 EC 99 00 66 00 11
{
	func_169(panParam0, 0);
	func_253(panParam0, 0);
	func_253(panParam0, 1);
...
void func_257(Any* panParam0) // Position - 0x9A7F Signature - 22 01 03 00 00 66 00 09 39 5D 84 00 66 00 39
{
	func_169(panParam0, 1);
	func_167(panParam0);
	return;
...
void func_258(Any* panParam0) // Position - 0x9A94 Signature - 22 01 03 00 00 66 00 11 39 5D
{
	func_169(panParam0, 2);
	func_253(panParam0, 3);
	return;
...
void func_259(Any* panParam0) // Position - 0x9AAA Signature - 22 01 03 00 00 66 00 1D
{
	func_169(panParam0, 3);
	func_253(panParam0, 4);
	return;
...
void func_260(Any* panParam0) // Position - 0x9AC0 Signature - 22 01 03 00 00 66 00 2F 39 EC
{
	func_253(panParam0, 0);
	func_253(panParam0, 1);
	return;
...
void func_261(Any* panParam0) // Position - 0x9AD6 Signature - 22 01 03 00 00 66 00 11 39 EC
{
	func_253(panParam0, 2);
	func_253(panParam0, 3);
	return;
...
void func_262(Any* panParam0) // Position - 0x9AEC Signature - 22 01 03 00 00 66 00 42 39 EC
{
	func_253(panParam0, 4);
	func_253(panParam0, 5);
	return;
...
BOOL func_263(Any* panParam0, int iParam1) // Position - 0x9B02 Signature - 22 02 04 00 00 5D F6
{
...
BOOL func_264(Any* panParam0, int iParam1) // Position - 0x9B39 Signature - 22 02 04 00 00 37
{
...
int func_265(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, var uParam6, BOOL bParam7) // Position - 0x9B5A Signature - 22 08
{
	var unk;
...
int func_266(int iParam0, int iParam1) // Position - 0x9B8A Signature - 22 02 04 00 00 66 00 08 15
{
	if (iParam0 == -1)
		return -1;
...
int func_267(int iParam0) // Position - 0x9BA9 Signature - 22 01 03 00 00 66 00 39 6D 81 00 05 8B 04 00 2F 50 01 01 66 00 5D
{
	if (!func_162(iParam0))
		return 0;
...
BOOL func_268(int iParam0, BOOL bParam1) // Position - 0x9BCB Signature - 22 02 04 00 00 66 00 08 20
{
...
Vector3 func_269(int iParam0) // Position - 0x9BFE Signature - 22 01 03 00 00 39 84 AD 00 3C 15 00 00 00 00 00 7B 00 01 00 00 00 87
{
	switch (func_301())
	{
		case 0:
			return 1452.2505f, -1695.1158f, 64.9668f;
	
		case 1:
			return 1163.5503f, -324.00864f, 97.10712f;
	
		case 2:
			return 2682.1038f, 858.447f, 85.90118f;
	
		case 3:
			return 1311.3326f, 1183.9337f, 151.58594f;
	
		case 4:
			return 40.99253f, 1813.064f, 189.5056f;
	
		case 5:
			return 109.94106f, 1282.2561f, 176.292f;
	
		case 6:
			return -1450.8594f, 1686.2659f, 255.2526f;
	
		case 7:
			return 66.91456f, -445.5748f, 72.15018f;
	
		case 8:
			return -1698.0358f, 380.6171f, 106.08258f;
	
		case 9:
			return -2016.359f, -909.59174f, 84.91344f;
	
		case 10:
			return -1362.0912f, -1267.6244f, 82.41972f;
	
		case 11:
			return -2449.0513f, -1457.9423f, 148.70496f;
	
		case 12:
			return -1559.3394f, -1930.7284f, 50.99157f;
	
		case 13:
			return -1764.4445f, -2717.768f, 62.81413f;
	
		case 14:
			return -2190.5444f, -2200.2883f, 64.42333f;
	
		case 15:
			return -2803.2598f, -3142.291f, 5.88098f;
	
		case 16:
			return -3175.1685f, -2402.267f, 22.72451f;
	
		case 17:
			return -4220.6113f, -2690.138f, 0.65931f;
	
		case 18:
			return -4372.619f, -3274.0547f, 20.26154f;
	
		case 19:
			return -5456.922f, -3562.7441f, -21.1142f;
	
		case 20:
			return -5796.2217f, -2650.1453f, -16.68393f;
...
float func_270(int iParam0) // Position - 0x9E0B Signature - 22 01 03 00 00 39 84 AD 00 3C 15 00 00 00 00 00 7B 00 01 00 00 00 7D
{
	switch (func_301())
	{
		case 0:
...
BOOL func_271(var uParam0, ePedType eptParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0x9F44 Signature - 22 0B
{
	Ped ped;
	...
	if (!func_221(eptParam1))
		return false;

	ped = func_302(eptParam1, uParam2, fParam5, bParam8, true, bParam6, iParam7, bParam9);
...
void func_272(int iParam0) // Position - 0x9FE1 Signature - 22 01 03 00 00 89 0D 27 07
{
...
void func_273(var uParam0, int iParam1) // Position - 0x9FF8 Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 02
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_274(var uParam0, int iParam1) // Position - 0xA009 Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 02
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

struct<2> func_275(int iParam0, int iParam1) // Position - 0xA01E Signature - 22 02 09
{
	var statId;
	var unk2;
	int num;
...
BOOL func_276() // Position - 0xA069 Signature - 22 00 02 00 00 5D 0C
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

BOOL func_277(Player plParam0) // Position - 0xA08E Signature - 22 01 05 00 00 66 00 4B 03 4B
{
	var unk;
	int num;

	if (func_305(plParam0, &unk, &num, true))
		if (num != -1)
			return true;
...
BOOL func_278(Ped pedParam0, Entity eParam1, var uParam2, var uParam3, int iParam4, int iParam5) // Position - 0xA0AF Signature - 22 06 09 00 00 03
{
	int frameCount;
	...
	if (frameCount > uParam2->f_6)
		func_306(uParam2, true, frameCount);
	...
	if (!Global_1940199.f_6 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		{
			if (func_307(pedParam0, uParam2))
			{
				*uParam3 = 128;
				func_308(pedParam0, uParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1940199.f_21)
		{
			if (!(uParam2->f_2 & 8 != 0))
			{
				if (func_309(pedParam0, uParam2))
				{
					*uParam3 = 8;
					func_308(pedParam0, uParam2, *uParam3);
					return true;
				}
				else if (func_310(pedParam0, eParam1, uParam2))
				{
					*uParam3 = 8;
					func_308(pedParam0, uParam2, *uParam3);
					return true;
		...
		if (Global_1940199.f_20 && func_312(PLAYER::PLAYER_ID(), false, true, uParam2->f_2 & 524288 == 0))
		{
		...
		{
			if (func_313(uParam2, 1065353216))
			{
				if (!(uParam2->f_2 & 4 != 0))
				{
					if (func_314(Global_33, pedParam0, uParam2))
					{
						*uParam3 = 4;
						func_308(pedParam0, uParam2, *uParam3);
						return true;
				...
				{
					if (func_315(Global_33, pedParam0, uParam2))
					{
						*uParam3 = 256;
						func_308(pedParam0, uParam2, *uParam3);
						return true;
		...
		if (!(uParam2->f_2 & 16 != 0))
		{
			...
			{
				if (func_316(Global_33, pedParam0, uParam2, false))
				{
					*uParam3 = 16;
					func_308(pedParam0, uParam2, *uParam3);
					return true;
			...
			else if (func_316(Global_33, pedParam0, uParam2, true))
			{
				*uParam3 = 16;
				func_308(pedParam0, uParam2, *uParam3);
				return true;
		...
		if (Global_1940199.f_24 || Global_1940199.f_25)
		{
			if (!(uParam2->f_2 & 2 != 0))
			{
				...
				{
					if (func_320(pedParam0, Global_1940199.f_35, *uParam2 & 128 != 0, false, *uParam2 & 256 != 0) && func_321(uParam2, pedParam0) && func_322(uParam2, pedParam0))
					{
						*uParam3 = 2;
						func_308(pedParam0, uParam2, *uParam3);
						return true;
		...
		if (!(uParam2->f_2 & 2 != 0))
		{
			if (uParam2->f_13 < 4f)
			{
				if (func_320(pedParam0, Global_1940199.f_35, *uParam2 & 128 != 0, true, *uParam2 & 256 != 0) && func_321(uParam2, pedParam0) && func_322(uParam2, pedParam0))
				{
					*uParam3 = 2;
					func_308(pedParam0, uParam2, *uParam3);
					return true;
			...
			else if (Global_1940199.f_34 == 0)
			{
				...
				{
					if (func_323(pedParam0, Global_1940199.f_35))
					{
						func_324();
						*uParam3 = 2;
						func_308(pedParam0, uParam2, *uParam3);
			...
			if (uParam2->f_13 < 10f)
			{
				if (func_325(uParam2, pedParam0) || uParam2->f_10 > 0 && func_326() - uParam2->f_10 < 2000)
				{
			...
			if (Global_1940199.f_36 != 0)
			{
				if (func_327())
				{
					if (func_323(pedParam0, Global_1940199.f_36))
					{
						func_324();
						*uParam3 = 2;
						func_308(pedParam0, uParam2, *uParam3);
		...
		if (uParam2->f_13 < uParam2->f_29)
		{
			...
			{
				if (func_330(pedParam0, eParam1, uParam2))
				{
					*uParam3 = 2048;
					func_308(pedParam0, uParam2, *uParam3);
					return true;
...
void func_279(int iParam0) // Position - 0xA69B Signature - 22 01 03 00 00 89 5A 80 13 80
{
	func_201(&(uLocal_90.f_19.f_1), iParam0);
	return;
}

void func_280(BOOL bParam0) // Position - 0xA6AF Signature - 22 01 04 00 00 6F
{
	int num;

	if (!func_116(64, 255))
	{
		num = func_243(uLocal_90.f_1, uLocal_90.f_2);
		func_337(num);
		...
		if (bParam0)
			func_339(uLocal_90.f_1, uLocal_90.f_4);
...
BOOL func_281(Ped pedParam0, Ped pedParam1) // Position - 0xA707 Signature - 22 02 04 00 00 66 00 03 05 00 6A 8B
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_282(int iParam0) // Position - 0xA73E Signature - 22 01 03 00 00 89 5A 80 13 27
{
	return func_161(uLocal_90.f_19.f_1, iParam0);
}

void func_283(int iParam0, BOOL bParam1) // Position - 0xA752 Signature - 22 02 06 00 00 66 00 4B 04 4B 05 39 D2
{
	int num;
	int num2;

	func_340(iParam0, &num, &num2);

	if (!func_341(iParam0, num, num2, bParam1))
		return;
...
void func_284(int iParam0, Player plParam1) // Position - 0xA77F Signature - 22 02 0C 00 00 39
{
	var unk;
	var value;
...
Ped func_285(Ped pedParam0) // Position - 0xA7D1 Signature - 22 01 04 00 00 66 00 03 05 00 6A 05 8B 04 00 2F 50 01 01 66 00 03 05 00 1D
{
	Ped lootTarget;
...
Ped func_286(Ped pedParam0) // Position - 0xA831 Signature - 22 01 03 00 00 66 00 50
{
	return pedParam0;
}

void func_287(BOOL bParam0) // Position - 0xA83B Signature - 22 01 03 00 00 6D 08
{
	if (!func_60(8))
		return;
...
Hash func_288() // Position - 0xA876 Signature - 22 00 04 00 00 2F 6D
{
	Hash num;
...
void func_289(Ped pedParam0, BOOL bParam1) // Position - 0xAA67 Signature - 22 02 04 00 00 66 00 03 05 00 6A 05
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_290() // Position - 0xAAAC Signature - 22 00 02 00 00 6D 2B
{
	PED::ADD_RELATIONSHIP_GROUP("NB_RIVAL_COLLECTOR_COLLECTOR", &(uLocal_90.f_19.f_7));
	PED::ADD_RELATIONSHIP_GROUP("NB_RIVAL_COLLECTOR_PLAYER", &(uLocal_90.f_19.f_8));

	if (ENTITY::DOES_ENTITY_EXIST(func_215(0)))
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(func_215(0), uLocal_90.f_19.f_7);

	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(6, uLocal_90.f_19.f_7, uLocal_90.f_19.f_8);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(0, uLocal_90.f_19.f_8, uLocal_90.f_19.f_8);
	return;
}

void func_291() // Position - 0xAB0D Signature - 22 00 03 00 00 6F
{
	int num;

	if (!func_116(32, 255))
	{
		func_344(uLocal_90.f_1, uLocal_90.f_3);
	
		if (!func_116(1024, 255))
		{
			func_345(uLocal_90.f_1);
			func_133(1024);
		}
		...
		func_338(num);
		func_131(2);
		func_346(uLocal_90.f_9);
		func_347(uLocal_90.f_1);
		func_348(uLocal_90.f_1, uLocal_90.f_2, uLocal_90.f_3);
	
		if (func_349(uLocal_90.f_1))
		{
			func_350(false, 827348479);
			func_131(1024);
		}
...
void func_292() // Position - 0xABAC Signature - 22 00 02 00 00 11 39 76
{
	if (!func_60(2))
		return;
...
Hash func_293(var uParam0, var uParam1) // Position - 0xABC6 Signature - 22 02 07 00 00 4B 04 6A 80 01 08 3D 41 6A 80 02 08 3D 41 41 11 4B 00 2D 4B 04 39 53 CB 00 8B 05
{
	int num;
	...
	if (func_351(uParam0, &num))
		return num;

	return 0;
}

int func_294(var uParam0, var uParam1) // Position - 0xABF0 Signature - 22 02 07 00 00 4B 04 6A 80 01 08 3D 41 6A 80 02 08 3D 41 41 11 4B 00 2D 4B 04 39 53 CB 00 8B 07
{
	var unk;
	...
	if (func_351(uParam0, &unk))
		return unk.f_1;

	return -1;
}

int func_295(int iParam0) // Position - 0xAC1C Signature - 22 01 09
{
	int num;
	int num2;
	...
	if (func_263(&num2, iParam0))
		num = func_352() - DATAFILE::_0xE13634BB6BAF0734(num2, num2.f_1) - 1;

	return num;
}

int func_296(int iParam0) // Position - 0xAC47 Signature - 22 01 03 00 00 66 00 08 15 04 00 2F 50 01 01 66 00 5D F6 FF 12 63
{
	if (iParam0 == -1)
		return 0;
...
BOOL func_297(int iParam0, BOOL bParam1) // Position - 0xAC63 Signature - 22 02 04 00 00 66 00 3C
{
	switch (iParam0)
	{
...
void func_298(Any* panParam0) // Position - 0xACCB Signature - 22 01 03 00 00 03 01 00 54
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
	...
	*panParam0 = 183;
	...
	func_353(panParam0, panParam0->f_1);
	return;
}

struct<2> func_299(int iParam0) // Position - 0xAD36 Signature - 22 01 05 00 00 66 00 4B 03 6C
{
	var unk;
...
void func_300(Any* panParam0, int iParam1, int iParam2) // Position - 0xAD48 Signature - 22 03 06 00 00 66 01 2F
{
	int i;
...
int func_301() // Position - 0xAD84 Signature - 22 00 02 00 00 89 5A 27 02
{
	return uLocal_90.f_2;
}

Ped func_302(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, int iParam8, BOOL bParam9) // Position - 0xAD90 Signature - 22 0A
{
	Ped ped;
...
int func_303(int iParam0) // Position - 0xADBC Signature - 22 01 03 00 00 66 00 3C 22
{
	switch (iParam0)
	{
		case 1:
...
struct<2> func_304(int iParam0, int iParam1) // Position - 0xAFA8 Signature - 22 02 06 00 00 66 00 67
{
	int num;
...
BOOL func_305(Player plParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xAFBE Signature - 22 04 07 00 00 66 03
{
	Player player;
...
void func_306(var uParam0, BOOL bParam1, int iParam2) // Position - 0xB00A Signature - 22 03 05 00 00 66 02 39
{
	func_354(iParam2);
			...
			if (*uParam0 & 16 != 0)
				if (!(*uParam0 & 33554432 != 0))
					if (uParam0->f_14 == joaat("weapon_thrown_dynamite"))
						...
						if (func_356(true, true))
							func_201(uParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_33) && !func_356(true, true) || *uParam0 & 8192 != 0)
...
BOOL func_307(Ped pedParam0, var uParam1) // Position - 0xB1DA Signature - 22 02 07 00 00 66 00 03
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_359(pedParam0, uParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_360(pedParam0, pedIndexFromEntityIndex) <= func_361(uParam1))
				return true;
			break;
	}
...
void func_308(Ped pedParam0, var uParam1, int iParam2) // Position - 0xB2B1 Signature - 22 03 05 00 00 66 02 25
{
	if (iParam2 != 16384)
...
BOOL func_309(Ped pedParam0, var uParam1) // Position - 0xB2EE Signature - 22 02 08 00 00 86
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_365(pedParam0, !(*uParam1 & 268435456 != 0), !(*uParam1 & 536870912 != 0), !(*uParam1 & 1073741824 != 0), 0, false))
		{
			if (uParam1->f_13 < 5f)
				num = 95f;
			...
			num2 = func_366(uParam1);
		
			if (func_367(uParam1, pedParam0, num, num2))
			{
				if (uParam1->f_3 == 0)
					uParam1->f_3 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - uParam1->f_3;
				num4 = func_368(uParam1);
...
BOOL func_310(Ped pedParam0, Entity eParam1, var uParam2) // Position - 0xB3D8 Signature - 22 03 07 00 00 66 01
{
	float num;
	float num2;
	...
	if (func_370(eParam1, !(*uParam2 & 268435456 != 0), !(*uParam2 & 536870912 != 0), !(*uParam2 & 1073741824 != 0), 0))
	{
		if (uParam2->f_13 < 5f)
			num = 95f;
		...
		num2 = func_366(uParam2);
	
		if (func_367(uParam2, pedParam0, num, num2))
		{
			if (uParam2->f_3 == 0)
			...
			if (uParam2->f_3 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_3 > func_368(uParam2))
				{
					func_363(uParam2, true);
					return true;
				}
			}
		}
...
BOOL func_311(Ped pedParam0, var uParam1) // Position - 0xB4AE Signature - 22 02 08 00 00 03
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_359(pedParam0, uParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - uParam1->f_4 > func_368(uParam1))
		{
			customDistance = func_366(uParam1);
...
BOOL func_312(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB5B7 Signature - 22 04 29
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_313(var uParam0, int iParam1) // Position - 0xB6EC Signature - 22 02 06 00 00 66 00 27 09 2F 23 04 00 09 50 02 01 39 37 C0 00 67 04 66 04 66 00 27 09 10 67 05 66 05 36
{
	int num;
	int num2;
...
BOOL func_314(Ped pedParam0, Ped pedParam1, var uParam2) // Position - 0xB723 Signature - 22 03 08 00 00 66 01 03
{
	float num;
...
BOOL func_315(Ped pedParam0, Ped pedParam1, var uParam2) // Position - 0xB82A Signature - 22 03 06 00 00 66 02
{
	var weaponHash;

	if (uParam2->f_13 < (float)func_373(uParam2))
	{
...
BOOL func_316(Ped pedParam0, Ped pedParam1, var uParam2, BOOL bParam3) // Position - 0xB895 Signature - 22 04 10
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, uParam2->f_24))
				{
					...
					if (func_375(pedParam1, entityCoords, outCoords))
					{
						func_363(uParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, uParam2->f_24))
				{
					...
					if (func_375(pedParam1, entityCoords, outCoords2))
					{
						func_363(uParam2, true);
						return true;
					}
...
BOOL func_317(Ped pedParam0, var uParam1) // Position - 0xBA0E Signature - 22 02 12
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_359(pedParam0, uParam1, Global_1940199.f_28[i]) || pedParam0 == Global_1940199.f_28[i])
		{
		}
		else
		{
			flag2 = func_376(Global_1940199.f_28[i]);
			num = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(Global_1940199.f_28[i], false, false), entityCoords);
		
			if (func_377(Global_1940199.f_28[i]))
			{
				if (num < 35f)
				{
			...
			if (func_378(uParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1940199.f_28[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				uParam1->f_11 = pedParam0;
			...
			else if (func_379(uParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1940199.f_28[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				uParam1->f_11 = pedParam0;
			...
			else if (func_380(uParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1940199.f_28[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				uParam1->f_11 = pedParam0;
...
BOOL func_318(var uParam0, var uParam1) // Position - 0xBBEA Signature - 22 02 0F
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_319(var uParam0, int iParam1) // Position - 0xBC62 Signature - 22 02 06 00 00 66 00 27 09 2F 23 04 00 09 50 02 01 39 37 C0 00 67 04 66 04 66 00 27 09 10 67 05 66 05 66 01 2E 04 00 09 50 02 01 2F 50 02 01 22 05
{
	int num;
	int num2;
...
int func_320(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xBC91 Signature - 22 05 0A
{
	Ped entity2;
...
int func_321(var uParam0, Ped pedParam1) // Position - 0xBE26 Signature - 22 02 05 00 00 66 01 6D BE
{
	int _int;
...
BOOL func_322(var uParam0, Ped pedParam1) // Position - 0xBE73 Signature - 22 02 04 00 00 66 00 39 3F
{
	if (func_383(uParam0))
		return true;
...
BOOL func_323(Ped pedParam0, Ped pedParam1) // Position - 0xBF20 Signature - 22 02 04 00 00 66 01 03
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_384(pedParam0, pedParam1, true, true) < 4f)
...
void func_324() // Position - 0xBF6D Signature - 22 00 02 00 00 50 00 00 22 02 0C
{
	return;
}

BOOL func_325(var uParam0, Ped pedParam1) // Position - 0xBF75 Signature - 22 02 0C 00 00 70
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_385(vehiclePedIsUsing, pedParam1, entityCoords))
		{
			uParam0->f_10 = func_326();
			return true;
		}
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_386(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_326() // Position - 0xC037 Signature - 22 00 03 00 00 03
{
...
BOOL func_327() // Position - 0xC055 Signature - 22 00 02 00 00 5D E7 9A 1D 27 24
{
	if (Global_1940199.f_36 == 0)
		return false;
	...
	if (func_326() - Global_1940199.f_37 >= 10000)
		return false;

	return true;
}

BOOL func_328(var uParam0, Ped pedParam1) // Position - 0xC0A2 Signature - 22 02 07 00 00 66 00 27
{
	float num;
	int num2;
	int num3;
	...
	if (uParam0->f_13 > func_387(uParam0) && uParam0->f_13 > num)
		return false;

	num3 = func_388(pedParam1);
	num2 = func_389(uParam0->f_15);
...
BOOL func_329(var uParam0, Ped pedParam1) // Position - 0xC156 Signature - 22 02 0D
{
	Ped ped;
	var entityCoords;
	var entityCoords2;
...
BOOL func_330(Ped pedParam0, Entity eParam1, var uParam2) // Position - 0xC1F4 Signature - 22 03 08 00 00 66 02
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *uParam2 & 128 != 0;
	return func_392(pedParam0, eParam1, flag, flag3, uParam2->f_13, flag2);
}

BOOL func_331(Ped pedParam0, var uParam1) // Position - 0xC23C Signature - 22 02 0A 00 00 66
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_393(pedParam0, uParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_33, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_33, 17))
					if (!func_396(uParam1, pedParam0))
						if (func_386(pedIndexFromEntityIndex, Global_34, true) < 7f)
							return true;
			break;
...
BOOL func_332(Ped pedParam0, var uParam1) // Position - 0xC597 Signature - 22 02 04 00 00 2F
{
	if (!func_397(0))
		return false;
...
BOOL func_333(var uParam0, int iParam1) // Position - 0xC5D0 Signature - 22 02 06 00 00 66 00 27 09 2F 23 04 00 09 50 02 01 39 37 C0 00 67 04 66 04 66 00 27 09 10 67 05 66 05 66 01 2E 04 00 09 50 02 01 2F 50 02 01 22 02
{
	int num;
	int num2;
...
BOOL func_334(var uParam0, var uParam1) // Position - 0xC5FF Signature - 22 02 04 00 00 66 00 76 03
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_335(Ped pedParam0, var uParam1) // Position - 0xC613 Signature - 22 02 04 00 00 66 00 03 05 00 99
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (uParam1->f_5 == 0)
		uParam1->f_5 = func_326();
	else if (func_326() - uParam1->f_5 > func_398(uParam1))
		return func_399(pedParam0, uParam1, false, -1082130432);

	return false;
}

BOOL func_336(var uParam0, Ped pedParam1) // Position - 0xC660 Signature - 22 02 06 00 00 66 01
{
...
void func_337(int iParam0) // Position - 0xC6B3 Signature - 22 01 2A
{
	int num;
	int num2;
	var unk;
	...
	if (value != 0)
	{
		statId = { func_299(joaat("mp_fetch_last_attempted_dynamic_mission_unlock")) };
		STATS::STAT_ID_SET_INT(&statId, value, true);
		statId = { func_299(joaat("mp_fetch_last_attempted_dynamic_mission_timestamp")) };
	...
	if (value2 != 0)
	{
		statId2 = { func_299(joaat("mp_fetch_last_attempted_cooldown_tag_id")) };
		STATS::STAT_ID_SET_INT(&statId2, value2, true);
		statId2 = { func_299(joaat("mp_fetch_last_attempted_cooldown_tag_timestamp")) };
...
void func_338(int iParam0) // Position - 0xC792 Signature - 22 01 0B 00 00 09
{
	var unk;
...
void func_339(int iParam0, int iParam1) // Position - 0xC7AB Signature - 22 02 05 00 00 66 00 66 01 39 0A
{
	int num;
	...
	func_403(num, iParam0);
	return;
}

void func_340(int iParam0, var uParam1, var uParam2) // Position - 0xC7D2 Signature - 22 03 06 00 00 66 00 67
{
	int num;
...
BOOL func_341(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xC7EE Signature - 22 04 06 00 00 66 01 2F
{
	...
	if (Global_1900460.f_67 && !func_407(iParam0, 1) || func_408(32768))
		if (!func_407(iParam0, 262144) || !Global_1904402.f_8875)
			return false;
...
void func_342(int iParam0, int iParam1) // Position - 0xC890 Signature - 22 02 05 00 00 66 00 5D
{
	int address;
...
void func_343(Any* panParam0, var uParam1) // Position - 0xC8B4 Signature - 22 02 04 00 00 4B
{
...
void func_344(int iParam0, int iParam1) // Position - 0xC8EA Signature - 22 02 26 00 00 4B 04
{
	var unk;
	var statId;
	BOOL address;
	...
	statId = { func_275(iParam0, joaat("variations_seen")) };
	...
	if (!func_106(&unk, 4) && func_410(address) == unk.f_1)
		address = false;
...
void func_345(int iParam0) // Position - 0xC990 Signature - 22 01 03 00 00 66 00 39 EB
{
	func_411(iParam0);
	return;
}

void func_346(var uParam0, var uParam1) // Position - 0xC99E Signature - 22 02 26 00 00 11
{
	Hash hash;
	var unk;
...
void func_347(int iParam0) // Position - 0xCA47 Signature - 22 01 05 00 00 66 00 37
{
	var statId;

	statId = { func_275(iParam0, joaat("num_times_seen")) };
	STATS::_STAT_ID_INCREMENT_INT(&statId, 1);
	return;
}

void func_348(int iParam0, int iParam1, int iParam2) // Position - 0xCA65 Signature - 22 03 25
{
	var unk;
	int num;
...
BOOL func_349(int iParam0) // Position - 0xCAE2 Signature - 22 01 03 00 00 66 00 3C 01 00 09
{
	switch (iParam0)
	{
		case 9:
...
int func_350(BOOL bParam0, Hash hParam1) // Position - 0xCAFD Signature - 22 02 04 00 00 03 01 00 0C
{
	if (!NETWORK::NETWORK_IS_IN_SESSION())
		return 0;
...
BOOL func_351(int iParam0, var uParam1, Any* panParam2) // Position - 0xCB53 Signature - 22 03 05 00 00 11
{
	if (!func_36(iParam0))
		return false;
...
int func_352() // Position - 0xCC5E Signature - 22 00 08
{
	int numChildren;
	Any any;
...
void func_353(Any* panParam0, var uParam1) // Position - 0xCC96 Signature - 22 02 04 00 00 50
{
	return;
}

void func_354(int iParam0) // Position - 0xCC9E Signature - 22 01 07 00 00 70
{
	int num;
	BOOL flag;
	Hash weaponHash;
	...
	{
		case 0:
			func_417(&(Global_1940199.f_28), &(Global_1940199.f_33));
...
var func_355(int iParam0) // Position - 0xCE36 Signature - 22 01 03 00 00 66 00 5D DD
{
	return Global_1102813.f_3695[iParam0 /*3*/];
}

BOOL func_356(BOOL bParam0, BOOL bParam1) // Position - 0xCE49 Signature - 22 02 06 00 00 66 00 4B 04 4B 05 39 81
{
	Ped ped;
	Ped ped2;

	if (func_418(bParam0, &ped, &ped2))
	{
		if (bParam1)
		{
...
BOOL func_357(var uParam0) // Position - 0xCE9C Signature - 22 01 04 00 00 5D E7 9A 1D 27 22
{
	Ped ped;
...
void func_358(var uParam0) // Position - 0xCF1E Signature - 22 01 03 00 00 66 00 76 6D
{
...
BOOL func_359(Ped pedParam0, var uParam1, Ped pedParam2) // Position - 0xCF45 Signature - 22 03 09
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_389(pedParam2);
	else
		num2 = func_388(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_389(pedParam0);
	else
		num = func_388(pedParam0);
...
float func_360(Ped pedParam0, Ped pedParam1) // Position - 0xD03E Signature - 22 02 04 00 00 66 00 66 01 09
{
	return func_384(pedParam0, pedParam1, true, true);
}

float func_361(var uParam0) // Position - 0xD050 Signature - 22 01 03 00 00 66 00 27 1D
{
	return uParam0->f_29;
}

BOOL func_362(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xD05C Signature - 22 05 07 00 00 66 00 3C
{
	switch (iParam0)
	{
		case 1:
...
void func_363(var uParam0, BOOL bParam1) // Position - 0xD0C1 Signature - 22 02 04 00 00 66 01 8B 0E 00 66 00 37
{
	if (bParam1)
...
void func_364() // Position - 0xD0E7 Signature - 22 00 02 00 00 03 01 00 8E
{
...
BOOL func_365(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0xD0FB Signature - 22 06 0B 00 00 66
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_384(ped, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_421(ped, 0)))
			if (func_422(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_366(var uParam0) // Position - 0xD26B Signature - 22 01 03 00 00 66 00 27 12
{
	return uParam0->f_18;
}

BOOL func_367(var uParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0xD277 Signature - 22 04 07 00 00 66 00 27
{
	float num;
...
int func_368(var uParam0) // Position - 0xD2D8 Signature - 22 01 03 00 00 66 00 27 13
{
	return uParam0->f_19;
}

int func_369(var uParam0) // Position - 0xD2E4 Signature - 22 01 03 00 00 66 00 27 14
{
	return uParam0->f_20;
}

BOOL func_370(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xD2F0 Signature - 22 05 09
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_421(ped, 0)))
			if (func_423(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_371(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD3B2 Signature - 22 03 05 00 00 5D E7
{
...
float func_372(var uParam0) // Position - 0xD450 Signature - 22 01 03 00 00 66 00 27 19
{
	return uParam0->f_25;
}

int func_373(var uParam0) // Position - 0xD45C Signature - 22 01 03 00 00 66 00 27 17
{
	return uParam0->f_23;
}

int func_374(var uParam0) // Position - 0xD468 Signature - 22 01 04 00 00 66 00 27
{
	int num;
...
BOOL func_375(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0xD5A5 Signature - 22 07 09
{
	if (func_424(pedParam0, vParam4, 0.5f))
...
BOOL func_376(Ped pedParam0) // Position - 0xD5E8 Signature - 22 01 03 00 00 66 00 6D 09
{
	...
	if (func_425(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_377(Ped pedParam0) // Position - 0xD64E Signature - 22 01 04 00 00 66 00 03 05 00 6A 05 8B 04 00 2F 50 01 01 66 00 03 05 00 3B
{
	Hash entityModel;
...
BOOL func_378(var uParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0xD67A Signature - 22 05 08 00 00 66 03 8B 04 00 2F 50 05 01 66 04 8B 0D 00 66 01 39 AC E4 00 8B 04 00 2F 50 05 01 7C
{
	float num;
...
BOOL func_379(var uParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0xD6C1 Signature - 22 05 08 00 00 66 03 8B 04 00 2F 50 05 01 66 04 8B 0D 00 66 01 39 AC E4 00 8B 04 00 2F 50 05 01 86
{
	float num;
...
BOOL func_380(var uParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0xD70C Signature - 22 04 07 00 00 66 00 39
{
	float num;
...
BOOL func_381(Ped pedParam0, var uParam1) // Position - 0xD786 Signature - 22 02 04 00 00 66 00 03 05 00 AB
{
...
BOOL func_382(Ped pedParam0, Ped pedParam1) // Position - 0xD7D3 Signature - 22 02 04 00 00 66 00 03 05 00 2E
{
	...
	if (!WEAPON::_IS_WEAPON_LASSO(func_428(pedParam0, true, 0, false)) && !(func_428(pedParam0, true, 0, false) == joaat("weapon_thrown_bolas")))
		return false;
...
BOOL func_383(var uParam0) // Position - 0xD83F Signature - 22 01 03 00 00 66 00 76 11
{
	return !(*uParam0 & 2 != 0);
}

float func_384(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0xD84F Signature - 22 04 06 00 00 66 00 03 05 00 6A 05 6A
{
...
BOOL func_385(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD897 Signature - 22 05 08 00 00 66 00
{
	float num;

	num = func_386(veParam0, uParam2, true);
...
float func_386(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD8C3 Signature - 22 05 07 00 00 66 00 03 05 00 6A
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_387(var uParam0) // Position - 0xD8EB Signature - 22 01 03 00 00 66 00 27 1A
{
	return uParam0->f_26;
}

int func_388(Ped pedParam0) // Position - 0xD8F7 Signature - 22 01 03 00 00 66 00 09 03 09 00 C8 05 8B 04 00 08 50 01 01 66 00 6D 83
{
...
int func_389(Ped pedParam0) // Position - 0xD94B Signature - 22 01 03 00 00 66 00 09 03 09 00 C8 05 8B 04 00 08 50 01 01 66 00 6D 78
{
	if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(pedParam0, true))
		return -1;
...
int func_390(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0xD99F Signature - 22 03 08 00 00 66 01 2F
{
	var entityCoords;

	entityCoords = { ENTITY::GET_ENTITY_COORDS(pedParam1, false, false) };
	return func_429(pedParam0, entityCoords, iParam2);
}

float func_391(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xD9BF Signature - 22 06 08
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_392(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0xD9DD Signature - 22 06 0B 00 00 5D
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_384(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_384(pedParam0, Global_1940199.f_34, false, true) < 2.5f)
...
BOOL func_393(Ped pedParam0, var uParam1, BOOL bParam2) // Position - 0xDB4D Signature - 22 03 07 00 00 09
{
	Ped ped;
	Ped ped2;

	func_418(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_33, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_33, 17))
					if (!bParam2 || !func_396(uParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_33, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_33, 17))
				if (!bParam2 || !func_396(uParam1, ped2))
					if (func_386(ped2, Global_34, true) < 5f)
						return true;

	return false;
}

BOOL func_394(Ped pedParam0) // Position - 0xDC3B Signature - 22 01 03 00 00 66 00 03
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_395(var uParam0) // Position - 0xDC61 Signature - 22 01 03 00 00 66 00 76 21
{
	return func_161(*uParam0, 131072);
}

BOOL func_396(var uParam0, Ped pedParam1) // Position - 0xDC74 Signature - 22 02 05 00 00 66 01 6D CB
{
...
BOOL func_397(int iParam0) // Position - 0xDCE8 Signature - 22 01 03 00 00 2F 50
{
	return false;
}

int func_398(var uParam0) // Position - 0xDCF1 Signature - 22 01 03 00 00 66 00 27 16
{
	return uParam0->f_22;
}

BOOL func_399(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xDCFD Signature - 22 04 06 00 00 66 02
{
	if (!bParam2)
		if (uParam1->f_5 == 0)
			return 0;
...
int func_400(int iParam0, var uParam1, var uParam2) // Position - 0xDD78 Signature - 22 03 26
{
	int num;
	int i;
	int num2;
...
BOOL func_401(int iParam0, int iParam1) // Position - 0xDE0A Signature - 22 02 04 00 00 66 01 2F
{
	if (iParam1 < 0 || iParam1 > func_430(iParam0) - 1)
		return false;

	return true;
}

int func_402(int iParam0) // Position - 0xDE2F Signature - 22 01 03 00 00 66 00 5C
{
	return iParam0 + 8;
}

void func_403(int iParam0, int iParam1) // Position - 0xDE3B Signature - 22 02 07 00 00 66 01
{
	var statId;
	int address;

	statId = { func_275(iParam1, joaat("character_memory")) };
...
BOOL func_404(int iParam0, int iParam1) // Position - 0xDE84 Signature - 22 02 04 00 00 66 00 87
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_405(int iParam0) // Position - 0xDE9C Signature - 22 01 03 00 00 66 00 42 39 7F
{
...
BOOL func_406(int iParam0) // Position - 0xDEB3 Signature - 22 01 07 00 00 66
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_407(int iParam0, int iParam1) // Position - 0xDF7F Signature - 22 02 04 00 00 66 00 5D 12
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_408(int iParam0) // Position - 0xDF98 Signature - 22 01 03 00 00 5D 00
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_409() // Position - 0xDFAB Signature - 22 00 02 00 00 39 60
{
	if (!func_18())
		return false;
...
int func_410(BOOL bParam0) // Position - 0xDFC6 Signature - 22 01 04 00 00 2F 67 03 66 00 2F
{
	int i;
...
void func_411(int iParam0) // Position - 0xDFEB Signature - 22 01 06 00 00 5D
{
	int value;
	var statId;
...
BOOL func_412(int iParam0, var uParam1, var uParam2) // Position - 0xE017 Signature - 22 03 08 00 00 4B
{
	var unk;

	unk.f_1 = -1;
	unk.f_2 = -1;
	func_351(iParam0, &unk);

	if (func_431(iParam0, unk, uParam2))
		return true;

	return false;
}

BOOL func_413() // Position - 0xE04B Signature - 22 00 02 00 00 5D 17 00 18 27 0A
{
	return !Global_1572887.f_10;
}

void func_414(Hash hParam0, int iParam1) // Position - 0xE05A Signature - 22 02 04 00 00 66 00 27 02 66 01 30
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

void func_415(Any* panParam0) // Position - 0xE06D Signature - 22 01 03 00 00 2F 66 00 32 08
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
BOOL func_416() // Position - 0xE083 Signature - 22 00 02 00 00 39 DA
{
	if (func_432())
		return false;
...
void func_417(Any* panParam0, int iParam1) // Position - 0xE0D9 Signature - 22 02 07 00 00 03
{
	int num;
	int i;
	Player player;
...
BOOL func_418(BOOL bParam0, var uParam1, var uParam2) // Position - 0xE181 Signature - 22 03 07 00 00 5D
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_419(var uParam0) // Position - 0xE248 Signature - 22 01 05 00 00 66 03
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_420(var uParam0) // Position - 0xE2FE Signature - 22 01 04 00 00 5D E7 9A 1D 27 20
{
	int i;
...
Hash func_421(Ped pedParam0, int iParam1) // Position - 0xE363 Signature - 22 02 05 00 00 66 00 4B
{
	Hash weaponHash;
...
BOOL func_422(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0xE37A Signature - 22 05 07 00 00 66 00 03 05 00 8F 05
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_423(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_423(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0xE3A8 Signature - 22 07 0C
{
	float screenX;
	float screenY;
...
BOOL func_424(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0xE3F2 Signature - 22 05 0D
{
...
BOOL func_425(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE433 Signature - 22 04 06 00 00 66 03
{
...
BOOL func_426(Ped pedParam0) // Position - 0xE4AC Signature - 22 01 04 00 00 66 00 03 05 00 8F
{
...
float func_427(var uParam0) // Position - 0xE5A2 Signature - 22 01 03 00 00 66 00 27 1C
{
	return uParam0->f_28;
}

Hash func_428(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xE5AE Signature - 22 04 07 00 00 37
{
	Hash weaponHash;
...
int func_429(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xE5F0 Signature - 22 05 11
{
	var entityCoords;
	...
	value = func_433(entityForwardVector, unk5);
	...
	if (func_434(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

int func_430(int iParam0) // Position - 0xE67F Signature - 22 01 03 00 00 66 00 3C 02 00 04
{
	switch (iParam0)
	{
		case 4:
...
BOOL func_431(int iParam0, var uParam1, var uParam2) // Position - 0xE6A5 Signature - 22 03 0A 00 00 66 00 39
{
	var unk;
	...
	if (func_436(iParam0, uParam1, &unk))
		func_437(iParam0, &unk, uParam2);
	else
		return false;
...
BOOL func_432() // Position - 0xE6DA Signature - 22 00 02 00 00 5D E7 9A 1D 27 26
{
...
float func_433(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xE711 Signature - 22 06 09 00 00 73
{
	float num;
...
BOOL func_434(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0xE778 Signature - 22 09 0B
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_435(int iParam0) // Position - 0xE7A1 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21 00 04 00 00 00 1B 00 05 00 00 00 15 00 06 00 00 00 0F 00 07 00 00 00 09 00 08 00 00 00 03 00 68 04 00 09 50 01 01 2F 50 01 01 22 03
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_436(int iParam0, var uParam1, Any* panParam2) // Position - 0xE7E0 Signature - 22 03 05 00 00 5D F8 89 11 27 07 66 02 32 37 19
{
	*panParam2 = Global_1149432.f_7;
	panParam2->f_2 = 1351168281;
	panParam2->f_3 = func_438(iParam0);
	panParam2->f_4 = uParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam2->f_1), panParam2);
}

void func_437(int iParam0, Any* panParam1, var uParam2) // Position - 0xE814 Signature - 22 03 06 00 00 66 00 66
{
	int num;
	...
	*uParam2 = iParam0;
	...
	uParam2->f_3 = func_439(iParam0, uParam2->f_1);
...
int func_438(int iParam0) // Position - 0xEA6F Signature - 22 01 04 00 00 2F 67 03 66 00 3C
{
	int num;
...
int func_439(int iParam0, var uParam1) // Position - 0xEBE4 Signature - 22 02 1F
{
	var unk;

	if (func_445(iParam0, uParam1, &unk))
		return unk.f_2;

	return 0;
}

int func_440(int iParam0) // Position - 0xEC01 Signature - 22 01 03 00 00 66 00 3C 1E
{
	switch (iParam0)
	{
		case joaat("IWD_INF"):
...
int func_441(int iParam0) // Position - 0xED57 Signature - 22 01 03 00 00 66 00 3C 07 00 18
{
	switch (iParam0)
	{
...
int func_442(int iParam0) // Position - 0xEDAE Signature - 22 01 03 00 00 66 00 3C 13
{
	switch (iParam0)
	{
...
int func_443(int iParam0) // Position - 0xEE88 Signature - 22 01 03 00 00 66 00 3C 0D
{
	switch (iParam0)
	{
		case -1641798436:
...
int func_444(int iParam0) // Position - 0xEF20 Signature - 22 01 03 00 00 66 00 3C 26
{
	switch (iParam0)
	{
		case -1968391995:
...
BOOL func_445(int iParam0, var uParam1, var uParam2) // Position - 0xF0CA Signature - 22 03 0A 00 00 66 00 66
{
	var unk;

	if (func_446(iParam0, uParam1, &unk))
		func_447(&unk, iParam0, uParam2);
	else
		return false;
...
BOOL func_446(int iParam0, var uParam1, Any* panParam2) // Position - 0xF0F1 Signature - 22 03 05 00 00 5D F8 89 11 27 07 66 02 32 37 A7
{
	*panParam2 = Global_1149432.f_7;
...
void func_447(Any* panParam0, int iParam1, var uParam2) // Position - 0xF125 Signature - 22 03 06 00 00 66 01 66
{
	var unk;
