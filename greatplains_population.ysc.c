...
void func_1() // Position - 0x52 Signature - 22 00 02 00 00 03
{
...
void func_2() // Position - 0x8B Signature - 22 00 02 00 00 2F
{
...
int func_3() // Position - 0x2D5 Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x2E3 Signature - 22 02 05
{
	int i;
...
void func_5() // Position - 0x3C3 Signature - 22 00 02 00 00 50
{
	return;
}

void func_6(Volume volParam0) // Position - 0x3CB Signature - 22 01
{
...
void func_7(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x40C Signature - 22 03 05 00 00 66 00 03 05 00 03 05 8B 03 00 50 03 00 66 00 66 01 25
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_8(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x482 Signature - 22 03 05 00 00 66 00 03 05 00 03 05 8B 03 00 50 03 00 66 00 66 01 6D
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_9(var uParam0, int iParam1) // Position - 0x4F8 Signature - 22 02 04
{
