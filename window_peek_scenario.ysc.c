...
void func_1() // Position - 0x87 Signature - 22 00 02 00 00 50 00 00 22 00 02
{
	return;
}

void func_2() // Position - 0x8F Signature - 22 00 02 00 00 39
{
	func_7();
...
BOOL func_3() // Position - 0xB4 Signature - 22 00 02 00 00 54 0E
{
	if (hLocal_14 != 0)
...
void func_4() // Position - 0xDD Signature - 22 00 02 00 00 50 00 00 22 00 03
{
	return;
}

void func_5() // Position - 0xE5 Signature - 22 00 03
{
	int i;
...
void func_6() // Position - 0x13D Signature - 22 00 02 00 00 70 21 00 03 05 00 02
{
...
void func_7() // Position - 0x29B Signature - 22 00 02 00 00 54 14
{
	CAM::DESTROY_CAM(caLocal_20, false);
...
void func_8() // Position - 0x2B1 Signature - 22 00 02 00 00 03
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x2BD Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 1F 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 16 4B 03 39 CC
{
	struct<2> eventData;
...
void func_10(int iParam0) // Position - 0x2E5 Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 1F 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 16 4B 03 39 D4
{
	struct<2> eventData;
...
void func_11(int iParam0) // Position - 0x30D Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 1F 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 16 4B 03 39 DC
{
	struct<2> eventData;
...
BOOL func_12(int iParam0) // Position - 0x335 Signature - 22 01 03 00 00 54
{
	return bLocal_18 && iParam0 != false;
}

void func_13() // Position - 0x344 Signature - 22 00 02 00 00 11
{
	if (func_12(2))
		return;
...
void func_14() // Position - 0x37E Signature - 22 00 02 00 00 70 21 00 03 05 00 15
{
	if (PED::IS_PED_USING_ANY_SCENARIO(Global_33))
	{
		if (TASK::IS_PED_EXITING_SCENARIO(Global_33, false))
...
void func_15(BOOL bParam0) // Position - 0x3D1 Signature - 22 01 03 00 00 66 00 39
{
	if (func_12(bParam0))
		return;
...
void func_16(int iParam0) // Position - 0x3EC Signature - 22 01 03 00 00 66 00 4E
{
	iLocal_19 = iParam0;
	return;
}

void func_17(var uParam0, BOOL bParam1) // Position - 0x3F8 Signature - 22 02 08
{
	float num;
	float num2;
...
void func_18(var uParam0) // Position - 0x5CC Signature - 22 01 03 00 00 50 01 00 22 01 03 00 00 50 01 00 22 01
{
	return;
}

void func_19(var uParam0) // Position - 0x5D4 Signature - 22 01 03 00 00 50 01 00 22 01 03 00 00 50 01 00 22 00
{
	return;
}

void func_20(var uParam0) // Position - 0x5DC Signature - 22 01 03 00 00 50 01 00 22 00
{
	return;
}

void func_21() // Position - 0x5E4 Signature - 22 00 02 00 00 09 37
{
...
void func_22(int iParam0, int iParam1) // Position - 0x602 Signature - 22 02 04
{
...
void func_23(var uParam0, var uParam1, var uParam2, var uParam3, eControlAction ecaParam4, eControlAction ecaParam5, eControlAction ecaParam6, eControlAction ecaParam7, eControlType ectParam8) // Position - 0x620 Signature - 22 09
{
...
float func_24(float fParam0, float fParam1, float fParam2) // Position - 0x67C Signature - 22 03
{
	if (fParam0 > fParam2)
		return fParam2;
