...
void main() // Position - 0x0 Signature - 22 00 83
{
	var unk;
	int i;
...
void func_1() // Position - 0x27B Signature - 22 00 02 00 00 54
{
...
BOOL func_2(Hash hParam0, int iParam1) // Position - 0x296 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 0B
{
	if (hParam0 == 0)
		return false;
...
BOOL func_3(Hash hParam0, Hash hParam1) // Position - 0x2B0 Signature - 22 02 04 00 00 66 00 2F 39
{
	if (!func_2(hParam0, 0))
...
BOOL func_4() // Position - 0x2F1 Signature - 22 00 02 00 00 5D
{
...
void func_5(var uParam0) // Position - 0x348 Signature - 22 01 06
{
	int i;
	int j;
	int num;
...
Hash func_6(Hash hParam0) // Position - 0x417 Signature - 22 01 03 00 00 66 00 50
{
	return hParam0;
}

BOOL func_7(Hash hParam0, Hash hParam1) // Position - 0x421 Signature - 22 02 04 00 00 66 00 11
{
...
BOOL func_8(BOOL bParam0, BOOL bParam1) // Position - 0x457 Signature - 22 02 05
{
	int i;
...
BOOL func_9() // Position - 0x537 Signature - 22 00 02 00 00 09
{
	return func_13(1);
}

void func_10(var uParam0) // Position - 0x544 Signature - 22 01 04
{
	int i;
...
void func_11(var uParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5D8 Signature - 22 05
{
	var unk;
...
BOOL func_12(Hash hParam0, int iParam1) // Position - 0x66B Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 09
{
	if (hParam0 == 0)
		return false;
...
BOOL func_13(int iParam0) // Position - 0x685 Signature - 22 01 03 00 00 66 00 39
{
	return func_14(iParam0);
}

BOOL func_14(int iParam0) // Position - 0x693 Signature - 22 01 03 00 00 5D
{
	return func_15(Global_1940085.f_38, iParam0);
}

BOOL func_15(int iParam0, int iParam1) // Position - 0x6A7 Signature - 22 02 04 00 00 66 00 66
{
