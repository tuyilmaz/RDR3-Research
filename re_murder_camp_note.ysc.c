...
void func_6() // Position - 0x10C Signature - 22 00 07
{
	Hash entityModel;
...
void func_7() // Position - 0x4F4 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 03
{
	return;
}

void func_8() // Position - 0x4FC Signature - 22 00 02 00 00 03 00
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x508 Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 21 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 06 4B 03 39 A3
{
	struct<2> eventData;
...
void func_10(int iParam0) // Position - 0x530 Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 21 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 06 4B 03 39 B1
{
	struct<2> eventData;
...
void func_11(int iParam0) // Position - 0x558 Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 21 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 06 4B 03 39 C9
{
	struct<2> eventData;
...
BOOL func_12() // Position - 0x580 Signature - 22 00 02 00 00 03 01
{
...
void func_13(int iParam0) // Position - 0x5A4 Signature - 22 01 03 00 00 03
{
...
int func_14() // Position - 0x5E7 Signature - 22 00 02 00 00 89 12 27 21
{
	return pedLocal_18.f_33;
}

BOOL func_15() // Position - 0x5F3 Signature - 22 00 02 00 00 89 12 27 20
{
	return pedLocal_18.f_32;
}

void func_16() // Position - 0x5FF Signature - 22 00 02 00 00 2F
{
	pedLocal_18.f_32 = 0;
	return;
}

void func_17(int iParam0) // Position - 0x60C Signature - 22 01 03 00 00 66 00 89
{
...
void func_18() // Position - 0x61E Signature - 22 00 02 00 00 89 12 27 1E
{
...
BOOL func_19() // Position - 0x667 Signature - 22 00 02 00 00 89 12 80
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(pedLocal_18.f_7)))
...
int func_20() // Position - 0x695 Signature - 22 00 02 00 00 5D
{
	return Global_1896646.f_41;
}

void func_21(var uParam0) // Position - 0x6A3 Signature - 22 01 03 00 00 66 00 27
{
	pedLocal_18 = uParam0->f_1;
	return;
}

void func_22(var uParam0) // Position - 0x6B1 Signature - 22 01 03 00 00 37
{
...
void func_23(var uParam0) // Position - 0x6C9 Signature - 22 01 03 00 00 50
{
	return;
}

void func_24() // Position - 0x6D1 Signature - 22 00 02 00 00 09 89
{
	pedLocal_18.f_32 = 1;
	return;
}
