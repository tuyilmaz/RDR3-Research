...
void func_2() // Position - 0x93 Signature - 22 00 02 00 00 2F
{
...
void func_3() // Position - 0xCB8 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 50
{
	return;
}

void func_4() // Position - 0xCC0 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 5D
{
	return;
}

int func_5() // Position - 0xCC8 Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

BOOL func_6(BOOL bParam0, BOOL bParam1) // Position - 0xCD6 Signature - 22 02 05
{
	int i;
...
void func_7() // Position - 0xDB6 Signature - 22 00 02 00 00 54
{
...
void func_8(Volume volParam0) // Position - 0xDCA Signature - 22 01 03 00 00 66 00 03 05 00 16 05 8B 03 00 50 01 00 66 00 21 FF
{
...
void func_9(Volume volParam0) // Position - 0xE11 Signature - 22 01 03 00 00 66 00 03 05 00 16 05 8B 03 00 50 01 00 66 00 6D
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xE52 Signature - 22 03 05 00 00 66 00 03 05 00 16 05 8B 03 00 50 03 00 66 00 66 01 6D 40
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xEC5 Signature - 22 03 05 00 00 66 00 03 05 00 16 05 8B 03 00 50 03 00 66 00 66 01 25 00 10 30 6D 40
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xF44 Signature - 22 03 05 00 00 66 00 03 05 00 16 05 8B 03 00 50 03 00 66 00 66 01 25 00 10 30 6D 80
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_13(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xFBA Signature - 22 03 05 00 00 66 00 03 05 00 16 05 8B 03 00 50 03 00 66 00 66 01 6D E0
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_14(Volume volParam0) // Position - 0x1030 Signature - 22 01 03 00 00 66 00 03 05 00 16 05 8B 03 00 50 01 00 66 00 21 1F
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_15(var uParam0, int iParam1) // Position - 0x1071 Signature - 22 02 04
{
