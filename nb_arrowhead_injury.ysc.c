...
void func_1(int iParam0) // Position - 0x3A Signature - 22 01 03 00 00 6D 20
{
	...
	func_8();
	func_9();
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_0, 13, 42);
	func_10(NETWORK::_NETWORK_GET_SIZE_OF_HOST_BROADCAST_DATA_STORAGE(&iLocal_0), 13, "m_hostData");
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&uLocal_13, 97, 43);
	func_11(NETWORK::_NETWORK_GET_SIZE_OF_PLAYER_BROADCAST_DATA_STORAGE(&uLocal_13[0 /*3*/]), 97, "m_clientData");
	func_12(false);
...
void func_2(Any* panParam0) // Position - 0x95 Signature - 22 01 03 00 00 54 00 4D
{
	if (iLocal_0 == 6)
		return;
...
BOOL func_3() // Position - 0xBB Signature - 22 00 02 00 00 2F
{
	if (func_16(false, false))
		return true;
	else if (func_17(uLocal_110.f_9, 0, 1))
		return true;
	else if (!func_18())
		return true;
	else if (!func_19(uLocal_110.f_12))
		return true;
	else if (!func_21(func_20(uLocal_110.f_12), uLocal_110.f_9))
		return true;
	else if (uLocal_110.f_8 == 6)
		return true;
...
int func_8() // Position - 0x194 Signature - 22 00 05 00 00 03 01 00 96
{
	int scriptStatus;
	int gameTimer;
	int timeoutTime;
...
void func_9() // Position - 0x2A5 Signature - 22 00 02 00 00 50 00 00 22 03
{
	return;
}
...
void func_13(Any* panParam0) // Position - 0x388 Signature - 22 01 25
{
	...
	player = 255;
	MISC::COPY_SCRIPT_STRUCT(&uLocal_110, panParam0, 5);
	num = func_30(&flag, uLocal_110.f_1, uLocal_110.f_2);
	...
	unk.f_26 = -1;
	unk.f_28 = 2;
	func_31(&unk, uLocal_110.f_1, uLocal_110.f_2, uLocal_110.f_3, player);
	uLocal_110.f_9 = { func_32(unk.f_5, 8) };
	uLocal_110.f_14 = unk.f_5;
	uLocal_110.f_15 = { unk.f_11 };
	uLocal_110.f_18 = unk.f_7;
	func_33();
	func_34();
	return;
}

void func_14() // Position - 0x443 Signature - 22 00 02 00 00 39 8F
{
	func_35();
	return;
}

void func_15() // Position - 0x44F Signature - 22 00 02 00 00 50 00 00 22 02 05
{
	return;
}
...
BOOL func_21(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6A0 Signature - 22 04 06 00 00 66 00 66 02
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

void func_22() // Position - 0x6BB Signature - 22 00 02 00 00 54 00 62 23
{
	if (iLocal_0 <= 5)
		func_40();
...
void func_23() // Position - 0x723 Signature - 22 00 02 00 00 39 B2
{
	func_47();
	func_48();
...
void func_24() // Position - 0x797 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 39 4F
{
	return;
}

void func_25() // Position - 0x79F Signature - 22 00 02 00 00 39 4F
{
	if (func_56())
...
void func_26() // Position - 0x7C9 Signature - 22 00 02 00 00 39 79
{
	func_58();
	return;
}

void func_27() // Position - 0x7D5 Signature - 22 00 02 00 00 89 6E 27 0C
{
	if (uLocal_110.f_12 != -1)
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_GET_NUM_PARTICIPANTS() <= 1)
			func_59(uLocal_110.f_12, 4);

	func_60();

	if (func_61(64))
		func_62(iLocal_0.f_6);
...
BOOL func_29() // Position - 0x82D Signature - 22 00 02 00 00 5D FD 0B 10 27 08
{
...
void func_33() // Position - 0xD76 Signature - 22 00 02 00 00 39 D9
{
	func_105();
	return;
}

void func_34() // Position - 0xD82 Signature - 22 00 02 00 00 09 03
{
	NETWORK::RESERVE_NETWORK_MISSION_PEDS(1);
	return;
}

void func_35() // Position - 0xD8F Signature - 22 00 02 00 00 50 00 00 22 02 04
{
	return;
}

BOOL func_36(int iParam0, var uParam1) // Position - 0xD97 Signature - 22 02 04 00 00 66 00 39 E1
{
	if (!func_106(iParam0))
		return false;
...
BOOL func_37(int iParam0) // Position - 0xDCB Signature - 22 01 03 00 00 5D 17 00 18 27 0E 08 15 04 00 2F 50 01 01 5D
{
...
BOOL func_38(int iParam0, int iParam1) // Position - 0xDEC Signature - 22 02 04 00 00 5D 77
{
...
BOOL func_39() // Position - 0xE28 Signature - 22 00 02 00 00 85
{
	if (Global_1048576)
		return true;
...
void func_40() // Position - 0xE80 Signature - 22 00 02 00 00 50 00 00 22 00 22
{
	return;
}

void func_41() // Position - 0xE88 Signature - 22 00 22 00 00 89
{
	Player player;
	var unk;

	player = Global_1207480.f_231.f_1066[uLocal_110.f_12 /*17*/].f_5;
	unk.f_10 = 1106247680;
	unk.f_15 = 4;
	unk.f_20 = 4;
	unk.f_26 = -1;
	...
	iLocal_0.f_6 = func_109(GANG::NETWORK_GET_GANG_LEADER(GANG::NETWORK_GET_GANG_ID(player)));
	func_110(256);

	if (func_111(iLocal_0.f_6))
	{
		func_112(5);
		func_108(6);
	}
...
void func_42() // Position - 0xF25 Signature - 22 00 22 00 00 4B
{
	var unk;
	BOOL flag;
	...
	unk.f_26 = -1;
	unk.f_28 = 2;
	func_31(&unk, uLocal_110.f_1, uLocal_110.f_2, -1, 255);
	...
	if (func_113(unk, &flag))
	{
		MISC::CLEAR_AREA(uLocal_110.f_15, unk.f_10, 2442122);
		func_108(2);
	}
	else if (flag)
	{
	...
	if (!func_114(iLocal_0.f_3.f_2))
	{
		func_115(&(iLocal_0.f_3.f_2));
	}
	else if (func_116(iLocal_0.f_3.f_2) > 45000)
	{
		func_112(4);
		func_108(6);
	}
...
void func_43() // Position - 0xFE2 Signature - 22 00 02 00 00 09 6D
{
	if (func_117(1, 255))
	{
		if (!func_118(1))
...
void func_44() // Position - 0x1015 Signature - 22 00 03 00 00 11
{
	BOOL flag;
...
void func_45() // Position - 0x105F Signature - 22 00 02 00 00 39 9F
{
	func_124();
	func_125();
	func_126();

	if (func_127() || iLocal_0.f_2 != 0)
	{
		func_128();
		func_108(5);
	}
...
void func_46() // Position - 0x108F Signature - 22 00 02 00 00 42 6D FF 39 EC 79 00 8B
{
	if (func_117(4, 255))
	{
		if (func_129())
...
void func_47() // Position - 0x10B2 Signature - 22 00 02 00 00 25 00 01
{
	if (!func_118(256))
		return;
	...
	if (func_118(512))
	{
		if (func_61(64) && func_109(PLAYER::PLAYER_ID()) == iLocal_0.f_6)
		{
			func_62(iLocal_0.f_6);
			func_130(64);
		}
	...
	{
		if (func_109(PLAYER::PLAYER_ID()) == iLocal_0.f_6)
		{
			func_131(iLocal_0.f_6, 1, true);
			func_132(64);
		}
	}
	else if (func_109(PLAYER::PLAYER_ID()) != iLocal_0.f_6)
	{
		func_62(iLocal_0.f_6);
		func_130(64);
	}
...
void func_48() // Position - 0x1148 Signature - 22 00 02 00 00 70
{
	if (!Global_13)
...
void func_49() // Position - 0x1181 Signature - 22 00 02 00 00 39 CE
{
	func_135();
	return;
}

void func_50() // Position - 0x118D Signature - 22 00 02 00 00 54 00 4D 15 08 00 4D 39 3A 7D 00 68 0F
{
	if (iLocal_0 == 6)
	{
		func_136(6);
...
void func_51() // Position - 0x11B2 Signature - 22 00 02 00 00 54 00 4D 15 08 00 4D 39 3A 7D 00 68 0B
{
	if (iLocal_0 == 6)
		func_136(6);
	else if (iLocal_0 > 1)
...
void func_52() // Position - 0x11D3 Signature - 22 00 04 00 00 09 6D
{
	BOOL flag;
	int num;
	...
	if (!func_117(1, 255))
	{
		...
		else
		{
			...
			if (!func_114(uLocal_110.f_11))
				func_115(&(uLocal_110.f_11));
		
			if (func_116(uLocal_110.f_11) >= num)
				func_136(6);
		}
	}
	else if (iLocal_0 > 2)
	{
		func_139(&(uLocal_110.f_11));
		func_140();
		func_136(3);
	}
...
void func_53() // Position - 0x1256 Signature - 22 00 05 00 00 11
{
	int num;
	int num2;
	int num3;
	...
	if (!func_117(2, 255))
	{
		...
		else
		{
			...
			if (func_143(uLocal_110.f_11) >= num3)
				func_136(6);
		}
	}
	else if (iLocal_0 > 3)
...
void func_54() // Position - 0x12DF Signature - 22 00 02 00 00 54 00 62 75
{
	if (iLocal_0 >= 5)
	{
		func_148();
...
void func_55() // Position - 0x1315 Signature - 22 00 02 00 00 42 6D FF 39 EC 79 00 05
{
	if (!func_117(4, 255))
	{
		if (func_156())
...
BOOL func_56() // Position - 0x134F Signature - 22 00 02 00 00 42 39
{
	return func_118(4) || NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_GET_NUM_PARTICIPANTS() <= 1;
}

void func_57() // Position - 0x1371 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 89
{
	return;
}

void func_58() // Position - 0x1379 Signature - 22 00 02 00 00 89 6E 80 20 80
{
	func_158(&(uLocal_110.f_32.f_13));

	if (VOLUME::DOES_VOLUME_EXIST(uLocal_110.f_32.f_11))
		VOLUME::DELETE_VOLUME(uLocal_110.f_32.f_11);

	return;
}

void func_59(int iParam0, int iParam1) // Position - 0x13A2 Signature - 22 02 05 00 00 03
{
	Player playerIndex;

	playerIndex = PLAYER::GET_PLAYER_INDEX();

	if (func_159(iParam0, playerIndex, iParam1))
		return;
...
void func_60() // Position - 0x13D2 Signature - 22 00 04 00 00 09 39
{
	int num;
	BOOL flag;
	...
	func_160(uLocal_110.f_9, num, 0, 255, 0);
	func_132(4);

	if (flag)
	{
		func_161(uLocal_110.f_1, uLocal_110.f_2);
	
		if (!func_61(256))
		{
			if (num == 1)
				func_162(uLocal_110.f_18, 1);
			else
				func_162(uLocal_110.f_18, 0);
		
			func_132(256);
		}
	
		func_163(uLocal_110.f_18);
	}
	else
	{
		func_162(uLocal_110.f_18, 2);
	}

	return;
}

BOOL func_61(int iParam0) // Position - 0x14A1 Signature - 22 01 03 00 00 89 6E 27 07
{
	return func_164(uLocal_110.f_7, iParam0);
}

void func_62(int iParam0) // Position - 0x14B3 Signature - 22 01 04 00 00 66 00 39 17 83 00 05 8B 03
{
	Player player;
...
void func_63() // Position - 0x14E7 Signature - 22 00 07
{
	BOOL flag;
	int i;
	Entity entity;
	...
	for (j = 0; j <= 0; j = j + 1)
	{
		...
		if (flag && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_0.f_7.f_3[j]) && NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(iLocal_0.f_7.f_3[j]))
		{
			if (uLocal_110.f_19 == 0)
			{
				if (func_167() == 0)
				{
					func_168(NETWORK::NET_TO_PED(iLocal_0.f_7.f_3[j]), false, false);
				}
				else
				{
					TASK::TASK_FLEE_PED(NETWORK::NET_TO_PED(iLocal_0.f_7.f_3[j]), PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 4, 0, -1082130432, -1, 0);
					PED::SET_PED_KEEP_TASK(NETWORK::NET_TO_PED(iLocal_0.f_7.f_3[j]), true);
				}
			}
		
			if (TASK::IS_PED_IN_WRITHE(NETWORK::NET_TO_PED(iLocal_0.f_7.f_3[j])) && PED::_0x12EB4E31F092C9B3(NETWORK::NET_TO_PED(iLocal_0.f_7.f_3[j])))
				PED::SET_PAUSE_PED_WRITHE_BLEEDOUT(NETWORK::NET_TO_PED(iLocal_0.f_7.f_3[j]), false);
		
			entity2 = NETWORK::NET_TO_ENT(iLocal_0.f_7.f_3[j]);
...
void func_64(var uParam0, var uParam1) // Position - 0x163D Signature - 22 02 04 00 00 11 66
{
	uParam0->f_9 = 2;
...
int func_65(var uParam0) // Position - 0x1660 Signature - 22 01 05 00 00 66 00 39
{
	int num;
	int i;
	...
	num = func_170(uParam0, uParam0->f_9);
...
struct<15> func_66(int iParam0) // Position - 0x16C1 Signature - 22 01 12 00 00 4B 03 6A 11
{
	var unk;
...
void func_67(Any* panParam0, int iParam1) // Position - 0x172B Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0A 66 00 32 42 66 00 6C 01 0D
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 4;
	panParam0->f_2 = 7;
	func_171(panParam0, iParam1);
...
void func_68(Any* panParam0, int iParam1) // Position - 0x18DD Signature - 22 02 04 00 00 09 66 00 6C 06 6D 14 66 00 32 11
{
	panParam0->f_6 = 1;
	*panParam0 = 20;
	panParam0->f_1 = 2;
...
void func_69(Any* panParam0, int iParam1) // Position - 0x1C8A Signature - 22 02 04 00 00 09 66 00 6C 06 6D 15 66 00 32 6D
{
	panParam0->f_6 = 1;
	*panParam0 = 21;
	panParam0->f_1 = 8;
	...
	{
		case 0:
			func_174(panParam0, 2);
			func_174(panParam0, 3);
			func_174(panParam0, 5);
		...
		case 2:
			func_174(panParam0, 0);
			func_174(panParam0, 1);
			func_174(panParam0, 2);
			func_174(panParam0, 3);
			func_174(panParam0, 5);
		...
		case 3:
			...
			func_174(panParam0, 2);
			func_174(panParam0, 3);
			func_174(panParam0, 4);
			func_174(panParam0, 5);
			func_174(panParam0, 7);
...
void func_70(Any* panParam0, int iParam1) // Position - 0x2250 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0B 66 00 32 09 66 00 6C 01 11
{
	panParam0->f_6 = 1;
	*panParam0 = 11;
	panParam0->f_1 = 1;
...
void func_71(Any* panParam0, int iParam1) // Position - 0x2475 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0F
{
	panParam0->f_6 = 1;
	*panParam0 = 15;
	panParam0->f_1 = 3;
...
void func_72(Any* panParam0, int iParam1) // Position - 0x2742 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 10
{
	panParam0->f_6 = 1;
	*panParam0 = 16;
	panParam0->f_1 = 2;
	panParam0->f_2 = 8;
	func_175(panParam0, iParam1);
...
void func_73(Any* panParam0, int iParam1, int iParam2) // Position - 0x2A4F Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0A 66 00 32 6D
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 12;
	...
	switch (iParam1)
	{
		case 0:
			...
			func_174(panParam0, 1);
			func_174(panParam0, 2);
			func_174(panParam0, 9);
			func_174(panParam0, 10);
			func_174(panParam0, 11);
...
void func_74(Any* panParam0, int iParam1) // Position - 0x2E54 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 15 66 00 32 09
{
	panParam0->f_6 = 1;
	*panParam0 = 21;
	panParam0->f_1 = 1;
...
void func_75(Any* panParam0, int iParam1) // Position - 0x322F Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0A 66 00 32 42 66 00 6C 01 09
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 4;
...
void func_76(Any* panParam0, int iParam1, int iParam2) // Position - 0x3422 Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0C
{
	panParam0->f_6 = 1;
	*panParam0 = 12;
	panParam0->f_1 = 4;
...
void func_77(Any* panParam0, int iParam1) // Position - 0x367A Signature - 22 02 04 00 00 09 66 00 6C 06 6D 14 66 00 32 09
{
	panParam0->f_6 = 1;
	*panParam0 = 20;
	panParam0->f_1 = 1;
...
void func_78(Any* panParam0, int iParam1) // Position - 0x3A28 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 09
{
	panParam0->f_6 = 1;
	*panParam0 = 9;
	panParam0->f_1 = 2;
...
void func_79(Any* panParam0, int iParam1, Player plParam2) // Position - 0x3BF0 Signature - 22 03 05 00 00 09 66 00 6C 06 09
{
	panParam0->f_6 = 1;
	*panParam0 = 1;
	panParam0->f_1 = 6;
	panParam0->f_2 = 1;
	func_172(panParam0);
	func_177(panParam0, 1);
	func_177(panParam0, 4);
	func_177(panParam0, 8);
	func_177(panParam0, 16);
	...
	switch (iParam1)
	{
		case 0:
			...
			panParam0->f_11 = { func_179(func_109(plParam2)) };
			break;
	}
...
void func_80(Any* panParam0, int iParam1, int iParam2) // Position - 0x3C5F Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0A 66 00 32 62
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 5;
...
void func_81(Any* panParam0, int iParam1) // Position - 0x3E59 Signature - 22 02 04 00 00 09 66 00 6C 06 09
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 1;
	*panParam0 = 12;
...
void func_82(Any* panParam0, int iParam1, int iParam2) // Position - 0x40A5 Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0F
{
	panParam0->f_6 = 1;
	*panParam0 = 15;
	panParam0->f_1 = 2;
...
void func_83(Any* panParam0, int iParam1) // Position - 0x431A Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0F 66 00 32 42
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 15;
...
void func_84(Any* panParam0, int iParam1) // Position - 0x4643 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0D
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 13;
...
void func_85(Any* panParam0, int iParam1) // Position - 0x4907 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0A 66 00 32 42 66 00 6C 01 09 66 00 6C 02 37 1B
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_86(Any* panParam0, int iParam1) // Position - 0x4B8A Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0A 66 00 32 11
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_87(Any* panParam0, int iParam1) // Position - 0x4DBE Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0B
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 11;
...
void func_88(Any* panParam0, int iParam1) // Position - 0x5020 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 14 66 00 32 42 66 00 6C 01 11
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 20;
...
void func_89(Any* panParam0, int iParam1) // Position - 0x5557 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0F 66 00 32 62
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 15;
...
void func_90(Any* panParam0, int iParam1) // Position - 0x5958 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0A 66 00 32 4D
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_91(Any* panParam0, int iParam1) // Position - 0x5C2F Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 14 66 00 32 42 66 00 6C 01 09
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 20;
...
void func_92(Any* panParam0, int iParam1) // Position - 0x6055 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0A 66 00 32 42 66 00 6C 01 09 66 00 6C 02 37 04
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_93(Any* panParam0, int iParam1) // Position - 0x62C0 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 19
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 25;
...
void func_94(Any* panParam0, int iParam1, int iParam2) // Position - 0x67C5 Signature - 22 03 06 00 00 09
{
	BOOL flag;
	...
	*panParam0 = 10;
	...
	func_188(panParam0, iParam1, iParam2);
...
void func_95(Any* panParam0, int iParam1, int iParam2) // Position - 0x69BB Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0A 66 00 32 1D
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 3;
...
void func_96(Any* panParam0, int iParam1) // Position - 0x6BC5 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0A 66 00 32 11
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 2;
...
void func_97(Any* panParam0, int iParam1) // Position - 0x6E05 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0B 66 00 32 09 66 00 6C 01 09
{
	panParam0->f_6 = 1;
	*panParam0 = 11;
	panParam0->f_1 = 1;
...
void func_98(Any* panParam0, int iParam1) // Position - 0x701E Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0A 66 00 32 09
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 1;
...
void func_99(Any* panParam0, int iParam1) // Position - 0x720A Signature - 22 02 04 00 00 09 66 00 6C 06 0D
{
	panParam0->f_6 = 1;
	*panParam0 = 7;
	panParam0->f_1 = 3;
...
void func_100(Any* panParam0, int iParam1) // Position - 0x7386 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 08
{
	panParam0->f_6 = 1;
	*panParam0 = 8;
	panParam0->f_1 = 2;
...
void func_101(Any* panParam0, int iParam1, int iParam2) // Position - 0x7522 Signature - 22 03 06 00 00 66 01 3C
{
	int num;
	...
	*panParam0 = func_192(num);
	panParam0->f_1 = 0;
	panParam0->f_6 = 2;
	func_177(panParam0, 32);

	if (iParam2 != -1)
	{
		panParam0->f_9 = func_194(func_193(num), iParam2);
		panParam0->f_15[0] = func_195(func_193(num), iParam2);
		panParam0->f_5 = func_196(num, iParam2);
		panParam0->f_11 = { func_197(num, iParam2) };
	}

	return;
}

int func_102(int iParam0) // Position - 0x76D5 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 2E
{
	switch (iParam0)
	{
		case 2:
...
int func_103(var uParam0, var uParam1, int iParam2) // Position - 0x776B Signature - 22 03 08 00 00 2F 67 05
{
	int num;
	int num2;
	int num3;
...
struct<2> func_104() // Position - 0x77C0 Signature - 22 00 04 00 00 4B
{
	var unk;
...
void func_105() // Position - 0x77D9 Signature - 22 00 02 00 00 50 00 00 22 01 03
{
	return;
}

BOOL func_106(int iParam0) // Position - 0x77E1 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21 00 04 00 00 00 1B 00 05 00 00 00 15 00 06 00 00 00 0F 00 07 00 00 00 09 00 08 00 00 00 03 00 68 04 00 09 50 01 01 2F 50 01 01 22 02
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_107(var uParam0, int iParam1) // Position - 0x7820 Signature - 22 02 04 00 00 66 00 27 19
{
	return func_198(uParam0->f_25, iParam1);
}

void func_108(int iParam0) // Position - 0x7832 Signature - 22 01 03 00 00 54 00 66
{
	if (iLocal_0 != iParam0)
		iLocal_0 = iParam0;
...
int func_109(Player plParam0) // Position - 0x7845 Signature - 22 01 04 00 00 66 00 67
{
	Player player;
...
void func_110(int iParam0) // Position - 0x7875 Signature - 22 01 03 00 00 66 00 39 15
{
	if (!func_118(iParam0))
		func_199(&(iLocal_0.f_1), iParam0);

	return;
}

BOOL func_111(int iParam0) // Position - 0x7891 Signature - 22 01 03 00 00 66 00 39 17 83 00 05 8B 04 00 2F 50 01 01 66 00 39 85 8F 00 6A
{
	if (!func_165(iParam0))
		return false;

	return func_200(iParam0) && Global_1141332[iParam0 /*27*/].f_18.f_1 != 0;
}

void func_112(int iParam0) // Position - 0x78C0 Signature - 22 01 03 00 00 89 00 27 02
{
...
BOOL func_113(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31) // Position - 0x78D7 Signature - 22 20 2C
{
	...
	if (_IS_NULL_VECTOR(uLocal_110.f_15))
	{
		*uParam31 = 1;
		return false;
	}
	...
	{
		if (VOLUME::DOES_VOLUME_COLLIDE_WITH_ANY_VOLUME_LOCK(uLocal_110.f_15, uParam0.f_10, false, 0, 0))
		{
...
BOOL func_114(int iParam0) // Position - 0x79BB Signature - 22 01 03 00 00 66 00 2F 1C
{
	return iParam0 != 0;
}

void func_115(int iParam0) // Position - 0x79C7 Signature - 22 01 03 00 00 5D 32 C5 13 27 10 66 00 32
{
	*iParam0 = Global_1295666.f_16;
	return;
}

int func_116(var uParam0) // Position - 0x79D8 Signature - 22 01 03 00 00 5D 32 C5 13 27 10 66 00 10
{
	return (Global_1295666.f_16 - uParam0) * 1000;
}

BOOL func_117(int iParam0, int iParam1) // Position - 0x79EC Signature - 22 02 04 00 00 66 01 6D
{
	if (iParam1 == 255)
		if (!func_204(&iParam1))
			return false;

	return func_164(uLocal_13[iParam1 /*3*/], iParam0);
}

BOOL func_118(int iParam0) // Position - 0x7A15 Signature - 22 01 03 00 00 89 00 27 01
{
	return func_164(iLocal_0.f_1, iParam0);
}

BOOL func_119() // Position - 0x7A27 Signature - 22 00 02 00 00 09 50 00 01 22 00 02 00 00 50 00 00 22 00
{
	return true;
}

void func_120() // Position - 0x7A30 Signature - 22 00 02 00 00 50 00 00 22 00 05 00 00 09
{
	return;
}

BOOL func_121() // Position - 0x7A38 Signature - 22 00 05 00 00 09
{
	BOOL num;
	BOOL flag;
	int i;
	...
	for (i = 0; i <= 0; i = i + 1)
	{
		if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_0.f_7.f_3[i]))
		{
			if (func_205(i, &flag) || flag)
			{
				num = 0;
				break;
			}
...
BOOL func_122() // Position - 0x7A8E Signature - 22 00 03 00 00 09 50 00 01 22 00
{
	return true;
}

void func_123() // Position - 0x7A97 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 6D
{
	return;
}

void func_124() // Position - 0x7A9F Signature - 22 00 02 00 00 6D 20 39 15 7A 00 05
{
	if (!func_118(32) && func_207(32))
		func_110(32);

	if (!func_118(64) && func_207(64))
		func_110(64);

	if (!func_118(16) && func_208(16))
		func_110(16);

	if (!func_118(2048) && func_207(2048) && !func_207(4096))
		func_110(2048);

	return;
}

void func_125() // Position - 0x7B23 Signature - 22 00 03 00 00 66
{
	BOOL flag;
	...
	if (func_118(2048) && !func_207(4096))
	{
		func_112(6);
		return;
	}
...
void func_126() // Position - 0x7B63 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 39 BF
{
	return;
}

BOOL func_127() // Position - 0x7B6B Signature - 22 00 02 00 00 39 BF
{
	if (func_209())
		return true;
...
void func_128() // Position - 0x7BCA Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 09 50 00 01 22 01
{
	return;
}

BOOL func_129() // Position - 0x7BD2 Signature - 22 00 02 00 00 09 50 00 01 22 01
{
	return true;
}

void func_130(int iParam0) // Position - 0x7BDB Signature - 22 01 03 00 00 66 00 39 A1 14 00 8B
{
	if (func_61(iParam0))
		func_215(&(uLocal_110.f_7), iParam0);

	return;
}

int func_131(int iParam0, int iParam1, BOOL bParam2) // Position - 0x7BF6 Signature - 22 03 07 00 00 66 00
{
	int num;
	Player player;
	...
	if (bParam2)
		func_217(&(Global_1144526[player /*83*/].f_70.f_1), 1);
	else
...
void func_132(int iParam0) // Position - 0x7C69 Signature - 22 01 03 00 00 66 00 39 A1 14 00 05
{
	if (!func_61(iParam0))
		func_199(&(uLocal_110.f_7), iParam0);

	return;
}

void func_133(int iParam0) // Position - 0x7C85 Signature - 22 01 03 00 00 03 01 00 23 89
{
	if (func_164(uLocal_13[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/], iParam0))
		func_215(&uLocal_13[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/], iParam0);

	return;
}

void func_134(int iParam0) // Position - 0x7CAC Signature - 22 01 03 00 00 66 00 6D FF 39
{
	if (!func_117(iParam0, 255))
		func_199(&uLocal_13[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/], iParam0);

	return;
}

void func_135() // Position - 0x7CCE Signature - 22 00 04 00 00 2F
{
	int i;
...
void func_136(int iParam0) // Position - 0x7D3A Signature - 22 01 03 00 00 89 6E 27 08
{
	if (uLocal_110.f_8 != iParam0)
		uLocal_110.f_8 = iParam0;

	return;
}

BOOL func_137() // Position - 0x7D51 Signature - 22 00 05 00 00 6D
{
	char* textDatabase;
	BOOL num;
	int i;
...
BOOL func_138() // Position - 0x7DA6 Signature - 22 00 03 00 00 2F 67
{
	BOOL flag;
...
void func_139(var uParam0) // Position - 0x7DB4 Signature - 22 01 03 00 00 2F 66 00 32 50
{
	*uParam0 = 0;
	return;
}

void func_140() // Position - 0x7DC0 Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 09 50 00 01 22 00
{
	return;
}

int func_141() // Position - 0x7DC8 Signature - 22 00 02 00 00 09 50 00 01 22 00 03
{
	return 1;
}

int func_142() // Position - 0x7DD1 Signature - 22 00 03 00 00 09 50 00 01 22 01
{
	return 1;
}

int func_143(int iParam0) // Position - 0x7DDA Signature - 22 01 03 00 00 66 00 5D 32
{
	return (iParam0 - Global_1295666.f_16) * 1000;
}

void func_144() // Position - 0x7DEE Signature - 22 00 02 00 00 09 39 A1
{
	if (!func_61(1))
	{
		func_224(uLocal_110.f_9);
		func_132(1);
	}
...
void func_145() // Position - 0x7E0E Signature - 22 00 02 00 00 50 00 00 22 00 04
{
	return;
}

void func_146() // Position - 0x7E16 Signature - 22 00 04 00 00 86
{
	int i;
	Ped ped;

	func_225(50f, 20f, 1, 1077936128, false);
	func_226(1065353216, 1065353216);

	for (i = 0; i <= 0; i = i + 1)
	{
		if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_0.f_7.f_3[i]))
		{
			uLocal_110.f_19.f_4[i /*2*/].f_1 = NETWORK::NET_TO_PED(iLocal_0.f_7.f_3[i]);
		
			if (!ENTITY::IS_ENTITY_DEAD(uLocal_110.f_19.f_4[i /*2*/].f_1))
			{
				ped = func_227(i);
				...
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(ped))
				{
					switch (i)
					{
						case 0:
							...
							PED::_SET_PED_DAMAGE_CLEANLINESS(ped, 1);
							PED::_SET_PED_DAMAGED(ped, true);
							...
							PED::_EQUIP_META_PED_OUTFIT(ped, func_228());
							PED::_EQUIP_META_PED_OUTFIT(ped, func_229());
...
void func_147() // Position - 0x7F1C Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 50
{
	return;
}

void func_148() // Position - 0x7F24 Signature - 22 00 02 00 00 50 00 00 22 00 03
{
	return;
}

void func_149() // Position - 0x7F2C Signature - 22 00 03 00 00 1D
{
	float num;
	...
	if (func_231(uLocal_110.f_1, 600))
	{
		num = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false, false), uLocal_110.f_15);
...
void func_150() // Position - 0x7FB4 Signature - 22 00 02 00 00 39 31
{
	func_232();
	func_233();
	func_234();
...
void func_151() // Position - 0x7FC8 Signature - 22 00 02 00 00 39 63
{
	if (func_235())
		func_134(8);
	else
...
void func_152() // Position - 0x7FE6 Signature - 22 00 02 00 00 39 A0
{
	func_236();
	func_237(iLocal_0.f_7);
	func_238();

	switch (uLocal_110.f_19)
	{
		case 0:
			func_239();
			break;
...
void func_153() // Position - 0x804A Signature - 22 00 02 00 00 6F
{
	if (!func_117(8, 255))
		func_134(16);
	else
...
void func_154() // Position - 0x806C Signature - 22 00 03 00 00 08
{
	int i;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		{
			uLocal_110.f_5 = uLocal_110.f_5 || uLocal_13[i /*3*/];
			uLocal_110.f_6 = uLocal_110.f_6 && uLocal_13[i /*3*/];
		}
	}
...
void func_155() // Position - 0x80BC Signature - 22 00 02 00 00 25 00 04 39 A1
{
	if (func_61(1024) && !func_117(16384, 255) && !(SAVE::SAVEGAME_IS_SAVE_PENDING() || func_244(&Global_0, 1)))
		func_134(16384);

	return;
}

BOOL func_156() // Position - 0x80FC Signature - 22 00 02 00 00 09 50 00 01 22 00 02 00 00 50 00 00 22 01
{
	return true;
}

void func_157() // Position - 0x8105 Signature - 22 00 02 00 00 50 00 00 22 01 04
{
	return;
}

void func_158(var uParam0) // Position - 0x810D Signature - 22 01 04 00 00 2F 67 03 66 03 66 00 76
{
	int i;
...
BOOL func_159(int iParam0, Player plParam1, int iParam2) // Position - 0x813B Signature - 22 03 05 00 00 66 01 03
{
...
void func_160(var uParam0, var uParam1, int iParam2, int iParam3, Player plParam4, int iParam5) // Position - 0x8163 Signature - 22 06 18 00 00 11
{
	int deedType;
	Hash deedHash;
	int data;
	...
	deedType = func_246(func_245(uParam0));
	deedHash = func_247(uParam0);
	str = "";
	data.f_1 = iParam3;
	data = 0;
	data.f_2 = 0;
	...
	if (func_28() == 0)
	{
		...
		str = func_248(Global_265213.f_122484.f_80.f_22);
		func_249(uParam0, &data, iParam2);
	}
...
void func_161(int iParam0, var uParam1) // Position - 0x8232 Signature - 22 02 05 00 00 66 00 66
{
	int num;

	num = func_250(iParam0, uParam1);
...
void func_162(int iParam0, int iParam1) // Position - 0x8253 Signature - 22 02 04 00 00 66 00 5D
{
	func_115(&Global_1260806.f_3351[iParam0]);

	switch (iParam1)
	{
		case 0:
			Global_1260806.f_3357[iParam0] = func_252(iParam0);
			break;
	
		case 1:
			Global_1260806.f_3357[iParam0] = func_253(iParam0);
			break;
	
		case 2:
			Global_1260806.f_3357[iParam0] = func_254(iParam0);
			break;
	}
...
void func_163(int iParam0) // Position - 0x82C0 Signature - 22 01 06 00 00 39
{
	var statId;
	int value;
...
BOOL func_164(int iParam0, int iParam1) // Position - 0x8308 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01 03 00 00 66 00 2F
{
	return iParam0 && iParam1 != false;
}

BOOL func_165(int iParam0) // Position - 0x8317 Signature - 22 01 03 00 00 66 00 2F 35
{
...
void func_166(int iParam0) // Position - 0x8336 Signature - 22 01 03 00 00 66 00 89 6E 80 13 80 04 17
{
	if (!MAP::DOES_BLIP_EXIST(uLocal_110.f_19.f_4[iParam0 /*2*/]))
		return;

	MAP::REMOVE_BLIP(&uLocal_110.f_19.f_4[iParam0 /*2*/]);
	return;
}

int func_167() // Position - 0x8361 Signature - 22 00 02 00 00 39 3D
{
	return func_256();
}

void func_168(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x836D Signature - 22 03 05 00 00 66 00 03
{
...
BOOL func_169(var uParam0) // Position - 0x83A9 Signature - 22 01 03 00 00 11 66 00 2D
{
	if (func_36(*uParam0))
		return true;
...
int func_170(var uParam0, int iParam1) // Position - 0x83ED Signature - 22 02 0B
{
	int num;
	int num2;
	BOOL flag;
...
void func_171(Any* panParam0, int iParam1) // Position - 0x854C Signature - 22 02 04 00 00 66 01 3C 0A
{
	switch (iParam1)
	{
		case 0:
...
void func_172(Any* panParam0) // Position - 0x8601 Signature - 22 01 04 00 00 2F 67 03 66 03 66 00 27 02
{
	int i;

	for (i = 0; i <= panParam0->f_2 - 1; i = i + 1)
	{
		func_261(panParam0, i);
	}

	return;
}

void func_173(Any* panParam0) // Position - 0x8628 Signature - 22 01 04 00 00 2F 67 03 66 03 66 00 27 01
{
	int i;

	for (i = 0; i <= panParam0->f_1 - 1; i = i + 1)
	{
		func_174(panParam0, i);
	}

	return;
}

void func_174(Any* panParam0, int iParam1) // Position - 0x864F Signature - 22 02 04 00 00 66 00 80 03
{
	MISC::SET_BIT(&(panParam0->f_3), iParam1);
	return;
}

void func_175(Any* panParam0, int iParam1) // Position - 0x8661 Signature - 22 02 04 00 00 66 01 3C 10
{
	switch (iParam1)
	{
		case 0:
...
void func_176(Any* panParam0, int iParam1) // Position - 0x86F2 Signature - 22 02 04 00 00 66 01 3C 0C
{
	switch (iParam1)
	{
		case 0:
			func_261(panParam0, 0);
			break;
	
		case 1:
		case 2:
			func_261(panParam0, 1);
			func_261(panParam0, 2);
			break;
...
void func_177(Any* panParam0, int iParam1) // Position - 0x8793 Signature - 22 02 04 00 00 66 00 80 19
{
	func_217(&(panParam0->f_25), iParam1);
	return;
}

void func_178(Any* panParam0, int iParam1) // Position - 0x87A5 Signature - 22 02 04 00 00 66 01 3C 04
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_179(int iParam0) // Position - 0x8800 Signature - 22 01 03 00 00 66 00 39 17 83 00 05 8B 06
{
	if (!func_165(iParam0))
		return 0f, 0f, 0f;
...
void func_180(Any* panParam0, int iParam1) // Position - 0x8824 Signature - 22 02 04 00 00 66 01 3C 05
{
	switch (iParam1)
	{
		case 0:
...
void func_181(Any* panParam0, int iParam1) // Position - 0x887C Signature - 22 02 04 00 00 66 01 3C 02
{
	switch (iParam1)
	{
		case 0:
...
void func_182(Any* panParam0, int iParam1) // Position - 0x88C9 Signature - 22 02 04 00 00 66 01 3C 0F 00 00 00 00 00 57 00 01 00 00 00 51 00 02 00 00 00 4B
{
	switch (iParam1)
	{
		case 0:
...
void func_183(Any* panParam0, int iParam1) // Position - 0x8961 Signature - 22 02 04 00 00 66 01 3C 0D
{
	switch (iParam1)
	{
		case 0:
...
void func_184(Any* panParam0, int iParam1) // Position - 0x89EC Signature - 22 02 04 00 00 66 01 3C 14 00 00 00 00 00 75 00 01 00 00 00 6F 00 02 00 00 00 69 00 03 00 00 00 63 00 04 00 00 00 5D 00 05 00 00 00 68
{
	switch (iParam1)
	{
		case 0:
...
void func_185(Any* panParam0, int iParam1) // Position - 0x8AB8 Signature - 22 02 04 00 00 66 01 3C 0F 00 00 00 00 00 57 00 01 00 00 00 51 00 02 00 00 00 5C
{
	switch (iParam1)
	{
		case 0:
...
void func_186(Any* panParam0, int iParam1) // Position - 0x8B77 Signature - 22 02 04 00 00 66 01 3C 14 00 00 00 00 00 75 00 01 00 00 00 6F 00 02 00 00 00 69 00 03 00 00 00 63 00 04 00 00 00 5D 00 05 00 00 00 57
{
	switch (iParam1)
	{
		case 0:
...
void func_187(Any* panParam0, int iParam1) // Position - 0x8C30 Signature - 22 02 04 00 00 66 01 3C 19
{
	switch (iParam1)
	{
		case 0:
...
void func_188(Any* panParam0, int iParam1, int iParam2) // Position - 0x8D18 Signature - 22 03 05 00 00 66 01 3C 0A 00 00 00 00 00 39 00 01 00 00 00 33 00 02 00 00 00 2D 00 03 00 00 00 27 00 04 00 00 00 21 00 05 00 00 00 2C 00 06 00 00 00 26 00 07 00 00 00 20 00 08 00 00 00 1A 00 09 00 00 00 14 00 68 30
{
	switch (iParam1)
	{
		case 0:
...
void func_189(Any* panParam0, int iParam1, int iParam2) // Position - 0x8DA5 Signature - 22 03 05 00 00 66 01 3C 0A 00 00 00 00 00 39 00 01 00 00 00 33 00 02 00 00 00 2D 00 03 00 00 00 27 00 04 00 00 00 21 00 05 00 00 00 2C 00 06 00 00 00 26 00 07 00 00 00 20 00 08 00 00 00 1A 00 09 00 00 00 14 00 68 29
{
	switch (iParam1)
	{
		case 0:
...
void func_190(Any* panParam0, int iParam1) // Position - 0x8E2B Signature - 22 02 04 00 00 66 01 3C 01
{
	switch (iParam1)
	{
		case 0:
...
int func_191(int iParam0) // Position - 0x8E5F Signature - 22 01 03 00 00 66 00 5D 06
{
	return Global_1260806.f_3432[iParam0];
}

int func_192(int iParam0) // Position - 0x8E72 Signature - 22 01 03 00 00 66 00 08 15 04 00 08
{
	if (iParam0 == -1)
		return -1;
...
int func_193(int iParam0) // Position - 0x8E8E Signature - 22 01 03 00 00 66 00 08 15 04 00 2F 50 01 01 66 00 5D F6 FF 12 17
{
	if (iParam0 == -1)
		return 0;
...
var func_194(int iParam0, int iParam1) // Position - 0x8EA8 Signature - 22 02 0A 00 00 4B
{
	var unk;
	var unk2;

	if (func_271(&unk2, iParam0) && func_272(&unk2, iParam1))
		func_273(unk2, 1099008783, &unk, false);

	return unk;
}

int func_195(int iParam0, int iParam1) // Position - 0x8EDB Signature - 22 02 0A 00 00 2F
{
	int num;
	var unk;
	...
	if (func_271(&unk, iParam0) && func_272(&unk, iParam1))
		func_273(unk, -1052341598, &num, false);

	return num;
}

int func_196(int iParam0, int iParam1) // Position - 0x8F11 Signature - 22 02 05 00 00 66 00 08 15 04
{
	int num;
...
Vector3 func_197(int iParam0, int iParam1) // Position - 0x8F38 Signature - 22 02 05 00 00 66 00 08 15 06
{
	int num;
...
BOOL func_198(int iParam0, int iParam1) // Position - 0x8F65 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02
{
	return iParam0 && iParam1 != false;
}

void func_199(var uParam0, int iParam1) // Position - 0x8F74 Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_200(int iParam0) // Position - 0x8F85 Signature - 22 01 04 00 00 66 00 39 17 83 00 05 8B 04
{
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x8FB0 Signature - 22 03 05 00 00 66 00 73
{
...
void func_202(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31) // Position - 0x8FDA Signature - 22 20 22
{
...
int func_203(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x9005 Signature - 22 1F
{
	var args;
...
BOOL func_204(var uParam0) // Position - 0x901E Signature - 22 01 03 00 00 03 01 00 23 66
{
	*uParam0 = NETWORK::PARTICIPANT_ID_TO_INT();

	if (!func_276(*uParam0, true))
	{
		*uParam0 = 255;
		return false;
	}
...
BOOL func_205(int iParam0, var uParam1) // Position - 0x9043 Signature - 22 02 04 00 00 09 03
{
	...
	if (!func_279(&iLocal_0.f_7.f_3[iParam0], func_222(iParam0), func_277(iParam0), func_278(iParam0), true, 0, false, true, true))
	{
		*uParam1 = 1;
		return false;
	}
...
void func_206() // Position - 0x908E Signature - 22 00 02 00 00 11 39 C0
{
	func_112(2);
	return;
}

BOOL func_207(int iParam0) // Position - 0x909B Signature - 22 01 03 00 00 89 6E 27 05
{
	return func_164(uLocal_110.f_5, iParam0);
}

BOOL func_208(int iParam0) // Position - 0x90AD Signature - 22 01 03 00 00 89 6E 27 06
{
	return func_164(uLocal_110.f_6, iParam0);
}

BOOL func_209() // Position - 0x90BF Signature - 22 00 02 00 00 89 00
{
	if (iLocal_0.f_7 == 5)
		return true;
...
void func_210() // Position - 0x90D4 Signature - 22 00 02 00 00 09 39 49
{
	if (func_280(1))
		func_281(1);
...
void func_211() // Position - 0x90E9 Signature - 22 00 02 00 00 6D 10
{
	if (func_280(16) || func_282(32) || func_280(2048))
		func_281(3);

	return;
}

void func_212() // Position - 0x9118 Signature - 22 00 02 00 00 11 39 49
{
	if (func_280(2))
		func_281(2);
...
void func_213() // Position - 0x912D Signature - 22 00 02 00 00 25 00 04 39 49
{
	if (func_280(1024))
		func_281(5);
...
void func_214() // Position - 0x9144 Signature - 22 00 02 00 00 6D 80
{
	if (func_280(128))
		func_281(5);
...
void func_215(var uParam0, int iParam1) // Position - 0x915A Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 01 03
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_216(int iParam0) // Position - 0x916F Signature - 22 01 03 00 00 66 00 39 17 83 00 05 8B 04 00 2F 50 01 01 66 00 39 85 8F 00 05
{
	if (!func_165(iParam0))
		return 0;
...
void func_217(var uParam0, int iParam1) // Position - 0x919F Signature - 22 02 04 00 00 66 00 66 01 39 88
{
	func_283(uParam0, iParam1);
	return;
}

void func_218(var uParam0, int iParam1) // Position - 0x91AF Signature - 22 02 04 00 00 66 00 66 01 39 99
{
	func_284(uParam0, iParam1);
	return;
}

void func_219(int iParam0) // Position - 0x91BF Signature - 22 01 16
{
	var unk;
	struct<4> eventData;
...
void func_220(int iParam0) // Position - 0x9201 Signature - 22 01 03 00 00 50 01 00 22 01 03 00 00 50
{
	return;
}

void func_221(int iParam0) // Position - 0x9209 Signature - 22 01 03 00 00 50 01 00 22 01 03 00 00 66
{
	return;
}

ePedType func_222(int iParam0) // Position - 0x9211 Signature - 22 01 03 00 00 66 00 3C 01 00 00 00 00 00 03 00 68 37
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_223(ePedType eptParam0) // Position - 0x925F Signature - 22 01 03 00 00 66 00 2F 15
{
...
void func_224(var uParam0, var uParam1) // Position - 0x927E Signature - 22 02 04 00 00 11 4B 00 2D 39 A1
{
	if (func_247(uParam0) == 0)
	{
	}
	else if (!STATS::STATSTRACKER_IS_INITIALIZED(func_247(uParam0)))
	{
		STATS::_0x99230691875FC218(func_245(uParam0), func_247(uParam0), Global_34);
	}

	return;
}

void func_225(float fParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x92C1 Signature - 22 05 07 00 00 66 00 66
{
	fParam0 >= fParam1;
	uLocal_110.f_32.f_2 = iParam2;
	uLocal_110.f_32.f_9 = fParam0;
	uLocal_110.f_32.f_10 = fParam1;
	uLocal_110.f_32.f_8 = iParam3;

	if (bParam4)
		func_199(&(uLocal_110.f_32.f_12), 1);
	else
		func_215(&(uLocal_110.f_32.f_12), 1);

	return;
}

void func_226(int iParam0, int iParam1) // Position - 0x930F Signature - 22 02 04 00 00 89
{
	func_199(&(uLocal_110.f_32.f_12), 2);
	uLocal_110.f_32.f_7 = iParam1;
	uLocal_110.f_32.f_5 = iParam0;
	return;
}

Ped func_227(int iParam0) // Position - 0x9332 Signature - 22 01 03 00 00 66 00 89 6E 80 13 80 04 63
{
	return uLocal_110.f_19.f_4[iParam0 /*2*/].f_1;
}

Hash func_228() // Position - 0x9346 Signature - 22 00 02 00 00 39 B9 A6 00 3C 03 00 00 00 00 00 0F 00 01 00 00 00 11 00 02 00 00 00 13 00 68 18 00 37 D1
{
	switch (func_287())
	{
		case 0:
...
Hash func_229() // Position - 0x9387 Signature - 22 00 02 00 00 39 B9 A6 00 3C 03 00 00 00 00 00 0F 00 01 00 00 00 11 00 02 00 00 00 13 00 68 18 00 37 A5
{
	switch (func_287())
	{
		case 0:
...
BOOL func_230() // Position - 0x93C8 Signature - 22 00 02 00 00 6D 20 39 15 7A 00 6A
{
	return func_118(32) || func_117(32, 255);
}

BOOL func_231(int iParam0, int iParam1) // Position - 0x93E3 Signature - 22 02 07 00 00 66 00
{
	var statId;
	int num;
	...
	statId = { func_288(iParam0, joaat("cooldown")) };
...
void func_232() // Position - 0x9431 Signature - 22 00 02 00 00 50 00 00 22 00 05 00 00 03
{
	return;
}

void func_233() // Position - 0x9439 Signature - 22 00 05 00 00 03 01 00 23
{
	int i;
	BOOL flag;
	int num;
...
void func_234() // Position - 0x9470 Signature - 22 00 0D
{
	float num;
	int num2;
	Ped playerPed;
	...
	if (uLocal_110.f_32.f_4)
		return;

	if (!func_204(&num2))
		return;

	if (func_164(uLocal_13[num2 /*3*/].f_2, 1))
	{
		uLocal_110.f_32.f_4 = 1;
		return;
	}

	playerPed = PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());

	if (func_291(playerPed, false))
		return;

	num3 = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(playerPed, true, false), uLocal_110.f_15);
	num4 = uLocal_110.f_32.f_9;
	num5 = uLocal_110.f_32.f_10;

	if (func_164(uLocal_110.f_32.f_12, 2))
	{
		flag = false;
		entitySpeed = ENTITY::GET_ENTITY_SPEED(playerPed);
		num6 = num * (1f / uLocal_110.f_32.f_7);
	
		if (entitySpeed > 0f)
			if (func_292(uLocal_110.f_15, playerPed))
				flag = true;
	
		if (flag)
		{
			if (uLocal_110.f_32.f_6 < 1f)
			{
				uLocal_110.f_32.f_6 = uLocal_110.f_32.f_6 + num6;
			
				if (uLocal_110.f_32.f_6 > 1f)
					uLocal_110.f_32.f_6 = 1f;
			}
		}
		else if (uLocal_110.f_32.f_6 > 0f)
		{
			uLocal_110.f_32.f_6 = uLocal_110.f_32.f_6 - num6;
		
			if (uLocal_110.f_32.f_6 < 0f)
				uLocal_110.f_32.f_6 = 0f;
		}
	
		num7 = entitySpeed * uLocal_110.f_32.f_5 * uLocal_110.f_32.f_6;
		num4 = num4 + num7;
		num5 = num5 + num7;
	}
	...
	if (num3 <= num4)
	{
		func_199(&(uLocal_13[num2 /*3*/].f_2), 1);
	}
	else if (VOLUME::DOES_VOLUME_EXIST(uLocal_110.f_32.f_11) && ENTITY::IS_ENTITY_IN_VOLUME(playerPed, uLocal_110.f_32.f_11, false, 0))
	{
		func_199(&(uLocal_13[num2 /*3*/].f_2), 1);
	}
	else if (uLocal_110.f_32 > 0)
	{
		for (i = 0; i < 1; i = i + 1)
		{
			func_293(&uLocal_110.f_32.f_13[i /*9*/], num5, 1082130432, 0, 0, false, 0, true);
		}
	
		if (func_294(&(uLocal_110.f_32.f_13), uLocal_110.f_32, uLocal_110.f_32.f_8))
			func_199(&(uLocal_13[num2 /*3*/].f_2), 1);
	}
...
BOOL func_235() // Position - 0x9663 Signature - 22 00 03 00 00 09 67
{
	BOOL flag;

	flag = true;

	if (flag && !UNLOCK::UNLOCK_IS_UNLOCKED(uLocal_110.f_14))
		return false;

	if (func_295())
		return false;

	if (func_296(PLAYER::GET_PLAYER_INDEX()))
		return false;

	return true;
}

void func_236() // Position - 0x96A0 Signature - 22 00 12
{
	int i;
	var unk;

	uLocal_110.f_19.f_11 = -1;
	uLocal_110.f_19.f_12 = 0;

	for (i = 0; i < 32; i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
		{
			uLocal_110.f_19.f_11 = uLocal_110.f_19.f_11 && uLocal_13[i /*3*/].f_1;
			uLocal_110.f_19.f_12 = uLocal_110.f_19.f_12 || uLocal_13[i /*3*/].f_1;
		}
	
		if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		{
			if (func_297(512, i) && !func_298(1))
			{
				unk = { func_299(1667262090) };
				unk.f_10 = NETWORK::NETWORK_GET_PLAYER_INDEX(PLAYER::INT_TO_PARTICIPANTINDEX(i));
				unk.f_11 = MISC::GET_RANDOM_INT_IN_RANGE(0, 6);
				func_300(&unk);
				func_301(1, true);
			}
		}
...
void func_237(var uParam0) // Position - 0x9750 Signature - 22 01 03 00 00 89 6E 27 13
{
	if (uLocal_110.f_19 != uParam0)
		uLocal_110.f_19 = uParam0;

	return;
}

void func_238() // Position - 0x9767 Signature - 22 00 03 00 00 39
{
	Ped ped;
	...
	if (!func_280(512))
	{
		ped = uLocal_110.f_19.f_4[0 /*2*/].f_1;
	
		if (ENTITY::DOES_ENTITY_EXIST(ped) && ENTITY::IS_ENTITY_DEAD(ped))
			if (func_302(ped, PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), false, true) < 1.25f)
				func_303(512);
	}
...
void func_239() // Position - 0x97C5 Signature - 22 00 11
{
	var unk;

	if (!func_280(1) && ENTITY::HAS_COLLISION_LOADED_AROUND_ENTITY(uLocal_110.f_19.f_4[0 /*2*/].f_1))
	{
		if (func_304())
		{
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uLocal_110.f_19.f_4[0 /*2*/].f_1))
			{
				if (func_167() == 1)
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_110.f_19.f_4[0 /*2*/].f_1, func_305(), 2f, 20000, 1048576000, 0, 1193033728);
					PED::_0x735662994E60A710(uLocal_110.f_19.f_4[0 /*2*/].f_1, true);
				}
				else if (!func_306(uLocal_110.f_19.f_4[0 /*2*/].f_1, -916659666))
				{
					TASK::TASK_ANIMAL_WRITHE(uLocal_110.f_19.f_4[0 /*2*/].f_1, 0, 0);
				}
			
				func_303(1);
				unk = { func_299(joaat("blip")) };
				func_300(&unk);
			}
		}
		else if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uLocal_110.f_19.f_4[0 /*2*/].f_1))
		{
			if (TASK::IS_PED_IN_WRITHE(uLocal_110.f_19.f_4[0 /*2*/].f_1))
				if (!PED::_0x12EB4E31F092C9B3(uLocal_110.f_19.f_4[0 /*2*/].f_1))
					PED::SET_PAUSE_PED_WRITHE_BLEEDOUT(uLocal_110.f_19.f_4[0 /*2*/].f_1, true);
			else if (func_167() == 0 && !func_306(uLocal_110.f_19.f_4[0 /*2*/].f_1, -916659666))
				TASK::TASK_ANIMAL_WRITHE(uLocal_110.f_19.f_4[0 /*2*/].f_1, 0, 1);
		}
	}
...
void func_240() // Position - 0x9906 Signature - 22 00 08 00 00 6D
{
	Ped playerPed;
	Ped ped;
	Ped ped2;
	...
	if (func_307(&(uLocal_110.f_19.f_8), 10f))
	{
		if (func_302(playerPed, ped, true, true) < 125f)
			func_308(1891783641, ped, true);
	
		func_309(&(uLocal_110.f_19.f_8));
	}

	if (PED::_0x4642182A298187D0(playerPed, 9, &ped2, 4, 2) == 3)
	{
		if (ped2 == func_310(ped))
		{
			func_309(&(uLocal_110.f_19.f_8));
			func_303(16);
		}
	}
	else if (!func_311(ped))
	{
		if (func_280(4))
		{
			if (ENTITY::DOES_ENTITY_EXIST(ped))
			{
				if (PED::_GET_PED_REMAINING_REVIVAL_TIME(ped, false) <= 0f && ENTITY::IS_ENTITY_DEAD(ped))
				{
					if (func_302(ped, PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), true, false) < 10f && !func_312(2))
					{
						if (!func_295())
							func_313(joaat("PERSONA_HONOR_ACTION__NB_ARROWHEAD_INJURY_BLEED_OUT"), true, false);
		...
		else
		{
			if (func_167() != 0)
			{
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(ped))
				{
					if (!func_280(8))
					{
						PED::_0x735662994E60A710(ped, false);
						TASK::_TASK_ANIMAL_BLEED_OUT(ped, 0, true, joaat("weapon_bow"), 0, 0);
						func_303(8);
					}
				
					PED::SET_PED_MAX_MOVE_BLEND_RATIO(ped, func_316());
				}
			}
			...
			else if (func_167() == 1 && !func_280(256))
			{
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(ped))
				{
					if (func_317(ped, func_305(), true) < 3f)
					{
						TASK::TASK_ANIMAL_WRITHE(ped, 0, 0);
						func_303(256);
					}
				}
			}
...
void func_241() // Position - 0x9ADD Signature - 22 00 03 00 00 2F 89
{
	Ped ped;
	...
	if (func_307(&(uLocal_110.f_19.f_8), 10f))
	{
		if (func_302(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), ped, true, true) < 125f)
			func_308(1891783641, ped, true);
	...
	if (!func_280(2))
	{
		if (func_167() == 1 && !func_280(256))
		{
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(ped))
			{
				if (func_317(ped, func_305(), true) < 3f || !func_306(ped, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD))
				{
					TASK::TASK_ANIMAL_WRITHE(ped, 0, 0);
					func_303(256);
				}
		...
		if (!ENTITY::IS_ENTITY_OCCLUDED(ped) && func_302(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), ped, true, true) < 30f || func_311(ped))
			func_318();
		...
		if (func_230())
		{
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(ped))
			{
				if (func_167() == 1 && !func_280(256) && TASK::GET_SCRIPT_TASK_STATUS(ped, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD, true) != 1)
				{
					TASK::TASK_ANIMAL_WRITHE(ped, 0, 0);
					func_303(256);
				}
			
				PED::SET_PAUSE_PED_WRITHE_BLEEDOUT(ped, false);
				func_303(2);
			}
		}
		...
		{
			if (TASK::IS_PED_IN_WRITHE(ped))
				if (!PED::_0x12EB4E31F092C9B3(ped))
...
void func_242() // Position - 0x9C3B Signature - 22 00 03 00 00 6D
{
	char* str;

	if (!func_312(8) && func_307(&(uLocal_110.f_19.f_8), 5f) && func_302(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), uLocal_110.f_19.f_4[0 /*2*/].f_1, true, true) < 20f)
	{
		if (!func_319(2, 1))
		{
			str = func_320();
...
void func_243() // Position - 0x9CAF Signature - 22 00 02 00 00 09 39 83
{
	if (func_312(1))
	{
		if (!func_312(4))
			if (!PED::_IS_META_PED_OUTFIT_EQUIPPED(uLocal_110.f_19.f_4[0 /*2*/].f_1, func_229()))
				func_315(4);
	
		if (!func_322(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID())) && func_323(uLocal_110.f_19.f_4[0 /*2*/].f_1))
		{
			func_324(1);
			func_303(128);
		}
...
BOOL func_244(Hash hParam0, int iParam1) // Position - 0x9D13 Signature - 22 02 04 00 00 66 00 27 02 66 01 69
{
	return hParam0->f_2 && iParam1 != false;
}

int func_245(Any anParam0, var uParam1) // Position - 0x9D24 Signature - 22 02 04 00 00 66 00 50
{
	return anParam0;
}

int func_246(int iParam0) // Position - 0x9D2E Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 29
{
	switch (iParam0)
	{
		case 2:
...
Hash func_247(var uParam0, var uParam1) // Position - 0x9DA1 Signature - 22 02 04 00 00 11 4B 00 2D 39 37
{
	return func_325(uParam0);
}

char* func_248(var uParam0, var uParam1, var uParam2) // Position - 0x9DB1 Signature - 22 03 05 00 00 4B
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

void func_249(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x9DC5 Signature - 22 04 0D
{
	int num;
	int i;
	int num2;
...
int func_250(int iParam0, var uParam1) // Position - 0x9ED7 Signature - 22 02 26 00 00 4B 05
{
	int num;
	var unk;
	int num2;
...
void func_251(int iParam0) // Position - 0x9F41 Signature - 22 01 0B 00 00 11
{
	var unk;
...
var func_252(int iParam0) // Position - 0x9F5A Signature - 22 01 03 00 00 66 00 3C 01 00 02 00 00 00 03 00 68 0B 00 5D 67 04 1D 80 F5 27 3B
{
	switch (iParam0)
	{
		case 2:
...
var func_253(int iParam0) // Position - 0x9F83 Signature - 22 01 03 00 00 66 00 3C 01 00 02 00 00 00 03 00 68 0B 00 5D 67 04 1D 80 F5 27 3D
{
	switch (iParam0)
	{
		case 2:
...
var func_254(int iParam0) // Position - 0x9FAC Signature - 22 01 03 00 00 66 00 3C 01 00 02 00 00 00 03 00 68 0B 00 5D 67 04 1D 80 F5 27 3C
{
	switch (iParam0)
	{
		case 2:
...
struct<2> func_255(int iParam0) // Position - 0x9FD5 Signature - 22 01 05 00 00 66 00 3C
{
	var unk;
	...
	{
		case 1:
			return func_331(joaat("mp_beat_manager_moonshiner_cooldown_timestamp"));
	
		case 2:
			return func_331(-1122351331);
	
		case 3:
			return func_331(1185140727);
...
int func_256() // Position - 0xA03D Signature - 22 00 02 00 00 89 6E 27 03
{
	return uLocal_110.f_3;
}

int func_257(int iParam0) // Position - 0xA049 Signature - 22 01 03 00 00 66 00 3C 04 00 00 00 00 00 15 00 01 00 00 00 13 00 02 00 00 00 11
{
	switch (iParam0)
	{
		case 0:
...
int func_258(int iParam0) // Position - 0xA084 Signature - 22 01 03 00 00 66 00 3C 04 00 00 00 00 00 15 00 01 00 00 00 13 00 02 00 00 00 32
{
	switch (iParam0)
	{
		case 0:
...
void func_259(Any* panParam0) // Position - 0xA120 Signature - 22 01 03 00 00 66 00 2F 39 4F 86 00 66 00 09
{
	func_174(panParam0, 0);
	func_174(panParam0, 1);
	func_174(panParam0, 3);
...
void func_260(Any* panParam0) // Position - 0xA143 Signature - 22 01 03 00 00 66 00 39 28
{
	func_173(panParam0);
	func_332(panParam0, 0, 3);
	return;
}

void func_261(Any* panParam0, int iParam1) // Position - 0xA159 Signature - 22 02 04 00 00 66 00 80 04
{
	MISC::SET_BIT(&(panParam0->f_4), iParam1);
	return;
}

void func_262(Any* panParam0) // Position - 0xA16B Signature - 22 01 03 00 00 66 00 2F 39 4F 86 00 66 00 2F 39 59 A1 00 66 00 09 39 59 A1 00 66 00 42
{
	func_174(panParam0, 0);
	func_261(panParam0, 0);
	func_261(panParam0, 1);
	func_261(panParam0, 4);
	func_261(panParam0, 5);
	return;
}

void func_263(Any* panParam0) // Position - 0xA196 Signature - 22 01 03 00 00 66 00 09 39 4F 86 00 66 00 11
{
	func_174(panParam0, 1);
	func_261(panParam0, 2);
	func_261(panParam0, 3);
	func_261(panParam0, 6);
	func_261(panParam0, 7);
	func_177(panParam0, 2);
	return;
}

void func_264(Any* panParam0) // Position - 0xA1C8 Signature - 22 01 03 00 00 66 00 2F 39 4F 86 00 66 00 2F 39 59 A1 00 66 00 09 39 59 A1 00 66 00 11
{
	func_174(panParam0, 0);
	func_261(panParam0, 0);
	func_261(panParam0, 1);
...
void func_265(Any* panParam0) // Position - 0xA1EC Signature - 22 01 03 00 00 66 00 09 39 4F 86 00 66 00 39
{
	func_174(panParam0, 1);
	func_172(panParam0);
	return;
...
void func_266(Any* panParam0) // Position - 0xA201 Signature - 22 01 03 00 00 66 00 11 39 4F
{
	func_174(panParam0, 2);
	func_261(panParam0, 3);
	return;
...
void func_267(Any* panParam0) // Position - 0xA217 Signature - 22 01 03 00 00 66 00 1D
{
	func_174(panParam0, 3);
	func_261(panParam0, 4);
	return;
...
void func_268(Any* panParam0) // Position - 0xA22D Signature - 22 01 03 00 00 66 00 2F 39 59
{
	func_261(panParam0, 0);
	func_261(panParam0, 1);
	return;
...
void func_269(Any* panParam0) // Position - 0xA243 Signature - 22 01 03 00 00 66 00 11 39 59
{
	func_261(panParam0, 2);
	func_261(panParam0, 3);
	return;
...
void func_270(Any* panParam0) // Position - 0xA259 Signature - 22 01 03 00 00 66 00 42 39
{
	func_261(panParam0, 4);
	func_261(panParam0, 5);
	return;
...
BOOL func_271(Any* panParam0, int iParam1) // Position - 0xA26F Signature - 22 02 04 00 00 5D F6
{
...
BOOL func_272(Any* panParam0, int iParam1) // Position - 0xA2A6 Signature - 22 02 04 00 00 37
{
...
int func_273(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, var uParam6, BOOL bParam7) // Position - 0xA2C7 Signature - 22 08 0B
{
	var unk;
...
int func_274(int iParam0, int iParam1) // Position - 0xA2F7 Signature - 22 02 04 00 00 66 00 08 15
{
	if (iParam0 == -1)
		return -1;
...
int func_275(int iParam0) // Position - 0xA316 Signature - 22 01 03 00 00 66 00 39 17 83 00 05 8B 04 00 2F 50 01 01 66 00 5D
{
	if (!func_165(iParam0))
		return 0;
...
BOOL func_276(int iParam0, BOOL bParam1) // Position - 0xA338 Signature - 22 02 04 00 00 66 00 08 20
{
...
Vector3 func_277(int iParam0) // Position - 0xA36B Signature - 22 01 03 00 00 66 00 3C 01 00 00 00 00 00 03 00 68 09
{
	switch (iParam0)
	{
		case 0:
			return uLocal_110.f_15;
...
float func_278(int iParam0) // Position - 0xA38D Signature - 22 01 03 00 00 66 00 3C 01 00 00 00 00 00 03 00 68 08
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_279(var uParam0, ePedType eptParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0xA3AC Signature - 22 0B
{
	Ped ped;
	...
	if (!func_223(eptParam1))
		return false;

	ped = func_333(eptParam1, uParam2, fParam5, bParam8, true, bParam6, iParam7, bParam9);
...
BOOL func_280(int iParam0) // Position - 0xA449 Signature - 22 01 03 00 00 89 6E 80 13 27 0C
{
	return func_164(uLocal_110.f_19.f_12, iParam0);
}

void func_281(int iParam0) // Position - 0xA45D Signature - 22 01 03 00 00 89 00 27 07
{
...
BOOL func_282(int iParam0) // Position - 0xA474 Signature - 22 01 03 00 00 89 6E 80 13 27 0B
{
	return func_164(uLocal_110.f_19.f_11, iParam0);
}

void func_283(var uParam0, int iParam1) // Position - 0xA488 Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 02
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_284(var uParam0, int iParam1) // Position - 0xA499 Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 02
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_285(Any* panParam0, int iParam1) // Position - 0xA4AE Signature - 22 02 04 00 00 09 66 01
{
	if (!SCRIPTS::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam1, panParam0, 15))
		return false;

	if (panParam0->f_4.f_1 != uLocal_110.f_1)
		return false;

	if (panParam0->f_4 != uLocal_110)
		return false;

	if (panParam0->f_4.f_2 != uLocal_110.f_2)
		return false;

	if (panParam0->f_4.f_3 != uLocal_110.f_3)
		return false;

	return true;
}

void func_286(var uParam0) // Position - 0xA50A Signature - 22 01 18
{
	Ped ped;
	BOOL flag;
	Any gangId;
	...
	switch (uParam0->f_9)
	{
		case joaat("blip"):
			...
			args.f_12 = -1;
			args.f_13 = -1;
			args = joaat("EVENT_SHOCKING_BEAT_ALARMING");
			args.f_1 = uLocal_110.f_19.f_4[0 /*2*/].f_1;
			uLocal_110.f_19.f_7 = EVENT::_CREATE_SHOCKING_EVENT(&args);
		
			if (func_302(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), uLocal_110.f_19.f_4[0 /*2*/].f_1, true, true) < 125f)
				func_308(1891783641, uLocal_110.f_19.f_4[0 /*2*/].f_1, true);
		
			func_309(&(uLocal_110.f_19.f_8));
			break;
	
		case 1667262090:
			if (func_302(uLocal_110.f_19.f_4[0 /*2*/].f_1, PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), true, false) < 25f)
			{
				func_314();
				func_334(true);
				func_335(2, 1);
			...
			if (GANG::NETWORK_IS_GANG_ID_VALID(gangId) && GANG::NETWORK_IS_GANG_IN_SESSION(gangId) && GANG::NETWORK_IS_GANG_ID_VALID(gangId2) && GANG::NETWORK_IS_GANG_IN_SESSION(gangId2) && !func_295())
				if (gangId == gangId2)
					flag = true;
		
			if (uParam0->f_10 == PLAYER::PLAYER_ID() || flag)
			{
				func_336(uParam0->f_11);
				func_303(1024);
			}
			...
			if (ENTITY::DOES_ENTITY_EXIST(ped))
			{
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(ped))
				{
					PED::_0xA2F8B3B5FEDFC100(ped, func_229());
					PED::_UPDATE_PED_VARIATION(ped, false, true, true, true, false);
				}
			}
			break;
...
int func_287() // Position - 0xA6B9 Signature - 22 00 02 00 00 39 27 B6 00 3C 14 00 00 00 00 00 75 00 01 00 00 00 73
{
	switch (func_337())
	{
		case 0:
...
struct<2> func_288(int iParam0, int iParam1) // Position - 0xA794 Signature - 22 02 09
{
	var statId;
	var unk2;
	int num;
...
void func_289(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA7DF Signature - 22 03 05 00 00 66 01 6A
{
	if (bParam1 && iParam2 != iParam0)
		uLocal_13[iParam2 /*3*/].f_2 = uLocal_13[iParam2 /*3*/].f_2 || uLocal_13[iParam0 /*3*/].f_2;

	return;
}

float func_290() // Position - 0xA80F Signature - 22 00 04 00 00 89
{
	int gameTimer;
	float num;

	if (uLocal_110.f_32.f_3 == 0)
	{
		uLocal_110.f_32.f_3 = MISC::GET_GAME_TIMER();
		return 0.03125f;
	}

	gameTimer = MISC::GET_GAME_TIMER();
	num = BUILTIN::TO_FLOAT(gameTimer - uLocal_110.f_32.f_3) * 0.001f;
	uLocal_110.f_32.f_3 = gameTimer;
	return num;
}

BOOL func_291(Ped pedParam0, BOOL bParam1) // Position - 0xA858 Signature - 22 02 04 00 00 66 00 03 05 00 97 8B 1B
{
...
BOOL func_292(var uParam0, var uParam1, var uParam2, Ped pedParam3) // Position - 0xA885 Signature - 22 04 09
{
	...
	return func_340(entityForwardVector, uParam0) > func_340(entityForwardVector, ENTITY::GET_ENTITY_COORDS(pedParam3, true, false));
}

int func_293(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, BOOL bParam7) // Position - 0xA8C1 Signature - 22 08 0C
{
	float num;
	...
	switch (*uParam0)
	{
		case 0:
			...
			else if (func_341(uParam0, num, fParam1 * fParam1, iParam3))
				*uParam0 = 1;
			else
				uParam0->f_8 = 0f;
			break;
		...
		case 1:
			...
			if (isTrackedPedVisible)
			{
				...
				else
				{
					...
					if (func_342(uParam0, num, fParam1 * fParam1, iParam3))
						*uParam0 = 0;
					else
						*uParam0 = 2;
				}
	...
	if (uParam0->f_8 != 0f)
		uParam0->f_7 = func_343() - uParam0->f_8;
	else
		uParam0->f_7 = 0f;
...
BOOL func_294(var uParam0, int iParam1, float fParam2) // Position - 0xAA7D Signature - 22 03 08 00 00 2F 67 06
{
	int i;
	int num;
	float num2;
...
BOOL func_295() // Position - 0xAB0B Signature - 22 00 02 00 00 5D 0C
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

BOOL func_296(Player plParam0) // Position - 0xAB30 Signature - 22 01 05 00 00 66 00 4B 03 4B
{
	var unk;
	int num;

	if (func_344(plParam0, &unk, &num, true))
		if (num != -1)
			return true;
...
BOOL func_297(int iParam0, int iParam1) // Position - 0xAB51 Signature - 22 02 04 00 00 66 01 2F 39
{
	if (!func_276(iParam1, false))
		if (!func_204(&iParam1))
			return false;

	if (!func_276(iParam1, true))
		return false;

	if (func_164(uLocal_13[iParam1 /*3*/].f_1, iParam0))
		return true;

	return false;
}

BOOL func_298(int iParam0) // Position - 0xAB97 Signature - 22 01 03 00 00 89 00 80
{
	return func_164(iLocal_0.f_7.f_5, iParam0);
}

struct<15> func_299(int iParam0) // Position - 0xABAB Signature - 22 01 12 00 00 4B 03 6A 80
{
	int num;

	num.f_10 = 255;
	MISC::COPY_SCRIPT_STRUCT(&(num.f_4), &uLocal_110, 5);
	num.f_9 = iParam0;
	num = 185;
...
void func_300(Any* panParam0) // Position - 0xABE7 Signature - 22 01 03 00 00 66 00 42 6D
{
	func_346(panParam0, func_345(4, 117));
	return;
}

void func_301(int iParam0, BOOL bParam1) // Position - 0xABFC Signature - 22 02 04 00 00 66 01 8B
{
	if (bParam1)
		if (!NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
			return;

	func_199(&(iLocal_0.f_7.f_5), iParam0);
	return;
}

float func_302(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAC20 Signature - 22 04 06 00 00 66 00 03
{
...
void func_303(int iParam0) // Position - 0xAC68 Signature - 22 01 04 00 00 4B
{
	int num;
	...
	func_199(&(uLocal_13[num /*3*/].f_1), iParam0);
	return;
}

BOOL func_304() // Position - 0xAC8B Signature - 22 00 02 00 00 89 6E 80 20 27
{
	return uLocal_110.f_32.f_4;
}

Vector3 func_305() // Position - 0xAC99 Signature - 22 00 02 00 00 39 27 B6 00 3C 14 00 00 00 00 00 75 00 01 00 00 00 81
{
	switch (func_337())
	{
		case 0:
			return -1960.4227f, -2081.308f, 56.64626f;
	
		case 1:
			return 116.83887f, 94.82872f, 103.02901f;
	
		case 2:
			return -922.43164f, 894.5942f, 141.36533f;
	
		case 3:
			return 2819.5132f, 1068.565f, 45.8229f;
	
		case 4:
			return 1705.6462f, -1107.0967f, 41.68002f;
	
		case 5:
			return 1271.8954f, -873.2363f, 66.67879f;
	
		case 6:
			return 321.12708f, 1229.421f, 184.55562f;
	
		case 7:
			return -1771.546f, -270.35355f, 181.04152f;
	
		case 8:
			return -1241.0646f, -1134.0673f, 69.09028f;
	
		case 9:
			return -2351.374f, -1570.987f, 150.77242f;
	
		case 10:
			return -2684.8079f, -2585.378f, 68.77023f;
	
		case 11:
			return -4516.411f, -3314.9067f, 15.34342f;
	
		case 12:
			return -4645.0845f, -2681.1633f, -9.38732f;
	
		case 13:
			return -5720.355f, -3208.3665f, -23.00574f;
	
		case 14:
			return -1628.3545f, -2275.2178f, 43.5816f;
	
		case 15:
			return -1599.3645f, 1690.0924f, 236.81633f;
	
		case 16:
			return 431.78998f, 2051.425f, 235.00125f;
	
		case 17:
			return -559.3034f, 511.83832f, 98.66551f;
	
		case 18:
			return 1742.8333f, 595.4795f, 104.01485f;
	
		case 19:
			return 1574.6223f, -1752.9833f, 52.35271f;
...
BOOL func_306(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xAE8E Signature - 22 02 04 00 00 66 00 03 05 00 97 8B 47
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
BOOL func_307(var uParam0, float fParam1) // Position - 0xAEE7 Signature - 22 02 04 00 00 66 00 39 74
{
	if (!func_347(uParam0))
		return false;
...
void func_308(Hash hParam0, Ped pedParam1, BOOL bParam2) // Position - 0xAF0E Signature - 22 03 05 00 00 66 02
{
	if (bParam2)
	{
...
void func_309(var uParam0) // Position - 0xAF2D Signature - 22 01 03 00 00 66 00 73
{
	func_349(uParam0, 0f);
	return;
}

Ped func_310(Ped pedParam0) // Position - 0xAF3C Signature - 22 01 03 00 00 66 00 50
{
	return pedParam0;
}

BOOL func_311(Ped pedParam0) // Position - 0xAF46 Signature - 22 01 03 00 00 66 00 03 05 00 97
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_312(int iParam0) // Position - 0xAF83 Signature - 22 01 03 00 00 89 6E 80 13 27 01
{
	return func_164(uLocal_110.f_19.f_1, iParam0);
}

void func_313(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAF97 Signature - 22 03 0E
{
	var unk;
	var value;
	int i;
	...
	if (!bParam1)
		if (!Global_1149432.f_3876.f_2[func_351(iParam0, 1) /*4*/])
			return;

	Global_1149432.f_3876.f_2[func_351(iParam0, 1) /*4*/].f_2 = Global_1149432.f_3876.f_2[func_351(iParam0, 1) /*4*/].f_2 + 1;
...
void func_314() // Position - 0xB0D8 Signature - 22 00 02 00 00 11 39 A1
{
	if (!func_61(2))
		return;
...
void func_315(int iParam0) // Position - 0xB0F2 Signature - 22 01 03 00 00 89 6E 80 13 80 01 66 00 39 74
{
	func_199(&(uLocal_110.f_19.f_1), iParam0);
	return;
}

float func_316() // Position - 0xB106 Signature - 22 00 0A
{
	Vector3 vector;
	Vector3 vector2;
	...
	vector = { uLocal_110.f_15 };
	vector2 = { func_305() };
	distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(vector, vector2, true);
	num = func_317(uLocal_110.f_19.f_4[0 /*2*/].f_1, vector2, true);
	return func_353(1f, 2f, num / distanceBetweenCoords);
}

float func_317(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xB150 Signature - 22 05 07 00 00 66 00 03
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
void func_318() // Position - 0xB178 Signature - 22 00 03 00 00 6F
{
	int num;

	if (!func_117(32, 255))
	{
		func_354(uLocal_110.f_1, uLocal_110.f_3);
	
		if (!func_117(1024, 255))
		{
			func_355(uLocal_110.f_1);
			func_134(1024);
		}
	
		num = func_250(uLocal_110.f_1, uLocal_110.f_2);
		func_356(num);
		func_357(num);
		func_132(2);
		func_358(uLocal_110.f_9);
		func_359(uLocal_110.f_1);
		func_360(uLocal_110.f_1, uLocal_110.f_2, uLocal_110.f_3);
	
		if (func_361(uLocal_110.f_1))
		{
			func_362(false, 827348479);
			func_132(1024);
		}
...
BOOL func_319(int iParam0, int iParam1) // Position - 0xB217 Signature - 22 02 04 00 00 66 00 66 01 39 8C C2 00 05 8B 04
{
	if (!func_363(iParam0, iParam1))
		return false;

	return func_364(iParam1, iParam0);
}

char* func_320() // Position - 0xB237 Signature - 22 00 02 00 00 39 B9 A6 00 3C 03 00 00 00 00 00 0F 00 01 00 00 00 0F
{
	switch (func_287())
	{
		case 0:
...
int func_321(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xB270 Signature - 22 06 18 00 00 4B
{
	int num;
	var unk13;
	int num2;
...
BOOL func_322(Ped pedParam0) // Position - 0xB2AB Signature - 22 01 04 00 00 66 00 03
{
	var lootTarget;
...
BOOL func_323(Entity eParam0) // Position - 0xB315 Signature - 22 01 03 00 00 66 00 03 05 00 16
{
	return ENTITY::_IS_ENTITY_FULLY_LOOTED(eParam0);
}

void func_324(int iParam0) // Position - 0xB323 Signature - 22 01 03 00 00 89 6E 80 13 80 01 66 00 39 5A
{
	func_215(&(uLocal_110.f_19.f_1), iParam0);
	return;
}

Hash func_325(var uParam0, var uParam1) // Position - 0xB337 Signature - 22 02 07 00 00 4B 04 6A 80 01 08 3D 41 6A 80 02 08 3D 41 41 11 4B 00 2D 4B 04 39 E0 C2 00 8B 05
{
	int num;
...
int func_326(var uParam0, var uParam1) // Position - 0xB361 Signature - 22 02 07 00 00 4B 04 6A 80 01 08 3D 41 6A 80 02 08 3D 41 41 11 4B 00 2D 4B 04 39 E0 C2 00 8B 07
{
	var unk;
	...
	if (func_365(uParam0, &unk))
		return unk.f_1;

	return -1;
}

int func_327(int iParam0) // Position - 0xB38D Signature - 22 01 09
{
	int num;
	int num2;
	...
	if (func_271(&num2, iParam0))
		num = func_366() - DATAFILE::_0xE13634BB6BAF0734(num2, num2.f_1) - 1;

	return num;
}

int func_328(int iParam0) // Position - 0xB3B8 Signature - 22 01 03 00 00 66 00 08 15 04 00 2F 50 01 01 66 00 5D F6 FF 12 63
{
	if (iParam0 == -1)
		return 0;
...
BOOL func_329(int iParam0, BOOL bParam1) // Position - 0xB3D4 Signature - 22 02 04 00 00 66 00 3C 0D
{
	switch (iParam0)
	{
...
void func_330(Any* panParam0) // Position - 0xB43C Signature - 22 01 03 00 00 03 01 00 54 05 8B 03
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
	...
	*panParam0 = 183;
	...
	func_367(panParam0, panParam0->f_1);
	return;
}

struct<2> func_331(int iParam0) // Position - 0xB4A7 Signature - 22 01 05 00 00 66 00 4B 03 6C
{
	var unk;
...
void func_332(Any* panParam0, int iParam1, int iParam2) // Position - 0xB4B9 Signature - 22 03 06 00 00 66 01 2F
{
	int i;
...
Ped func_333(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, int iParam8, BOOL bParam9) // Position - 0xB4F5 Signature - 22 0A
{
	Ped ped;
...
void func_334(BOOL bParam0) // Position - 0xB521 Signature - 22 01 03 00 00 6D 08
{
	if (!func_61(8))
		return;
...
void func_335(int iParam0, int iParam1) // Position - 0xB55C Signature - 22 02 04 00 00 66 00 66 01 39 8C C2 00 05 8B 03
{
	if (!func_363(iParam0, iParam1))
		return;
...
void func_336(int iParam0) // Position - 0xB57B Signature - 22 01 04 00 00 37
{
	int num;
	...
	func_369(num, 0, 255, 0, false);
	return;
}

int func_337() // Position - 0xB627 Signature - 22 00 02 00 00 89 6E 27 02
{
	return uLocal_110.f_2;
}

int func_338(int iParam0) // Position - 0xB633 Signature - 22 01 03 00 00 66 00 3C 22
{
	switch (iParam0)
	{
		case 1:
...
struct<2> func_339(int iParam0, int iParam1) // Position - 0xB81F Signature - 22 02 06 00 00 66
{
	int num;
...
float func_340(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xB835 Signature - 22 06 08
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

BOOL func_341(var uParam0, float fParam1, float fParam2, int iParam3) // Position - 0xB856 Signature - 22 04 06 00 00 66 01
{
	if (fParam1 > fParam2)
		return false;
...
BOOL func_342(var uParam0, float fParam1, float fParam2, int iParam3) // Position - 0xB87B Signature - 22 04 06 00 00 66 00 66 01
{
	if (func_341(uParam0, fParam1, fParam2, iParam3))
	{
		if (uParam0->f_8 == 0f)
			uParam0->f_8 = func_343() - 0.02f;
...
float func_343() // Position - 0xB8B6 Signature - 22 00 03 00 00 03
{
...
BOOL func_344(Player plParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xB8E8 Signature - 22 04 07
{
	Player player;
...
var func_345(int iParam0, int iParam1) // Position - 0xB934 Signature - 22 02 04 00 00 73
{
	return func_370(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

void func_346(Any* panParam0, var uParam1) // Position - 0xB952 Signature - 22 02 04 00 00 4B 01 03 05 00 A7 05 8B 03 00 50 02 00 09
{
...
BOOL func_347(var uParam0) // Position - 0xB974 Signature - 22 01 03 00 00 66 00 76 09
{
	return func_371(*uParam0, 1);
}

float func_348(var uParam0) // Position - 0xB984 Signature - 22 01 03 00 00 66 00 39 74
{
	if (!func_347(uParam0))
		return uParam0->f_1;
...
void func_349(var uParam0, float fParam1) // Position - 0xB9B9 Signature - 22 02 04 00 00 39
{
...
BOOL func_350() // Position - 0xB9DF Signature - 22 00 02 00 00 39 1F
{
	if (func_28() != 0)
		return true;
...
int func_351(int iParam0, int iParam1) // Position - 0xBA37 Signature - 22 02 04 00 00 66 00 3C 6A
{
	switch (iParam0)
	{
		case -2086327823:
...
void func_352(Any* panParam0, var uParam1) // Position - 0xBEDE Signature - 22 02 04 00 00 4B 01 03 05 00 A7 05 8B 03 00 50 02 00 6D
{
	if (!SCRIPTS::_IS_ANY_PLAYER_BIT_SET(&uParam1))
		return;
...
float func_353(float fParam0, float fParam1, float fParam2) // Position - 0xBF15 Signature - 22 03 05 00 00 48
{
	return ((1f - fParam2) * fParam0) + (fParam2 * fParam1);
}

void func_354(int iParam0, int iParam1) // Position - 0xBF2A Signature - 22 02 26 00 00 4B 04
{
	var unk;
	var statId;
	BOOL address;
	...
	statId = { func_288(iParam0, joaat("variations_seen")) };
	...
	if (!func_107(&unk, 4) && func_375(address) == unk.f_1)
		address = false;
...
void func_355(int iParam0) // Position - 0xBFD0 Signature - 22 01 03 00 00 66 00 39 A1 C8
{
	func_376(iParam0);
	return;
}

void func_356(int iParam0) // Position - 0xBFDE Signature - 22 01 2A
{
	int num;
	int num2;
	var unk;
	...
	if (func_114(Global_1260806[iParam0 /*4*/]))
		return;

	func_377(iParam0, &num, &num2);
	unk.f_10 = 1106247680;
	unk.f_15 = 4;
	unk.f_20 = 4;
	unk.f_26 = -1;
	...
	func_115(&Global_1260806[iParam0 /*4*/]);
	value = unk.f_5;

	if (value != 0)
	{
		statId = { func_331(joaat("mp_fetch_last_attempted_dynamic_mission_unlock")) };
		STATS::STAT_ID_SET_INT(&statId, value, true);
		statId = { func_331(joaat("mp_fetch_last_attempted_dynamic_mission_timestamp")) };
	...
	if (value2 != 0)
	{
		statId2 = { func_331(joaat("mp_fetch_last_attempted_cooldown_tag_id")) };
		STATS::STAT_ID_SET_INT(&statId2, value2, true);
		statId2 = { func_331(joaat("mp_fetch_last_attempted_cooldown_tag_timestamp")) };
...
void func_357(int iParam0) // Position - 0xC0BE Signature - 22 01 0B 00 00 09
{
	var unk;
...
void func_358(var uParam0, var uParam1) // Position - 0xC0D7 Signature - 22 02 26 00 00 11
{
	Hash hash;
	var unk;
...
void func_359(int iParam0) // Position - 0xC180 Signature - 22 01 05 00 00 66 00 37
{
	var statId;

	statId = { func_288(iParam0, joaat("num_times_seen")) };
	STATS::_STAT_ID_INCREMENT_INT(&statId, 1);
	return;
}

void func_360(int iParam0, int iParam1, int iParam2) // Position - 0xC19E Signature - 22 03 25
{
	var unk;
	int num;
...
BOOL func_361(int iParam0) // Position - 0xC21B Signature - 22 01 03 00 00 66 00 3C 01 00 09
{
	switch (iParam0)
	{
		case 9:
...
int func_362(BOOL bParam0, Hash hParam1) // Position - 0xC236 Signature - 22 02 04 00 00 03 01 00 0C
{
	if (!NETWORK::NETWORK_IS_IN_SESSION())
		return 0;
...
BOOL func_363(int iParam0, int iParam1) // Position - 0xC28C Signature - 22 02 04 00 00 66 01 2F 35
{
	if (iParam1 < 0 || iParam1 > func_381(iParam0) - 1)
		return false;

	return true;
}

BOOL func_364(int iParam0, int iParam1) // Position - 0xC2B1 Signature - 22 02 07 00 00 66 01 37 69 C8 6A 35 39 94 A7 00 11 4B 04 06 4B 04 4B 06 03 09 00 68 05 8B 04
{
	var statId;
	int address;

	statId = { func_288(iParam1, joaat("character_memory")) };
...
BOOL func_365(int iParam0, var uParam1, Any* panParam2) // Position - 0xC2E0 Signature - 22 03 05 00 00 11
{
	if (!func_36(iParam0))
		return false;
...
int func_366() // Position - 0xC3EB Signature - 22 00 08 00 00 2F
{
	int numChildren;
	Any any;
...
void func_367(Any* panParam0, var uParam1) // Position - 0xC423 Signature - 22 02 04 00 00 50
{
	return;
}

void func_368(int iParam0, int iParam1) // Position - 0xC42B Signature - 22 02 07 00 00 66 01 37 69 C8 6A 35 39 94 A7 00 11 4B 04 06 4B 04 4B 06 03 09 00 68 05 8B 03
{
	var statId;
	int address;
...
int func_369(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0xC474 Signature - 22 05 24
{
	var unk;
	var unk13;
	var unk26;
	...
	unk.f_1 = 10;
	unk13.f_1 = 11;
	return func_383(iParam0, &unk26, &unk13, &unk, iParam1, iParam2, iParam3, bParam4);
}

var func_370(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0xC4A4 Signature - 22 0C
{
	var value;
	Player bitIndex;
	int i;
	...
	else
	{
		...
		{
			case joaat("volBox"):
				volume = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(fParam0, fParam3, fParam6, func_385());
				break;
		
			case joaat("volSphere"):
				volume = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(fParam0, fParam3, fParam6, func_385());
				break;
		
			case joaat("volCylinder"):
				volume = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(fParam0, fParam3, fParam6, func_385());
				break;
		}
	}

	if (flag4 & 8 != 0)
		flag4 = flag4 || func_386(PLAYER::GET_PLAYER_TEAM(player));
...
BOOL func_371(int iParam0, int iParam1) // Position - 0xC837 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01 03 00 00 66 00 76
{
	return iParam0 && iParam1 != false;
}

BOOL func_372(var uParam0) // Position - 0xC846 Signature - 22 01 03 00 00 66 00 76 11
{
	return func_371(*uParam0, 2);
}

void func_373(var uParam0, int iParam1) // Position - 0xC856 Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_374(var uParam0, int iParam1) // Position - 0xC867 Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 01 04
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_375(BOOL bParam0) // Position - 0xC87C Signature - 22 01 04 00 00 2F 67 03 66 00 2F
{
	int i;
...
void func_376(int iParam0) // Position - 0xC8A1 Signature - 22 01 06 00 00 5D
{
	int value;
	var statId;
...
int func_377(int iParam0, var uParam1, var uParam2) // Position - 0xC8CD Signature - 22 03 26
{
	int num;
	int i;
	int num2;
...
BOOL func_378(int iParam0, var uParam1, var uParam2) // Position - 0xC95F Signature - 22 03 08 00 00 4B
{
	var unk;
	...
	if (func_390(iParam0, unk, uParam2))
		return true;

	return false;
}

BOOL func_379() // Position - 0xC993 Signature - 22 00 02 00 00 5D 17 00 18 27 0A
{
	return !Global_1572887.f_10;
}

void func_380(Hash hParam0, int iParam1) // Position - 0xC9A2 Signature - 22 02 04 00 00 66 00 27 02 66 01 30
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

int func_381(int iParam0) // Position - 0xC9B5 Signature - 22 01 03 00 00 66 00 3C 02
{
	switch (iParam0)
	{
		case 4:
...
void func_382(Any* panParam0) // Position - 0xC9DB Signature - 22 01 03 00 00 2F 66 00 32 08
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
int func_383(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0xC9F1 Signature - 22 08 1E
{
	BOOL flag;
	int num;
	var unk;
	...
	unk2.f_14 = iParam6;
	unk2 = { *iParam2 };
	func_392(anParam1, iParam0, unk2);
	return 1;
}

int func_384() // Position - 0xCAD2 Signature - 22 00 02 00 00 5D FD 0B 10 27 0C
{
	return Global_1051645.f_12;
}

char* func_385() // Position - 0xCAE0 Signature - 22 00 02 00 00 6D 68
{
	return "unnamed";
}

BOOL func_386(int iParam0) // Position - 0xCAEB Signature - 22 01 04 00 00 2F 67 03 66 00 3C 09
{
	int num;
...
BOOL func_387(int iParam0) // Position - 0xCB7A Signature - 22 01 03 00 00 5D 17 00 18 27 0E 08 15 04 00 2F 50 01 01 6D
{
	if (Global_1572887.f_14 == -1)
		return false;

	return func_393(36, iParam0);
}

int func_388(int iParam0) // Position - 0xCB98 Signature - 22 01 03 00 00 66 00 6D FF 15
{
	if (iParam0 == 255)
...
BOOL func_389(Player plParam0) // Position - 0xCBE3 Signature - 22 01 03 00 00 03 01 00 54 05 8B 04
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;

	if (func_394(plParam0))
	{
...
BOOL func_390(int iParam0, var uParam1, var uParam2) // Position - 0xCC28 Signature - 22 03 0A 00 00 66 00 39
{
	var unk;
...
void func_391(int iParam0, int iParam1) // Position - 0xCC5D Signature - 22 02 04 00 00 66 01 2F 15
{
	if (iParam1 == 0)
		return;
...
void func_392(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0xCC8D Signature - 22 13
{
	int i;
	var unk;
...
BOOL func_393(int iParam0, int iParam1) // Position - 0xCD48 Signature - 22 02 05 00 00 66 00 67
{
	int num;
	...
	if (iParam1 == 255)
		return func_400(&(Global_1102813.f_4), num, 5);
	...
	if (Global_1295666.f_17[iParam1])
		return func_400(&(Global_1101558[iParam1 /*38*/].f_4), num, 5);

	return false;
}

BOOL func_394(Player plParam0) // Position - 0xCDBC Signature - 22 01 03 00 00 5D 77
{
...
void func_395(Player plParam0) // Position - 0xCDD9 Signature - 22 01 04 00 00 5D 17 00 18 27 11 2F 1C 6A 05 8B 09 00 5D 17 00 18 27 0E 2F 1C 30 8B 03 00 50 01 00 66 00 67 03 66 03 2F 35 6A 05 8B 06 00 66 03 6D 20 7E 30 8B 03 00 50 01 00 66 03 5D 32
{
	Player player;
...
BOOL func_396(int iParam0) // Position - 0xCE5C Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21 00 04 00 00 00 1B 00 05 00 00 00 15 00 06 00 00 00 0F 00 07 00 00 00 09 00 08 00 00 00 03 00 68 04 00 09 50 01 01 2F 50 01 01 22 03
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_397(int iParam0, var uParam1, Any* panParam2) // Position - 0xCE9B Signature - 22 03 05 00 00 5D F8 89 11 27 07 66 02 32 37 19
{
	*panParam2 = Global_1149432.f_7;
	panParam2->f_2 = 1351168281;
	panParam2->f_3 = func_404(iParam0);
	panParam2->f_4 = uParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam2->f_1), panParam2);
}

void func_398(int iParam0, Any* panParam1, var uParam2) // Position - 0xCECF Signature - 22 03 06 00 00 66 00
{
	int num;
	...
	*uParam2 = iParam0;
	...
	uParam2->f_3 = func_405(iParam0, uParam2->f_1);
...
BOOL func_399(Any anParam0) // Position - 0xD12A Signature - 22 01 03 00 00 66 00 76 2F
{
...
BOOL func_400(Any* panParam0, int iParam1, int iParam2) // Position - 0xD170 Signature - 22 03 07 00 00 66 01
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_401() // Position - 0xD1A7 Signature - 22 00 02 00 00 5D DD
{
	return Global_1102813.f_3672;
}

void func_402(Player plParam0) // Position - 0xD1B6 Signature - 22 01 04 00 00 5D 17 00 18 27 11 2F 1C 6A 05 8B 09 00 5D 17 00 18 27 0E 2F 1C 30 8B 03 00 50 01 00 66 00 67 03 66 03 2F 35 6A 05 8B 06 00 66 03 6D 20 7E 30 8B 03 00 50 01 00 66 03 5D 77
{
	Player player;
...
void func_403(Player plParam0) // Position - 0xD222 Signature - 22 01 03 00 00 66 00 5D 77
{
...
int func_404(int iParam0) // Position - 0xD25D Signature - 22 01 04 00 00 2F 67 03 66 00 3C 16
{
	int num;
...
int func_405(int iParam0, var uParam1) // Position - 0xD3D2 Signature - 22 02 1F
{
	var unk;
...
int func_406(int iParam0) // Position - 0xD3EF Signature - 22 01 03 00 00 66 00 3C 1E
{
	switch (iParam0)
	{
		case joaat("IWD_INF"):
...
int func_407(int iParam0) // Position - 0xD545 Signature - 22 01 03 00 00 66 00 3C 07 00 18
{
	switch (iParam0)
	{
...
int func_408(int iParam0) // Position - 0xD59C Signature - 22 01 03 00 00 66 00 3C 13
{
	switch (iParam0)
	{
...
int func_409(int iParam0) // Position - 0xD676 Signature - 22 01 03 00 00 66 00 3C 0D
{
	switch (iParam0)
	{
		case -1641798436:
...
int func_410(int iParam0) // Position - 0xD70E Signature - 22 01 03 00 00 66 00 3C 26
{
	switch (iParam0)
	{
		case -1968391995:
...
BOOL func_411(int iParam0, var uParam1, var uParam2) // Position - 0xD8B8 Signature - 22 03 0A 00 00 66 00 66
{
	var unk;

	if (func_412(iParam0, uParam1, &unk))
		func_413(&unk, iParam0, uParam2);
	else
		return false;
...
BOOL func_412(int iParam0, var uParam1, Any* panParam2) // Position - 0xD8DF Signature - 22 03 05 00 00 5D F8 89 11 27 07 66 02 32 37 A7
{
	*panParam2 = Global_1149432.f_7;
...
void func_413(Any* panParam0, int iParam1, var uParam2) // Position - 0xD913 Signature - 22 03 06 00 00 66 01 66
{
	var unk;
