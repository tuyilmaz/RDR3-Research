...
void main() // Position - 0x0 Signature - 22 00 02 00 00 39 22
{
	func_1();
...
void func_1() // Position - 0x22 Signature - 22 00 02 00 00 6D
{
	func_4(32, -1);
	func_5();
...
BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0x53 Signature - 22 02 05
{
	int i;
...
void func_3() // Position - 0x133 Signature - 22 00 02 00 00 39 55
{
	func_9();
	return;
}

void func_4(int iParam0, int iParam1) // Position - 0x13F Signature - 22 02 04
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_9();
...
int func_5() // Position - 0x15C Signature - 22 00 05
{
	int scriptStatus;
	int gameTimer;
	int timeoutTime;
...
BOOL func_6() // Position - 0x26D Signature - 22 00 02 00 00 5D 17 00 18 27 0A 8B
{
...
void func_7() // Position - 0x29B Signature - 22 00 27
{
	var unk;
	int num;
...
void func_8(BOOL bParam0) // Position - 0x38C Signature - 22 01
{
	int num;
	var unk;
	int num2;
...
void func_9() // Position - 0x455 Signature - 22 00 02 00 00 03
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

int func_10() // Position - 0x461 Signature - 22 00 02 00 00 5D 17 00 18 27 0E
{
	return Global_1572887.f_14;
}

BOOL func_11() // Position - 0x46F Signature - 22 00 02 00 00 5D FD
{
	return Global_1051645.f_8;
}

int func_12(int iParam0, int iParam1, char* sParam2) // Position - 0x47D Signature - 22 03 05 00 00 09 50 03 01 22
{
	return 1;
}

BOOL func_13() // Position - 0x486 Signature - 22 00 02 00 00 5D 17 00 18 27 0A 05
{
	return !Global_1572887.f_10;
}

int func_14() // Position - 0x495 Signature - 22 00 02 00 00 5D DD
{
	return Global_1102813.f_3672;
}

int func_15(int iParam0, int iParam1, char* sParam2) // Position - 0x4A4 Signature - Not Found!
{
	return 1;
}
