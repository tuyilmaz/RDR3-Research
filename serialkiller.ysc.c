...
void func_22(int iParam0) // Position - 0x87C Signature - 22 01 03 00 00 50 01 00 22 00 02 00 00 50
{
	return;
}
...
BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x88C Signature - 22 02 04 00 00 66 00 39 AE
{
	if (func_54(iParam0))
		return true;
...
void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x968 Signature - 22 01 03 00 00 66 00 67 00 50 01 00 22 00 02 00 00 50
{
	iParam0 = iParam0;
	return;
}
...
void func_37(int iParam0) // Position - 0xA1B Signature - 22 01 03 00 00 66 00 39 F1 0F 00 05 8B 03
{
	if (!func_58(iParam0))
		return;
...
BOOL func_40(int iParam0) // Position - 0xA5D Signature - 22 01 03 00 00 66 00 67 00 2F
{
	iParam0 = iParam0;
	return false;
}
...
Hash func_94(int iParam0) // Position - 0x388D Signature - 22 01 08
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
BOOL func_97(int iParam0, BOOL bParam1) // Position - 0x3A91 Signature - 22 02 04 00 00 66 00 39 B7
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_150(int iParam0, BOOL bParam1) // Position - 0x5058 Signature - 22 02 04 00 00 66 00 5D B8 0C 10 80 5C 63 4B 27 31
{
...
void func_163(int iParam0, int iParam1) // Position - 0x525A Signature - 22 02 04 00 00 66 00 76 66 00
{
...
BOOL func_175(BOOL bParam0, BOOL bParam1) // Position - 0x53BD Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01
{
