...
void func_1() // Position - 0x77 Signature - 22 00 02 00 00 03
{
...
void func_2() // Position - 0xB0 Signature - 22 00 08
{
	Vector3 vector;
	Vector3 vector2;
...
void func_3() // Position - 0xF8 Signature - 22 00 02 00 00 86
{
...
int func_4() // Position - 0x2B7 Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

BOOL func_5(BOOL bParam0, BOOL bParam1) // Position - 0x2C5 Signature - 22 02 05
{
	int i;
...
void func_6() // Position - 0x3A5 Signature - 22 00 04
{
	PersChar persChar;
	PersChar persChar2;
...
void func_7() // Position - 0x451 Signature - 22 00 02 00 00 39
{
	func_14();
...
void func_8(Volume volParam0) // Position - 0x466 Signature - 22 01 03 00 00 66 00 03 05 00 03 05 8B 03 00 50 01 00 66 00 6D
{
...
void func_9(Volume volParam0) // Position - 0x4A7 Signature - 22 01 03 00 00 66 00 03 05 00 03 05 8B 03 00 50 01 00 66 00 21
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x4EE Signature - 22 03
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
BOOL func_11(int iParam0) // Position - 0x56D Signature - 22 01 06 00 00 66 00 09 39 93 06 00 67 03 66 03 6D 1F 59 67 04 66 03 6D 1F 47 67 05 66 04 39
{
	int num;
	int num2;
	int offset;
...
void func_12(int iParam0) // Position - 0x5EC Signature - 22 01 06 00 00 66 00 09 39 93 06 00 67 03 66 03 6D 1F 59 67 04 66 03 6D 1F 47 67 05 66 04 87 26 00 80 76 63 01 66 05 03 08 00 08
{
	int num;
	int num2;
	int offset;
...
void func_13(int iParam0) // Position - 0x61F Signature - 22 01 06 00 00 66 00 09 39 93 06 00 67 03 66 03 6D 1F 59 67 04 66 03 6D 1F 47 67 05 66 04 87 26 00 80 76 63 01 66 05 03 08 00 18
{
	int num;
	int num2;
	int offset;
...
void func_14() // Position - 0x652 Signature - 22 00 02 00 00 54
{
...
void func_15(var uParam0, int iParam1) // Position - 0x67E Signature - 22 02 04 00 00 66 00 76
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_16(int iParam0, int iParam1) // Position - 0x693 Signature - 22 02 04 00 00 66 00 3C
{
	switch (iParam0)
	{
...
BOOL func_17(int iParam0) // Position - 0x1F38 Signature - 22 01 04
{
	int num;
...
BOOL func_18(int iParam0) // Position - 0x1F55 Signature - 22 01 03 00 00 66 00 37
{
...
int func_19(int iParam0) // Position - 0x1F6C Signature - 22 01 03 00 00 66 00 39
{
	return func_20(iParam0) + 30;
}

int func_20(int iParam0) // Position - 0x1F7C Signature - 22 01 03 00 00 66 00 14
{
	return iParam0 * 31;
}
