...
void func_1() // Position - 0x106 Signature - 22 00 02 00 00 89
{
	ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&obLocal_0);
	return;
}

BOOL func_2() // Position - 0x114 Signature - 22 00 02 00 00 70
{
...
BOOL func_3() // Position - 0x152 Signature - 22 00 03
{
	int weaponHash;
...
Vector3 func_4(float fParam0, var uParam1, var uParam2) // Position - 0x1A5 Signature - 22 03 07
{
	float num;
	float num2;
...
Vector3 func_5() // Position - 0x1E4 Signature - 22 00 02 00 00 86
{
	return -1502.098f, 2458.125f, 418.487f;
}

float func_6(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x1FB Signature - 22 06
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

float func_7(float fParam0, float fParam1, float fParam2) // Position - 0x21C Signature - 22 03 05 00 00 66
{
	if (fParam0 > fParam2)
		return fParam2;
...
float func_8(float fParam0, float fParam1, float fParam2) // Position - 0x243 Signature - 22 03 05 00 00 48
{
