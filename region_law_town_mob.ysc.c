...
void func_1() // Position - 0x4D Signature - 22 00 03 00 00 03 00
{
	int i;
...
void func_2() // Position - 0xA8 Signature - 22 00 05
{
	Volume aggregate;
	Volume aggregate2;
	int num;
...
BOOL func_3(int iParam0) // Position - 0x216 Signature - 22 01 03 00 00 2F
{
	return false;
}

void func_4() // Position - 0x21F Signature - 22 00 07
{
	float num;
	float num2;
	int num3;
...
BOOL func_5(Ped pedParam0, int iParam1) // Position - 0x405 Signature - 22 02 05 00 00 66 00
{
	int num;
...
void func_6(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x504 Signature - 22 04 06
{
...
Volume func_7(int iParam0) // Position - 0x572 Signature - 22 01 03 00 00 66 00 39 D5 0A 00 05 8B 04 00 2F 50 01 01 66 00 5D 83 CC 1C 63 24 27 04
{
	if (!func_18(iParam0))
		return 0;
...
Vector3 func_8(int iParam0, BOOL bParam1) // Position - 0x592 Signature - 22 02 08
{
...
void func_9(var uParam0, int iParam1) // Position - 0x5F2 Signature - 22 02 05 00 00 66 01 67 04 66 00 76 09 66 04 03 09 00 36 30 66 00 32 50 02 00 22 05
{
	int bitShift;
...
float func_10(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x60C Signature - 22 05 07
{
...
ePedType func_11(int iParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4, float fParam5, float fParam6, float fParam7) // Position - 0x634 Signature - 22 08 0A
{
	if (!func_19(iParam0))
		return 0;
...
BOOL func_12() // Position - 0x66E Signature - 22 00 03 00 00 54
{
	float num;
...
void func_13() // Position - 0x6FA Signature - 22 00 08
{
	int i;
	var unk;
	Blip blip;
	...
	for (i = 0; i < iLocal_49; i = i + 1)
	{
		...
		if (func_5(iLocal_49[i], 0))
		{
			...
			MAP::BLIP_ADD_MODIFIER(blip, 1086257954);
...
void func_14(var uParam0) // Position - 0xA1B Signature - 22 01 03 00 00 66 00 73
{
	func_29(uParam0, 0f);
	return;
}

int func_15(int iParam0) // Position - 0xA2A Signature - 22 01 04 00 00 66 00 3C
{
	int num;
...
void func_16(Ped pedParam0) // Position - 0xA7C Signature - 22 01 03 00 00 70
{
...
BOOL func_17(int iParam0, int iParam1) // Position - 0xAC6 Signature - 22 02 04 00 00 66 00 66
{
	return iParam0 && iParam1 != false;
}

BOOL func_18(int iParam0) // Position - 0xAD5 Signature - 22 01 03 00 00 66 00 2F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_19(int iParam0) // Position - 0xAEB Signature - 22 01 03 00 00 66 00 08
{
	return iParam0 > -1 && iParam0 < 16;
}

Hash func_20(int iParam0) // Position - 0xB01 Signature - 22 01 04 00 00 66 00 39
{
	int num;
...
BOOL func_21(int iParam0, var uParam1, ePedType eptParam2) // Position - 0xB44 Signature - 22 03 16
{
	var unk;
	BOOL flag;
	float num;
...
void func_22(Volume volParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0xD3B Signature - 22 06
{
	int num;
...
void func_23(Volume volParam0, int iParam1) // Position - 0xD8F Signature - 22 02 05 00 00 25
{
	int num;
...
Vector3 func_24(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0xDF7 Signature - 22 05 0B
{
	var unk;
	float endRange;
...
Ped func_25(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0xE3F Signature - 22 0D
{
	Ped ped;
...
int func_26() // Position - 0xE7F Signature - 22 00 02 00 00 85
{
	return Global_1902569;
}

int func_27(int iParam0) // Position - 0xE8B Signature - 22 01 03 00 00 66 00 6D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

void func_28(var uParam0, int iParam1) // Position - 0xE9E Signature - 22 02 05 00 00 66 01 67 04 66 00 76 09 66 04 03 09 00 36 30 66 00 32 50 02 00 22 02
{
	int bitShift;
...
void func_29(var uParam0, float fParam1) // Position - 0xEB8 Signature - 22 02 04 00 00 39
{
...
void func_30(Ped pedParam0) // Position - 0xEDE Signature - 22 01 04 00 00 66 00 03
{
	Blip blipFromEntity;
...
int func_31() // Position - 0xF01 Signature - 22 00 02 00 00 5D
{
	return Global_1893611.f_2;
}

int func_32(int iParam0) // Position - 0xF0F Signature - 22 01 03 00 00 66 00 39 D5 0A 00 05 8B 04 00 2F 50 01 01 66 00 5D 83 CC 1C 63 24 27 15
{
	if (!func_18(iParam0))
		return 0;
...
Vector3 func_33(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0xF2F Signature - 22 04 07
{
	float num;
...
void func_34(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xF66 Signature - 22 08 0B
{
	BOOL flag;
...
float func_35() // Position - 0x1030 Signature - 22 00 03 00 00 03 01
{
...
void func_36(var uParam0, int iParam1) // Position - 0x1062 Signature - 22 02 04 00 00 66 00 76 66 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_37(var uParam0, int iParam1) // Position - 0x1073 Signature - 22 02 04 00 00 66 00 76 66 00
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_38(Blip* pblParam0) // Position - 0x1088 Signature - 22 01 03 00 00 66 00 76
{
...
void func_39(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x10A0 Signature - 22 03 05
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_40(Ped pedParam0, BOOL bParam1) // Position - 0x10E5 Signature - 22 02 04 00 00 66 00 03
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_41(Ped pedParam0, int iParam1) // Position - 0x112A Signature - 22 02 04 00 00 66 01
{
	if (iParam1 == 1)
