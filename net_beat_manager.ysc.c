...
void func_1() // Position - 0x2E Signature - 22 00 03 00 00 03
{
	int gameTimer;
...
BOOL func_2() // Position - 0x61 Signature - 22 00 02 00 00 2F 2F
{
...
void func_3() // Position - 0x77 Signature - 22 00 02 00 00 39 4D
{
	if (!func_12())
		return;
...
void func_4() // Position - 0xCC Signature - 22 00 02 00 00 50
{
	return;
}

void func_5() // Position - 0xD4 Signature - 22 00 02 00 00 03 00
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_6(int iParam0, int iParam1) // Position - 0xE0 Signature - 22 02 04 00 00 03 01 00 75
{
...
int func_7() // Position - 0xFD Signature - 22 00 05 00 00 03
{
	int scriptStatus;
	int gameTimer;
	int timeoutTime;
...
BOOL func_8() // Position - 0x20E Signature - 22 00 02 00 00 5D 17 00 18 27 0A 8B
{
...
void func_9() // Position - 0x23C Signature - 22 00 02 00 00 39 23
{
	func_22();
...
void func_10(BOOL bParam0) // Position - 0x2A4 Signature - 22 01 0D 00 00 03
{
	int num;
	var unk;
	int num2;
...
BOOL func_11(BOOL bParam0, BOOL bParam1) // Position - 0x36D Signature - 22 02 05 00 00 5D
{
	int i;
...
BOOL func_12() // Position - 0x44D Signature - 22 00 02 00 00 03 01
{
...
BOOL func_13() // Position - 0x461 Signature - 22 00 02 00 00 85 00
{
	if (Global_1048576)
		return true;
...
void func_14() // Position - 0x4B9 Signature - 22 00 03 00 00 2F 67 02 66 02 62
{
	int i;
...
void func_15() // Position - 0x50C Signature - 22 00 07 00 00 4B
{
	var weatherType1;
	var weatherType2;
...
void func_16() // Position - 0x5AA Signature - 22 00 08 00 00 2F 39
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_17() // Position - 0x731 Signature - 22 00 02 00 00 6D 0F
{
...
void func_18() // Position - 0x775 Signature - 22 00 02 00 00 5D 06 3D 13 78 23
{
...
void func_19() // Position - 0x7BE Signature - 22 00 02 00 00 5D 06 3D 13 78 15 0D 3C
{
...
int func_20() // Position - 0x807 Signature - 22 00 02 00 00 5D 17 00 18 27 0E
{
	return Global_1572887.f_14;
}

BOOL func_21() // Position - 0x815 Signature - 22 00 02 00 00 5D FD 0B 10 27 08
{
	return Global_1051645.f_8;
}

void func_22() // Position - 0x823 Signature - 22 00 02 00 00 39 86
{
	func_60();
	func_61();
	return;
...
BOOL func_23(int iParam0, int iParam1, char* sParam2) // Position - 0x833 Signature - 22 03 05 00 00 09 50 03 01 22 00 03
{
	return true;
}

void func_24() // Position - 0x83C Signature - 22 00 03 00 00 2F 67 02 66 02 6D 1F 23 0F
{
	int i;
...
void func_25() // Position - 0x85D Signature - 22 00 03 00 00 09
{
	int i;
...
BOOL func_26(int iParam0, int iParam1, char* sParam2) // Position - 0x88E Signature - 22 03 05 00 00 09 50 03 01 22 00 02
{
	return true;
}

BOOL func_27() // Position - 0x897 Signature - 22 00 02 00 00 5D 17 00 18 27 0A 05
{
	return !Global_1572887.f_10;
}

void func_28() // Position - 0x8A6 Signature - 22 00 02 00 00 5D 06 3D 13 39
{
...
BOOL func_29(var uParam0, var uParam1) // Position - 0x8C2 Signature - 22 02 04 00 00 66 00 39 3A
{
	if (!func_66(uParam0))
		return false;
...
BOOL func_30(int iParam0) // Position - 0x8F6 Signature - 22 01 03 00 00 66 00 2F 1C
{
	return iParam0 != 0;
}

int func_31(int iParam0) // Position - 0x902 Signature - 22 01 03 00 00 5D 32 C5 13 27 10 66 00 10
{
	return (Global_1295666.f_16 - iParam0) * 1000;
}

int func_32(int iParam0) // Position - 0x916 Signature - 22 01 03 00 00 66 00 5D 06 3D 13 18 1D
{
	return Global_1260806.f_3357[iParam0];
}

void func_33(int iParam0) // Position - 0x929 Signature - 22 01 03 00 00 2F 66 00 32 50
{
	*iParam0 = 0;
	return;
}

BOOL func_34(int iParam0) // Position - 0x935 Signature - 22 01 03 00 00 66 00 3C 06 00 2D
{
	switch (iParam0)
	{
		case joaat("OVERCAST"):
...
BOOL func_35(int iParam0) // Position - 0x96E Signature - 22 01 03 00 00 66 00 3C 08
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
BOOL func_36(int iParam0) // Position - 0x9B3 Signature - 22 01 03 00 00 66 00 3C 05 00 F6
{
	switch (iParam0)
	{
		case joaat("snow"):
...
BOOL func_37(int iParam0) // Position - 0x9E6 Signature - 22 01 03 00 00 66 00 3C 01 00 01
{
	switch (iParam0)
	{
		case joaat("Fog"):
...
BOOL func_38(int iParam0) // Position - 0xA01 Signature - 22 01 03 00 00 66 00 3C 03 00 44
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
BOOL func_39(int iParam0) // Position - 0xA28 Signature - 22 01 03 00 00 66 00 3C 02 00 2B
{
	switch (iParam0)
	{
		case joaat("SNOWLIGHT"):
...
BOOL func_40(int iParam0) // Position - 0xA49 Signature - 22 01 03 00 00 66 00 3C 01 00 11
{
	switch (iParam0)
	{
...
BOOL func_41(int iParam0) // Position - 0xA64 Signature - 22 01 03 00 00 5D 06 3D 13 78 9E
{
	return MISC::IS_BIT_SET(Global_1260806.f_3486, iParam0);
}

void func_42(int iParam0) // Position - 0xA79 Signature - 22 01 03 00 00 5D 06 3D 13 18 9E 0D 66 00 03 08 00 0C
{
	MISC::SET_BIT(&(Global_1260806.f_3486), iParam0);
	return;
}

BOOL func_43(int iParam0) // Position - 0xA8E Signature - 22 01 05 00 00 66 00 2F
{
	Hash unlockHash;
	int num;
...
struct<2> func_44() // Position - 0xAE8 Signature - 22 00 02 00 00 5D 2C
{
...
int func_45(var uParam0, var uParam1) // Position - 0xB33 Signature - 22 02 07 00 00 4B 04 6A 80 01 08 3D 41 6A 80 02 08 3D 41 41 11 4B 00 2D 4B 04 39 54 15 00 8B 07
{
	var unk;
...
int func_46(int iParam0) // Position - 0xB5F Signature - 22 01 09 00 00 4B
{
	var unk;
	var unk2;
...
void func_47(int iParam0) // Position - 0xB85 Signature - 22 01 03 00 00 5D 06 3D 13 18 9E 0D 66 00 03 08 00 17
{
	MISC::CLEAR_BIT(&(Global_1260806.f_3486), iParam0);
	return;
}

BOOL func_48() // Position - 0xB9A Signature - 22 00 02 00 00 5D 0C
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

int func_49() // Position - 0xBBF Signature - 22 00 08 00 00 03
{
...
BOOL func_50(int iParam0) // Position - 0xC1F Signature - 22 01 03 00 00 66 00 08 20
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_51(int iParam0, Vector3* pvParam1, var uParam2) // Position - 0xC35 Signature - 22 03 0B 00 00 6D
{
	int num;
	float num2;
...
void func_52() // Position - 0xCB5 Signature - 22 00 02 00 00 5D 06 3D 13 78 15 0D 2F
{
...
void func_53() // Position - 0xCCD Signature - 22 00 02 00 00 39 58
{
	if (func_77())
	{
		func_78();
...
void func_54() // Position - 0xCFB Signature - 22 00 2D 00
{
	var unk;
	int num;
	var unk32;
...
void func_55() // Position - 0xE51 Signature - 22 00 02 00 00 5D 51 26 13 18 D0 09 27 03 39 F6 08 00 05 8B 10
{
...
void func_56() // Position - 0xEA4 Signature - 22 00 02 00 00 5D F6 FF 12 78 58 26 11 72 03 00 50 00 00 39
{
...
void func_57() // Position - 0xEC3 Signature - 22 00 02 00 00 5D F6 FF 12 78 58 26 11 72 03 00 50 00 00 5D
{
	if (Global_1245174.f_9816 != 2)
		return;
...
void func_58() // Position - 0xEF9 Signature - 22 00 03 00 00 5D
{
	BOOL flag;
...
void func_59() // Position - 0xF53 Signature - 22 00 02 00 00 5D 51 26 13 18 D0 09 27 03 39 F6 08 00 05 8B 15
{
	if (!func_30(Global_1254993.f_2512.f_3))
	{
		func_99(1);
...
void func_60() // Position - 0xF86 Signature - 22 00 06 00 00 4B
{
	var unk;
	int i;
...
void func_61() // Position - 0xFBB Signature - 22 00 06 00 00 42
{
	var unk;
...
void func_62(int iParam0) // Position - 0xFD0 Signature - 22 01 6A
{
	var unk;
...
BOOL func_63(int iParam0) // Position - 0x100A Signature - 22 01 06
{
	var statId;
	int num;
...
void func_64(var uParam0) // Position - 0x1033 Signature - 22 01 38
{
	int i;
	var src;
	var src2;
...
void func_65() // Position - 0x1110 Signature - 22 00 07 00 00 2F
{
	var unk;
	int i;
...
BOOL func_66(int iParam0) // Position - 0x113A Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21 00 04 00 00 00 1B 00 05 00 00 00 15 00 06 00 00 00 0F 00 07 00 00 00 09 00 08 00 00 00 03 00 68 04 00 09 50 01 01 2F 50 01 01 22 01
{
	switch (iParam0)
	{
		case 2:
...
int func_67(int iParam0) // Position - 0x1179 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 2E
{
	switch (iParam0)
	{
		case 2:
...
Hash func_68(int iParam0) // Position - 0x120F Signature - 22 01 03 00 00 66 00 3C 09 00 01 00 00 00 33 00 02
{
	switch (iParam0)
	{
		case 1:
...
int func_69(int iParam0, int iParam1) // Position - 0x129E Signature - 22 02 04 00 00 66 01 3C 09
{
	switch (iParam1)
	{
		case 1:
...
struct<2> func_70(int iParam0) // Position - 0x1540 Signature - 22 01 03 00 00 11 66 00 5D
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_71(int iParam0, var uParam1, Any* panParam2) // Position - 0x1554 Signature - 22 03 05 00 00 11
{
	if (!func_29(iParam0))
		return false;
...
BOOL func_72(Any* panParam0, int iParam1) // Position - 0x165F Signature - 22 02 04 00 00 5D
{
...
int func_73(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, var uParam6, BOOL bParam7) // Position - 0x1696 Signature - 22 08 0B
{
	var unk;
...
int func_74(int iParam0) // Position - 0x16C6 Signature - 22 01 03 00 00 66 00 3C 0C
{
	switch (iParam0)
	{
...
int func_75(int iParam0) // Position - 0x1753 Signature - 22 01 03 00 00 66 00 3C B4
{
	switch (iParam0)
	{
		case 0:
...
void func_76(int iParam0) // Position - 0x213B Signature - 22 01 03 00 00 5D 06 3D 13 78 23
{
...
BOOL func_77() // Position - 0x2158 Signature - 22 00 02 00 00 09
{
	return func_107(1);
}

void func_78() // Position - 0x2165 Signature - 22 00 03 00 00 2F 67 02 66 02 6D 1F 23 30
{
	int i;
...
void func_79() // Position - 0x21A7 Signature - 22 00 03 00 00 2F 67 02 66 02 5D
{
	int i;
...
void func_80() // Position - 0x21E2 Signature - 22 00 05 00 00 2F
{
	int i;
	int num;
	int num2;
...
void func_81(int iParam0, BOOL bParam1) // Position - 0x2248 Signature - 22 02 04 00 00 66 00 39 6D 22 00 8B
{
	if (func_82(iParam0))
	{
		bParam1;
...
BOOL func_82(int iParam0) // Position - 0x226D Signature - 22 01 03 00 00 5D 51
{
	return func_110(Global_1254993.f_2512.f_1, iParam0);
}

void func_83(BOOL bParam0, int iParam1) // Position - 0x2284 Signature - 22 02 07 00 00 66 00 6A
{
	int num;
	int i;
	int num2;
...
void func_84(int iParam0, BOOL bParam1) // Position - 0x230A Signature - 22 02 04 00 00 66 00 39 6D 22 00 05
{
	if (!func_82(iParam0))
	{
		bParam1;
...
BOOL func_85() // Position - 0x2330 Signature - 22 00 03 00 00 66
{
	int num;
...
BOOL func_86(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x238E Signature - 22 04 08 00 00 08
{
	float num;
	int i;
...
void func_87(Any* panParam0, int iParam1, int iParam2, int iParam3, Player plParam4) // Position - 0x2436 Signature - 22 05 27
{
	var src;
	int i;
...
BOOL func_88(Vector3 vParam0, var uParam1, var uParam2, int iParam3, float fParam4) // Position - 0x275C Signature - 22 05 08 00 00 03
{
...
void func_89(Any anParam0, int iParam1) // Position - 0x27A3 Signature - 22 02 04 00 00 66 00 09
{
	func_151(anParam0, 1, iParam1, 255);
	return;
}

int func_90(int iParam0) // Position - 0x27B6 Signature - 22 01 03 00 00 66 00 5D 06 3D 13 18 68
{
	return Global_1260806.f_3432[iParam0];
}

BOOL func_91(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x27C9 Signature - 22 04 10
{
	var unk;
	var unk6;
	int num;
...
void func_92(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2825 Signature - 22 05 2F
{
	var unk;
...
void func_93(int iParam0, int iParam1, int iParam2) // Position - 0x2871 Signature - 22 03 2D
{
	var unk;
...
int func_94(int iParam0, int iParam1, var uParam2, Player plParam3) // Position - 0x28B1 Signature - 22 04 06 00 00 66 02
{
...
int func_95(int iParam0, int iParam1, int iParam2) // Position - 0x28DE Signature - 22 03 24
{
	var unk;
...
BOOL func_96(int iParam0, int iParam1, int iParam2, int iParam3, Player plParam4) // Position - 0x2927 Signature - 22 05 4E
{
	var unk;
	var unk41;
...
void func_97(int iParam0) // Position - 0x2AF5 Signature - 22 01 03 00 00 5D 32 C5 13 27 10 66 00 32
{
	*iParam0 = Global_1295666.f_16;
	return;
}

void func_98() // Position - 0x2B06 Signature - 22 00 23
{
	int num;
	var unk;
	int i;
...
void func_99(int iParam0) // Position - 0x2B7A Signature - 22 01 03 00 00 5D 06 3D 13 78 15
{
...
int func_100() // Position - 0x2B97 Signature - 22 00 24
{
	var unk;
	int num;
	int num2;
...
void func_101(BOOL bParam0) // Position - 0x2BF0 Signature - 22 01 03 00 00 2F 5D
{
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x2C3F Signature - 22 02 04 00 00 66 00 6D FF 39 A5 99 00 8B
{
...
BOOL func_103(var uParam0) // Position - 0x2C69 Signature - 22 01 24
{
	int num;
	int num2;
	BOOL flag;
...
void func_104(int iParam0, BOOL bParam1) // Position - 0x2D8D Signature - 22 02 04 00 00 66 00 6D FF 39 A5 99 00 05
{
	if (!func_169(iParam0, 255))
	{
		bParam1;
...
struct<2> func_105(int iParam0, int iParam1) // Position - 0x2DB8 Signature - 22 02 09 00 00 66
{
	var statId;
	var unk2;
	int num;
...
void func_106(Any* panParam0) // Position - 0x2E03 Signature - 22 01 03 00 00 2F 66 00 32 08
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
BOOL func_107(int iParam0) // Position - 0x2E19 Signature - 22 01 04 00 00 2F 67 03 66 03 6D 1F 23 27
{
	int i;
...
BOOL func_108(int iParam0) // Position - 0x2E53 Signature - 22 01 04 00 00 2F 67 03 66 03 6D 1F 23 33
{
	int i;
...
void func_109(int iParam0, int iParam1) // Position - 0x2E99 Signature - 22 02 04 00 00 66 00 76 66 00
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_110(int iParam0, int iParam1) // Position - 0x2EAE Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 03
{
	return iParam0 && iParam1 != false;
}

void func_111(var uParam0, int iParam1, int iParam2) // Position - 0x2EBD Signature - 22 03 05 00 00 66 00 66 01
{
...
void func_112(var uParam0, int iParam1) // Position - 0x2ED9 Signature - 22 02 04 00 00 66 00 66 01 39 7F
{
	func_176(uParam0, iParam1);
	return;
}

void func_113(int iParam0, int iParam1) // Position - 0x2EE9 Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 03
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

int func_114(int iParam0, var uParam1, var uParam2) // Position - 0x2EFA Signature - 22 03 26
{
	int num;
	int i;
	int num2;
...
void func_115(Any* panParam0, int iParam1) // Position - 0x2F8C Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0A 66 00 32 42 66 00 6C 01 0D
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 4;
...
void func_116(Any* panParam0, int iParam1) // Position - 0x313E Signature - 22 02 04 00 00 09 66 00 6C 06 6D 14 66 00 32 11
{
	panParam0->f_6 = 1;
	*panParam0 = 20;
	panParam0->f_1 = 2;
...
void func_117(Any* panParam0, int iParam1) // Position - 0x34EB Signature - 22 02 04 00 00 09 66 00 6C 06 6D 15 66 00 32 6D
{
	panParam0->f_6 = 1;
	*panParam0 = 21;
	panParam0->f_1 = 8;
...
void func_118(Any* panParam0, int iParam1) // Position - 0x3AB1 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0B 66 00 32 09 66 00 6C 01 11
{
	panParam0->f_6 = 1;
	*panParam0 = 11;
	panParam0->f_1 = 1;
...
void func_119(Any* panParam0, int iParam1) // Position - 0x3CD6 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0F
{
	panParam0->f_6 = 1;
	*panParam0 = 15;
	panParam0->f_1 = 3;
...
void func_120(Any* panParam0, int iParam1) // Position - 0x3FA3 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 10
{
	panParam0->f_6 = 1;
	*panParam0 = 16;
	panParam0->f_1 = 2;
...
void func_121(Any* panParam0, int iParam1, int iParam2) // Position - 0x42E9 Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0A 66 00 32 6D
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 12;
...
void func_122(Any* panParam0, int iParam1) // Position - 0x46EE Signature - 22 02 04 00 00 09 66 00 6C 06 6D 15 66 00 32 09
{
	panParam0->f_6 = 1;
	*panParam0 = 21;
	panParam0->f_1 = 1;
...
void func_123(Any* panParam0, int iParam1) // Position - 0x4AC9 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0A 66 00 32 42 66 00 6C 01 09
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 4;
...
void func_124(Any* panParam0, int iParam1, int iParam2) // Position - 0x4CBC Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0C
{
	panParam0->f_6 = 1;
	*panParam0 = 12;
	panParam0->f_1 = 4;
...
void func_125(Any* panParam0, int iParam1) // Position - 0x4F14 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 14 66 00 32 09
{
	panParam0->f_6 = 1;
	*panParam0 = 20;
	panParam0->f_1 = 1;
...
void func_126(Any* panParam0, int iParam1) // Position - 0x52C2 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 09
{
	panParam0->f_6 = 1;
	*panParam0 = 9;
	panParam0->f_1 = 2;
...
void func_127(Any* panParam0, int iParam1, Player plParam2) // Position - 0x548A Signature - 22 03 05 00 00 09 66 00 6C 06 09
{
	panParam0->f_6 = 1;
	*panParam0 = 1;
	panParam0->f_1 = 6;
...
void func_128(Any* panParam0, int iParam1, int iParam2) // Position - 0x54F9 Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0A 66 00 32 62
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 5;
...
void func_129(Any* panParam0, int iParam1) // Position - 0x56F3 Signature - 22 02 04 00 00 09 66 00 6C 06 09
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 1;
	*panParam0 = 12;
...
void func_130(Any* panParam0, int iParam1, int iParam2) // Position - 0x593E Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0F
{
	panParam0->f_6 = 1;
	*panParam0 = 15;
	panParam0->f_1 = 2;
...
void func_131(Any* panParam0, int iParam1) // Position - 0x5BB3 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0F 66 00 32 42
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 15;
...
void func_132(Any* panParam0, int iParam1) // Position - 0x5EDC Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0D
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 13;
...
void func_133(Any* panParam0, int iParam1) // Position - 0x61A0 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0A 66 00 32 42 66 00 6C 01 09 66 00 6C 02 37 1B
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_134(Any* panParam0, int iParam1) // Position - 0x6423 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0A 66 00 32 11
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_135(Any* panParam0, int iParam1) // Position - 0x6657 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0B
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 11;
...
void func_136(Any* panParam0, int iParam1) // Position - 0x68B9 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 14 66 00 32 42 66 00 6C 01 11
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 20;
...
void func_137(Any* panParam0, int iParam1) // Position - 0x6DF0 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0F 66 00 32 62
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 15;
...
void func_138(Any* panParam0, int iParam1) // Position - 0x71F1 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0A 66 00 32 4D
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_139(Any* panParam0, int iParam1) // Position - 0x74C8 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 14 66 00 32 42 66 00 6C 01 09
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 20;
...
void func_140(Any* panParam0, int iParam1) // Position - 0x78EE Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 0A 66 00 32 42 66 00 6C 01 09 66 00 6C 02 37 04
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_141(Any* panParam0, int iParam1) // Position - 0x7B59 Signature - 22 02 04 00 00 09 66 00 6C 06 11 66 00 6C 07 6D 19
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 25;
...
void func_142(Any* panParam0, int iParam1, int iParam2) // Position - 0x8063 Signature - 22 03 06 00 00 09
{
	BOOL flag;
...
void func_143(Any* panParam0, int iParam1, int iParam2) // Position - 0x8259 Signature - 22 03 05 00 00 09 66 00 6C 06 6D 0A 66 00 32 1D
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 3;
...
void func_144(Any* panParam0, int iParam1) // Position - 0x8463 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0A 66 00 32 11
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 2;
...
void func_145(Any* panParam0, int iParam1) // Position - 0x86A3 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0B 66 00 32 09 66 00 6C 01 09
{
	panParam0->f_6 = 1;
	*panParam0 = 11;
	panParam0->f_1 = 1;
...
void func_146(Any* panParam0, int iParam1) // Position - 0x88BC Signature - 22 02 04 00 00 09 66 00 6C 06 6D 0A 66 00 32 09
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 1;
...
void func_147(Any* panParam0, int iParam1) // Position - 0x8AA8 Signature - 22 02 04 00 00 09 66 00 6C 06 0D
{
	panParam0->f_6 = 1;
	*panParam0 = 7;
	panParam0->f_1 = 3;
...
void func_148(Any* panParam0, int iParam1) // Position - 0x8C24 Signature - 22 02 04 00 00 09 66 00 6C 06 6D 08
{
	panParam0->f_6 = 1;
	*panParam0 = 8;
	panParam0->f_1 = 2;
...
void func_149(Any* panParam0, int iParam1, int iParam2) // Position - 0x8DC0 Signature - 22 03 06 00 00 66 01 3C
{
	int num;
...
Vector3 func_150(Player plParam0) // Position - 0x8F73 Signature - 22 01 03 00 00 66 00 03
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

void func_151(Any anParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8F87 Signature - 22 04 09
{
	Player player;
	int num;
	int num2;
...
struct<2> func_152(int iParam0, int iParam1) // Position - 0x8FC9 Signature - 22 02 28
{
	var unk;
	var unk2;
	var unk35;
...
int func_153(int iParam0, var uParam1) // Position - 0x9025 Signature - 22 02 0A 00 00 2F 67 04 4B 05 66 00 39 5F 16 00 6A 8B 09 00 4B 05 66 01 39 1B AB 00 69 8B 11 00 62 4B 05 2D 37 25
{
	int num;
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_154(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x905B Signature - 22 04 1B
{
	int num;
...
void func_155(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x926E Signature - 22 05 07 00 00 09
{
	uParam0->f_4 = 1;
	uParam0->f_6 = iParam1;
...
void func_156(Any* panParam0) // Position - 0x92AD Signature - 22 01 03 00 00 03 01 00 75 05 8B 03
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
...
BOOL func_157(var uParam0, int iParam1) // Position - 0x9319 Signature - 22 02 04 00 00 66 00 27
{
	return func_221(uParam0->f_25, iParam1);
}

int func_158(int iParam0, var uParam1, Player plParam2) // Position - 0x932B Signature - 22 03 08 00 00 66 00
{
	int num;
	BOOL flag;
	int i;
...
int func_159(int iParam0, int iParam1, var uParam2) // Position - 0x9388 Signature - 22 03 1F
{
	int num;
	var unk;
	int i;
...
int func_160(BOOL bParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9490 Signature - 22 04 2B
{
	int randomIntInRange;
	int startRange;
	int i;
...
void func_161(var uParam0, var uParam1) // Position - 0x952E Signature - 22 02 04 00 00 11 66
{
	uParam0->f_9 = 2;
...
int func_162(int iParam0) // Position - 0x9551 Signature - 22 01 03 00 00 66 00 3C 23
{
	switch (iParam0)
	{
		case 0:
...
int func_163(int iParam0) // Position - 0x9748 Signature - 22 01 03 00 00 25
{
	return 2452;
}

BOOL func_164(float fParam0, var uParam1, var uParam2) // Position - 0x9753 Signature - 22 03 06 00 00 66 00 03
{
	BOOL flag;
...
BOOL func_165(int* piParam0) // Position - 0x97A8 Signature - 22 01 03 00 00 66 00 76 66
{
	return *piParam0 == piParam0->f_2;
}

BOOL func_166(int* piParam0, var uParam1, BOOL bParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x97B8 Signature - 22 07
{
	int num;
	int num2;
...
void func_167(var uParam0) // Position - 0x98A9 Signature - 22 01 30
{
	var unk;
...
int func_168(int iParam0) // Position - 0x997A Signature - 22 01 09 00 00 08
{
	int num;
	int num2;
...
BOOL func_169(int iParam0, int iParam1) // Position - 0x99A5 Signature - 22 02 04 00 00 66 01 6D FF 15 06
{
	if (iParam1 == 255)
...
void func_170(var uParam0) // Position - 0x99CA Signature - 22 01 04 00 00 2F 5D
{
	int num;
...
void func_171(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x9A00 Signature - 22 04 0A
{
	float num;
	int num2;
	int num3;
...
int func_172(int iParam0) // Position - 0x9B17 Signature - 22 01 03 00 00 66 00 3C 22
{
	switch (iParam0)
	{
		case 1:
...
struct<2> func_173(int iParam0, int iParam1) // Position - 0x9D03 Signature - 22 02 06 00 00 66 00 67
{
	int num;
...
void func_174(var uParam0, int iParam1, int iParam2) // Position - 0x9D19 Signature - 22 03 05 00 00 66 01 66 02 39 20
{
...
void func_175(var uParam0, int iParam1, int iParam2) // Position - 0x9D3A Signature - 22 03 05 00 00 66 01 66 02 39 5F
{
...
void func_176(var uParam0, int iParam1) // Position - 0x9D7F Signature - 22 02 0A 00 00 5D 67 04 1D 80 F5
{
	float num;
	int i;
	float num2;
...
void func_177(Any* panParam0, int iParam1) // Position - 0x9ECA Signature - 22 02 04 00 00 66 01 3C 0A
{
	switch (iParam1)
	{
		case 0:
...
void func_178(Any* panParam0) // Position - 0x9F7F Signature - 22 01 04 00 00 2F 67 03 66 03 66 00 27 02
{
	int i;
...
void func_179(Any* panParam0) // Position - 0x9FA6 Signature - 22 01 04 00 00 2F 67 03 66 03 66 00 27 01
{
	int i;
...
void func_180(Any* panParam0, int iParam1) // Position - 0x9FCD Signature - 22 02 04 00 00 66 00 80 03
{
	MISC::SET_BIT(&(panParam0->f_3), iParam1);
	return;
}

void func_181(Any* panParam0, int iParam1) // Position - 0x9FDF Signature - 22 02 04 00 00 66 01 3C 10
{
	switch (iParam1)
	{
		case 0:
...
void func_182(Any* panParam0, int iParam1) // Position - 0xA070 Signature - 22 02 04 00 00 66 01 3C 0C
{
	switch (iParam1)
	{
		case 0:
...
void func_183(Any* panParam0, int iParam1) // Position - 0xA111 Signature - 22 02 04 00 00 66 00 80 19
{
	func_249(&(panParam0->f_25), iParam1);
	return;
}

void func_184(Any* panParam0, int iParam1) // Position - 0xA123 Signature - 22 02 04 00 00 66 01 3C 04
{
	switch (iParam1)
	{
		case 0:
...
int func_185(Player plParam0) // Position - 0xA17E Signature - 22 01 04 00 00 66 00 67
{
	Player player;
...
Vector3 func_186(int iParam0) // Position - 0xA1AE Signature - 22 01 03 00 00 66 00 39 BD BA 00 05 8B 06
{
	if (!func_254(iParam0))
		return 0f, 0f, 0f;
...
void func_187(Any* panParam0, int iParam1) // Position - 0xA1D2 Signature - 22 02 04 00 00 66 01 3C 05
{
	switch (iParam1)
	{
		case 0:
...
void func_188(Any* panParam0, int iParam1) // Position - 0xA22A Signature - 22 02 04 00 00 66 01 3C 02
{
	switch (iParam1)
	{
		case 0:
...
void func_189(Any* panParam0, int iParam1) // Position - 0xA277 Signature - 22 02 04 00 00 66 01 3C 0F 00 00 00 00 00 57 00 01 00 00 00 51 00 02 00 00 00 4B
{
	switch (iParam1)
	{
		case 0:
...
void func_190(Any* panParam0, int iParam1) // Position - 0xA30F Signature - 22 02 04 00 00 66 01 3C 0D
{
	switch (iParam1)
	{
		case 0:
...
void func_191(Any* panParam0, int iParam1) // Position - 0xA39A Signature - 22 02 04 00 00 66 01 3C 14 00 00 00 00 00 75 00 01 00 00 00 6F 00 02 00 00 00 69 00 03 00 00 00 63 00 04 00 00 00 5D 00 05 00 00 00 68
{
	switch (iParam1)
	{
		case 0:
...
void func_192(Any* panParam0, int iParam1) // Position - 0xA466 Signature - 22 02 04 00 00 66 01 3C 0F 00 00 00 00 00 57 00 01 00 00 00 51 00 02 00 00 00 5C
{
	switch (iParam1)
	{
		case 0:
...
void func_193(Any* panParam0, int iParam1) // Position - 0xA525 Signature - 22 02 04 00 00 66 01 3C 14 00 00 00 00 00 75 00 01 00 00 00 6F 00 02 00 00 00 69 00 03 00 00 00 63 00 04 00 00 00 5D 00 05 00 00 00 57
{
	switch (iParam1)
	{
		case 0:
...
void func_194(Any* panParam0, int iParam1) // Position - 0xA5DE Signature - 22 02 04 00 00 66 01 3C 19
{
	switch (iParam1)
	{
		case 0:
...
void func_195(Any* panParam0, int iParam1, int iParam2) // Position - 0xA6C6 Signature - 22 03 05 00 00 66 01 3C 0A 00 00 00 00 00 39 00 01 00 00 00 33 00 02 00 00 00 2D 00 03 00 00 00 27 00 04 00 00 00 21 00 05 00 00 00 2C 00 06 00 00 00 26 00 07 00 00 00 20 00 08 00 00 00 1A 00 09 00 00 00 14 00 68 30
{
	switch (iParam1)
	{
		case 0:
...
void func_196(Any* panParam0, int iParam1, int iParam2) // Position - 0xA753 Signature - 22 03 05 00 00 66 01 3C 0A 00 00 00 00 00 39 00 01 00 00 00 33 00 02 00 00 00 2D 00 03 00 00 00 27 00 04 00 00 00 21 00 05 00 00 00 2C 00 06 00 00 00 26 00 07 00 00 00 20 00 08 00 00 00 1A 00 09 00 00 00 14 00 68 29
{
	switch (iParam1)
	{
		case 0:
...
void func_197(Any* panParam0, int iParam1) // Position - 0xA7D9 Signature - 22 02 04 00 00 66 01 3C 01
{
	switch (iParam1)
	{
		case 0:
...
int func_198(int iParam0) // Position - 0xA80D Signature - 22 01 03 00 00 66 00 08 15 04 00 08
{
	if (iParam0 == -1)
		return -1;
...
int func_199(int iParam0) // Position - 0xA829 Signature - 22 01 03 00 00 66 00 08 15 04 00 2F 50 01 01 66 00 5D F6 FF 12 17
{
	if (iParam0 == -1)
		return 0;
...
var func_200(int iParam0, int iParam1) // Position - 0xA843 Signature - 22 02 0A 00 00 4B 05 66 00 39 5F 16 00 6A 8B 09 00 4B 05 66 01 39 1E BB 00 69 8B 11 00 62 4B 05 2D 37 0F
{
	var unk;
	var unk2;
...
int func_201(int iParam0, int iParam1) // Position - 0xA876 Signature - 22 02 0A 00 00 2F 67 04 4B 05 66 00 39 5F 16 00 6A 8B 09 00 4B 05 66 01 39 1E
{
	int num;
	var unk;
...
Hash func_202(int iParam0, int iParam1) // Position - 0xA8AC Signature - 22 02 05 00 00 66 00 08 15 04 00 2F 50 02 01 66 00 66 01 39 3F BB 00 67 04 66 04 5D F6 FF 12 18 36 02 17
{
	int num;
...
Vector3 func_203(int iParam0, int iParam1) // Position - 0xA8D3 Signature - 22 02 05 00 00 66 00 08 15 06
{
	int num;
...
int func_204(int iParam0) // Position - 0xA900 Signature - 22 01 03 00 00 66 00 3C 09 00 00
{
	switch (iParam0)
	{
		case 0:
...
var func_205(int iParam0, int iParam1) // Position - 0xA98F Signature - 22 02 0A 00 00 4B 05 66 00 39 5F 16 00 6A 8B 09 00 4B 05 66 01 39 1E BB 00 69 8B 11 00 62 4B 05 2D 37 E9
{
	var unk;
	var unk2;
...
struct<33> func_206(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA9C2 Signature - 22 04 27
{
	var unk;
...
struct<2> func_207(int iParam0, int iParam1) // Position - 0xA9DC Signature - 22 02 06 00 00 4B
{
	int num;
...
struct<2> func_208() // Position - 0xAB02 Signature - 22 00 04
{
	var unk;
...
BOOL func_209(Any* panParam0, var uParam1) // Position - 0xAB1B Signature - 22 02 04 00 00 37 88
{
...
int func_210(int iParam0) // Position - 0xAB3C Signature - 22 01 08 00 00 4B 03 39 E8 BB 00 05 8B 04 00 2F
{
	var unk;
...
int func_211(int iParam0, int iParam1) // Position - 0xABA8 Signature - 22 02 09 00 00 4B 04 39 E8 BB 00 05 8B 04 00 2F 50 02 01 4B 04 62 2F 2F 09 39 2A BC 00 05 8B 04 00 2F 50 02 01 4B 04 4D 2F 2F 09 39 2A BC 00 05 8B 04 00 2F 50 02 01 4B 04 6D 08 66 00 39 63 BC 00 2F 09 39 2A BC 00 05 8B 04 00 2F 50 02 01 4B 04 6D 0C 2F 2F 09 39 2A BC 00 05 8B 04 00 2F 50 02 01 4B 04 6D 0F
{
	var unk;
...
int func_212(int iParam0, int iParam1) // Position - 0xAC28 Signature - 22 02 09 00 00 4B 04 39 E8 BB 00 05 8B 04 00 2F 50 02 01 4B 04 62 2F 2F 09 39 2A BC 00 05 8B 04 00 2F 50 02 01 4B 04 4D 2F 2F 09 39 2A BC 00 05 8B 04 00 2F 50 02 01 4B 04 6D 08 66 00 39 63 BC 00 2F 09 39 2A BC 00 05 8B 04 00 2F 50 02 01 4B 04 6D 0C 2F 2F 09 39 2A BC 00 05 8B 04 00 2F 50 02 01 4B 04 6D 0D
{
	var unk;
...
int func_213(int iParam0, int iParam1, int iParam2) // Position - 0xACBB Signature - 22 03 0A 00 00 4B
{
	var unk;
...
int func_214(int iParam0) // Position - 0xAD62 Signature - 22 01 09 00 00 66 00 39 F9 BC 00 67 08 66 08 08 15 04 00 2F
{
	var unk;
	int num;
...
int func_215(int iParam0, int iParam1, int iParam2) // Position - 0xAE09 Signature - 22 03 0B 00 00 66
{
	var unk;
	int num;
...
BOOL func_216(int iParam0) // Position - 0xAEDE Signature - 22 01 09 00 00 2F 67 03 66
{
	int i;
	int j;
	var address;
...
int func_217(int iParam0) // Position - 0xAF3D Signature - 22 01 09 00 00 66 00 39 F9 BC 00 67 08 66 08 08 15 04 00 08
{
	var unk;
	int num;
...
int func_218(int iParam0) // Position - 0xAFE2 Signature - 22 01 0D 00 00 66 00 2F 15 04 00 2F 50 01 01 66 00 39 F9 BC 00 67 0A
{
	int i;
	int num;
	var unk;
...
int func_219(int iParam0) // Position - 0xB0DC Signature - 22 01 0D 00 00 66 00 2F 15 04 00 2F 50 01 01 66 00 39 F9 BC 00 67 08
{
	var unk;
	int num;
	int num2;
...
void func_220(Any* panParam0, var uParam1) // Position - 0xB1CE Signature - 22 02 07 00 00 2F
{
	int i;
	int num;
	int j;
...
BOOL func_221(int iParam0, int iParam1) // Position - 0xB210 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02
{
	return iParam0 && iParam1 != false;
}

BOOL func_222(BOOL bParam0, BOOL bParam1) // Position - 0xB21F Signature - 22 02 05 00 00 66 01 66 00 69
{
	BOOL flag;
...
int func_223(BOOL bParam0) // Position - 0xB233 Signature - 22 01 03 00 00 66 00 66
{
...
float func_224(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xB403 Signature - 22 06 08 00 00 73
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
int func_225(BOOL bParam0, int iParam1) // Position - 0xB421 Signature - 22 02 05 00 00 66 01 67
{
	int i;
...
int func_226(BOOL bParam0) // Position - 0xB44E Signature - 22 01 04 00 00 2F 67 03 66 00 2F
{
	int i;
...
int func_227(int iParam0, int iParam1) // Position - 0xB473 Signature - 22 02 23
{
	var unk;
...
int func_228(int iParam0) // Position - 0xB4BB Signature - 22 01 05 00 00 2F
{
	int num;
	int num2;
...
BOOL func_229(var uParam0) // Position - 0xB4FB Signature - 22 01 03 00 00 66 00 27 01
{
	if (uParam0->f_1 == -1)
		return false;
...
int func_230(int* piParam0, var uParam1) // Position - 0xB520 Signature - 22 02 06 00 00 2F
{
	int i;
	int num;
...
BOOL func_231(var uParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB561 Signature - 22 06 38
{
	var unk;
	var unk34;
	BOOL flag;
...
void func_232(var uParam0, int iParam1) // Position - 0xB7BA Signature - 22 02 04 00 00 66 01 66 00 32
{
	*uParam0 = iParam1;
	return;
}

var func_233(int iParam0, int iParam1) // Position - 0xB7C7 Signature - 22 02 04 00 00 73
{
	return func_281(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

void func_234(Any* panParam0, var uParam1) // Position - 0xB7E5 Signature - 22 02 04 00 00 4B
{
...
int func_235() // Position - 0xB813 Signature - 22 00 08 00 00 2F 67
{
	int numChildren;
	Any any;
...
float func_236(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4) // Position - 0xB84B Signature - 22 05 09
{
	int i;
	float num;
...
BOOL func_237(int iParam0) // Position - 0xB896 Signature - 22 01 03 00 00 66 00 3C 09 00 01 00 00 00 33 00 20
{
	switch (iParam0)
	{
		case 1:
...
int func_238(int iParam0) // Position - 0xB8E1 Signature - 22 01 03 00 00 66 00 3C 01 00 02 00 00 00 03 00 68 0B
{
	switch (iParam0)
	{
		case 2:
...
void func_239(int iParam0) // Position - 0xB903 Signature - 22 01 03 00 00 03 01 00 61 5D 25 30 13 63 67 80 1D 66 00 6D 1C 39 E5
{
	func_285(&(Global_1257509[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*103*/].f_29), iParam0, 28);
	return;
}

BOOL func_240(int iParam0, int iParam1) // Position - 0xB920 Signature - 22 02 04 00 00 66 01 5D 25 30 13 63 67 80 1D 66 00 6D 1C 39 17 C5 00 50 02 01 22 04
{
	return func_286(&(Global_1257509[iParam1 /*103*/].f_29), iParam0, 28);
}

void func_241(var uParam0, int iParam1, int iParam2, char* sParam3) // Position - 0xB93A Signature - 22 04 06 00 00 66 00 76
{
...
BOOL func_242(int iParam0, int iParam1) // Position - 0xB95F Signature - 22 02 04 00 00 66 01 5D 25 30 13 63 67 80 1D 66 00 6D 1C 39 17 C5 00 50 02 01 22 03
{
	return func_286(&(Global_1257509[iParam1 /*103*/].f_29), iParam0, 28);
}

float func_243(float fParam0, float fParam1, float fParam2) // Position - 0xB979 Signature - 22 03 05 00 00 66 00 66 02
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_244(Any* panParam0) // Position - 0xB9A0 Signature - 22 01 03 00 00 66 00 2F 39 CD 9F 00 66 00 09
{
	func_180(panParam0, 0);
	func_180(panParam0, 1);
	func_180(panParam0, 3);
...
void func_245(Any* panParam0) // Position - 0xB9C3 Signature - 22 01 03 00 00 66 00 39 A6
{
	func_179(panParam0);
...
void func_246(Any* panParam0, int iParam1) // Position - 0xB9D9 Signature - 22 02 04 00 00 66 00 80 04
{
	MISC::SET_BIT(&(panParam0->f_4), iParam1);
	return;
}

void func_247(Any* panParam0) // Position - 0xB9EB Signature - 22 01 03 00 00 66 00 2F 39 CD 9F 00 66 00 2F 39 D9 B9 00 66 00 09 39 D9 B9 00 66 00 42
{
	func_180(panParam0, 0);
	func_246(panParam0, 0);
	func_246(panParam0, 1);
...
void func_248(Any* panParam0) // Position - 0xBA16 Signature - 22 01 03 00 00 66 00 09 39 CD 9F 00 66 00 11
{
	func_180(panParam0, 1);
	func_246(panParam0, 2);
	func_246(panParam0, 3);
...
void func_249(var uParam0, int iParam1) // Position - 0xBA48 Signature - 22 02 04 00 00 66 00 66 01 39 33
{
	func_289(uParam0, iParam1);
	return;
}

void func_250(Any* panParam0) // Position - 0xBA58 Signature - 22 01 03 00 00 66 00 2F 39 CD 9F 00 66 00 2F 39 D9 B9 00 66 00 09 39 D9 B9 00 66 00 11
{
	func_180(panParam0, 0);
	func_246(panParam0, 0);
	func_246(panParam0, 1);
...
void func_251(Any* panParam0) // Position - 0xBA7C Signature - 22 01 03 00 00 66 00 09 39 CD 9F 00 66 00 39
{
	func_180(panParam0, 1);
	func_178(panParam0);
	return;
...
void func_252(Any* panParam0) // Position - 0xBA91 Signature - 22 01 03 00 00 66 00 11 39 CD
{
	func_180(panParam0, 2);
	func_246(panParam0, 3);
	return;
...
void func_253(Any* panParam0) // Position - 0xBAA7 Signature - 22 01 03 00 00 66 00 1D
{
	func_180(panParam0, 3);
	func_246(panParam0, 4);
	return;
...
BOOL func_254(int iParam0) // Position - 0xBABD Signature - 22 01 03 00 00 66 00 2F 35
{
...
void func_255(Any* panParam0) // Position - 0xBADC Signature - 22 01 03 00 00 66 00 2F 39 D9
{
	func_246(panParam0, 0);
	func_246(panParam0, 1);
	return;
...
void func_256(Any* panParam0) // Position - 0xBAF2 Signature - 22 01 03 00 00 66 00 11 39 D9
{
	func_246(panParam0, 2);
	func_246(panParam0, 3);
	return;
...
void func_257(Any* panParam0) // Position - 0xBB08 Signature - 22 01 03 00 00 66 00 42 39 D9
{
	func_246(panParam0, 4);
	func_246(panParam0, 5);
	return;
...
BOOL func_258(Any* panParam0, int iParam1) // Position - 0xBB1E Signature - 22 02 04 00 00 37 2B
{
...
int func_259(int iParam0, int iParam1) // Position - 0xBB3F Signature - 22 02 04 00 00 66 00 08
{
	if (iParam0 == -1)
		return -1;
...
BOOL func_260(int iParam0, int iParam1, var uParam2) // Position - 0xBB5E Signature - 22 03 0A 00 00 66 00 39
{
	var unk;
...
int func_261(var uParam0, var uParam1, int iParam2) // Position - 0xBB93 Signature - 22 03 08 00 00 2F
{
	int num;
	int num2;
	int num3;
...
BOOL func_262(Any* panParam0) // Position - 0xBBE8 Signature - 22 01 09 00 00 6D
{
	var src;
	int fileHandle;
...
BOOL func_263(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xBC2A Signature - 22 05 08 00 00 66 01
{
	var unk;
...
int func_264(int iParam0) // Position - 0xBC63 Signature - 22 01 03 00 00 66 00 3C 05 00 00 00 00 00 1B
{
	switch (iParam0)
	{
		case 0:
...
int func_265(Any anParam0, int iParam1) // Position - 0xBCBD Signature - 22 02 05 00 00 66 01 66 00 6C
{
	Any numNodes;
...
int func_266(Any* panParam0, int iParam1) // Position - 0xBCD5 Signature - 22 02 04 00 00 66 00 6D 1F 66 01 39 12 C9 00 50 02 01 22 02
{
	return func_293(panParam0, 31, iParam1);
}

int func_267(Any* panParam0, int iParam1) // Position - 0xBCE7 Signature - 22 02 04 00 00 66 00 6D 1F 66 01 39 12 C9 00 50 02 01 22 01
{
	return func_293(panParam0, 31, iParam1);
}

int func_268(int iParam0) // Position - 0xBCF9 Signature - 22 01 08 00 00 4B 03 39 E8 BB 00 05 8B 04 00 08
{
	var unk;
...
int func_269(int iParam0) // Position - 0xBD61 Signature - 22 01 03 00 00 66 00 3C 02 00 00
{
	switch (iParam0)
	{
		case 0:
...
int func_270(int iParam0) // Position - 0xBD91 Signature - 22 01 03 00 00 66 00 3C 05 00 00 00 00 00 23
{
	switch (iParam0)
	{
		case 0:
...
int func_271() // Position - 0xBDEB Signature - 22 00 02 00 00 5D 22
{
	return Global_1140770.f_235;
}

var func_272(int iParam0, int iParam1) // Position - 0xBDF9 Signature - 22 02 04 00 00 66 01 66 00 5D 22 68 11 63 12 80 02 17
{
	return Global_1140770[iParam0 /*18*/].f_2[iParam1 /*5*/];
}

int func_273(int iParam0, int iParam1) // Position - 0xBE0F Signature - 22 02 04 00 00 66 01 66 00 5D 22 68 11 63 12 80 02 63
{
	return Global_1140770[iParam0 /*18*/].f_2[iParam1 /*5*/].f_2;
}

int func_274(Any* panParam0, int iParam1) // Position - 0xBE27 Signature - 22 02 04 00 00 66 00 6D 27
{
	return func_295(func_293(panParam0, 39, iParam1));
}

int func_275(int iParam0) // Position - 0xBE3D Signature - 22 01 03 00 00 09
{
	return BUILTIN::SHIFT_LEFT(1, iParam0);
}

BOOL func_276(var uParam0) // Position - 0xBE4C Signature - 22 01 03 00 00 11 66 00 2D
{
	if (func_29(*uParam0))
		return true;
...
BOOL func_277(var uParam0, var uParam1) // Position - 0xBE90 Signature - 22 02 04 00 00 66 01 27
{
	if (uParam1->f_2 == -1)
		return false;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xBF53 Signature - 22 03 05 00 00 66 00 73
{
...
int func_279(var uParam0, var uParam1) // Position - 0xBF7D Signature - 22 02 07 00 00 4B 04 6A 80 01 08 3D 41 6A 80 02 08 3D 41 41 11 4B 00 2D 4B 04 39 54 15 00 8B 05
{
	int num;
...
BOOL func_280(int iParam0, var uParam1) // Position - 0xBFA7 Signature - 22 02 06 00 00 66 00 39
{
	int num;
...
var func_281(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0xBFD5 Signature - 22 0C
{
	var value;
	Player bitIndex;
	int i;
...
float func_282(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0xC369 Signature - 22 06 08 00 00 66
{
	switch (iParam5)
	{
		case 0:
...
BOOL func_283(var uParam0) // Position - 0xC492 Signature - 22 01 03 00 00 66 00 76 2F
{
	return *uParam0 == 0;
}

void func_284(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xC49F Signature - 22 04 07 00 00 66 00
{
	int num;
...
BOOL func_285(int* piParam0, int iParam1, int iParam2) // Position - 0xC4E5 Signature - 22 03 08 00 00 66 01 6D 1F 59 67 05 66 01 6D 1F 47 67 06 66 05 66 00 17 01 66 06 03 09 00 64 67 07 66 05 66 00 63 01 66 06 03 08 00 17
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_286(Any* panParam0, int iParam1, int iParam2) // Position - 0xC517 Signature - 22 03 07 00 00 66
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

void func_287(int iParam0, int iParam1) // Position - 0xC54E Signature - 22 02 06 00 00 66 00 08
{
	int num;
	int num2;
...
void func_288(Any* panParam0, int iParam1, int iParam2) // Position - 0xC5F7 Signature - 22 03 06 00 00 66 01 2F
{
	int i;
...
void func_289(var uParam0, int iParam1) // Position - 0xC633 Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_290(int iParam0) // Position - 0xC644 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21 00 04 00 00 00 1B 00 05 00 00 00 15 00 06 00 00 00 0F 00 07 00 00 00 09 00 08 00 00 00 03 00 68 04 00 09 50 01 01 2F 50 01 01 22 03
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_291(int iParam0, var uParam1, Any* panParam2) // Position - 0xC683 Signature - 22 03 05 00 00 5D F8 89 11 27 07 66 02 32 37 19
{
...
void func_292(int iParam0, Any* panParam1, var uParam2) // Position - 0xC6B7 Signature - 22 03 06 00 00 66 00 66
{
	int num;
...
var func_293(Any* panParam0, int iParam1, int iParam2) // Position - 0xC912 Signature - 22 03 06 00 00 66 01 66 00
{
	var unk;
...
int func_294(Any* panParam0, int iParam1) // Position - 0xC92E Signature - 22 02 04 00 00 66 00 6D 28
{
	return func_328(func_293(panParam0, 40, iParam1));
}

int func_295(int iParam0) // Position - 0xC944 Signature - 22 01 03 00 00 66 00 3C 03 00 07
{
	switch (iParam0)
	{
...
BOOL func_296(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xC976 Signature - 22 04 06 00 00 66 00 66
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

struct<2> func_297(int iParam0) // Position - 0xC991 Signature - 22 01 05 00 00 4B
{
	var unk;
...
int func_298() // Position - 0xCA61 Signature - 22 00 02 00 00 5D FD 0B 10 27 0C
{
	return Global_1051645.f_12;
}

char* func_299() // Position - 0xCA6F Signature - 22 00 02 00 00 6D 67
{
	return "unnamed";
}

BOOL func_300(int iParam0) // Position - 0xCA7A Signature - 22 01 04 00 00 2F 67 03 66 00 3C 09
{
	int num;
...
BOOL func_301(int iParam0) // Position - 0xCB09 Signature - 22 01 03 00 00 5D 17 00 18 27 0E 08 15 04 00 2F 50 01 01 6D
{
...
int func_302(int iParam0) // Position - 0xCB27 Signature - 22 01 03 00 00 66 00 6D FF
{
	if (iParam0 == 255)
...
BOOL func_303(Player plParam0) // Position - 0xCB72 Signature - 22 01 03 00 00 03 01 00 75 05 8B 04
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
float func_304(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4) // Position - 0xCBB7 Signature - 22 05 0F 00 00 1D 66 04 80 0B 2D 1D 4B 07
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
float func_305(var uParam0, int iParam1) // Position - 0xCCAC Signature - 22 02 04 00 00 03 01 00 56
{
...
float func_306(var uParam0, int iParam1, var uParam2) // Position - 0xCCCD Signature - 22 03 06 00 00 66 02
{
	int num;
...
float func_307(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4) // Position - 0xCD2B Signature - 22 05 0F 00 00 1D 66 04 80 0B 2D 1D 4B 08
{
	float num;
	Vector3 vector;
	int num2;
...
float func_308(var uParam0, int iParam1, var uParam2) // Position - 0xCE63 Signature - 22 03 05 00 00 66 02 27 07
{
...
float func_309(var uParam0, int iParam1, var uParam2) // Position - 0xCEAD Signature - 22 03 0A 00 00 66 02
{
	int num;
	var unk;
	int num2;
...
float func_310(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xCFA0 Signature - 22 04 07 00 00 66 03 6D
{
	int num;
...
float func_311(var uParam0, int iParam1, int iParam2) // Position - 0xCFDA Signature - 22 03 05 00 00 66 02 5D
{
...
float func_312(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xD027 Signature - 22 04 08 00 00 66 03
{
	int num;
	int num2;
...
float func_313(var uParam0, int iParam1, var uParam2) // Position - 0xD07A Signature - 22 03 0B 00 00 09
{
	int i;
	int num;
	int num2;
...
float func_314(var uParam0, int iParam1, var uParam2) // Position - 0xD18C Signature - 22 03 05 00 00 66 02 27 0E
{
	if (uParam2->f_14 == 0)
		return 0f;
...
float func_315(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xD1C4 Signature - 22 04 07 00 00 66 03 27
{
	int num;
...
float func_316(var uParam0, int iParam1) // Position - 0xD1F2 Signature - 22 02 04 00 00 03 01 00 35
{
...
float func_317(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xD216 Signature - 22 04 0C 00 00 42
{
	int i;
	int num;
	int num2;
...
void func_318(Any anParam0, int iParam1) // Position - 0xD385 Signature - 22 02 04 00 00 66 00 2F
{
	func_151(anParam0, 0, iParam1, 255);
	return;
}

int func_319(int iParam0) // Position - 0xD398 Signature - 22 01 03 00 00 66 00 3C 1D
{
	switch (iParam0)
	{
		case 1:
...
void func_320(int iParam0) // Position - 0xD597 Signature - 22 01 03 00 00 03 01 00 61 5D 25 30 13 63 67 80 1D 66 00 6D 1C 39 68
{
	func_361(&(Global_1257509[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*103*/].f_29), iParam0, 28);
	return;
}

int func_321(int iParam0) // Position - 0xD5B4 Signature - 22 01 04 00 00 2F 67 03 66 00 3C 16
{
	int num;
...
int func_322(int iParam0, var uParam1) // Position - 0xD729 Signature - 22 02 1F
{
	var unk;
...
int func_323(int iParam0) // Position - 0xD746 Signature - 22 01 03 00 00 66 00 3C 1E
{
	switch (iParam0)
	{
		case joaat("IWD_INF"):
...
int func_324(int iParam0) // Position - 0xD89C Signature - 22 01 03 00 00 66 00 3C 07 00 18
{
	switch (iParam0)
	{
...
int func_325(int iParam0) // Position - 0xD8F3 Signature - 22 01 03 00 00 66 00 3C 13
{
	switch (iParam0)
	{
...
int func_326(int iParam0) // Position - 0xD9CD Signature - 22 01 03 00 00 66 00 3C 0D
{
	switch (iParam0)
	{
		case -1641798436:
...
int func_327(int iParam0) // Position - 0xDA65 Signature - 22 01 03 00 00 66 00 3C 26
{
	switch (iParam0)
	{
		case -1968391995:
...
int func_328(int iParam0) // Position - 0xDC0F Signature - 22 01 03 00 00 66 00 3C 05 00 F2
{
	switch (iParam0)
	{
		case -1340981006:
...
BOOL func_329(int iParam0, int iParam1) // Position - 0xDC55 Signature - 22 02 05 00 00 66 00 67
{
	int num;
...
BOOL func_330(Player plParam0) // Position - 0xDCC9 Signature - 22 01 03 00 00 5D 77
{
...
void func_331(Player plParam0) // Position - 0xDCE6 Signature - 22 01 04 00 00 5D 17 00 18 27 11 2F 1C 6A 05 8B 09 00 5D 17 00 18 27 0E 2F 1C 30 8B 03 00 50 01 00 66 00 67 03 66 03 2F 35 6A 05 8B 06 00 66 03 6D 20 7E 30 8B 03 00 50 01 00 66 03 5D 32
{
	Player player;
...
BOOL func_332(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xDD69 Signature - 22 04 07 00 00 1D
{
	float num;
...
void func_333(int iParam0) // Position - 0xDDAF Signature - 22 01 03 00 00 03 01 00 61 5D 25 30 13 63 67 66 00 6D 1C 39 68
{
	func_361(&Global_1257509[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*103*/], iParam0, 28);
	return;
}

int func_334(int iParam0, int iParam1) // Position - 0xDDCA Signature - 22 02 05 00 00 66 00 08 15 04 00 08
{
	int num;
...
Vector3 func_335(int iParam0, int iParam1, int iParam2) // Position - 0xDDF3 Signature - 22 03 0D
{
	var unk;
	var unk4;
...
float func_336() // Position - 0xDE35 Signature - 22 00 02 00 00 73
{
	return MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.1f);
}

void func_337(int iParam0) // Position - 0xDE47 Signature - 22 01 03 00 00 03 01 00 61 5D 25 30 13 63 67 66 00 6D 1C 39 E5
{
	func_285(&Global_1257509[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*103*/], iParam0, 28);
	return;
}

BOOL func_338(int iParam0) // Position - 0xDE62 Signature - 22 01 03 00 00 66 00 39 BD BA 00 05 8B 04 00 2F 50 01 01 66 00 39
{
	if (!func_254(iParam0))
		return false;
...
Vector3 func_339(int iParam0) // Position - 0xDE91 Signature - 22 01 03 00 00 1D
{
	return Global_1235687[iParam0 /*697*/].f_614;
}

BOOL func_340(var uParam0, var uParam1, var uParam2, int iParam3, float fParam4) // Position - 0xDEA7 Signature - 22 05 0F 00 00 66
{
	float num;
	int num2;
	int num3;
...
BOOL func_341(int iParam0) // Position - 0xDF8B Signature - 22 01 05 00 00 66 00 4B 03 4B
{
	int num;
	int num2;
...
int func_342(var uParam0) // Position - 0xDFC8 Signature - 22 01 03 00 00 66 00 27 06
{
	switch (uParam0->f_6)
	{
		case 1:
...
struct<2> func_343(int iParam0) // Position - 0xE003 Signature - 22 01 05 00 00 66 00 4B 03 6C
{
	var unk;
...
int func_344(var uParam0, var uParam1) // Position - 0xE015 Signature - 22 02 05 00 00 4B
{
	var unk;
...
int func_345(int iParam0) // Position - 0xE028 Signature - 22 01 04 00 00 5D 67
{
	int num;
...
BOOL func_346(int iParam0, int iParam1) // Position - 0xE04C Signature - 22 02 07 00 00 66 00 2F
{
	var statId;
	int num;
...
float func_347(int iParam0) // Position - 0xE09A Signature - 22 01 05 00 00 66 00 39
{
	int value;
	int value2;
...
float func_348(int iParam0) // Position - 0xE0D9 Signature - 22 01 03 00 00 66 00 3C 01 00 02 00 00 00 03 00 68 04
{
	switch (iParam0)
	{
		case 2:
...
int func_349(int iParam0) // Position - 0xE0F4 Signature - 22 01 03 00 00 66 00 08 15 04 00 2F 50 01 01 66 00 5D F6 FF 12 63
{
	if (iParam0 == -1)
		return 0;
...
void func_350(int iParam0, var uParam1, var uParam2) // Position - 0xE110 Signature - 22 03 05 00 00 66 00 3C
{
	switch (iParam0)
	{
		case joaat("Dusk"):
...
BOOL func_351(int iParam0, int iParam1) // Position - 0xE298 Signature - 22 02 05 00 00 03
{
	int clockHours;
...
BOOL func_352(int iParam0) // Position - 0xE2EB Signature - 22 01 03 00 00 66 00 2F 15
{
	if (iParam0 == 0)
		return 0;
	else if (iParam0 == -1)
...
int func_353(int iParam0) // Position - 0xE31D Signature - 22 01 03 00 00 66 00 5D 5A
{
	return Global_1148506.f_2[iParam0 /*18*/].f_1;
}

BOOL func_354(int iParam0) // Position - 0xE331 Signature - 22 01 03 00 00 2F 50
{
	return false;
}

BOOL func_355(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE33A Signature - 22 04 29
{
	var data;
	int i;
	Hash crimeType;
...
int func_356() // Position - 0xE46F Signature - 22 00 02 00 00 85 E9
{
	return Global_1902569;
}

BOOL func_357(int iParam0, int iParam1, BOOL bParam2) // Position - 0xE47B Signature - 22 03 05 00 00 66 02 8B
{
	if (bParam2)
...
BOOL func_358(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4) // Position - 0xE4A8 Signature - 22 05 07 00 00 73
{
	*uParam4 = 0f;
...
int func_359(int iParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, int iParam9) // Position - 0xE5C8 Signature - 22 0A
{
	int num;
	int num2;
	int num3;
...
int func_360(int iParam0) // Position - 0xE79F Signature - 22 01 03 00 00 66 00 3C 0F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_361(int* piParam0, int iParam1, int iParam2) // Position - 0xE868 Signature - 22 03 08 00 00 66 01 6D 1F 59 67 05 66 01 6D 1F 47 67 06 66 05 66 00 17 01 66 06 03 09 00 64 67 07 66 05 66 00 63 01 66 06 03 08 00 0C
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_362(int iParam0, var uParam1, var uParam2) // Position - 0xE89B Signature - 22 03 0A 00 00 66 00 66
{
	var unk;
...
int func_363() // Position - 0xE8C2 Signature - 22 00 02 00 00 5D DD
{
	return Global_1102813.f_3672;
}

void func_364(Player plParam0) // Position - 0xE8D1 Signature - 22 01 04 00 00 5D 17 00 18 27 11 2F 1C 6A 05 8B 09 00 5D 17 00 18 27 0E 2F 1C 30 8B 03 00 50 01 00 66 00 67 03 66 03 2F 35 6A 05 8B 06 00 66 03 6D 20 7E 30 8B 03 00 50 01 00 66 03 5D 77
{
	Player player;
...
void func_365(Player plParam0) // Position - 0xE93D Signature - 22 01 03 00 00 66 00 5D 77
{
...
BOOL func_366(Any* panParam0, int iParam1) // Position - 0xE978 Signature - 22 02 04 00 00 37 B4
{
...
int func_367(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, Vector3* pvParam6, BOOL bParam7) // Position - 0xE999 Signature - 22 08 0A 00 00 66 05 4B 00 6C 02 66 06 4B 00 03 09 00 4C
{
	uParam0.f_2 = iParam5;
...
BOOL func_368(int iParam0) // Position - 0xE9BF Signature - 22 01 04 00 00 66 00 39 BD
{
	int num;
...
int func_369(int iParam0) // Position - 0xE9EA Signature - 22 01 03 00 00 66 00 3C 04 00 00
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_370(int iParam0, int iParam1) // Position - 0xEA25 Signature - 22 02 04 00 00 66 01 66 00 5D B8 6C 12 80 E7 18 2A 04 63 11 80 08 17
{
	return func_393(Global_1207480.f_231.f_1066[iParam0 /*17*/].f_8[iParam1 /*4*/]);
}

int func_371(int iParam0, int iParam1) // Position - 0xEA44 Signature - 22 02 04 00 00 66 01 66 00 5D B8 6C 12 80 E7 18 2A 04 63 11 80 08 63
{
	return Global_1207480.f_231.f_1066[iParam0 /*17*/].f_8[iParam1 /*4*/].f_3;
}

BOOL func_372(int iParam0, int* piParam1, var uParam2) // Position - 0xEA61 Signature - 22 03 07 00 00 2F
{
	var statId;
...
int func_373(int iParam0) // Position - 0xEABB Signature - 22 01 03 00 00 66 00 3C 04 00 01
{
	switch (iParam0)
	{
		case 1:
...
float func_374(int iParam0) // Position - 0xEB10 Signature - 22 01 03 00 00 66 00 3C 02 00 07
{
	switch (iParam0)
	{
		case 7:
...
BOOL func_375(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEB43 Signature - 22 03 05 00 00 5D E7
{
...
BOOL func_376(int iParam0) // Position - 0xEBE1 Signature - 22 01 09 00 00 66 00 25
{
	int num;
	int num2;
	int num3;
...
int func_377(int iParam0, Player plParam1, BOOL bParam2, BOOL bParam3) // Position - 0xECBD Signature - 22 04 08 00 00 66 01
{
	int num;
	int i;
...
BOOL func_378() // Position - 0xED8C Signature - 22 00 02 00 00 39 61
{
	if (func_13())
		return false;
...
int func_379(int iParam0, var uParam1) // Position - 0xEDA0 Signature - 22 02 0A 00 00 08
{
	int num;
	int num2;
...
BOOL func_380(int iParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0xEDDA Signature - 22 04 0B
{
	BOOL flag;
	var unk;
	float num;
...
BOOL func_381(int iParam0, var uParam1) // Position - 0xEE5D Signature - 22 02 0A 00 00 2F 67 04 4B 05 66 00 39 5F 16 00 6A 8B 09 00 4B 05 66 01 39 1B AB 00 69 8B 11 00 62 4B 05 2D 37 E1
{
	BOOL num;
	var unk;
...
Vector3 func_382(int iParam0, var uParam1) // Position - 0xEE93 Signature - 22 02 0C
{
	var unk;
	var unk4;
...
int func_383(int iParam0, int iParam1) // Position - 0xEEC8 Signature - 22 02 0B
{
	int num;
	var unk;
	int num2;
...
BOOL func_384(int iParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xEF0D Signature - 22 04 0C 00 00 1D
{
	float num;
	float num2;
	Player player;
...
int func_385(int iParam0) // Position - 0xF00D Signature - 22 01 04 00 00 66 00 39 DC
{
	int i;
...
BOOL func_386(int iParam0) // Position - 0xF045 Signature - 22 01 03 00 00 66 00 3C 04 00 EC
{
	switch (iParam0)
	{
...
BOOL func_387(Player plParam0) // Position - 0xF072 Signature - 22 01 15
{
	var memberHandles;
	int i;
	int gangMembers;
...
BOOL func_388(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xF0F9 Signature - 22 06 0C
{
	var unk;
	var unk3;
...
Hash func_389(int iParam0, int iParam1) // Position - 0xF1A0 Signature - 22 02 05 00 00 66 00 08 15 04 00 2F 50 02 01 66 00 66 01 39 3F BB 00 67 04 66 04 5D F6 FF 12 18 36 02 63
{
	int num;
...
BOOL func_390(int iParam0, var uParam1, Any* panParam2) // Position - 0xF1C9 Signature - 22 03 05 00 00 5D F8 89 11 27 07 66 02 32 37 A7
{
	*panParam2 = Global_1149432.f_7;
...
void func_391(Any* panParam0, int iParam1, var uParam2) // Position - 0xF1FD Signature - 22 03 06 00 00 66 01 66 02
{
	var unk;
...
int func_392(int iParam0) // Position - 0xF277 Signature - 22 01 03 00 00 66 00 39 BD BA 00 05 8B 04 00 2F 50 01 01 66 00 5D
{
	if (!func_254(iParam0))
		return 0;
...
Vector3 func_393(int iParam0) // Position - 0xF299 Signature - 22 01 08 00 00 66
{
	float num;
	int value;
	int value2;
...
struct<2> func_394(int iParam0) // Position - 0xF2F5 Signature - 22 01 05 00 00 66 00 3C
{
	var unk;
...
int func_395(int iParam0) // Position - 0xF35D Signature - 22 01 03 00 00 66 00 2F 03
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_396(int iParam0) // Position - 0xF36F Signature - 22 01 03 00 00 66 00 4D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_397(int iParam0) // Position - 0xF381 Signature - 22 01 03 00 00 66 00 6D 0C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_398(int iParam0) // Position - 0xF394 Signature - 22 01 03 00 00 66 00 6D 1A
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_399(int iParam0) // Position - 0xF3B9 Signature - 22 01 03 00 00 66 00 6D 16
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_400(int iParam0) // Position - 0xF3CC Signature - 22 01 03 00 00 66 00 6D 11
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_401(int iParam0, int iParam1) // Position - 0xF3DF Signature - 22 02 04 00 00 66 01 2F
{
	if (iParam1 < 0)
		iParam1 = 0;
...
BOOL func_402(int iParam0) // Position - 0xF479 Signature - 22 01 03 00 00 66 00 3C 06 00 B2
{
	switch (iParam0)
	{
...
BOOL func_403(int iParam0) // Position - 0xF4B2 Signature - 22 01 03 00 00 66 00 3C 03 00 A3
{
	switch (iParam0)
	{
		case -1086711901:
...
BOOL func_404(int iParam0) // Position - 0xF4DC Signature - 22 01 03 00 00 66 00 3C 03 00 76
{
	switch (iParam0)
	{
		case -2096602762:
...
BOOL func_405(int iParam0, int iParam1, Player plParam2) // Position - 0xF506 Signature - 22 03 05 00 00 66 02 6D
{
	if (plParam2 == 255)
...
int func_406(int iParam0) // Position - 0xF53B Signature - 22 01 09 00 00 2F 67 03 4B
{
	int numChildren;
	Any any;
...
BOOL func_407(int iParam0, int iParam1, int iParam2) // Position - 0xF575 Signature - 22 03 06 00 00 66 00 08
{
	int num;
...
BOOL func_408(int iParam0, int iParam1, BOOL bParam2) // Position - 0xF5A4 Signature - 22 03 0A 00 00 2F
{
	int i;
	var unk;
	float num;
...
float func_409(int iParam0, int iParam1) // Position - 0xF60B Signature - 22 02 0A 00 00 5D 67 04 1D 80 AB
{
	var unk;
	var unk2;
...
BOOL func_410(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0xF648 Signature - 22 04 08 00 00 2F
{
	int i;
	Player player;
...
BOOL func_411(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0xF695 Signature - 22 05 08 00 00 66 04
{
	int num;
...
int func_412(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL* pbParam6, BOOL bParam7) // Position - 0xF6B8 Signature - 22 08 0A 00 00 66 05 4B 00 6C 02 66 06 4B 00 03 09 00 47
{
	uParam0.f_2 = iParam5;
...
int func_413(int iParam0) // Position - 0xF6DE Signature - 22 01 03 00 00 66 00 3C 03 00 9C
{
	switch (iParam0)
	{
...
BOOL func_414(int iParam0) // Position - 0xF716 Signature - 22 01 03 00 00 66 00 42 39 FD
{
	return func_426(iParam0, 4);
}

BOOL func_415(int iParam0) // Position - 0xF725 Signature - 22 01 04 00 00 03 01 00 21 67 03 66 00 5D 6B 88 11 80 02 63 2B 27 0B
{
	int frameCount;
...
float func_416(int iParam0) // Position - 0xF761 Signature - 22 01 03 00 00 66 00 3C 03 00 00
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_417(int iParam0) // Position - 0xF7A0 Signature - 22 01 04 00 00 03 01 00 21 67 03 66 00 5D 6B 88 11 80 02 63 2B 27 09
{
	int frameCount;
...
BOOL func_418(int iParam0) // Position - 0xF7DC Signature - 22 01 04 00 00 66 00 39 44
{
	int num;
...
BOOL func_419(int iParam0) // Position - 0xF814 Signature - 22 01 03 00 00 66 00 5D 8B
{
	return Global_1225099[iParam0 /*28*/] == -1;
}

BOOL func_420(int iParam0, Player plParam1) // Position - 0xF826 Signature - 22 02 04 00 00 66 01 6D FF 15 0E
{
	if (plParam1 == 255)
...
struct<2> func_421() // Position - 0xF852 Signature - 22 00 02 00 00 11
{
	return Global_1051268;
}

var func_422(BOOL bParam0, var uParam1, var uParam2) // Position - 0xF860 Signature - 22 03 05 00 00 66 00 8B
{
	if (bParam0)
		return uParam1;
...
BOOL func_423(int iParam0) // Position - 0xF877 Signature - 22 01 03 00 00 66 00 2F 7E
{
	return iParam0 >= 0 && iParam0 <= 12;
}

float func_424(int iParam0, int iParam1, int iParam2) // Position - 0xF88D Signature - 22 03 0B 00 00 5D
{
	var unk;
	var unk2;
...
int func_425(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float* pfParam6, BOOL bParam7) // Position - 0xF8D7 Signature - 22 08 0A 00 00 66 05 4B 00 6C 02 66 06 4B 00 03 09 00 36
{
	uParam0.f_2 = iParam5;
...
BOOL func_426(int iParam0, int iParam1) // Position - 0xF8FD Signature - 22 02 05 00 00 2F
{
	int i;
...
int func_427(int iParam0) // Position - 0xF944 Signature - 22 01 03 00 00 66 00 3C 16
{
	switch (iParam0)
	{
		case -2096602762:
...
BOOL func_428(int iParam0) // Position - 0xF9E2 Signature - 22 01 03 00 00 5D 17 00 18 27 0E 08 15 04 00 2F 50 01 01 5D
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_429() // Position - 0xFA03 Signature - 22 00 02 00 00 2F 39
{
	return func_430(func_70(0));
}

BOOL func_430(var uParam0, var uParam1) // Position - 0xFA14 Signature - 22 02 04 00 00 11 4B
{
	return func_431(uParam0, 1, 4);
}

BOOL func_431(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0xFA26 Signature - 22 04 07 00 00 11
{
	int num;
...
int func_432(int iParam0, var uParam1) // Position - 0xFA61 Signature - 22 02 04 00 00 66 00 11
{
	if (iParam0 == 2)
