...
void func_1() // Position - 0xAB Signature - 22 00 02 00 00 03
{
...
void func_2() // Position - 0xE4 Signature - 22 00 08
{
	Vector3 vector;
	Vector3 vector2;
...
void func_3() // Position - 0x12C Signature - 22 00 02 00 00 6D
{
...
int func_4() // Position - 0x72D Signature - 22 00 02 00 00 5D
{
	return Global_1572887.f_14;
}

void func_5() // Position - 0x73B Signature - 22 00 02 00 00 37 91
{
...
BOOL func_6(BOOL bParam0, BOOL bParam1) // Position - 0x757 Signature - 22 02 05
{
	int i;
...
void func_7() // Position - 0x837 Signature - 22 00 03 00 00 03
{
	PersChar persChar;
...
void func_8() // Position - 0x8C0 Signature - 22 00 02 00 00 37 42
{
	FLOCK::_0xFB16F08F47B83B4C(joaat("SPECIES_BIRD_CROW"));
	return;
}

void func_9(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x8D1 Signature - 22 03 05 00 00 66 00 03 05 00 18 05 8B 03 00 50 03 00 66 00 66 01 25 00 10 30 6D 40
{
...
void func_10(Volume volParam0) // Position - 0x950 Signature - 22 01 03 00 00 66 00 03
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
BOOL func_11() // Position - 0x991 Signature - 22 00 02 00 00 2F
{
	return false;
}

void func_12(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x99A Signature - 22 03 05 00 00 66 00 03 05 00 18 05 8B 03 00 50 03 00 66 00 66 01 25 00 10 30 6D 80
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_13(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xA10 Signature - 22 03 05 00 00 66 00 03 05 00 18 05 8B 03 00 50 03 00 66 00 66 01 6D
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_14(Hash hParam0, int iParam1) // Position - 0xA86 Signature - 22 02 04 00 00 66 00 09
{
	func_19(hParam0, true, 0, false, false, 0, false, false);
	return;
}

BOOL func_15(int iParam0) // Position - 0xA9B Signature - 22 01 06 00 00 66 00 09 39 20 0C 00 67 03 66 03 6D 1F 59 67 04 66 03 6D 1F 47 67 05 66 04 39
{
	int num;
	int num2;
	int offset;
...
void func_16(int iParam0) // Position - 0xB1A Signature - 22 01 06 00 00 66 00 09 39 20 0C 00 67 03 66 03 6D 1F 59 67 04 66 03 6D 1F 47 67 05 66 04 87 26 00 80 76 63 01 66 05 03 08 00 21
{
	int num;
	int num2;
	int offset;
...
void func_17(int iParam0) // Position - 0xB4D Signature - 22 01 06 00 00 66 00 09 39 20 0C 00 67 03 66 03 6D 1F 59 67 04 66 03 6D 1F 47 67 05 66 04 87 26 00 80 76 63 01 66 05 03 08 00 06
{
	int num;
	int num2;
	int offset;
...
void func_18(var uParam0, int iParam1) // Position - 0xB80 Signature - 22 02 04 00 00 66 00 76
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_19(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0xB95 Signature - 22 08
{
...
int func_20(int iParam0, int iParam1) // Position - 0xC20 Signature - 22 02 04 00 00 66 00 3C
{
	switch (iParam0)
	{
...
BOOL func_21(int iParam0) // Position - 0x24C5 Signature - 22 01 04 00
{
	int num;
...
BOOL func_22(int iParam0) // Position - 0x24E2 Signature - 22 01 03 00 00 66 00 37
{
...
Hash func_23(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x24F9 Signature - 22 03 05 00 00 66 00 03 05 00 11
{
...
BOOL func_24(Hash hParam0) // Position - 0x259D Signature - 22 01 03 00 00 66 00 39 93
{
	if (func_31(hParam0))
...
void func_25(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x25B8 Signature - 22 04
{
	if (func_24(hParam0))
	{
...
void func_26(Hash hParam0, BOOL bParam1) // Position - 0x25F0 Signature - 22 02 04 00 00 66 00 39 9D 25 00 8B 1D 00 66 00 03 05 00 0B 11
{
	if (func_24(hParam0))
...
void func_27(Hash hParam0, BOOL bParam1) // Position - 0x261E Signature - 22 02 04 00 00 66 00 39 9D 25 00 8B 1D 00 66 00 03 05 00 0B 09
{
	if (func_24(hParam0))
...
void func_28(Hash hParam0, BOOL bParam1) // Position - 0x264C Signature - 22 02 04 00 00 66 00 39 9D 25 00 8B 1D 00 66 00 03 05 00 0B 2F
{
	if (func_24(hParam0))
...
BOOL func_29() // Position - 0x267A Signature - 22 00 02 00 00 09
{
	return true;
}

int func_30(int iParam0) // Position - 0x2683 Signature - 22 01 03 00 00 66 00 39 9F
{
	return func_32(iParam0) + 30;
}

BOOL func_31(Hash hParam0) // Position - 0x2693 Signature - 22 01 03 00 00 66 00 2F
{
	return hParam0 != 0;
}

int func_32(int iParam0) // Position - 0x269F Signature - 22 01 03 00 00 66 00 14
{
	return iParam0 * 31;
}
