...
void func_1(int iParam0) // Position - 0x3D Signature - 22 01 03 00 00 6D
{
	func_7(32, iParam0);
	func_8();
...
void func_2(var uParam0) // Position - 0x78 Signature - 22 01 04
{
	Entity entity;
...
BOOL func_3() // Position - 0xE5 Signature - 22 00 02 00 00 2F
{
...
BOOL func_4() // Position - 0x15E Signature - 22 00 02 00 00 54 00
{
	switch (iLocal_0)
	{
		case 0:
...
void func_5() // Position - 0x196 Signature - 22 00 02 00 00 50
{
	return;
}

void func_6() // Position - 0x19E Signature - 22 00 02 00 00 03 00
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_7(int iParam0, int iParam1) // Position - 0x1AA Signature - 22 02 04 00 00 03 01 00 32
{
...
int func_8() // Position - 0x1C7 Signature - 22 00 05 00 00 03
{
	int scriptStatus;
	int gameTimer;
	int timeoutTime;
...
int func_9(int iParam0, int iParam1, char* sParam2) // Position - 0x2D8 Signature - 22 03 05
{
	return 1;
}

void func_10(BOOL bParam0) // Position - 0x2E1 Signature - 22 01 0D
{
	int num;
	var unk;
	int num2;
...
void func_11(int iParam0) // Position - 0x3AA Signature - 22 01 03 00 00 54
{
	if (iLocal_0 != iParam0)
		iLocal_0 = iParam0;
...
void func_12(var uParam0, BOOL bParam1) // Position - 0x3BD Signature - 22 02 04 00 00 66 01
{
...
BOOL func_13(BOOL bParam0, BOOL bParam1) // Position - 0x3DD Signature - 22 02 05
{
	int i;
...
BOOL func_14(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x4BD Signature - 22 04 06 00 00 5D
{
...
void func_15() // Position - 0x5E6 Signature - 22 00 02 00 00 39 DE
{
	if (func_26())
	{
		func_11(1);
...
void func_16() // Position - 0x667 Signature - 22 00 02 00 00 03 01
{
...
int func_17() // Position - 0x69F Signature - 22 00 02 00 00 5D 17
{
	return Global_1572887.f_14;
}

BOOL func_18() // Position - 0x6AD Signature - 22 00 02 00 00 5D FD
{
	return Global_1051645.f_8;
}

BOOL func_19(var uParam0) // Position - 0x6BB Signature - 22 01 03 00 00 66 00 76 09
{
	return func_29(*uParam0, 1);
}

void func_20(var uParam0) // Position - 0x6CB Signature - 22 01 03 00 00 66 00 2F
{
	func_30(uParam0, 0);
	return;
}

BOOL func_21(var uParam0, var uParam1) // Position - 0x6DA Signature - 22 02 04 00 00 66 00 39 D6
{
	if (!func_31(uParam0))
		return false;
...
BOOL func_22(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x70E Signature - 22 04 06 00 00 66
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

BOOL func_23(int iParam0) // Position - 0x729 Signature - 22 01 03 00 00 5D
{
...
BOOL func_24(int iParam0, int iParam1) // Position - 0x74A Signature - 22 02 04 00 00 5D
{
...
BOOL func_25() // Position - 0x786 Signature - 22 00 02 00 00 85
{
	if (Global_1048576)
		return true;
...
BOOL func_26() // Position - 0x7DE Signature - 22 00 23
{
	int i;
	struct<32> eventData;
...
void func_27() // Position - 0x8B7 Signature - 22 00 02 00 00 54 0E
{
...
void func_28(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x94A Signature - 22 03 0E
{
	var unk;
	var value;
	int i;
...
BOOL func_29(int iParam0, int iParam1) // Position - 0xA8B Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 04 00 00 03
{
	return iParam0 && iParam1 != false;
}

void func_30(var uParam0, int iParam1) // Position - 0xA9A Signature - 22 02 04 00 00 03 01 00 31
{
...
BOOL func_31(int iParam0) // Position - 0xAD6 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21
{
	switch (iParam0)
	{
		case 2:
...
int func_32(int iParam0) // Position - 0xB15 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 2E
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_33(int iParam0, int iParam1) // Position - 0xBAB Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 04 00 00 66
{
	return iParam0 && iParam1 != false;
}

BOOL func_34(var uParam0, int iParam1) // Position - 0xBBA Signature - 22 02 04 00 00 66 00 39 BB
{
	if (!func_19(uParam0))
		return false;
...
BOOL func_35() // Position - 0xBE0 Signature - 22 00 05 00 00 2F
{
	int i;
	Player player;
	Ped playerPed;
...
BOOL func_36(Ped pedParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0xC61 Signature - 22 08
{
	char* str;
...
void func_37(var uParam0, int iParam1) // Position - 0xCA8 Signature - 22 02 04 00 00 66 00 66 01 39
{
	func_45(uParam0, iParam1);
	return;
}

BOOL func_38() // Position - 0xCB8 Signature - 22 00 02 00 00 39 9F
{
	if (func_17() != 0)
		return true;
...
int func_39(int iParam0, int iParam1) // Position - 0xD10 Signature - 22 02 04 00 00 66 00 3C
{
	switch (iParam0)
	{
		case -2086327823:
...
void func_40(Any* panParam0, var uParam1) // Position - 0x11B7 Signature - 22 02 04 00 00 4B
{
...
void func_41(var uParam0, int iParam1) // Position - 0x11EE Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 02
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_42(var uParam0, int iParam1) // Position - 0x11FF Signature - 22 02 04 00 00 66 00 76 66 00
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_43(var uParam0) // Position - 0x1214 Signature - 22 01 03 00 00 66 00 39
{
	if (!func_19(uParam0))
		return 0;
...
BOOL func_44(Ped pedParam0, Any* panParam1) // Position - 0x1245 Signature - 22 02 04 00 00 66 00 66 01 03
{
	return AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, panParam1);
}

void func_45(var uParam0, int iParam1) // Position - 0x1255 Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_46(var uParam0) // Position - 0x1266 Signature - 22 01 03 00 00 66 00 76 11
{
	return func_29(*uParam0, 2);
}

int func_47(int iParam0) // Position - 0x1276 Signature - 22 01 03 00 00 66 00 03
{
