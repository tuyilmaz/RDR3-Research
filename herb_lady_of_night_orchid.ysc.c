...
void func_1(var uParam0) // Position - 0x7B0 Signature - 22 01 03 00 00 66 00 6D 16 39
{
	func_50(uParam0, 22);
	return;
}
...
int func_124(int iParam0) // Position - 0x4715 Signature - 22 01 03 00 00 66 00 6D 16 03
{
