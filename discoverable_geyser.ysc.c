...
void func_1() // Position - 0x6F Signature - 22 00 02 00 00 39 D1
{
	func_5();
...
BOOL func_2() // Position - 0x86 Signature - 22 00 02 00 00 03
{
...
BOOL func_3(var uParam0) // Position - 0x9A Signature - 22 01 04 00 00 54
{
...
void func_4() // Position - 0xBF Signature - 22 00 08
{
	int i;
	int num;
	int j;
...
void func_5() // Position - 0x2D1 Signature - 22 00 04
{
	int i;
	int j;
...
int func_6(Hash hParam0) // Position - 0x316 Signature - 22 01 03 00 00 66 00 3C 01
{
	switch (hParam0)
	{
...
BOOL func_7(int iParam0) // Position - 0x335 Signature - 22 01 03 00 00 66 00 3C 03 00 00 00 00 00 0F 00 01 00 00 00 10
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_8(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x36D Signature - 22 04
{
...
BOOL func_9() // Position - 0x3A3 Signature - 22 00 02 00 00 39 28
{
	if (func_19())
		return false;
...
void func_10(int iParam0) // Position - 0x3C1 Signature - 22 01 03 00 00 66 00 5D
{
	Global_1956875.f_1431 = iParam0;
	return;
}

BOOL func_11(var uParam0, int iParam1) // Position - 0x3D2 Signature - 22 02 04 00 00 66 00
{
	if (*uParam0 != iParam1)
	{
		*uParam0 = iParam1;
...
struct<11> func_12(int iParam0, int iParam1) // Position - 0x3EC Signature - 22 02 0F
{
	var unk;
...
BOOL func_13(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x938 Signature - 22 0C
{
...
Vector3 func_14(int iParam0) // Position - 0x97A Signature - 22 01 03 00 00 66 00 3C 03 00 00 00 00 00 0F 00 01 00 00 00 1E
{
	switch (iParam0)
	{
		case 0:
...
int func_15(int iParam0) // Position - 0x9DE Signature - 22 01 03 00 00 66 00 39 4D
{
	if (func_20(iParam0))
		return 3;
...
void func_16(int iParam0, int iParam1) // Position - 0xA1B Signature - 22 02 04 00 00 66 01
{
	switch (iParam1)
	{
		case 3:
...
void func_17(int iParam0) // Position - 0xC51 Signature - 22 01 0C
{
	Vector3 vector;
	var entityCoords;
	var unk5;
...
void func_18(var uParam0) // Position - 0xD0F Signature - 22 01 03 00 00 66 00 76
{
	if (VOLUME::DOES_VOLUME_EXIST(*uParam0))
...
BOOL func_19() // Position - 0xD28 Signature - 22 00 02 00 00 5D
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

BOOL func_20(int iParam0) // Position - 0xD4D Signature - 22 01 04 00 00 89 0D 27 20 66 00 39 96 0E 00 47 67 03 66 03 2F
{
	int num;
...
BOOL func_21(int iParam0) // Position - 0xD7C Signature - 22 01 04 00 00 89 0D 27 20 66 00 39 96 0E 00 47 67 03 66 03 66 00 39 B9 0E 00 7E
{
	int num;
...
BOOL func_22(int iParam0) // Position - 0xDB7 Signature - 22 01 04 00 00 89 0D 27 20 66 00 39 96 0E 00 47 67 03 66 03 66 00 39 B9 0E 00 66 00 39 EB 0E 00 43 7E
{
	int num;
...
BOOL func_23(int iParam0) // Position - 0xE00 Signature - 22 01 04 00 00 89 0D 27 20 66 00 39 96 0E 00 47 67 03 66 03 66 00 39 B9 0E 00 66 00 39 EB 0E 00 43 66
{
	int num;
...
Vector3 func_24(float fParam0, var uParam1, var uParam2) // Position - 0xE57 Signature - 22 03
{
	float num;
	float num2;
...
int func_25(int iParam0) // Position - 0xE96 Signature - 22 01 03 00 00 66 00 39 B9
{
	return func_26(iParam0) + func_27(iParam0) + func_28(iParam0) + func_29(iParam0);
}

int func_26(int iParam0) // Position - 0xEB9 Signature - 22 01 03 00 00 66 00 3C 03 00 00 00 00 00 0F 00 01 00 00 00 0E 00 02 00 00 00 0D 00 68 0F
{
	switch (iParam0)
	{
		case 0:
...
int func_27(int iParam0) // Position - 0xEEB Signature - 22 01 03 00 00 66 00 3C 03 00 00 00 00 00 0F 00 01 00 00 00 0E 00 02 00 00 00 0D 00 68 0E
{
	switch (iParam0)
	{
		case 0:
...
int func_28(int iParam0) // Position - 0xF1C Signature - 22 01 03 00 00 66 00 3C 03 00 00 00 00 00 0F 00 01 00 00 00 0D 00 02 00 00 00 0B 00 68 0C 00 42
{
	switch (iParam0)
	{
		case 0:
...
int func_29(int iParam0) // Position - 0xF4B Signature - 22 01 03 00 00 66 00 3C 03 00 00 00 00 00 0F 00 01 00 00 00 0D 00 02 00 00 00 0B 00 68 0C 00 1D
{
	switch (iParam0)
	{
		case 0:
