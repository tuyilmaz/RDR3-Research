...
void func_1(var uParam0) // Position - 0x7B0 Signature - 22 01 03 00 00 66 00 4D 39
{
	func_50(uParam0, 6);
	return;
}
...
int func_126(int iParam0) // Position - 0x473B Signature - 22 01 03 00 00 66 00 4D 03
{
