...
void main() // Position - 0x0 Signature - 22 00 02 00 00 03 00
{
...
void func_1() // Position - 0xA2 Signature - 22 00 02 00 00 6D
{
	func_4(68);
	func_5();
...
void func_2() // Position - 0xCC Signature - 22 00 02 00 00 42
{
	func_4(4);
	func_5();
	func_7(2);
...
BOOL func_3() // Position - 0xF5 Signature - 22 00 02 00 00 03 01
{
...
void func_4(int iParam0) // Position - 0x13C Signature - 22 01 03 00 00 5D 00
{
	Global_1572864.f_3 = Global_1572864.f_3 || iParam0;
	return;
}

void func_5() // Position - 0x153 Signature - 22 00 03 00 00 2F 67 02 2F 67 02 66 02 11
{
	int i;
...
void func_6(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x17E Signature - 22 0B
{
...
void func_7(int iParam0) // Position - 0x20B Signature - 22 01 03 00 00 66
{
	if (iParam0 == 0)
		iParam0 = 1;
...
void func_8(int iParam0) // Position - 0x224 Signature - 22 01 03 00 00 5D 17 00 18 18 2C 01 80 01 66 00 39
{
	func_11(&(Global_1572887.f_300.f_1), func_10(iParam0), 3);
	return;
}

void func_9() // Position - 0x241 Signature - 22 00 03 00 00 2F 67 02 2F 67 02 66 02 6D
{
	int i;
...
int func_10(int iParam0) // Position - 0x2D0 Signature - 22 01 04
{
	int num;
...
BOOL func_11(Any* panParam0, int iParam1, int iParam2) // Position - 0x48A Signature - 22 03 08
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_12(int iParam0) // Position - 0x4BD Signature - 22 01 03 00 00 5D 17 00 18 18 2C 01 80 01 66 00 1D
{
	return func_13(&(Global_1572887.f_300.f_1), iParam0, 3);
}

BOOL func_13(Any* panParam0, int iParam1, int iParam2) // Position - 0x4D5 Signature - 22 03 07
{
