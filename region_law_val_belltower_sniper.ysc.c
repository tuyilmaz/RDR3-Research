...
void func_1() // Position - 0x60 Signature - 22 00 02 00 00 54 2D
{
...
void func_2() // Position - 0x91 Signature - 22 00 02 00 00 86
{
...
int func_3(var uParam0) // Position - 0xCC Signature - 22 01 03 00 00 2F
{
	return 0;
}

int func_4() // Position - 0xD5 Signature - 22 00 03 00 00 54 2C
{
	float num;
...
void func_5() // Position - 0x118 Signature - 22 00 02 00 00 54 2C
{
	switch (iLocal_44)
	{
		case 1:
...
BOOL func_6(Ped pedParam0, int iParam1) // Position - 0x19D Signature - 22 02 05
{
	int num;
...
void func_7(Ped* ppedParam0) // Position - 0x29C Signature - 22 01 03 00 00 66 00 76 03
{
...
int func_8(int iParam0) // Position - 0x2FB Signature - 22 01 04
{
	int num;
...
float func_9(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x34D Signature - 22 05
{
...
float func_10(var uParam0) // Position - 0x375 Signature - 22 01 03 00 00 66 00 39
{
	if (!func_15(uParam0))
		return 0f;
...
void func_11() // Position - 0x3A7 Signature - 22 00 03 00 00 54 2F
{
	int value;
...
void func_12(var uParam0) // Position - 0x424 Signature - 22 01 03 00 00 66 00 73
{
	func_20(uParam0, 0f);
	return;
}

void func_13(Ped pedParam0, eControlAction ecaParam1) // Position - 0x433 Signature - 22 02 04 00 00 66 00 03 05 00 1B
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
BOOL func_14(int iParam0, int iParam1) // Position - 0x47A Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01
{
	return iParam0 && iParam1 != false;
}

BOOL func_15(var uParam0) // Position - 0x489 Signature - 22 01 03 00 00 66 00 76 09
{
	return func_21(*uParam0, 1);
}

BOOL func_16(var uParam0) // Position - 0x499 Signature - 22 01 03 00 00 66 00 76 11
{
	return func_21(*uParam0, 2);
}

float func_17() // Position - 0x4A9 Signature - 22 00 03 00 00 03
{
...
Ped func_18(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x4DB Signature - 22 0D
{
	Ped ped;
...
void func_19(Ped pedParam0) // Position - 0x51B Signature - 22 01 03 00 00 66 00 2F
{
...
void func_20(var uParam0, float fParam1) // Position - 0x549 Signature - 22 02 04 00 00 39
{
...
BOOL func_21(int iParam0, int iParam1) // Position - 0x56F Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 08
{
	return iParam0 && iParam1 != false;
}

void func_22(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x57E Signature - 22 08
{
	BOOL flag;
...
void func_23(Ped pedParam0) // Position - 0x648 Signature - 22 01 03 00 00 66 00 11
{
...
void func_24(var uParam0, int iParam1) // Position - 0x6D1 Signature - 22 02 04 00 00 66 00 76 66 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_25(var uParam0, int iParam1) // Position - 0x6E2 Signature - 22 02 04 00 00 66 00 76 66 00
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_26(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6F7 Signature - 22 03
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_27(Ped pedParam0, BOOL bParam1) // Position - 0x73C Signature - 22 02 04 00 00 66 00 03 05 00 34
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_28(Ped pedParam0, int iParam1) // Position - 0x781 Signature - 22 02 04 00 00 66 01
{
	if (iParam1 == 1)
