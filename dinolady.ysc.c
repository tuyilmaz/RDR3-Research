...
void func_76(int iParam0) // Position - 0x228A Signature - 22 01 03 00 00 50 01 00 22 01
{
	return;
}

void func_77(int iParam0) // Position - 0x2292 Signature - 22 01 04 00 00 2F 67 03 66 03 1D
{
	int i;
...
void func_78(int iParam0) // Position - 0x22C3 Signature - 22 01 04 00 00 2F 67 03 66 03 6D 28 8A 21
{
	int i;
...
BOOL func_79(int iParam0, BOOL bParam1) // Position - 0x22F6 Signature - 22 02 07
{
	int num;
	int num2;
	int num3;
...
BOOL func_80(int iParam0) // Position - 0x23AC Signature - 22 01 04 00 00 2F 67 03 66 03 6D 28 8A 67
{
	int i;
...
BOOL func_81(int iParam0, BOOL bParam1) // Position - 0x2426 Signature - 22 02 04 00 00 5D 17 00 18 27 0E 08 15 0F
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_82(int iParam0) // Position - 0x2457 Signature - 22 01 03 00 00 66 00 39 F1 0F 00 05 8B 04 00 2F 50 01 01 66 00 37
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_83(int iParam0) // Position - 0x2478 Signature - 22 01 03 00 00 66 00 39 F1 0F 00 05 8B 04 00 2F 50 01 01 66 00 3C
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_84(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x24CB Signature - 22 05 08
{
	BOOL flag;
...
BOOL func_85(int iParam0) // Position - 0x2B8B Signature - 22 01 03 00 00 66 00 08 20 6A 8B 07
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_86(int iParam0) // Position - 0x2BA2 Signature - 22 01 03 00 00 66 00 3C 05
{
	switch (iParam0)
	{
		case 64:
...
int func_87(int iParam0, BOOL bParam1) // Position - 0x2BE5 Signature - 22 02 04 00 00 66 00 39 8B 2B 00 05 8B 04 00 2F 50 02 01 66 00 11 39 F4 3E 00 05 8B 04 00 2F 50 02 01 66 00 6D
{
	if (!func_85(iParam0))
		return 0;
...
BOOL func_88(int iParam0) // Position - 0x2CD0 Signature - 22 01 03 00 00 66 00 08 20 6A 8B 06 00 66 00 6D 10
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_89(int iParam0) // Position - 0x2CE6 Signature - 22 01 03 00 00 66 00 6D 16
{
...
BOOL func_90() // Position - 0x2D1B Signature - 22 00 02 00 00 70
{
	if (Global_13)
		return false;
...
const char* func_91(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x2D5E Signature - 22 07 0A
{
	const char* str;
...
BOOL func_92(int iParam0) // Position - 0x37BD Signature - 22 01 03 00 00 66 00 08 20 6A 8B 05
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_93(int iParam0) // Position - 0x37D2 Signature - 22 01 03 00 00 66 00 3C 11
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0) // Position - 0x388D Signature - 22 01 08
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_95(int iParam0) // Position - 0x38FB Signature - 22 01 03 00 00 66 00 3C 21
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_96(int iParam0) // Position - 0x3A56 Signature - 22 01 03 00 00 66 00 3C 03 00 00
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_97(int iParam0, int iParam1) // Position - 0x3A91 Signature - 22 02 04 00 00 66 00 39 B7
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_98(int iParam0, int iParam1) // Position - 0x3AD3 Signature - 22 02 04 00 00 66 00 39 BD
{
	if (!func_92(iParam0))
		return false;
...
int func_99() // Position - 0x3B18 Signature - 22 00 02 00 00 85 E9
{
	return Global_1902569;
}

int func_100(int iParam0) // Position - 0x3B24 Signature - 22 01 03 00 00 66 00 6D 0C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_101(int iParam0) // Position - 0x3B37 Signature - 22 01 03 00 00 66 00 4D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_102(float fParam0) // Position - 0x3B49 Signature - 22 01 03 00 00 66 00 86
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_103(var uParam0, int iParam1) // Position - 0x3B5F Signature - 22 02 04 00 00 66 01
{
...
int func_104(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3B95 Signature - 22 08 1B
{
	int duration;
	var data;
	int num;
...
BOOL func_105(int iParam0) // Position - 0x3BD8 Signature - 22 01 03 00 00 66 00 39 AB
{
	if (func_129(iParam0))
		if (!func_130(44))
			return false;
...
void func_106(int iParam0, int iParam1) // Position - 0x3BF8 Signature - 22 02 04 00 00 66 00 76 66 01
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_107(int iParam0, int iParam1) // Position - 0x3C09 Signature - 22 02 06
{
	int num;
...
void func_108(var uParam0, var uParam1, int iParam2) // Position - 0x3C1F Signature - 22 03 05 00 00 4B
{
...
void func_109(int iParam0) // Position - 0x3C3C Signature - 22 01 03 00 00 66 00 5D F7
{
...
void func_110(int iParam0) // Position - 0x3D1C Signature - 22 01 05 00 00 66 00 5D
{
	int i;
	int num;
...
BOOL func_111(int iParam0, BOOL bParam1) // Position - 0x3EF4 Signature - 22 02 04 00 00 39 00 0D 00 08 72 04
{
	if (func_45() != -1)
		return false;
...
int func_112(int iParam0, BOOL bParam1) // Position - 0x3F22 Signature - 22 02 04 00 00 66 00 39 8B 2B 00 05 8B 04 00 2F 50 02 01 66 00 11 39 F4 3E 00 05 8B 04 00 2F 50 02 01 66 00 39
{
	if (!func_85(iParam0))
		return 0;
...
int func_113(int iParam0) // Position - 0x3FA5 Signature - 22 01 03 00 00 66 00 3C 03 00 1B
{
	switch (iParam0)
	{
		case 27:
...
int func_114(int iParam0) // Position - 0x3FCC Signature - 22 01 03 00 00 66 00 3C 02
{
	switch (iParam0)
	{
		case 33:
...
void func_115() // Position - 0x3FED Signature - 22 00 04
{
	int i;
	var unk;
...
void func_116() // Position - 0x41B6 Signature - 22 00 03 00 00 2F 67 02 66 02 42
{
	int i;
...
void func_117(int iParam0, BOOL bParam1) // Position - 0x4231 Signature - 22 02 08 00 00 66
{
	BOOL flag;
...
Hash func_118(int iParam0) // Position - 0x45E0 Signature - 22 01 03 00 00 66 00 39 8B 2B 00 05 8B 04 00 2F 50 01 01 66 00 5D A7 E5 1C 17
{
	if (!func_85(iParam0))
		return 0;
...
void func_119(int iParam0, PersChar pchParam1) // Position - 0x45FE Signature - 22 02 04 00 00 66 00 39 8B 2B 00 05 8B 03
{
	if (!func_85(iParam0))
		return;
...
PersChar func_120(int iParam0) // Position - 0x461F Signature - 22 01 03 00 00 66 00 39 8B 2B 00 05 8B 04 00 2F 50 01 01 66 00 5D A7 E5 1C 63 03 27 01
{
	if (!func_85(iParam0))
		return 0;
...
void func_121(int iParam0, BOOL bParam1) // Position - 0x463F Signature - 22 02 04 00 00 39 00 0D 00 08 72 03 00 50 02 00 66 00 39 8B 2B 00 05 8B 03 00 50 02 00 66 00 87 AB 26 17 02 66 00
{
	if (func_45() != -1)
		return;
...
BOOL func_122(int iParam0) // Position - 0x4678 Signature - 22 01 03 00 00 66 00 39 8B 2B 00 05 8B 04 00 2F 50 01 01 66 00 11
{
	if (!func_85(iParam0))
		return false;
...
BOOL func_123() // Position - 0x469E Signature - 22 00 02 00 00 2F
{
	return false;
}

BOOL func_124() // Position - 0x46A7 Signature - 22 00 06 00 00 39
{
	var unk;
	var unk3;
...
BOOL func_125(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x470F Signature - 22 03 05 00 00 5D
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_126(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4885 Signature - 22 08 0A
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_127(var uParam0, var uParam1, var uParam2) // Position - 0x4899 Signature - 22 03 06
{
	int i;
...
const char* func_128(int iParam0) // Position - 0x48C7 Signature - 22 01 03 00 00 66 00 3C 32
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_129(int iParam0) // Position - 0x4BAB Signature - 22 01 03 00 00 66 00 3C 03 00 16
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_130(int iParam0) // Position - 0x4BD5 Signature - 22 01 03 00 00 66 00 39 1D
{
	if (!func_161(iParam0))
		return false;
...
struct<2> func_131(Player plParam0) // Position - 0x4BF1 Signature - 22 01 05 00 00 66 00 4B
{
	var gamerHandle;
...
const char* func_132(const char* sParam0, int iParam1) // Position - 0x4C05 Signature - 22 02 04 00 00 6D 2A
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_133(int iParam0, BOOL bParam1) // Position - 0x4C1F Signature - 22 02 05 00 00 66
{
	char* ambientZone;
...
void func_134(int iParam0, BOOL bParam1) // Position - 0x4C53 Signature - 22 02 04 00 00 66 00 3C 01
{
	switch (iParam0)
	{
		case 5:
...
void func_135(int iParam0, int iParam1) // Position - 0x4C88 Signature - 22 02 04 00 00 66 00 5D F7
{
	func_163(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_136(int iParam0) // Position - 0x4CA2 Signature - 22 01 03 00 00 66 00 39 8B 2B 00 05 8B 04 00 2F 50 01 01 66 00 5D A7 E5 1C 63 03 27 02 03 01
{
	if (!func_85(iParam0))
		return false;
...
void func_137(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4CC7 Signature - 22 05 09
{
	PersChar persChar;
...
void func_138(int iParam0, BOOL bParam1) // Position - 0x4DB3 Signature - 22 02 04 00 00 66 00 39 9F 52 00 05 8B 03 00 50 02 00 66 01
{
	if (!func_166(iParam0))
		return;
...
void func_139(int iParam0, int iParam1) // Position - 0x4E09 Signature - 22 02 04 00 00 66 00 39 55
{
	if (!func_171(iParam0))
		return;
...
int func_140(int iParam0) // Position - 0x4E7C Signature - 22 01 03 00 00 66 00 5D 08 3B 1D 80
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_141(Hash hParam0) // Position - 0x4E92 Signature - 22 01 03 00 00 66 00 39 6B
{
...
void func_142(int iParam0) // Position - 0x4EB2 Signature - 22 01 03 00 00 2F 66 00 5D 08
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_143(int iParam0, BOOL bParam1) // Position - 0x4EC8 Signature - 22 02 04 00 00 39 00 0D 00 08 72 03 00 50 02 00 66 00 39 8B 2B 00 05 8B 03 00 50 02 00 66 00 87 AB 26 17 02 66 01
{
	if (func_45() != -1)
		return;
...
void func_144(int iParam0) // Position - 0x4EF9 Signature - 22 01 04 00 00 66 00 39 8B
{
	Ped ped;
...
void func_145(int iParam0) // Position - 0x4F3D Signature - 22 01 03 00 00 2F 66 00 5D B8 0C 10 80 5C 63 4B 6C 31
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_146(int iParam0) // Position - 0x4F52 Signature - 22 01 03 00 00 2F 66 00 5D B8 0C 10 80 5C 63 4B 6C 32
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_147(int iParam0) // Position - 0x4F67 Signature - 22 01 03 00 00 2F 66 00 5D B8 0C 10 80 5C 63 4B 6C 01
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_148(int iParam0) // Position - 0x4F7C Signature - 22 01 06 00 00 5D
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_149(int iParam0) // Position - 0x4FFB Signature - 22 01 03 00 00 66 00 6D 1C
{
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x5058 Signature - 22 02 04 00 00 66 00 5D B8 0C 10 80 5C 63 4B 27 31
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_151(int iParam0, int iParam1) // Position - 0x5071 Signature - 22 02 04 00 00 66 00 5D B8 0C 10 80 5C 63 4B 27 01
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_152(int iParam0, int iParam1) // Position - 0x508A Signature - 22 02 04 00 00 66 00 66 01 39
{
...
int func_153(int iParam0) // Position - 0x50C5 Signature - 22 01 03 00 00 66 00 5D B8
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_154(int iParam0) // Position - 0x50D9 Signature - 22 01 03 00 00 50 01 00 22 02
{
	return;
}

BOOL func_155(int iParam0, int iParam1) // Position - 0x50E1 Signature - 22 02 04 00 00 66 00 08
{
	if (iParam0 == -1)
		return false;
...
BOOL func_156() // Position - 0x5108 Signature - 22 00 02 00 00 85 00
{
	if (Global_1048576)
		return true;
...
struct<2> func_157() // Position - 0x5160 Signature - 22 00 02 00 00 11
{
	return Global_1051268;
}

BOOL func_158(var uParam0, var uParam1) // Position - 0x516E Signature - 22 02 04 00 00 66 00 39 CC
{
	if (!func_176(uParam0))
		return false;
...
struct<2> func_159() // Position - 0x51A2 Signature - 22 00 02 00 00 5D 2C
{
...
BOOL func_160(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x51ED Signature - 22 04 0D
{
	var unk;
	float num;
	float num2;
...
BOOL func_161(int iParam0) // Position - 0x521D Signature - 22 01 03 00 00 66 00 2F 15 04
{
	if (iParam0 == 0)
		return false;
...
BOOL func_162(int iParam0) // Position - 0x5230 Signature - 22 01 06 00 00 66
{
	int num;
	int num2;
	int offset;
...
void func_163(var uParam0, int iParam1) // Position - 0x525A Signature - 22 02 04 00 00 66 00 76 66 00
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_164(int iParam0) // Position - 0x526F Signature - 22 01 03 00 00 66 00 39 8B 2B 00 05 8B 04 00 2F 50 01 01 66 00 5D A7 E5 1C 63 03 27 02 03 05
{
	if (!func_85(iParam0))
		return false;
...
BOOL func_165(Hash hParam0) // Position - 0x5293 Signature - 22 01 03 00 00 66 00 2F 1C 50 01 01 22
{
	return hParam0 != 0;
}

BOOL func_166(int iParam0) // Position - 0x529F Signature - 22 01 03 00 00 66 00 08 20 6A 8B 06 00 66 00 6D B4 35 69 50
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_167(int iParam0, BOOL bParam1) // Position - 0x52B5 Signature - 22 02 04 00 00 66 00 39 9F 52 00 05 8B 04
{
	if (!func_166(iParam0))
		return false;
...
void func_168(int iParam0, BOOL bParam1) // Position - 0x52DB Signature - 22 02 04 00 00 66 00 39 9F 52 00 05 8B 03 00 50 02 00 66 00 5D 08 3B 1D 18 DC 45 17 01 66 01
{
	if (!func_166(iParam0))
		return;
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x5309 Signature - 22 02 04 00 00 66 00 39 9F 52 00 05 8B 03 00 50 02 00 66 00 5D 08 3B 1D 18 DC 45 17 01 66 00
{
	if (!func_166(iParam0))
		return;
...
void func_170(int iParam0) // Position - 0x5343 Signature - 22 01 03 00 00 66 00 39 A4
{
	func_181(func_180(iParam0));
	return;
}

BOOL func_171(int iParam0) // Position - 0x5355 Signature - 22 01 03 00 00 66 00 08 20 6A 8B 06 00 66 00 6D 28
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_172(Hash hParam0) // Position - 0x536B Signature - 22 01 03 00 00 66 00 39 D2
{
	if (func_182(hParam0))
...
BOOL func_173() // Position - 0x5386 Signature - 22 00 02 00 00 09 50 00 01 22 01 04
{
	return 1;
}

Ped func_174(int iParam0) // Position - 0x538F Signature - 22 01 04 00 00 66 00 39 1F
{
	PersChar persChar;
...
BOOL func_175(int iParam0, int iParam1) // Position - 0x53BD Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01
{
	return iParam0 && iParam1 != false;
}

BOOL func_176(int iParam0) // Position - 0x53CC Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21
{
	switch (iParam0)
	{
		case 2:
...
int func_177(int iParam0) // Position - 0x540B Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 2E
{
	switch (iParam0)
	{
		case 2:
...
void func_178(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x54A1 Signature - 22 04 06
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_179(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x5F3E Signature - 22 09
{
	float num;
	float num2;
	float num3;
...
int func_180(int iParam0) // Position - 0x5FA4 Signature - 22 01 03 00 00 66 00 08 20 6A 8B 06 00 66 00 6D B4 35 69 05
{
...
void func_181(int iParam0) // Position - 0x64C1 Signature - 22 01 03 00 00 66 00 5D 08 3B 1D 8C
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_182(Hash hParam0) // Position - 0x64D2 Signature - Not Found!
{
	return hParam0 != 0;
}
