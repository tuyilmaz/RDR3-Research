...
int func_2() // Position - 0x11B Signature - 22 00 02 00 00 5D 17
{
	return Global_1572887.f_14;
}

struct<2> func_3(int iParam0) // Position - 0x129 Signature - 22 01 03 00 00 11
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_4(int iParam0, var uParam1) // Position - 0x13D Signature - 22 02 04 00 00 66 00 50
{
	return iParam0;
}

void func_5(var uParam0) // Position - 0x147 Signature - 22 01 03 00 00 66 00 80
{
...
BOOL func_6(var uParam0) // Position - 0x1B7 Signature - 22 01 03 00 00 03 01 00 14
{
...
BOOL func_7() // Position - 0x1D1 Signature - 22 00 02 00 00 2F 50
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x1DA Signature - 22 01 07
{
	Hash hash;
	BOOL flag;
	BOOL flag2;
...
int func_9(var uParam0, var uParam1, var uParam2) // Position - 0x8C0 Signature - 22 03 07 00 00 4B
{
	int num;
	int scenario;
...
int func_10(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x8F3 Signature - 22 04 07 00 00 4B
{
	int num;
...
void func_11(var uParam0, int iParam1) // Position - 0x93A Signature - 22 02 04 00 00 66 00 27 10 66 01 39 EE 21 00 05
{
...
int func_12(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x95A Signature - 22 04 08
{
	int num;
	BOOL flag;
...
void func_13(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x9F5 Signature - 22 04 06 00 00 66 00 27
{
...
void func_14(var uParam0, var uParam1) // Position - 0xA2C Signature - 22 02 04 00 00 66 00 03
{
	Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_1 = uParam0;
	return;
}

void func_15() // Position - 0xA42 Signature - 22 00 02 00 00 2F 03
{
...
void func_16(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA71 Signature - 22 03 06 00 00 66 01
{
	int num;
...
void func_17(var uParam0) // Position - 0xAC5 Signature - 22 01 03 00 00 66 00 27 14
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20))
...
void func_18(var uParam0, var uParam1, var uParam2) // Position - 0xAE6 Signature - 22 03 05 00 00 1D 5D
{
...
void func_19(int iParam0, int iParam1, int iParam2) // Position - 0xB08 Signature - 22 03 05 00 00 66 01 66 00 5D B7 A6 12 63 FB 63
{
	func_70(&Global_1222327[iParam0 /*251*/][iParam1], iParam2);
	return;
}

void func_20() // Position - 0xB22 Signature - 22 00 02 00 00 08
{
...
void func_21() // Position - 0xB5E Signature - 22 00 02 00 00 03 01 00 AB 5D 92 A5 12 63 09 27 04 8B 27
{
...
void func_22(var uParam0) // Position - 0xB9C Signature - 22 01 03 00 00 66 00 39 AD
{
	func_71(uParam0);
...
void func_23(BOOL bParam0) // Position - 0xBB3 Signature - 22 01 03 00 00 66 00 8B 09
{
	if (bParam0)
		func_73(0, 6);
	else
...
void func_24(var uParam0) // Position - 0xBD0 Signature - 22 01 03 00 00 66 00 27 07
{
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_7))
...
BOOL func_25(var uParam0, int iParam1) // Position - 0xBEB Signature - 22 02 04 00 00 66 00 27 10 66 01 39 EE 21 00 50
{
	return func_64(uParam0->f_16, iParam1);
}

int func_26(var uParam0) // Position - 0xBFD Signature - 22 01 03 00 00 66 00 27 02
{
	return uParam0->f_2;
}

BOOL func_27(int iParam0) // Position - 0xC09 Signature - 22 01 09
{
	int i;
	Player player;
	float num;
...
BOOL func_28(var uParam0) // Position - 0xD7E Signature - 22 01 03 00 00 66 00 6D
{
	if (!func_25(uParam0, 32))
...
void func_29(var uParam0, int iParam1) // Position - 0xDCE Signature - 22 02 04 00 00 66 01 66 00 6C
{
	uParam0->f_2 = iParam1;
	return;
}

BOOL func_30(int iParam0) // Position - 0xDDC Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 66 00 6D
{
	if (iParam0 < 0)
		return false;
...
BOOL func_31(int iParam0, BOOL bParam1) // Position - 0xE1B Signature - 22 02 05 00 00 66 01 6A 8B 08 00 66 00 39 DC 0D 00 05 69 8B 04 00 2F
{
	int num;
...
int func_32(BOOL bParam0) // Position - 0xE4E Signature - 22 01 03 00 00 37
{
...
int func_33(var uParam0) // Position - 0xE81 Signature - 22 01 03 00 00 66 00 27 27
{
	return uParam0->f_39;
}

void func_34(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xE8D Signature - 22 04 06 00 00 1D
{
	if (!func_40(vParam1))
	{
		func_18(vParam1);
...
void func_35(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xF02 Signature - 22 08 0F
{
	BOOL flag;
	BOOL flag2;
	float num;
...
void func_36(int iParam0) // Position - 0x112B Signature - 22 01 04 00 00 66 00 39 DC
{
...
void func_37(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1229 Signature - 22 06 08 00 00 70
{
...
void func_38(var uParam0) // Position - 0x1281 Signature - 22 01 03 00 00 39 05
{
	uParam0->f_39 = func_87();
	return;
}

void func_39(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x1291 Signature - 22 08 0A 00 00 66 00
{
	if (!func_88(iParam0))
	{
...
BOOL func_40(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x12C5 Signature - 22 03 05 00 00 1D 4B
{
	return !PERSISTENCE::_PERSISTENCE_IS_SCENARIO_MARKED_AS_LOOTED_AT_COORDS(vParam0);
}

Vector3 func_41(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x12D6 Signature - 22 04 15
{
	var unk;
	float num;
	float num2;
...
void func_42(var uParam0) // Position - 0x138C Signature - 22 01 04 00 00 66 00 76
{
	int value;
...
int func_43(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x13E6 Signature - 22 03 06 00 00 66 00
{
	int i;
...
BOOL func_44(var uParam0, int iParam1) // Position - 0x1496 Signature - 22 02 04 00 00 37
{
	if (func_75(joaat("kit_collector_spade"), 1))
	{
...
int func_45(char* sParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, Hash hParam15, int iParam16) // Position - 0x157A Signature - 22 11 16
{
	int i;
	int num;
	int num2;
...
void func_46(int iParam0, var uParam1) // Position - 0x1658 Signature - 22 02 04 00 00 6D
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
BOOL func_47(int iParam0, BOOL bParam1) // Position - 0x1699 Signature - 22 02 09 00 00 66 01
{
	int num;
	int gameTimer;
	float progress;
...
BOOL func_48(int iParam0, int iParam1, int iParam2) // Position - 0x1793 Signature - 22 03 05 00 00 66 01 66 00 5D B7 A6 12 63 FB 17
{
	return func_64(Global_1222327[iParam0 /*251*/][iParam1], iParam2);
}

void func_49(Ped pedParam0) // Position - 0x17AD Signature - 22 01 04 00 00 66 00 03
{
	Entity firstEntityPedIsCarrying;
...
float func_50(int iParam0, BOOL bParam1) // Position - 0x17EF Signature - 22 02 05 00 00 66 01 6A 8B 08 00 66 00 39 DC 0D 00 05 69 8B 04 00 73
{
	int num;
...
void func_51() // Position - 0x1847 Signature - 22 00 02 00 00 2F 37
{
...
float func_52(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1870 Signature - 22 05 07 00 00 66 00 03 05 00 96
{
...
void func_53(float fParam0) // Position - 0x1898 Signature - 22 01 03 00 00 03 01 00 AB
{
	if (!Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_4)
	{
...
int func_54(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x18DC Signature - 22 04 07 00 00 2F 67
{
	int weaponHash;
...
float func_55(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x1902 Signature - 22 07 0C
{
	float num;
	float num2;
	float num3;
...
void func_56() // Position - 0x1967 Signature - 22 00 02 00 00 03 01 00 AB 5D 92 A5 12 63 09 27 04 8B 0D
{
	if (Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_4)
...
BOOL func_57(var uParam0) // Position - 0x198B Signature - 22 01 0B
{
	var unk;
	int i;
	var unk5;
...
void func_58(int iParam0) // Position - 0x1A37 Signature - 22 01 03 00 00 66 00 03 05 00 A1
{
...
void func_59(BOOL bParam0, BOOL bParam1) // Position - 0x1A51 Signature - 22 02 04 00 00 66 01 8B
{
	if (bParam1)
...
BOOL func_60() // Position - 0x1A83 Signature - 22 00 06 00 00 03
{
	int i;
	Player player;
	Player player2;
...
Hash func_61() // Position - 0x1B11 Signature - 22 00 07
{
	int i;
	var unk;
	Player player;
...
BOOL func_62(Hash hParam0, int iParam1) // Position - 0x1BAD Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 05
{
	if (hParam0 == 0)
		return false;
...
int func_63(int iParam0) // Position - 0x1BC7 Signature - 22 01 03 00 00 66 00 3C 6F
{
	switch (iParam0)
	{
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x21EE Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 04
{
	return iParam0 && iParam1 != false;
}

void func_65(int iParam0, int iParam1) // Position - 0x21FD Signature - 22 02 04 00 00 66 00 66 01 39 CE
{
	func_101(iParam0, iParam1);
	return;
}

int func_66(int iParam0) // Position - 0x220D Signature - 22 01 03 00 00 66 00 50 01 01 22 01
{
	return iParam0;
}

void func_67(int iParam0) // Position - 0x2217 Signature - 22 01 03 00 00 66 00 39 DF
{
	if (!func_102(iParam0))
		return;
...
int func_68(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x22CA Signature - 22 03 08
{
	int i;
	var src;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x2374 Signature - 22 06 08 00 00 66 00 66 03 7D
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

void func_70(int iParam0, int iParam1) // Position - 0x239D Signature - 22 02 04 00 00 66 00 66 01 39 EE
{
	func_103(iParam0, iParam1);
	return;
}

void func_71(var uParam0) // Position - 0x23AD Signature - 22 01 03 00 00 66 00 27 04
{
	if (uParam0->f_4 != -1)
	{
...
void func_72(int iParam0, int iParam1) // Position - 0x23E0 Signature - 22 02 04 00 00 66 00 39 51
{
	if (func_88(iParam0))
...
void func_73(int iParam0, int iParam1) // Position - 0x23F9 Signature - 22 02 04 00 00 66 00 66 01 39 03
{
...
void func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x243D Signature - 22 03 05 00 00 66 00 66
{
...
BOOL func_75(Hash hParam0, int iParam1) // Position - 0x24A4 Signature - 22 02 05 00 00 66 00 2F
{
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2527 Signature - 22 03 05 00 00 66 00 73
{
...
BOOL func_77(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2551 Signature - 22 03 05 00 00 66 00 27
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_78() // Position - 0x2650 Signature - 22 00 02 00 00 6D 59
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_79(var uParam0, int iParam1) // Position - 0x2665 Signature - 22 02 04 00 00 66 01 66 00 32
{
	*uParam0 = iParam1;
	return;
}

void func_80(int iParam0) // Position - 0x2672 Signature - 22 01 03 00 00 66 00 2F 23
{
	if (iParam0 <= 0)
		return;
...
void func_81(var uParam0) // Position - 0x2699 Signature - 22 01 03 00 00 66 00 73
{
	func_113(uParam0, 0f);
	return;
}

float func_82(var uParam0) // Position - 0x26A8 Signature - 22 01 03 00 00 66 00 39 0E
{
	if (!func_114(uParam0))
		return uParam0->f_1;
...
BOOL func_83() // Position - 0x26DD Signature - 22 00 02 00 00 70
{
...
BOOL func_84(Ped pedParam0) // Position - 0x2742 Signature - 22 01 03 00 00 66 00 39 89
{
...
BOOL func_85(int iParam0, BOOL bParam1) // Position - 0x278C Signature - 22 02 04 00 00 66 01 6A
{
	if (bParam1 && !func_30(iParam0))
		return false;
...
void func_86(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x27B1 Signature - 22 04 07 00 00 66
{
	int num;
...
int func_87() // Position - 0x2805 Signature - 22 00 02 00 00 37 9D
{
...
BOOL func_88(int iParam0) // Position - 0x2851 Signature - 22 01 03 00 00 66 00 76 2F 15
{
	if (*iParam0 == 0)
		return false;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2) // Position - 0x2869 Signature - 22 03 07 00 00 1D
{
	float num;
	float num2;
...
Vector3 func_90(float fParam0) // Position - 0x28A8 Signature - 22 01 03 00 00 66 00 03 05 00 BB
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Vector3 func_91(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x28BE Signature - 22 06 08 00 00 4B
{
...
float func_92(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x28F7 Signature - 22 06 08 00 00 66 00 66 03 24
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

BOOL func_93(Entity eParam0) // Position - 0x2918 Signature - 22 01 13
{
	int num;
	var unk5;
	Hash entityModel;
...
BOOL func_94(int iParam0, int iParam1) // Position - 0x29B2 Signature - 22 02 04 00 00 66 00 2F 8A 04
{
	if (iParam0 < 0)
		return false;
...
BOOL func_95(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x29D3 Signature - 22 08 0A 00 00 66 06
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_97(int iParam0, Any anParam1) // Position - 0x2D42 Signature - 22 02 10
{
	var unk;
...
struct<2> func_98(int iParam0, int iParam1) // Position - 0x2D6B Signature - 22 02 06 00 00 66 00
{
	int num;
...
void func_99(var uParam0, var uParam1, int iParam2) // Position - 0x2D81 Signature - 22 03 05 00 00 4B
{
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x2D9E Signature - 22 05 24
{
	var unk;
	var unk13;
	var unk26;
...
void func_101(var uParam0, int iParam1) // Position - 0x2DCE Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_102(int iParam0) // Position - 0x2DDF Signature - 22 01 03 00 00 66 00 11
{
	return func_94(iParam0, 2);
}

void func_103(int iParam0, int iParam1) // Position - 0x2DEE Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 02 04 00 00 66 00 5D
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_104(int iParam0, int iParam1) // Position - 0x2E03 Signature - 22 02 04 00 00 66 00 5D 77
{
	return MISC::IS_BIT_SET(Global_1072759.f_22475.f_417[iParam0 /*12*/], iParam1);
}

void func_105() // Position - 0x2E1F Signature - 22 00 02 00 00 5D 77
{
	SCRIPTS::_SET_ALL_PLAYER_BITS(&(Global_1072759.f_21353.f_260));
	return;
}

int func_106(Hash hParam0) // Position - 0x2E35 Signature - 22 01 0A 00 00 66 00 2F 39 AD 1B 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 37 05 8B 04 00 2F 50 01 01 4B 03 27 02
{
	var unk;
...
BOOL func_107(Hash hParam0, int iParam1) // Position - 0x2E60 Signature - 22 02 16
{
	Hash hash;
	int num;
	int num2;
	...
	if (func_132("ALL WEAPONS", &num, &num2, -1591664384, false))
	{
...
BOOL func_108(Hash hParam0) // Position - 0x2F07 Signature - 22 01 06
{
	int num;
	int num2;
	int num3;
...
int func_109(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2FC3 Signature - 22 04 0D
{
...
BOOL func_110(BOOL bParam0) // Position - 0x3085 Signature - 22 01 03 00 00 66 00 8B 0D
{
	if (bParam0)
...
BOOL func_111() // Position - 0x30B5 Signature - 22 00 02 00 00 39
{
	return func_144() != -1;
}

BOOL func_112() // Position - 0x30C3 Signature - 22 00 02 00 00 5D 0C CE 1D 27 01 37
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_113(var uParam0, float fParam1) // Position - 0x30E8 Signature - 22 02 04 00 00 39
{
...
BOOL func_114(var uParam0) // Position - 0x310E Signature - 22 01 03 00 00 66 00 76 09
{
	return func_147(*uParam0, 1);
}

BOOL func_115(var uParam0) // Position - 0x311E Signature - 22 01 03 00 00 66 00 76 11
{
	return func_147(*uParam0, 2);
}

float func_116() // Position - 0x312E Signature - 22 00 03
{
...
BOOL func_117(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x3160 Signature - 22 02 05 00 00 66 00 66
{
...
BOOL func_118(Ped pedParam0) // Position - 0x3189 Signature - 22 01 03 00 00 66 00 2F 39
{
	return func_148(pedParam0, 0);
}

BOOL func_119(Ped pedParam0) // Position - 0x3198 Signature - 22 01 03 00 00 66 00 1D
{
	return func_148(pedParam0, 3);
}

BOOL func_120(Ped pedParam0) // Position - 0x31A7 Signature - 22 01 03 00 00 66 00 42
{
	return func_148(pedParam0, 4) || func_148(pedParam0, 5);
}

BOOL func_121(Ped pedParam0) // Position - 0x31C3 Signature - 22 01 03 00 00 66 00 4D
{
	return func_148(pedParam0, 6);
}

BOOL func_122(Ped pedParam0) // Position - 0x31D2 Signature - 22 01 03 00 00 66 00 0D
{
	return func_148(pedParam0, 7);
}

void func_123(int iParam0, int iParam1) // Position - 0x31E1 Signature - 22 02 04 00 00 66 00 2F 8A 03 00 50 02 00 66 00 5D A6 C8 1D 63 17 27 01 66 00
{
	if (iParam0 < 0)
		return;
...
void func_124(int iParam0, BOOL bParam1) // Position - 0x3214 Signature - 22 02 04 00 00 66 00 5D A6 C8 1D 63 17 27 03 03 05 00 91 8B 3F
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_125(int iParam0, BOOL bParam1) // Position - 0x326C Signature - 22 02 04 00 00 66 00 5D A6 C8 1D 63 17 27 03 03 05 00 91 8B 10
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_126(int iParam0, int iParam1) // Position - 0x3295 Signature - 22 02 04 00 00 66 00 2F 8A 03 00 50 02 00 66 00 5D A6 C8 1D 63 17 27 01 66 01
{
	if (iParam0 < 0)
		return;
...
int func_127() // Position - 0x32BD Signature - 22 00 02 00 00 6D 2F
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

void func_128(var uParam0, int iParam1) // Position - 0x32D2 Signature - 22 02 06 00 00 66 01
{
	BOOL flag;
	int i;
...
BOOL func_129(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x33FE Signature - 22 05 17
{
	var unk;
	int num;
...
int func_130(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x346D Signature - 22 08 1E
{
	BOOL flag;
	int num;
	var unk;
...
Hash func_131(Hash hParam0, int iParam1) // Position - 0x354E Signature - 22 02 07
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_132(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x35C8 Signature - 22 05 07 00 00 66 04
{
...
BOOL func_133(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x35EF Signature - 22 04 06 00 00 66 02
{
	if (iParam2 < 0)
		return false;
...
BOOL func_134(Hash hParam0) // Position - 0x362A Signature - 22 01 03 00 00 66 00 03 05 00 04
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_135(int iParam0) // Position - 0x3645 Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 66 00 03
{
	if (iParam0 < 0)
		return 0;
...
int func_136(Hash hParam0) // Position - 0x3666 Signature - 22 01 0A 00 00 66 00 2F 39 AD 1B 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 37 05 8B 04 00 2F 50 01 01 4B 03 27 01
{
	var unk;
...
int func_137(Hash hParam0) // Position - 0x3691 Signature - 22 01 03 00 00 66 00 3C 0F
{
	switch (hParam0)
	{
...
int func_138(var uParam0, int iParam1) // Position - 0x3774 Signature - 22 02 05 00 00 2F
{
	int i;
...
int func_139(Hash hParam0) // Position - 0x37B1 Signature - 22 01 04 00 00 66 00 39 66
{
	int num;
...
int func_140(Hash hParam0, BOOL bParam1) // Position - 0x381E Signature - 22 02 18
{
	var unk;
	int num;
	int num2;
	...
	unk = { func_155(hParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };
...
int func_141(Hash hParam0, int iParam1) // Position - 0x387D Signature - 22 02 04 00 00 66 01 2F 15 04
{
	if (iParam1 == 0)
		return 0;
...
int func_142(BOOL bParam0) // Position - 0x38A9 Signature - 22 01 03 00 00 39 1B
{
	if (func_2() == -1)
	{
...
struct<4> func_143(Hash hParam0, BOOL bParam1) // Position - 0x38EA Signature - 22 02 09 00 00 66 00 66
{
	var unk;
...
int func_144() // Position - 0x390F Signature - 22 00 02 00 00 5D F4
{
	return Global_1149172.f_137;
}

void func_145(var uParam0, int iParam1) // Position - 0x391D Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 02
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_146(var uParam0, int iParam1) // Position - 0x392E Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 02 04 00 00 66 00 66
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_147(int iParam0, int iParam1) // Position - 0x3943 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 09
{
	return iParam0 && iParam1 != false;
}

BOOL func_148(Ped pedParam0, int iParam1) // Position - 0x3952 Signature - 22 02 09 00 00 66 00 03
{
	var unk;
	int num;
...
void func_149(var uParam0) // Position - 0x3991 Signature - 22 01 03 00 00 66 00 37
{
...
void func_150(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x39C9 Signature - 22 11 2A
{
	int i;
	var unk;
...
void func_151(int iParam0, int iParam1) // Position - 0x3A7F Signature - 22 02 04 00 00 66 01 2F 15 03
{
	if (iParam1 == 0)
		return;
...
void func_152(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x3AAF Signature - 22 13
{
	int i;
	var unk;
...
BOOL func_153(Hash hParam0, Hash hParam1) // Position - 0x3B6A Signature - 22 02 04 00 00 66 00 2F 39
{
	if (!func_62(hParam0, 0))
...
void func_154(Hash hParam0, var uParam1, var uParam2) // Position - 0x3BAB Signature - 22 03 05 00 00 2F
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_155(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3DB7 Signature - 22 07 1B
{
	Hash hash;
...
struct<4> func_156(BOOL bParam0) // Position - 0x3E95 Signature - 22 01 04 00 00 66 00 39 A9 38 00 67 03 66 03 11 15
{
	int num;
...
void func_157(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x3F36 Signature - 22 05 07 00 00 4B
{
...
BOOL func_158(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x3F51 Signature - 22 04 06 00 00 66 03
{
...
Hash func_159(Hash hParam0) // Position - 0x3F76 Signature - 22 01 03 00 00 66 00 50 01 01 22 02
{
	return hParam0;
}

BOOL func_160(Hash hParam0, int iParam1) // Position - 0x3F80 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 6D
{
	if (hParam0 == 0)
		return false;
...
struct<5> func_161(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x3F9A Signature - 22 03 2F
{
	var unk;
	int num;
	var unk6;
	...
	switch (num)
	{
		...
		case joaat("DOG"):
			...
			{
				unk = { func_162(joaat("kit_camp"), unk, 1084182731, bParam1) };
				unk.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(hParam0, joaat("kit_camp"));
			}
			else if (func_171(hParam0, -1483207246))
			{
				unk = { func_162(joaat("WARDROBE"), unk, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (iParam2 && func_167(hParam0, true))
			{
				...
				if (!func_168(hParam0, &unk, 1728382685, false, false))
					unk.f_4 = 1728382685;
				else if (!func_168(hParam0, &unk, -649335959, false, false))
					unk.f_4 = -649335959;
				else if (func_169(hParam0, &unk6, 1728382685))
					unk.f_4 = 1728382685;
				else
					unk.f_4 = -649335959;
			}
...
struct<4> func_162(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x430E Signature - 22 07 0D
{
	var outGuid;
...
int func_163() // Position - 0x433F Signature - 22 00 02 00 00 5D 0C CE 1D 27 01 50
{
	return Global_1953292.f_1;
}

BOOL func_164(Any anParam0) // Position - 0x434D Signature - 22 01 03 00 00 66 00 76 2F 0B
{
...
BOOL func_165(Hash hParam0, Hash hParam1) // Position - 0x4393 Signature - 22 02 04 00 00 66 00 11
{
...
struct<4> func_166(BOOL bParam0) // Position - 0x43C9 Signature - 22 01 04 00 00 5D
{
	int num;
	...
	if (Global_1572887.f_14 == 0)
	{
		...
		if (num == 2)
		{
			if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1292143))
				Global_1292143 = { func_162(joaat("character"), func_173(), -1591664384, bParam0) };
		...
		else if (num == 3)
		{
			if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&(Global_1292143.f_12)))
				Global_1292143.f_12 = { func_162(joaat("character"), func_173(), -1591664384, false) };
		
			return Global_1292143.f_12;
		}
	}

	return func_162(joaat("character"), func_173(), -1591664384, bParam0);
}

int func_167(Hash hParam0, BOOL bParam1) // Position - 0x4469 Signature - 22 02 04 00 00 66 00 39 66
{
...
BOOL func_168(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x44A0 Signature - 22 05 07 00 00 66 00 42
{
	return func_175(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_169(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x44BB Signature - 22 03 09
{
	var unk;
...
struct<4> func_170(BOOL bParam0) // Position - 0x44DC Signature - 22 01 04 00 00 66 00 39 A9 38 00 67 03 66 03 11 0B
{
	int num;
...
BOOL func_171(Hash hParam0, int iParam1) // Position - 0x4546 Signature - 22 02 08
{
	Hash hash;
	int num;
	int i;
	...
	for (i = 0; i < fitsSlotCount; i = i + 1)
	{
		if (ITEMDATABASE::_ITEMDATABASE_GET_FITS_SLOT_INFO(num, i, &hash))
			if (func_177(hParam0, iParam1, hash))
				return true;
	}
...
BOOL func_172(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x45B3 Signature - 22 08 0A 00 00 4B
{
	return func_178(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

struct<4> func_173() // Position - 0x45C9 Signature - 22 00 06 00 00 42
{
	var unk;
...
int func_174() // Position - 0x45D5 Signature - 22 00 02 00 00 37 20
{
...
int func_175(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x45F2 Signature - 22 09 10
{
...
BOOL func_176(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x4671 Signature - 22 04 07 00 00 2F 39
{
	int inventoryId;
...
BOOL func_177(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x46B6 Signature - 22 03 05 00 00 66 02
{
...
BOOL func_178(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x46E9 Signature - 22 05 07 00 00 66 00 03 05 00 25
{
...
int func_179(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4723 Signature - 22 04 06 00 00 66 00 39
{
...
BOOL func_180(Hash hParam0) // Position - 0x4756 Signature - 22 01 03 00 00 66 00 03 05 00 88
{
