...
void main() // Position - 0x0 Signature - 22 00 02 00 00 54 2F
{
...
void func_1() // Position - 0x33 Signature - 22 00 02 00 00 54 2D
{
...
BOOL func_2() // Position - 0x46 Signature - 22 00 02 00 00 03
{
...
void func_3() // Position - 0x83 Signature - 22 00 02 00 00 89 00 27 2C
{
	if (iLocal_0.f_44)
	{
...
BOOL func_4() // Position - 0xD0 Signature - 22 00 02 00 00 54 00
{
	switch (iLocal_0)
	{
		case 0:
...
void func_5() // Position - 0x1D0 Signature - 22 00 02 00 00 89 00 27 22
{
...
BOOL func_6() // Position - 0x20B Signature - 22 00 0A
{
	var unk;
	int numNodes;
	int i;
...
void func_7(char* sParam0, char* sParam1) // Position - 0x27A Signature - 22 02
{
...
BOOL func_8() // Position - 0x2A1 Signature - 22 00 02 00 00 89 00 80
{
