...
void func_6() // Position - 0x10C Signature - 22 00 02 00 00 54 12
{
...
void func_7() // Position - 0x2DB Signature - 22 00 02 00 00 50 00 00 22 00 02 00 00 03
{
	return;
}

void func_8() // Position - 0x2E3 Signature - 22 00 02 00 00 03 00
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x2EF Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 07 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 16 4B 03 39 05
{
	struct<2> eventData;
...
void func_10(int iParam0) // Position - 0x317 Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 07 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 16 4B 03 39 13
{
	struct<2> eventData;
...
void func_11(int iParam0) // Position - 0x33F Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 07 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 16 4B 03 39 47
{
	struct<2> eventData;
...
BOOL func_12() // Position - 0x367 Signature - 22 00 02 00 00 03 01
{
...
void func_13(int iParam0) // Position - 0x38B Signature - 22 01 03 00 00 03
{
...
int func_14() // Position - 0x3CE Signature - 22 00 02 00 00 89 12 27 19
{
	return pedLocal_18.f_25;
}

BOOL func_15() // Position - 0x3DA Signature - 22 00 02 00 00 89 12 27 18
{
	return pedLocal_18.f_24;
}

void func_16() // Position - 0x3E6 Signature - 22 00 02 00 00 2F
{
	pedLocal_18.f_24 = 0;
	return;
}

void func_17(int iParam0) // Position - 0x3F3 Signature - 22 01 03 00 00 66 00 89
{
...
void func_18(var uParam0) // Position - 0x405 Signature - 22 01 03 00 00 66 00 27
{
	pedLocal_18 = uParam0->f_1;
	return;
}

void func_19(var uParam0) // Position - 0x413 Signature - 22 01 03 00 00 89
{
...
void func_20(var uParam0) // Position - 0x447 Signature - 22 01 03 00 00 50
{
	return;
}

void func_21() // Position - 0x44F Signature - 22 00 02 00 00 09 89
{
	pedLocal_18.f_24 = 1;
	return;
}
