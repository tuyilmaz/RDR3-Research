...
void func_1(var uParam0, Entity eParam1) // Position - 0x34 Signature - 22 02 04 00 00 09
{
...
BOOL func_2(var uParam0) // Position - 0x87 Signature - 22 01 03 00 00 09 09
{
	if (func_8(true, true))
		return true;
...
void func_3(var uParam0) // Position - 0x198 Signature - 22 01 03 00 00 03
{
...
void func_4(var uParam0) // Position - 0x22D Signature - 22 01 05 00 00 03
{
	Player player;
	Ped playerPed;
...
void func_5(BOOL bParam0, int iParam1) // Position - 0x2CE Signature - 22 02 04 00 00 66 00 8B 10
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
void func_6() // Position - 0x2F0 Signature - 22 00 02 00 00 09 26
{
	Global_1913441 = 1;
	return;
}

void func_7() // Position - 0x2FD Signature - 22 00 02 00 00 5D 77 5E 10 78
{
...
BOOL func_8(BOOL bParam0, BOOL bParam1) // Position - 0x318 Signature - 22 02 05 00 00 5D
{
	int i;
...
float func_9(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x3F8 Signature - 22 06 08 00 00 73
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_10(var uParam0, int iParam1) // Position - 0x416 Signature - 22 02 04 00 00 66 01 66
{
	*uParam0 = iParam1;
...
void func_11(var uParam0) // Position - 0x42B Signature - 22 01 06 00 00 66 00 27
{
	float num;
	int _int;
	int gangId;
...
void func_12(var uParam0) // Position - 0x6F0 Signature - 22 01 07 00 00 5D
{
	float num;
	Player player;
	Ped playerPed;
...
void func_13(var uParam0) // Position - 0xDED Signature - 22 01 03 00 00 85 32
{
...
void func_14(var uParam0) // Position - 0xE31 Signature - 22 01 03 00 00 37
{
...
void func_15(var uParam0) // Position - 0xE91 Signature - 22 01 10 00
{
	Player player;
	Ped playerPed;
	int num;
...
void func_16(var uParam0) // Position - 0x16ED Signature - 22 01 07 00 00 39
{
	int i;
...
BOOL func_17() // Position - 0x18A1 Signature - 22 00 06 00 00 39
{
	int num;
	BOOL flag;
	BOOL flag2;
...
void func_18() // Position - 0x1BCE Signature - 22 00 02 00 00 08
{
...
BOOL func_19(int iParam0) // Position - 0x1BE6 Signature - 22 01 03 00 00 66 00 5D CF
{
	return Global_1102813.f_4[Global_1106895[iParam0 /*2*/]] && Global_1106895[iParam0 /*2*/].f_1 == Global_1106895[iParam0 /*2*/].f_1;
}

void func_20() // Position - 0x1C14 Signature - 22 00 02 00 00 2F 42 2F
{
	func_90(0, 4, false);
...
void func_21(Ped pedParam0, BOOL bParam1) // Position - 0x1C33 Signature - 22 02 04 00 00 66 01 8B 3B
{
	if (bParam1)
	{
		if (!func_92(64))
...
void func_22(var uParam0) // Position - 0x1CB2 Signature - 22 01 03 00 00 39 D6
{
	func_93();
	func_32(uParam0, 2);
	func_32(uParam0, 4);
...
void func_23() // Position - 0x1CCC Signature - 22 00 02 00 00 03 00
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

int func_24(Entity eParam0) // Position - 0x1CD8 Signature - 22 01 0A 00 00 66 00 09
{
...
BOOL func_25(int iParam0) // Position - 0x1D3F Signature - 22 01 03 00 00 66 00 2F 35
{
...
int func_26(int iParam0, BOOL bParam1) // Position - 0x1D5E Signature - 22 02 04 00 00 66 00 39 3F 1D 00 05 8B 0A
{
	if (!func_25(iParam0))
	{
		!bParam1;
...
int func_27(Any anParam0) // Position - 0x1DA4 Signature - 22 01 03 00 00 66 00 03 05 00 33
{
...
Vector3 func_28(int iParam0) // Position - 0x1DDC Signature - 22 01 03 00 00 66 00 39 3F
{
	if (!func_25(iParam0))
		return 0f, 0f, 0f;
...
int func_29(char* sParam0, Hash hParam1, Object obParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, int iParam16) // Position - 0x1E00 Signature - 22 11 15
{
	int i;
	int num;
	...
	for (i = 0; i < 60; i = i + 1)
	{
		if (func_96(i, 2))
		{
			...
			{
				if (obParam2 == Global_1951910[i /*23*/].f_11 && hParam1 == Global_1951910[i /*23*/].f_4)
	...
	if (num != 0)
	{
		func_97(num, hParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, obParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, false, bParam5, 0, hParam14, iParam16);
		return num;
	}
...
BOOL func_30(int iParam0) // Position - 0x1ED7 Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 66 00 6D
{
	if (iParam0 < 0)
		return false;
...
void func_31(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1F16 Signature - 22 04 07 00 00 66 03
{
	int num;
...
void func_32(var uParam0, int iParam1) // Position - 0x1F61 Signature - 22 02 04 00 00 66 00 27 01 66 00
{
	uParam0->f_1 = uParam0->f_1 - uParam0->f_1 && iParam1;
	return;
}

void func_33(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1F79 Signature - 22 04 07 00 00 66 02
{
	int num;
...
void func_34(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1FCD Signature - 22 03 06 00 00 66 02
{
	int num;
...
BOOL func_35(var uParam0, int iParam1) // Position - 0x1FF9 Signature - 22 02 04 00 00 66 00 27 13
{
...
Vector3 func_36(Player plParam0) // Position - 0x2015 Signature - 22 01 03 00 00 66 00 03 05 00 ED
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

BOOL func_37(int iParam0, int iParam1) // Position - 0x2029 Signature - 22 02 04 00 00 66 01 6D FF 15 0E
{
	if (iParam1 == 255)
...
BOOL func_38() // Position - 0x2055 Signature - 22 00 02 00 00 5D 77 5E 10 18 E4 6F 80 42
{
	return Global_1072759.f_28644.f_66.f_42 != 0;
}

BOOL func_39() // Position - 0x206A Signature - 22 00 02 00 00 5D 77 5E 10 18 E4 6F 80 17
{
	return Global_1072759.f_28644.f_23.f_3 != 0;
}

BOOL func_40() // Position - 0x207F Signature - 22 00 02 00 00 5D 77 5E 10 18 E4 6F 80 3B
{
	return Global_1072759.f_28644.f_59.f_6 == 2;
}

BOOL func_41(int iParam0) // Position - 0x2094 Signature - 22 01 03 00 00 09 66
{
	return func_103(1, iParam0);
}

BOOL func_42(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x20A3 Signature - 22 04 29
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_43() // Position - 0x21D8 Signature - 22 00 02 00 00 5D E5 EB 10 18 07 03 27 17
{
...
BOOL func_44() // Position - 0x221F Signature - 22 00 02 00 00 5D 1C 9B 1D 27 02 6A
{
	return Global_1940252.f_2 || Global_1940252 == 1;
}

BOOL func_45() // Position - 0x2239 Signature - 22 00 04 00 00 03 01 00 AA 67 03 66 03 2F 03 09 00 59 05 6A 8B 08 00 66 03 39 52 3F 00 05 69 8B 04 00 2F 50 00 01 66 03 03 05 00 83 67 02 66 02 03 05 00 75 05 8B 04 00 2F 50 00 01 66 02 39
{
...
BOOL func_46() // Position - 0x2298 Signature - 22 00 08
{
	Entity transportPedIsSeatedOn;
	Ped ped;
...
BOOL func_47() // Position - 0x231B Signature - 22 00 04 00 00 03 01 00 AA 67 03 66 03 2F 03 09 00 59 05 6A 8B 08 00 66 03 39 52 3F 00 05 69 8B 04 00 2F 50 00 01 66 03 03 05 00 83 67 02 66 02 03 05 00 75 05 8B 04 00 2F 50 00 01 66 02 03
{
	Entity transportPedIsSeatedOn;
	Ped ped;
...
BOOL func_48() // Position - 0x237A Signature - 22 00 03 00 00 5D
{
	Ped ped;
...
BOOL func_49(Player plParam0) // Position - 0x23CF Signature - 22 01 05 00 00 66 00 03 05 00 6A
{
...
BOOL func_50(Ped pedParam0, Ped pedParam1) // Position - 0x24C3 Signature - 22 02 04 00 00 66 00 03
{
...
void func_51(var uParam0) // Position - 0x24E5 Signature - 22 01 0D 00 00 2F
{
	Hash hash;
	int value;
	float num;
...
float func_52(int iParam0, BOOL bParam1) // Position - 0x25A5 Signature - 22 02 05 00 00 66 01 6A 8B 08 00 66 00 39 D7 1E 00 05 69 8B 04 00 73
{
	int num;
...
BOOL func_53(int iParam0, BOOL bParam1) // Position - 0x25FD Signature - 22 02 09 00 00 66 01
{
	int num;
	int gameTimer;
	float progress;
...
void func_54(int iParam0) // Position - 0x26F7 Signature - 22 01 03 00 00 5D 77 5E 10 18 10 5D 80 05 66 00 39 3A
{
	func_121(&(Global_1072759.f_23824.f_5), iParam0);
	return;
}

BOOL func_55(int iParam0, BOOL bParam1) // Position - 0x270E Signature - 22 02 05 00 00 66 01 6A 8B 08 00 66 00 39 D7 1E 00 05 69 8B 04 00 2F
{
	int num;
...
void func_56(var uParam0, const char* sParam1) // Position - 0x2741 Signature - 22 02 04 00 00 66 00 27 1A
{
	if (uParam0->f_26 > 0f)
		return;
...
void func_57(int iParam0, Hash hParam1) // Position - 0x276C Signature - 22 02 05 00 00 66 00 39
{
	int num;
...
BOOL func_58(BOOL bParam0, int iParam1) // Position - 0x27AE Signature - 22 02 04 00 00 03 01 00 9E
{
...
void func_59() // Position - 0x27E8 Signature - 22 00 02 00 00 2F 42 39
{
	func_126(0, 4);
	func_127(32768);
	return;
...
int func_60(var uParam0, int iParam1) // Position - 0x27FE Signature - 22 02 04 00 00 66 01 5D
{
...
void func_61(var uParam0, int iParam1) // Position - 0x2832 Signature - 22 02 04 00 00 66 00 27 01 66 01 30
{
	uParam0->f_1 = uParam0->f_1 || iParam1;
	return;
}

BOOL func_62(var uParam0, int iParam1) // Position - 0x2845 Signature - 22 02 04 00 00 66 00 27 01 66 01 69
{
	return uParam0->f_1 && iParam1 != false;
}

void func_63(var uParam0, var uParam1) // Position - 0x2856 Signature - 22 02 09 00 00 37
{
	int eventData;
	Any any;
...
Hash func_64(var uParam0) // Position - 0x2941 Signature - 22 01 04 00 00 66 00 27
{
	int num;
...
BOOL func_65(Hash hParam0, var uParam1) // Position - 0x29A7 Signature - 22 02 04 00 00 66 00 09 39
{
	*uParam1 = func_132(hParam0, true);
	return *uParam1 != 0;
}

BOOL func_66(Hash hParam0, var uParam1) // Position - 0x29BE Signature - 22 02 04 00 00 66 00 09 2F
{
	*uParam1 = func_133(hParam0, true, false);
	return *uParam1 != 0;
}

char* func_67(Hash hParam0) // Position - 0x29D6 Signature - 22 01 04 00 00 66 00 67 03 66 03 3C
{
	 Var0;
...
Player func_68() // Position - 0x2ADE Signature - 22 00 02 00 00 5D 4D
{
	return Global_1297229.f_200;
}

BOOL func_69(Player plParam0, BOOL bParam1) // Position - 0x2AEC Signature - 22 02 05 00 00 66 01 8B
{
	Player player;
...
// Unhandled jump detected. Output should be considered invalid
int func_70(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x2B41 Signature - 22 06 29
{
	var unk;
	int num;
	int i;
...
Hash func_71(int iParam0, var uParam1) // Position - 0x2C31 Signature - 22 02 04 00 00 66 01 27
{
...
int func_72(int iParam0, Hash hParam1) // Position - 0x2D62 Signature - 22 02 07 00 00 66 01
{
	var unk;
	int cashBalance;
	Player player;
...
int func_73(Hash hParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, Hash hParam5) // Position - 0x2E17 Signature - 22 06 4F
{
	int cashBalance;
	int goldBarBalance;
	var unk;
...
Hash func_74(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x3007 Signature - 22 03 26
{
	var unk;
	int num;
	int i;
...
int func_75(Hash hParam0) // Position - 0x3071 Signature - 22 01 0D 00 00 08
{
	int num;
	var unk;
	var unk6;
...
void func_76(var uParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x30D3 Signature - 22 04 06 00 00 66 02 66 00
{
...
void func_77(int iParam0) // Position - 0x30ED Signature - 22 01 04 00 00 03 01 00 19
{
	int idOfThisThread;
...
void func_78(BOOL bParam0, int iParam1) // Position - 0x312F Signature - 22 02 0B 00 00 66 00 8B
{
	int num;
	BOOL flag;
	BOOL flag2;
...
void func_79(int iParam0) // Position - 0x31A3 Signature - 22 01 03 00 00 5D 77 5E 10 18 10 5D 80 05 66 00 39 C7
{
	func_156(&(Global_1072759.f_23824.f_5), iParam0);
	return;
}

int func_80(int iParam0, var uParam1) // Position - 0x31BA Signature - 22 02 1B
{
	struct<6> eventData;
	eEventType eventAtIndex;
	int i;
...
int func_81(int iParam0) // Position - 0x325B Signature - 22 01 04 00 00 66 00 08
{
	int i;
...
void func_82(var uParam0) // Position - 0x32A7 Signature - 22 01 08 00 00 66
{
	var unk;
	Hash hash;
...
BOOL func_83(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x3303 Signature - 22 03 13
{
	Player playerIndex;
	Ped ped;
	int num;
...
int func_84() // Position - 0x35C8 Signature - 22 00 02 00 00 85 DD
{
	if (Global_1102813 <= 5)
...
BOOL func_85() // Position - 0x35FB Signature - 22 00 02 00 00 5D DD D3 10 80 1A 78 09 0D 6D
{
...
int func_86() // Position - 0x3665 Signature - 22 00 02 00 00 5D DD D3 10 80 1A 78 09 0D 50
{
	return Global_1102813.f_26.f_3337;
}

BOOL func_87(BOOL bParam0) // Position - 0x3676 Signature - 22 01 03 00 00 5D DD D3 10 80 1A 27 09 66 00 69 2F
{
	return Global_1102813.f_26.f_9 && bParam0 != false;
}

void func_88(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x368B Signature - 22 07 0C
{
	Player player;
	Ped ped;
...
void func_89() // Position - 0x37AD Signature - 22 00 03 00 00 6D
{
	Ped ped;
...
void func_90(int iParam0, int iParam1, BOOL bParam2) // Position - 0x383B Signature - 22 03 05 00 00 66 00 66 01 39
{
...
void func_91(int iParam0) // Position - 0x38A2 Signature - 22 01 03 00 00 5D DD D3 10 27 03 5D
{
	Global_1102813.f_3 = Global_1102813.f_3 - Global_1102813.f_3 && iParam0;
	return;
}

BOOL func_92(int iParam0) // Position - 0x38C0 Signature - 22 01 03 00 00 5D 77 5E 10 18 10 5D 27
{
	return Global_1072759.f_23824.f_5 && iParam0 != false;
}

void func_93() // Position - 0x38D6 Signature - 22 00 02 00 00 03 01 00 9E 09
{
...
int func_94(Player plParam0) // Position - 0x38FA Signature - 22 01 04 00 00 66 00 67 03 66 03 2F
{
	Player player;
...
int func_95(Player plParam0) // Position - 0x392A Signature - 22 01 04 00 00 66 00 03 05 00 F0
{
	int i;
...
BOOL func_96(int iParam0, int iParam1) // Position - 0x398D Signature - 22 02 04 00 00 66 00 2F 8A 04
{
	if (iParam0 < 0)
		return false;
...
void func_97(int iParam0, Hash hParam1, char* sParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, float fParam9, Volume volParam10, Object obParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, BOOL bParam21, BOOL bParam22, Hash hParam23, Hash hParam24, BOOL bParam25) // Position - 0x39AE Signature - 22 1A 1D
{
	Prompt prompt;
	...
	Global_1951910[iParam0 /*23*/].f_11 = obParam11;
...
int func_98(int iParam0) // Position - 0x3CC8 Signature - 22 01 03 00 00 66 00 50 01 01 22 02 04 00 00 66 00 2F
{
	return iParam0;
}

void func_99(int iParam0, int iParam1) // Position - 0x3CD2 Signature - 22 02 04 00 00 66 00 2F 8A 03 00 50 02 00 66 00 5D A6 C8 1D 63 17 27 01 66 00
{
	if (iParam0 < 0)
		return;
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x3D05 Signature - 22 02 04 00 00 66 00 5D A6 C8 1D 63 17 27 03 03 05 00 0D 8B 3F
{
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x3D5D Signature - 22 02 04 00 00 66 00 5D A6 C8 1D 63 17 27 03 03 05 00 0D 8B 10
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_102(int iParam0, int iParam1) // Position - 0x3D86 Signature - 22 02 04 00 00 66 00 2F 8A 03 00 50 02 00 66 00 5D A6 C8 1D 63 17 27 01 66 01
{
	if (iParam0 < 0)
		return;
...
BOOL func_103(int iParam0, int iParam1) // Position - 0x3DAE Signature - 22 02 05 00 00 66 00 67
{
	int num;
...
BOOL func_104(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3E22 Signature - 22 03 05 00 00 5D
{
...
BOOL func_105() // Position - 0x3EC0 Signature - 22 00 02 00 00 5D E5 EB 10 18 07 03 27 1C 08
{
	return Global_1108965.f_775.f_28 != -1;
}

struct<2> func_106(int iParam0) // Position - 0x3ED3 Signature - 22 01 03 00 00 11 66 00 5D
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_107(var uParam0, var uParam1) // Position - 0x3EE7 Signature - 22 02 04 00 00 66 00 39 2C
{
	if (!func_194(uParam0))
		return false;
...
BOOL func_108() // Position - 0x3F1B Signature - 22 00 02 00 00 5D E5 EB 10 18 07 03 27 1C 3C
{
...
BOOL func_109(Ped pedParam0) // Position - 0x3F52 Signature - 22 01 03 00 00 66 00 03 05 00 D7
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_110(Entity eParam0) // Position - 0x3F6F Signature - 22 01 04 00 00 66 00 03 05 00 75 05
{
	Hash entityModel;
...
Ped func_111(Ped pedParam0) // Position - 0x3FA1 Signature - 22 01 04 00 00 66 00 03 05 00 75 8B
{
	Ped ped;
...
BOOL func_112() // Position - 0x3FDD Signature - 22 00 02 00 00 37 49
{
...
int func_113(int iParam0, var uParam1) // Position - 0x4007 Signature - 22 02 04 00 00 66 00 50
{
	return iParam0;
}

BOOL func_114() // Position - 0x4011 Signature - 22 00 02 00 00 85 00
{
	if (Global_1048576)
		return true;
...
BOOL func_115(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x4069 Signature - 22 09 10 00 00 66 07
{
	Player player;
	Ped ped;
	BOOL isEntityDead;
...
BOOL func_116() // Position - 0x428F Signature - 22 00 02 00 00 5D 3A
{
	return Global_1896762.f_352;
}

BOOL func_117() // Position - 0x429E Signature - 22 00 02 00 00 5D 1C 9B 1D 27 02 50
{
	return Global_1940252.f_2;
}

BOOL func_118() // Position - 0x42AC Signature - 22 00 03 00 00 03 01 00 9E 03 05 00 2F
{
	Ped mountOwnedByPlayer;
...
BOOL func_119(Hash hParam0, int iParam1) // Position - 0x42F3 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 30
{
	if (hParam0 == 0)
		return false;
...
void func_120(int iParam0, BOOL bParam1) // Position - 0x430D Signature - 22 02 06 00 00 66
{
	int num;
	int num2;
...
void func_121(int iParam0, int iParam1) // Position - 0x433A Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 06
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

int func_122(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x434B Signature - 22 06 18
{
	int num;
	var unk13;
	int num2;
...
BOOL func_123(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4386 Signature - 22 03 05 00 00 66 01 8B 1E 00 66 00 03 05 00 43 05 8B 05 00 66 02 50 03 01 66 00 03 05 00 F0 05 8B 05 00 66 02 50 03 01 66 00 03 05 00 2F 03 05 00 75 05 8B 05 00 66 02 50 03 01 66 00 5D AB AD 13 63 13 27 0C 09
{
	if (bParam1)
	{
...
void func_124(BOOL bParam0, BOOL bParam1) // Position - 0x43D3 Signature - 22 02 06 00 00 03 01 00 9E
{
	Player player;
	Player player2;
...
BOOL func_125(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x446F Signature - 22 03 05 00 00 66 01 8B 1E 00 66 00 03 05 00 43 05 8B 05 00 66 02 50 03 01 66 00 03 05 00 F0 05 8B 05 00 66 02 50 03 01 66 00 03 05 00 2F 03 05 00 75 05 8B 05 00 66 02 50 03 01 66 00 5D AB AD 13 63 13 27 0C 11
{
	if (bParam1)
	{
		if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(plParam0))
...
void func_126(int iParam0, int iParam1) // Position - 0x44BC Signature - 22 02 04 00 00 66 00 66 01 39
{
...
void func_127(int iParam0) // Position - 0x4500 Signature - 22 01 03 00 00 5D DD D3 10 27 03 66
{
	Global_1102813.f_3 = Global_1102813.f_3 || iParam0;
	return;
}

char* func_128(int iParam0) // Position - 0x4517 Signature - 22 01 03 00 00 66 00 3C 06
{
	switch (iParam0)
	{
...
void func_129(var uParam0) // Position - 0x458B Signature - 22 01 1A
{
	Hash i;
	BOOL flag;
	Hash hash;
...
void func_130(var uParam0, BOOL bParam1) // Position - 0x471F Signature - 22 02 07 00 00 39
{
	int num;
	int num2;
	int num3;
...
int func_131(var uParam0) // Position - 0x476A Signature - 22 01 0A 00 00 39
{
	int num;
	Player player;
	int num2;
...
Hash func_132(Hash hParam0, BOOL bParam1) // Position - 0x47D2 Signature - 22 02 27
{
	int i;
	int num;
	var unk;
...
Hash func_133(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4865 Signature - 22 03 2F 00 00 4B
{
	int i;
	int num;
	var unk;
...
BOOL func_134(int iParam0) // Position - 0x49C4 Signature - 22 01 03 00 00 66 00 08
{
	return iParam0 > -1 && iParam0 <= 32;
}

BOOL func_135(Hash hParam0, Hash hParam1) // Position - 0x49DA Signature - 22 02 04 00 00 66 00 2F 39 F3 42 00 05 8B 04
{
	if (!func_119(hParam0, 0))
		return false;
...
BOOL func_136(Hash hParam0) // Position - 0x4A26 Signature - 22 01 03 00 00 66 00 37
{
...
BOOL func_137(Hash hParam0, Hash hParam1) // Position - 0x4A41 Signature - 22 02 04 00 00 66 00 2F 39 F3 42 00 05 8B 0F
{
	if (!func_119(hParam0, 0))
...
int func_138(Hash hParam0, BOOL bParam1) // Position - 0x4A82 Signature - 22 02 0B 00 00 66 00 2F
{
	var unk;
...
int func_139(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4ADA Signature - 22 04 27
{
	var unk;
	int num;
	int i;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_140(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x4B6E Signature - 22 06 09 00 00 2F 66 03 32 66 02 76 6D 0F 8A 04 00 2F 50 06 01 66 00 2F
{
	int i;
...
int func_141(Hash hParam0) // Position - 0x4BFE Signature - 22 01 0A 00 00 66 00 2F 39 F3 42 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 3B 05 8B 04 00 2F 50 01 01 4B 03 27 01
{
	var unk;
...
int func_142(Hash hParam0) // Position - 0x4C29 Signature - 22 01 0A 00 00 66 00 2F 39 F3 42 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 3B 05 8B 04 00 2F 50 01 01 4B 03 27 02
{
	var unk;
...
BOOL func_143() // Position - 0x4C54 Signature - 22 00 02 00 00 03 01 00 AA
{
...
int func_144(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4C70 Signature - 22 04 0D
{
...
BOOL func_145(BOOL bParam0) // Position - 0x4D32 Signature - 22 01 03 00 00 39 38 70 00 08 15 04
{
	if (func_229() == -1)
		return true;
...
BOOL func_146(Hash hParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x4D50 Signature - 22 05 11
{
	int num;
	var unk;
	var unk6;
...
BOOL func_147(Hash hParam0) // Position - 0x4DC8 Signature - 22 01 03 00 00 66 00 3C 04
{
	switch (hParam0)
	{
		case -1551258934:
...
int func_148(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x4DF5 Signature - 22 03 06 00 00 66 00 2F
{
	int num;
...
void func_149(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x4E5F Signature - 22 12
{
	int i;
...
BOOL func_150(Hash hParam0) // Position - 0x4EDD Signature - 22 01 03 00 00 66 00 39 FE 4B 00 37 8D FA 70 F8 0B 6A
{
...
struct<5> func_151(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x4F0B Signature - 22 03 2F 00 00 66
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_152(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x527F Signature - 22 07 0D
{
	var outGuid;
...
BOOL func_153(Any* panParam0) // Position - 0x52B0 Signature - 22 01 03 00 00 66 00 76
{
...
BOOL func_154(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x52E6 Signature - 22 04 06 00 00 4B 00 39 B0 52 00 05 8B 04 00 2F 50 04 01 4B 00 39
{
	if (!func_153(&uParam0))
		return false;
...
void func_155(int iParam0) // Position - 0x5315 Signature - 22 01 06 00 00 03
{
	Player player;
	Ped ped;
	BOOL flag;
...
void func_156(int iParam0, int iParam1) // Position - 0x53C7 Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 01
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_157(var uParam0) // Position - 0x53DC Signature - 22 01 03 00 00 66 00 27
{
	if (uParam0->f_24 == 0)
		return false;
...
BOOL func_158(Any* panParam0, Any* panParam1) // Position - 0x5409 Signature - 22 02 04 00 00 66 00 66 01 03
{
...
void func_159(var uParam0) // Position - 0x5421 Signature - 22 01 03 00 00 08 66 00 6C
{
	uParam0->f_25 = -1;
	uParam0->f_24 = 0;
	uParam0->f_23 = 0;
...
int func_160(Hash hParam0) // Position - 0x5438 Signature - 22 01 03 00 00 66 00 39 F4
{
	return func_248(hParam0);
}

BOOL func_161(BOOL bParam0) // Position - 0x5446 Signature - 22 01 03 00 00 85 13
{
	return Global_1958675 && bParam0 != false;
}

void func_162(BOOL bParam0) // Position - 0x5457 Signature - 22 01 03 00 00 66 00 39 46
{
	if (!func_161(bParam0))
...
int func_163(Hash hParam0) // Position - 0x5474 Signature - 22 01 04 00 00 2F
{
	int i;
...
void func_164() // Position - 0x54AC Signature - 22 00 02 00 00 09 39 87
{
	func_249(true);
	func_250(true);
	return;
...
void func_165() // Position - 0x54BE Signature - 22 00 02 00 00 03 01 00 9E 03
{
...
int func_166(BOOL bParam0) // Position - 0x54DA Signature - 22 01 20
{
	var unk;
...
int func_167(BOOL bParam0) // Position - 0x5502 Signature - 22 01 1B 00 00 4B 03 6A 6A 80
{
	var unk;
...
BOOL func_168(Ped pedParam0) // Position - 0x552A Signature - 22 01 06 00 00 66 00 2F
{
...
void func_169(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x559F Signature - 22 03 05 00 00 66 01 8B 1F
{
	if (bParam1)
	{
		func_253(78);
...
BOOL func_170(Player plParam0) // Position - 0x55D9 Signature - 22 01 05 00 00 66 00 03 05 00 43
{
	Vehicle vehicleOwnedByPlayer;
	Ped playerPed;
...
BOOL func_171() // Position - 0x5633 Signature - 22 00 03 00 00 03 01 00 9E 03 05 00 7E
{
	Vehicle vehicleOwnedByPlayer;
...
void func_172() // Position - 0x5662 Signature - 22 00 02 00 00 6F
{
	if (func_256(8, 255))
		return;
...
void func_173(BOOL bParam0, BOOL bParam1) // Position - 0x567C Signature - 22 02 04 00 00 66 00 8B 16 00 6D 46
{
	if (bParam0)
	{
		func_253(70);
...
void func_174(BOOL bParam0, BOOL bParam1) // Position - 0x56AD Signature - 22 02 04 00 00 66 00 8B 16 00 6D 42
{
	if (bParam0)
	{
		func_253(66);
...
void func_175(Hash hParam0) // Position - 0x56E5 Signature - 22 01 03 00 00 66 00 09 39 E4
{
	func_258(hParam0, true);
	return;
}

int func_176(BOOL bParam0, Hash hParam1) // Position - 0x56F4 Signature - 22 02 04 00 00 03 01 00 7F
{
...
void func_177() // Position - 0x574A Signature - 22 00 02 00 00 5D 1F
{
...
BOOL func_178() // Position - 0x576C Signature - 22 00 03 00 00 2F 67 02 2F
{
	int i;
...
int func_179() // Position - 0x5798 Signature - 22 00 02 00 00 5D EB
{
	return Global_1893611.f_2;
}

int func_180(int iParam0, BOOL bParam1) // Position - 0x57A6 Signature - 22 02 04 00 00 66 00 3C 8C
{
	switch (iParam0)
	{
		case 0:
...
int func_181(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x5F6B Signature - 22 04 07 00 00 39
{
	int num;
...
BOOL func_182(Player plParam0, BOOL bParam1) // Position - 0x5FB9 Signature - 22 02 06 00 00 03 01 00 DA
{
	int i;
	Any gangId;
...
void func_183() // Position - 0x605A Signature - 22 00 02 00 00 09 39 4D
{
	func_265(true);
	func_266(true, true);
	return;
...
int func_184(Player plParam0, BOOL bParam1) // Position - 0x606D Signature - 22 02 04 00 00 66 01 8B 0E
{
	if (bParam1)
		if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(plParam0))
			return -1;
...
Vector3 func_185(int iParam0, int iParam1) // Position - 0x6094 Signature - 22 02 07 00 00 66 00 08
{
	var unk;
...
float func_186(int iParam0, int iParam1) // Position - 0x60EB Signature - 22 02 05 00 00 66 00 08
{
	float num;
...
void func_187(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0x6136 Signature - 22 09 0F
{
	var entityCoords;
	float num;
...
int func_188(int iParam0) // Position - 0x6191 Signature - 22 01 03 00 00 66 00 39 C2
{
	return func_267(iParam0);
}

BOOL func_189(int iParam0) // Position - 0x619F Signature - 22 01 03 00 00 5D DD D3 10 80 1A 27 07
{
	return Global_1102813.f_26.f_7 && iParam0 != false;
}

BOOL func_190(int iParam0, int iParam1) // Position - 0x61B4 Signature - 22 02 04 00 00 66 00 5D 77
{
	return MISC::IS_BIT_SET(Global_1072759.f_22475.f_417[iParam0 /*12*/], iParam1);
}

void func_191() // Position - 0x61D0 Signature - 22 00 02 00 00 5D 77 5E 10 18 69
{
	SCRIPTS::_SET_ALL_PLAYER_BITS(&(Global_1072759.f_21353.f_260));
	return;
}

BOOL func_192(Any* panParam0, int iParam1, int iParam2) // Position - 0x61E6 Signature - 22 03 07
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_193() // Position - 0x621D Signature - 22 00 02 00 00 5D DD D3 10 78
{
	return Global_1102813.f_3672;
}

BOOL func_194(int iParam0) // Position - 0x622C Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21
{
	switch (iParam0)
	{
		case 2:
...
int func_195(int iParam0) // Position - 0x626B Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 2E
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_196() // Position - 0x6301 Signature - 22 00 03 00 00 2F 67 02 66
{
	int i;
...
Ped func_197(Ped pedParam0) // Position - 0x632C Signature - 22 01 04 00 00 66 00 39 EF
{
	Ped ped;
...
BOOL func_198() // Position - 0x6358 Signature - 22 00 02 00 00 70
{
	return ANIMSCENE::DOES_ANIM_SCENE_EXIST(Global_26573) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(Global_26573, false);
}

BOOL func_199(int iParam0, int iParam1) // Position - 0x6374 Signature - 22 02 04 00 00 66 01 6D FF 15 06 00 03 01 00 D5 67 01 66 01 2F 35 6A 05 8B 06 00 66 01 6D 20 7E 30 8B 04 00 2F 50 02 01 66 01 5D AB AD 13 63 13 27 09
{
	if (iParam1 == 255)
...
void func_200(int iParam0) // Position - 0x63AE Signature - 22 01 04 00 00 03 01 00 D5
{
	int num;
...
void func_201(int iParam0, var uParam1, var uParam2) // Position - 0x63DE Signature - 22 03 06 00 00 66 00 67
{
	int num;
...
BOOL func_202(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x63FA Signature - 22 04 06 00 00 66 01
{
	if (iParam1 < 0 || iParam1 > 32)
		return false;
...
void func_203(int iParam0, int iParam1) // Position - 0x649C Signature - 22 02 05 00 00 66 00 5D
{
	int address;
...
BOOL func_204(int iParam0, int iParam1) // Position - 0x64C0 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 01
{
	return iParam0 && iParam1 != false;
}

void func_205(var uParam0) // Position - 0x64CF Signature - 22 01 03 00 00 66 00 73
{
	func_280(uParam0, 0f);
	return;
}

void func_206(var uParam0) // Position - 0x64DE Signature - 22 01 03 00 00 73
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_207( Param0) // Position - 0x64F4 Signature - 22 01 04 00 00 39
{
	int num;
...
void func_208(Any anParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, Hash hParam20) // Position - 0x6519 Signature - 22 15 17 00 00 66 00 6D 13 4B 01 2D 66 14 39 F1 83 00 66
{
...
void func_209(var uParam0) // Position - 0x6557 Signature - 22 01 19
{
	BOOL flag;
	BOOL flag2;
	int cashBalance;
...
void func_210(var uParam0) // Position - 0x6791 Signature - 22 01 1B 00 00 4B 03 6A 6A 09
{
	BOOL flag;
	BOOL flag2;
	int cashBalance;
...
int func_211() // Position - 0x69E7 Signature - 22 00 02 00 00 5D 77 5E 10 18 10
{
	return Global_1072759.f_23824.f_4;
}

var func_212(BOOL bParam0, var uParam1, var uParam2) // Position - 0x69F8 Signature - 22 03 05 00 00 66 00 8B 08
{
	if (bParam0)
		return uParam1;
...
int func_213(int iParam0, int iParam1) // Position - 0x6A0F Signature - 22 02 04 00 00 66 00 3C 07 00 55
{
	switch (iParam0)
	{
		case joaat("NFT_CATEGORY_AMBARINO"):
...
int func_214(int iParam0, int iParam1) // Position - 0x6A76 Signature - 22 02 04 00 00 66 00 3C 07 00 00
{
	switch (iParam0)
	{
		case 0:
...
Hash func_215(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6AF3 Signature - 22 03 06 00 00 2F
{
	int num;
...
BOOL func_216(Hash hParam0) // Position - 0x6B8F Signature - 22 01 03 00 00 66 00 39 FE 4B 00 37 0F
{
	return func_141(hParam0) == 1946043663;
}

BOOL func_217(Hash hParam0) // Position - 0x6BA3 Signature - 22 01 03 00 00 66 00 39 FE 4B 00 37 8D FA 70 F8 0B 50
{
	return func_141(hParam0) == -126813555;
}

BOOL func_218(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x6BB7 Signature - 22 03 05 00 00 66 00 39
{
	if (!func_285(iParam0))
		return false;
...
Hash func_219(Hash hParam0) // Position - 0x6BEF Signature - 22 01 03 00 00 66 00 50 01 01 22 02 04 00 00 66 00 11
{
	return hParam0;
}

BOOL func_220(Hash hParam0, Hash hParam1) // Position - 0x6BF9 Signature - 22 02 04 00 00 66 00 11
{
...
int func_221(Hash hParam0, BOOL bParam1) // Position - 0x6C2F Signature - 22 02 05 00 00 66 00 11
{
	int num;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_222(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x6C68 Signature - 22 06 09 00 00 2F 66 03 32 66 02 76 6D 0F 8A 04 00 2F 50 06 01 66 00 39
{
	int i;
...
void func_223(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x6CF7 Signature - 22 04 2B 00 00 66 02 76 6D 0F 8A 06 00 50 04 00 68 16 00 66 03 66 02 76 20 6A 05 8B 05 00 66 03 09 35 30 8B 03 00 50 04 00 4B 0D 6A 80 01 6D 0A 3D 41 41 66 00 4B 0D 03 09 00 3F
{
	int i;
	int j;
	int k;
...
Hash func_224(Hash hParam0, int iParam1) // Position - 0x6ECD Signature - 22 02 07 00 00 66 00 2F
{
	int num;
	var unk;
	Hash hash;
...
int func_225(Hash hParam0, BOOL bParam1) // Position - 0x6F47 Signature - 22 02 18
{
	var unk;
	int num;
	int num2;
...
int func_226(Hash hParam0, int iParam1) // Position - 0x6FA6 Signature - 22 02 04 00 00 66 01 2F
{
	if (iParam1 == 0)
		return 0;
...
int func_227(BOOL bParam0) // Position - 0x6FD2 Signature - 22 01 03 00 00 39 38 70 00 08 15 17
{
	if (func_229() == -1)
	{
...
struct<4> func_228(Hash hParam0, BOOL bParam1) // Position - 0x7013 Signature - 22 02 09 00 00 66 00
{
	var unk;
...
int func_229() // Position - 0x7038 Signature - 22 00 02 00 00 5D 17 00 18 27 0E
{
	return Global_1572887.f_14;
}

BOOL func_230(Hash hParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x7046 Signature - 22 05 6A
{
	int num;
	var unk;
	int num2;
...
BOOL func_231(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x715E Signature - 22 07 3A
{
	var unk;
	int num;
	var unk15;
...
BOOL func_232(Hash hParam0, Any* panParam1) // Position - 0x727C Signature - 22 02 05 00 00 66 00 66
{
	int num;
...
BOOL func_233(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x7452 Signature - 22 03 05 00 00 66 00 66 01 66
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_234(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x7469 Signature - 22 03 05 00 00 66 00 8B 21
{
	if (bParam0)
	{
...
int func_235(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x74B2 Signature - 22 03 05 00 00 66 00 8B 0E
{
	if (bParam0)
	{
		func_298(iParam1, 1, 0, 0);
...
struct<4> func_236(BOOL bParam0) // Position - 0x74CE Signature - 22 01 04 00 00 5D
{
	int num;
...
struct<4> func_237(BOOL bParam0) // Position - 0x756E Signature - 22 01 04 00 00 66 00 39 D2 6F 00 67 03 66 03 11 15
{
	int num;
...
int func_238(Hash hParam0, BOOL bParam1) // Position - 0x760F Signature - 22 02 04 00 00 66 00 39 FE
{
...
BOOL func_239(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7646 Signature - 22 05 07 00 00 66 00 42
{
	return func_301(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_240(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x7661 Signature - 22 03 09 00 00 66
{
	var unk;
...
struct<4> func_241(BOOL bParam0) // Position - 0x7682 Signature - 22 01 04 00 00 66 00 39 D2 6F 00 67 03 66 03 11 0B
{
	int num;
...
BOOL func_242(Hash hParam0, int iParam1) // Position - 0x76EC Signature - 22 02 08 00 00 66 00
{
	Hash hash;
	int num;
	int i;
...
BOOL func_243(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x7759 Signature - 22 08
{
	return func_304(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_244(Any* panParam0) // Position - 0x776F Signature - 22 01 03 00 00 66 00 39 B0
{
...
int func_245(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x778B Signature - 22 04 06 00 00 4B 00 39 B0 52 00 05 8B 04 00 2F 50 04 01 4B 00 03
{
	if (!func_153(&uParam0))
		return 0;
...
BOOL func_246(int iParam0) // Position - 0x77A7 Signature - 22 01 03 00 00 66 00 2F 23
{
	if (iParam0 <= 0)
		return false;
...
void func_247() // Position - 0x77C5 Signature - 22 00 02 00 00 5D DD D3 10 27
{
	if (!Global_1102813.f_16)
		return;
...
int func_248(Hash hParam0) // Position - 0x77F4 Signature - 22 01 03 00 00 66 00 39 DD
{
	if (!func_150(hParam0))
		return 0;
...
void func_249(BOOL bParam0) // Position - 0x7887 Signature - 22 01 03 00 00 66 00 8B 0A 00 6D 75
{
	if (bParam0)
		func_253(117);
	else
...
void func_250(BOOL bParam0) // Position - 0x78A5 Signature - 22 01 03 00 00 66 00 8B 0A 00 6D 74
{
	if (bParam0)
		func_253(116);
	else
...
BOOL func_251(var uParam0, BOOL bParam1) // Position - 0x78C3 Signature - 22 02 44
{
	var unk;
	var unk30;
	int num;
...
BOOL func_252(var uParam0, BOOL bParam1) // Position - 0x796E Signature - 22 02 3F
{
	var unk;
	var unk25;
	int num;
...
int func_253(int iParam0) // Position - 0x7A19 Signature - 22 01 03 00 00 5D DD D3 10 80 04 66 00 62 39 2B
{
...
int func_254(int iParam0) // Position - 0x7A36 Signature - 22 01 03 00 00 5D DD D3 10 80 04 66 00 62 39 5E
{
...
float func_255(Ped pedParam0, Vehicle veParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7A53 Signature - 22 04 06 00 00 66 00 03
{
...
BOOL func_256(int iParam0, int iParam1) // Position - 0x7A9B Signature - 22 02 04 00 00 66 01 6D FF 15 06 00 03 01 00 D5 67 01 66 01 2F 35 6A 05 8B 06 00 66 01 6D 20 7E 30 8B 04 00 2F 50 02 01 66 01 5D AB AD 13 63 13 27 0A
{
	if (iParam1 == 255)
		iParam1 = PLAYER::NETWORK_PLAYER_ID_TO_INT();
...
void func_257(int iParam0) // Position - 0x7AD5 Signature - 22 01 03 00 00 11 66 00 39
{
	func_312(2, iParam0);
	return;
}

void func_258(Hash hParam0, BOOL bParam1) // Position - 0x7AE4 Signature - 22 02 08 00 00 66 01
{
...
BOOL func_259() // Position - 0x7C3B Signature - 22 00 02 00 00 5D 17 00 18 27 0A
{
	return !Global_1572887.f_10;
}

BOOL func_260() // Position - 0x7C4A Signature - 22 00 02 00 00 03 01 00 84
{
...
void func_261(Hash hParam0, int iParam1) // Position - 0x7C5E Signature - 22 02 04 00 00 66 00 27 02
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_262(int iParam0) // Position - 0x7C71 Signature - 22 01 03 00 00 66 00 09 39 B1
{
	return func_318(iParam0, 1);
}

BOOL func_263(int iParam0) // Position - 0x7C80 Signature - 22 01 03 00 00 66 00 2F 7E
{
	return iParam0 >= 0 && iParam0 <= 150;
}

int func_264(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x7C96 Signature - 22 04 0B 00 00 1D
{
	int num;
	int num2;
	int num3;
...
void func_265(BOOL bParam0) // Position - 0x7D4D Signature - 22 01 03 00 00 66 00 05
{
	if (!bParam0)
	{
		func_254(5);
...
void func_266(BOOL bParam0, BOOL bParam1) // Position - 0x7D77 Signature - 22 02 04 00 00 6D
{
	if (func_313(255) == 4)
		return;
...
int func_267(int iParam0) // Position - 0x7EC2 Signature - 22 01 03 00 00 66 00 3C 05 00 00 00 00 00 1B 00 01 00 00 00 1D 00 02 00 00 00 1F 00 03 00 00 00 21 00 04 00 00 00 23 00 68 28 00 37 80
{
	switch (iParam0)
	{
		case 0:
...
int func_268(int iParam0) // Position - 0x7F1D Signature - 22 01 03 00 00 66 00 3C 05 00 00 00 00 00 1B 00 01 00 00 00 1D 00 02 00 00 00 1F 00 03 00 00 00 21 00 04 00 00 00 23 00 68 28 00 37 07
{
	switch (iParam0)
	{
		case 0:
...
void func_269(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7F78 Signature - 22 04 06 00 00 39
{
	func_324();
...
BOOL func_270(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0x7FAC Signature - 22 05 0A
{
	Hash hash;
	int endRange;
	int randomIntInRange;
...
void func_271(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, float fParam7, float fParam8, float fParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13) // Position - 0x7FFD Signature - 22 0E
{
	if (func_313(255) == 4)
		return;
...
BOOL func_272(int iParam0, int iParam1) // Position - 0x81D5 Signature - 22 02 04 00 00 66 00 5D E1
{
	return func_326(Global_1206497.f_78[iParam0 /*20*/].f_6, iParam1);
}

Ped func_273(Ped pedParam0) // Position - 0x81EF Signature - 22 01 05 00 00 66 00 03 05 00 75
{
...
BOOL func_274(int iParam0, int iParam1) // Position - 0x823A Signature - 22 02 04 00 00 66 00 87
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_275(int iParam0) // Position - 0x8252 Signature - 22 01 03 00 00 66 00 42
{
...
BOOL func_276(int iParam0) // Position - 0x8269 Signature - 22 01 07 00 00 66
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_277(int iParam0, int iParam1) // Position - 0x8335 Signature - 22 02 04 00 00 66 00 5D 12
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_278(int iParam0) // Position - 0x834E Signature - 22 01 03 00 00 5D 00
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_279() // Position - 0x8361 Signature - 22 00 02 00 00 39
{
	if (!func_260())
		return false;
...
void func_280(var uParam0, float fParam1) // Position - 0x837C Signature - 22 02 04 00 00 39
{
...
int func_281(var uParam0) // Position - 0x83A2 Signature - 22 01 09
{
	var unk;
	int num;
...
void func_283(Any anParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, Hash hParam20) // Position - 0x8443 Signature - 22 15 17 00 00 66 00 6D 13 4B 01 2D 66 14 39 F1 83 00 5D 77 5E 10 18 10 5D 80 06 78 4B
{
	func_282(anParam0, uParam1, hParam20);
...
void func_284(Any anParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, Hash hParam20) // Position - 0x847A Signature - 22 15 17 00 00 66 00 6D 13 4B 01 2D 66 14 39 F1 83 00 5D 77 5E 10 18 10 5D 80 06 78 62
{
	func_282(anParam0, uParam1, hParam20);
...
BOOL func_285(int iParam0) // Position - 0x84B1 Signature - 22 01 03 00 00 66 00 2F 15
{
	if (iParam0 == 0)
		return false;
...
BOOL func_286(int iParam0, Hash hParam1) // Position - 0x84C9 Signature - 22 02 E0
{
	var unk;
	int num;
	Hash unlockHash;
...
BOOL func_287(Hash hParam0, int iParam1) // Position - 0x8612 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 0B
{
	if (hParam0 == 0)
		return false;
...
void func_288(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x862C Signature - 22 04 2B 00 00 66 02 76 6D 0F 8A 06 00 50 04 00 68 16 00 66 03 66 02 76 20 6A 05 8B 05 00 66 03 09 35 30 8B 03 00 50 04 00 4B 0D 6A 80 01 6D 0A 3D 41 41 66 00 4B 0D 03 09 00 96
{
	int i;
	int j;
	int k;
...
void func_289(Hash hParam0, var uParam1, var uParam2) // Position - 0x8802 Signature - 22 03 05 00 00 2F
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_290(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8A0E Signature - 22 07 1B
{
	Hash hash;
...
void func_291(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x8AEC Signature - 22 05 07 00 00 4B
{
...
BOOL func_292(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x8B07 Signature - 22 04 06 00 00 66 03
{
...
int func_293(int iParam0) // Position - 0x8B2C Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 66 00 03
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_294(Hash hParam0) // Position - 0x8B4D Signature - 22 01 03 00 00 66 00 03 05 00 A4
{
...
BOOL func_295(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x8B63 Signature - 22 06 08 00 00 2F
{
	*uParam1 = 0;
...
struct<17> func_296(Hash hParam0, var uParam1) // Position - 0x8BD0 Signature - 22 02 15
{
	var unk;
...
BOOL func_297(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x8C23 Signature - 22 04 06 00 00 66 02 66 03
{
...
void func_298(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8C3B Signature - 22 04 07 00 00 66 00 08 15 03 00 50 04 00 2F
{
	int i;
...
struct<4> func_299() // Position - 0x8CD9 Signature - 22 00 06 00 00 42
{
	var unk;
...
int func_300() // Position - 0x8CE5 Signature - 22 00 02 00 00 37 20
{
...
int func_301(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x8D02 Signature - 22 09 10 00 00 66 00
{
...
BOOL func_302(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x8D81 Signature - 22 04 07 00 00 2F 39
{
	int inventoryId;
...
BOOL func_303(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x8DC6 Signature - 22 03 05 00 00 66 02
{
...
BOOL func_304(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x8DF9 Signature - 22 05 07 00 00 66 00 03
{
...
int func_305() // Position - 0x8E33 Signature - 22 00 03 00 00 37
{
	int value;
...
BOOL func_306(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8E77 Signature - 22 04 06 00 00 66 02 2F
{
	if (iParam2 < 0)
		return false;
...
BOOL func_307(Any* panParam0, Any* panParam1, BOOL bParam2) // Position - 0x8EB2 Signature - 22 03 06 00 00 66 00 03 05 00 EC 05 8B 04 00 2F 50 03 01 66 02 39 D2 6F 00 67 05 66 05 66 00 66 01 6D 1D
{
	int inventoryId;
...
BOOL func_308(var uParam0, int iParam1) // Position - 0x8EE6 Signature - 22 02 04 00 00 66 00 76 66 01 39
{
	return func_326(*uParam0, iParam1);
}

BOOL func_309(Any* panParam0, Any* panParam1, BOOL bParam2) // Position - 0x8EF7 Signature - 22 03 06 00 00 66 00 03 05 00 EC 05 8B 04 00 2F 50 03 01 66 02 39 D2 6F 00 67 05 66 05 66 00 66 01 6D 18
{
	int inventoryId;
...
BOOL func_310(Any* panParam0, int iParam1, int iParam2) // Position - 0x8F2B Signature - 22 03 08 00 00 66 01 6D 1F 59 67 05 66 01 6D 1F 47 67 06 66 05 66 00 17 01 66 06 03 09 00 8E 67 07 66 05 66 00 63 01 66 06 03 08 00 3A
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_311(Any* panParam0, int iParam1, int iParam2) // Position - 0x8F5E Signature - 22 03 08 00 00 66 01 6D 1F 59 67 05 66 01 6D 1F 47 67 06 66 05 66 00 17 01 66 06 03 09 00 8E 67 07 66 05 66 00 63 01 66 06 03 08 00 E4
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_312(int iParam0, int iParam1) // Position - 0x8F90 Signature - 22 02 0D
{
	int eventData;
	var value;
	Player player;
...
int func_313(int iParam0) // Position - 0x90B4 Signature - 22 01 03 00 00 66 00 6D
{
	if (iParam0 == 255)
...
void func_314(var uParam0) // Position - 0x90FF Signature - 22 01 21
{
	var unk;
...
void func_315(float* pfParam0) // Position - 0x9111 Signature - 22 01 0C
{
	var unk;
...
int func_316(Hash hParam0) // Position - 0x9123 Signature - 22 01 08 00 00 5D
{
	var unk;
...
BOOL func_317(Hash hParam0, int iParam1, Vector3* pvParam2, float* pfParam3) // Position - 0x914F Signature - 22 04 0B 00 00 5D
{
	var unk;
...
BOOL func_318(int iParam0, int iParam1) // Position - 0x91B1 Signature - 22 02 04 00 00 66 00 39 3F 1D 00 05 8B 04
{
	if (!func_25(iParam0))
		return false;
...
int func_319(var uParam0, var uParam1, var uParam2) // Position - 0x91D9 Signature - 22 03 06 00 00 1D
{
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x9214 Signature - 22 03 05 00 00 66 00 73
{
...
void func_321(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x923E Signature - 22 04 06 00 00 66 00 39 ED
{
	func_335(iParam0);
...
void func_322(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, int iParam30) // Position - 0x92A0 Signature - 22 1F
{
	switch (uParam0.f_5)
	{
		case 1:
...
void func_323(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x92F6 Signature - 22 0A
{
	switch (uParam0.f_5)
	{
		case 1:
...
void func_324() // Position - 0x9323 Signature - 22 00 02 00 00 6D
{
...
int func_325(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x9362 Signature - 22 03 09 00 00 2F
{
	int i;
	int num;
	float num2;
...
BOOL func_326(int iParam0, int iParam1) // Position - 0x93BF Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 00
{
	return iParam0 && iParam1 != false;
}

float func_327() // Position - 0x93CE Signature - 22 00 03 00 00 03 01 00 DA
{
...
void func_328(var uParam0, int iParam1) // Position - 0x9400 Signature - 22 02 04 00 00 66 00 76 66 01 30 66 00 32 50 02 00 22 02
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_329(var uParam0, int iParam1) // Position - 0x9411 Signature - 22 02 04 00 00 66 00 76 66 00 76 66 01 69 10 66 00 32 50 02 00 22 1D
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_330(Any anParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28) // Position - 0x9426 Signature - 22 1D
{
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_331(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x947F Signature - 22 04 07 00 00 2F 66
{
	int i;
...
void func_332(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9596 Signature - 22 04 07 00 00 66 00 08 15 03 00 50 04 00 5D
{
	int i;
...
int func_333(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9672 Signature - 22 04 06 00 00 66 00 39 EC
{
...
int func_334(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x96A5 Signature - 22 07 09
{
	if (fParam0 < fParam3)
...
void func_335(int iParam0) // Position - 0x96ED Signature - 22 01 03 00 00 66 00 5D DD
{
	Global_1102813.f_26.f_12 = iParam0;
	return;
}

void func_336(BOOL bParam0) // Position - 0x96FF Signature - 22 01 03 00 00 66 00 39 FA
{
	if (func_341(bParam0))
		return;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x98BB Signature - 22 01 03 00 00 66 00 3C 62
{
	switch (iParam0)
	{
		case 0:
...
void func_339(int iParam0) // Position - 0x9DC9 Signature - 22 01 03 00 00 08 66 00 32
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
BOOL func_340(Hash hParam0) // Position - 0x9DEC Signature - 22 01 03 00 00 66 00 03 05 00 57
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_341(BOOL bParam0) // Position - 0x9DFA Signature - 22 01 03 00 00 5D DD D3 10 80 1A 27 09 66 00 69 66
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

void func_342(var uParam0) // Position - 0x9E10 Signature - 22 01 03 00 00 2F
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
