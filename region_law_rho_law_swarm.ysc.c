...
void func_1() // Position - 0x4D Signature - 22 00 02 00 00 6D
{
	LAW::_0x7EF2A2FE38D74456(func_5(8), false);
	return;
}

void func_2() // Position - 0x60 Signature - 22 00 02 00 00 09
{
	iLocal_47 = 1;
...
BOOL func_3(var uParam0) // Position - 0x70 Signature - 22 01 03 00 00 2F
{
	return false;
}

void func_4() // Position - 0x79 Signature - 22 00 02 00 00 54
{
	switch (iLocal_47)
	{
		case 1:
...
int func_5(int iParam0) // Position - 0xE5 Signature - 22 01 04
{
	int num;
...
BOOL func_6() // Position - 0x137 Signature - 22 00 03
{
	Ped ped;
...
BOOL func_7() // Position - 0x18C Signature - 22 00 08
{
	float num;
	float num2;
	int num3;
...
Ped func_8(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x216 Signature - 22 0D
{
	Ped ped;
...
void func_9(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x256 Signature - 22 04 06
{
...
void func_10(var uParam0, int iParam1, BOOL bParam2) // Position - 0x2C4 Signature - 22 03 05 00 00 2F
{
	uParam0->f_2 = 0;
...
int func_11(var uParam0, var uParam1) // Position - 0x2FF Signature - 22 02 04 00 00 66 00 66
{
	if (uParam0 > uParam1)
		return uParam0;
...
BOOL func_12(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0x315 Signature - 22 0C
{
	int num;
...
void func_13(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x43A Signature - 22 08
{
	BOOL flag;
...
void func_14(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10) // Position - 0x504 Signature - 22 0B
{
	int num;
	int num2;
...
void func_15(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1312 Signature - 22 05
{
	switch (iParam1)
	{
		case 0:
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1AD2 Signature - 22 03 05 00 00 66 00 73
{
...
Vector3 func_17(float fParam0, var uParam1, var uParam2) // Position - 0x1AFC Signature - 22 03 07
{
	float num;
	float num2;
...
void func_18(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1B3B Signature - 22 03 05 00 00 66 00 03
{
...
void func_19(Ped pedParam0, BOOL bParam1) // Position - 0x1B80 Signature - 22 02 04 00 00 66 00 03
{
...
void func_20(Ped pedParam0, int iParam1) // Position - 0x1BC5 Signature - 22 02 04 00 00 66 01
{
	if (iParam1 == 1)
...
float func_21(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x1BEC Signature - 22 04 07 00 00 66
{
	float num;
...
int func_22(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1C11 Signature - 22 04 07 00 00 39
{
	int num;
...
int func_23(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1C5F Signature - 22 03 05 00 00 1D
{
	return func_27(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

int func_24() // Position - 0x1C75 Signature - 22 00 02 00 00 5D
{
	return Global_1893611.f_2;
}

BOOL func_25(int iParam0) // Position - 0x1C83 Signature - 22 01 03 00 00 66 00 2F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

int func_26(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1C99 Signature - 22 04 0B
{
	int num;
	int num2;
	int num3;
...
int func_27(Hash hParam0) // Position - 0x1D50 Signature - 22 01 03 00 00 66 00 3C
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
int func_28(var uParam0, var uParam1, var uParam2) // Position - 0x1E0A Signature - 22 03 06
{
	int num;
...
int func_29(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x1E45 Signature - 22 07
{
	if (fParam0 < fParam3)
