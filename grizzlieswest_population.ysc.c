...
void func_1() // Position - 0xA8 Signature - 22 00 02 00 00 03
{
...
void func_2() // Position - 0xE1 Signature - 22 00 02 00 00 86
{
...
int func_3() // Position - 0x33A Signature - 22 00 02 00 00 5D 17
{
	return Global_1572887.f_14;
}

BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x348 Signature - 22 02 05
{
	int i;
...
void func_5() // Position - 0x428 Signature - 22 00 02 00 00 1D
{
...
BOOL func_6(int iParam0) // Position - 0x4F1 Signature - 22 01 06
{
	int num;
	int num2;
	int offset;
...
void func_7() // Position - 0x570 Signature - 22 00 02 00 00 5D 8C
{
	if (ENTITY::IS_MAP_ENTITY_PINNED(Global_1939596.f_313))
...
void func_8() // Position - 0x599 Signature - 22 00 02 00 00 50
{
	return;
}

void func_9(Volume volParam0) // Position - 0x5A1 Signature - 22 01 03 00 00 66 00 03 05 00 0C
{
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x5E2 Signature - 22 03 05 00 00 66 00 03 05 00 0C 05 8B 03 00 50 03 00 66 00 66 01 25
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x661 Signature - 22 03 05 00 00 66 00 03 05 00 0C 05 8B 03 00 50 03 00 66 00 66 01 6D
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12() // Position - 0x6D7 Signature - 22 00 03 00 00 62
{
	int num;
...
void func_13(Hash hParam0) // Position - 0x73C Signature - 22 01 03 00 00 66 00 03 05 00 21 05
{
...
int func_14(int iParam0, int iParam1) // Position - 0x755 Signature - 22 02 04 00 00 66 00 3C
{
	switch (iParam0)
	{
...
BOOL func_15(int iParam0) // Position - 0x1FFA Signature - 22 01 04
{
	int num;
...
BOOL func_16(int iParam0) // Position - 0x2017 Signature - 22 01 03 00 00 66 00 37
{
...
void func_17(var uParam0, int iParam1) // Position - 0x202E Signature - 22 02 04 00 00 66 00 76
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_18(Hash hParam0) // Position - 0x2043 Signature - 22 01 03 00 00 66 00 03 05 00 21 8B
{
	if (STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		return 1;
...
int func_19(int iParam0) // Position - 0x206A Signature - 22 01 03 00 00 66 00 39
{
	return func_21(iParam0) + 30;
}

BOOL func_20() // Position - 0x207A Signature - 22 00 02 00 00 39
{
	return func_22() == 4;
}

int func_21(int iParam0) // Position - 0x2088 Signature - 22 01 03 00 00 66 00 14
{
	return iParam0 * 31;
}

int func_22() // Position - 0x2094 Signature - 22 00 02 00 00 85
{
	if (Global_1102813 <= 5)
