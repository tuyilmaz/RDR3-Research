...
void func_2() // Position - 0x5E Signature - 22 00 02 00 00 39 C4
{
	func_7();
...
void func_6() // Position - 0x10C Signature - 22 00 08
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
void func_7() // Position - 0x4C4 Signature - 22 00 02 00 00 39 9F
{
	func_15();
...
void func_8() // Position - 0x4EF Signature - 22 00 02 00 00 03
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x4FB Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 05 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 35 4B 03 39 30
{
	struct<2> eventData;
...
void func_10(int iParam0) // Position - 0x523 Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 05 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 35 4B 03 39 38
{
	struct<2> eventData;
...
void func_11(int iParam0) // Position - 0x54B Signature - 22 01 05 00 00 11 66 00 4B 03 11 03 11 00 05 41 66 03 54 0F 15 0E 00 11 66 00 09 03 0C 00 35 4B 03 39 40
{
	struct<2> eventData;
...
BOOL func_12(Ped pedParam0, int iParam1) // Position - 0x573 Signature - 22 02 05
{
	int num;
...
BOOL func_13(int iParam0) // Position - 0x672 Signature - 22 01 03 00 00 66 00 09
{
	return func_34(iParam0, 1);
}

float func_14(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x681 Signature - 22 06
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_15() // Position - 0x69F Signature - 22 00 03 00 00 5D F7 99 1D 27 33 05
{
	PersChar persChar;
...
void func_16() // Position - 0x6EC Signature - 22 00 02 00 00 54 22
{
...
void func_17(BOOL bParam0) // Position - 0x745 Signature - 22 01 04 00 00 54
{
...
int func_18() // Position - 0x979 Signature - 22 00 02 00 00 39 00
{
	switch (func_19())
	{
		case 5:
...
int func_19() // Position - 0xA00 Signature - 22 00 02 00 00 5D EB
{
	return Global_1893611.f_2;
}

int func_20(int iParam0, int iParam1) // Position - 0xA0E Signature - 22 02 04 00 00 66 00 3C
{
	switch (iParam0)
	{
		case 5:
...
Vector3 func_21() // Position - 0xAF1 Signature - 22 00 02 00 00 86
{
	return -0.235327f, 1.850775f, 0f;
}

int func_22(int iParam0) // Position - 0xB04 Signature - 22 01 03 00 00 66 00 3C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_23(int iParam0) // Position - 0xB7A Signature - 22 01 03 00 00 66 00 08
{
	return iParam0 > -1 && iParam0 < 948;
}

Ped func_24(int iParam0) // Position - 0xB91 Signature - 22 01 03 00 00 66 00 39 7A 0B 00 05 8B 04 00 2F 50 01 01 66 00 11
{
	if (!func_23(iParam0))
		return 0;
...
void func_25(var uParam0, BOOL bParam1) // Position - 0xBD7 Signature - 22 02 04 00 00 66 01
{
...
BOOL func_26() // Position - 0xBF7 Signature - 22 00 02 00 00 5D F7 99 1D 27 32
{
	if (Global_1939959.f_50 != SCRIPTS::GET_ID_OF_THIS_THREAD())
...
void func_27(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC2F Signature - 22 03 08
{
...
void func_28() // Position - 0xF52 Signature - 22 00 02 00 00 50 00 00 22 03
{
	return;
}

void func_29(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF5A Signature - 22 03 06
{
	BOOL isPedUsingThisScenario;
...
void func_30(var uParam0) // Position - 0x1130 Signature - 22 01 03 00 00 50 01 00 22 01 03 00 00 50 01 00 22 01
{
	return;
}

void func_31(var uParam0) // Position - 0x1138 Signature - 22 01 03 00 00 50 01 00 22 01 03 00 00 50 01 00 22 02
{
	return;
}

void func_32(var uParam0) // Position - 0x1140 Signature - 22 01 03 00 00 50 01 00 22 02
{
	return;
}

BOOL func_33(int iParam0, int iParam1) // Position - 0x1148 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 04 00 00 39 4F
{
	return iParam0 && iParam1 != false;
}

BOOL func_34(int iParam0, BOOL bParam1) // Position - 0x1157 Signature - 22 02 04 00 00 39 4F
{
	if (func_51() != -1)
		return false;
...
PersChar func_35(int iParam0) // Position - 0x1185 Signature - 22 01 03 00 00 66 00 39 7A 0B 00 05 8B 04 00 2F 50 01 01 66 00 5D A7 E5 1C 63 03 27 01
{
	if (!func_23(iParam0))
		return 0;
...
Volume func_36(int iParam0) // Position - 0x11A5 Signature - 22 01 04 00 00 39
{
	Volume aggregate;
...
BOOL func_37(Volume volParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x147F Signature - 22 04
{
...
Hash func_38(int iParam0) // Position - 0x149F Signature - 22 01 03 00 00 66 00 39 7A 0B 00 05 8B 04 00 2F 50 01 01 66 00 5D A7 E5 1C 17 03 50
{
	if (!func_23(iParam0))
		return 0;
...
BOOL func_39(Hash hParam0) // Position - 0x14BD Signature - 22 01 03 00 00 66 00 2F
{
	return hParam0 != 0;
}

Ped func_40(int iParam0) // Position - 0x14C9 Signature - 22 01 04 00 00 66
{
	PersChar persChar;
...
Hash func_41(int iParam0) // Position - 0x14F7 Signature - 22 01 03 00 00 66 00 39 7A 0B 00 05 8B 04 00 2F 50 01 01 66 00 5D A7 E5 1C 17 03 03
{
	if (!func_23(iParam0))
		return 0;
...
BOOL func_42(var uParam0) // Position - 0x1519 Signature - 22 01 03 00 00 66 00 76 09
{
	return func_52(*uParam0, 1);
}

void func_43(var uParam0) // Position - 0x1529 Signature - 22 01 03 00 00 66 00 73
{
	func_53(uParam0, 0f);
	return;
}

BOOL func_44(int iParam0) // Position - 0x1538 Signature - 22 01 03 00 00 66 00 39 7A 0B 00 05 8B 04 00 2F 50 01 01 66 00 5D A7 E5 1C 63 03 27 02
{
	if (!func_23(iParam0))
		return false;
...
void func_45() // Position - 0x155D Signature - 22 00 03 00 00 5D F7 99 1D 27 33 8B
{
	PersChar persChar;
...
BOOL func_46(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x1596 Signature - 22 02 04 00 00 66 00 03
{
...
BOOL func_47() // Position - 0x15EF Signature - 22 00 02 00 00 5D F7 99 1D 27 33
{
...
void func_48() // Position - 0x163F Signature - 22 00 02 00 00 54 27
{
	if (!bLocal_39)
	{
		if (iLocal_17 == joaat("world_human_barcustomer_beer"))
...
BOOL func_49() // Position - 0x1702 Signature - 22 00 02 00 00 54 1F
{
...
void func_50(var uParam0) // Position - 0x1739 Signature - 22 01 03 00 00 73
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
int func_51() // Position - 0x174F Signature - 22 00 02 00 00 5D 17
{
	return Global_1572887.f_14;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x175D Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 04 00 00 39 E5
{
	return iParam0 && iParam1 != false;
}

void func_53(var uParam0, float fParam1) // Position - 0x176C Signature - 22 02 04 00 00 39 E5
{
...
int func_54(var uParam0) // Position - 0x1792 Signature - 22 01 03 00 00 66 00 39 19
{
	if (!func_42(uParam0))
...
float func_55() // Position - 0x17E5 Signature - 22 00 03 00 00 03 01 00 1D 8B 15
{
...
void func_56(var uParam0, int iParam1) // Position - 0x1817 Signature - 22 02 04 00 00 66 00 76 66 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_57(var uParam0, int iParam1) // Position - 0x1828 Signature - 22 02 04 00 00 66 00 76 66 00
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_58(var uParam0) // Position - 0x183D Signature - 22 01 03 00 00 66 00 76 11
{
	return func_52(*uParam0, 2);
}

int func_59() // Position - 0x184D Signature - 22 00 03 00 00 03 01 00 1D 8B 0B
{
	int networkTimeAccurate;
