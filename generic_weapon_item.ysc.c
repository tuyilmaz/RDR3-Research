...
void func_1(var uParam0) // Position - 0x202 Signature - 22 01 12 00 00 37
{
	Hash weaponHash;
	Ped ped;
	var unk;
	...
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(iLocal_16.f_1))
	{
		...
		else
		{
			...
			iLocal_16.f_7 = { func_17(weaponHash, unk5, -1591664384, false) };
		}
...
BOOL func_2() // Position - 0x343 Signature - 22 00 02 00 00 54
{
...
void func_3() // Position - 0x389 Signature - 22 00 02 00 00 0D
{
...
BOOL func_4() // Position - 0x3BD Signature - 22 00 02 00 00 70
{
...
int func_5() // Position - 0x433 Signature - 22 00 02 00 00 89
{
	return iLocal_16.f_6;
}

void func_6(int iParam0) // Position - 0x43F Signature - 22 01 03 00 00 66 00 89
{
	iLocal_16.f_6 = iParam0;
	return;
}

void func_7() // Position - 0x44D Signature - 22 00 03 00 00 70
{
	Object objectIndexFromEntityIndex;
...
int func_8(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x55A Signature - 22 04 12
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
struct<2> func_9(int iParam0, int iParam1) // Position - 0x70C Signature - 22 02 06 00 00 66 00 67
{
	int num;
...
void func_10(var uParam0, var uParam1, int iParam2) // Position - 0x722 Signature - 22 03 05 00 00 4B
{
...
void func_11(Object obParam0) // Position - 0x73F Signature - 22 01 05 00 00 39
{
	Ped ped;
	Hash weaponHash;
...
void func_12(Object obParam0) // Position - 0x785 Signature - 22 01 03 00 00 66 00 03 05 00 53
{
...
Ped func_13() // Position - 0x7C9 Signature - 22 00 02 00 00 6D
{
	return PLAYER::GET_PLAYER_PED(255);
}

struct<4> func_14() // Position - 0x7D7 Signature - 22 00 06
{
	var unk;
...
BOOL func_15(var uParam0, var uParam1) // Position - 0x7E3 Signature - 22 02 04 00 00 66 00 76
{
...
struct<5> func_16(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x824 Signature - 22 03 2F
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_17(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xB98 Signature - 22 07 0D 00 00 66 00
{
	var outGuid;
...
Hash func_18(Hash hParam0, Object obParam1) // Position - 0xBC9 Signature - 22 02 0C
{
	var unk;
...
const char* func_19(var uParam0) // Position - 0xBFC Signature - 22 01 05 00 00 66 00 76
{
...
float func_20(float fParam0, float fParam1, float fParam2) // Position - 0xC4F Signature - 22 03 05 00 00 66 00 66 02
{
	if (fParam0 > fParam2)
		return fParam2;
...
BOOL func_21() // Position - 0xC76 Signature - 22 00 02 00 00 5D 08
{
	return Global_1915656.f_20637 || Global_1915656.f_22504.f_1;
}

BOOL func_22(Hash hParam0, int iParam1) // Position - 0xC94 Signature - 22 02 05 00 00 66 00 2F 39 0A 0F 00 05 8B 04 00 2F 50 02 01 66 00 39
{
	int num;
...
BOOL func_23(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD17 Signature - 22 03 05 00 00 5D
{
...
BOOL func_24() // Position - 0xE8D Signature - 22 00 03 00 00 39
{
	BOOL num;
...
BOOL func_25() // Position - 0xEB4 Signature - 22 00 02 00 00 39
{
	if (!func_54())
		return false;
...
int func_26(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xECF Signature - 22 06 18
{
	int num;
	var unk13;
	int num2;
...
BOOL func_27(Hash hParam0, int iParam1) // Position - 0xF0A Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 0D
{
	if (hParam0 == 0)
		return false;
...
BOOL func_28(Hash hParam0) // Position - 0xF24 Signature - 22 01 03 00 00 66 00 39 D9
{
	return func_33(hParam0) == joaat("consumable");
}

Hash func_29(Hash hParam0, int iParam1) // Position - 0xF38 Signature - 22 02 07
{
	int num;
	var unk;
	Hash hash;
...
void func_30(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xFB2 Signature - 22 07 2F
{
	BOOL flag;
	int value;
	var unk;
	...
	str5 = func_70(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash), value), num5);
	...
	func_75(str5, str.f_1, MISC::GET_HASH_KEY(str), num6, num5, str3, str2, 0, true);
	return;
}

struct<2> func_31(Hash hParam0) // Position - 0x1483 Signature - 22 01 07
{
	var unk;
	var unk3;
...
int func_32(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1517 Signature - 22 04 0D
{
...
int func_33(Hash hParam0) // Position - 0x15D9 Signature - 22 01 0A 00 00 66 00 2F 39 0A 0F 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 4D 05 8B 04 00 2F 50 01 01 4B 03 27 02
{
	var unk;
...
BOOL func_34(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1604 Signature - 22 04 2F
{
	var unk;
	int num;
	int num2;
...
BOOL func_35(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x16D0 Signature - 22 05 11
{
	int num;
	var unk;
	var unk6;
...
BOOL func_36(BOOL bParam0) // Position - 0x1748 Signature - 22 01 03 00 00 39 29 26 00 08 15 04
{
	if (func_76() == -1)
		return true;
...
void func_37(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1766 Signature - 22 03 05 00 00 66 00 5D
{
...
struct<4> func_38(BOOL bParam0) // Position - 0x17A0 Signature - 22 01 04 00 00 5D
{
	int num;
...
struct<4> func_39(BOOL bParam0) // Position - 0x1840 Signature - 22 01 04 00 00 66 00 39 6C 1A 00 67 03 66 03 11 15
{
	int num;
...
int func_40(Hash hParam0, BOOL bParam1) // Position - 0x18E1 Signature - 22 02 04 00 00 66 00 39 BE
{
...
BOOL func_41(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1918 Signature - 22 05 07 00 00 66 00 42
{
	return func_92(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_42(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x1933 Signature - 22 03 09
{
	var unk;
...
struct<4> func_43(BOOL bParam0) // Position - 0x1954 Signature - 22 01 04 00 00 66 00 39 6C 1A 00 67 03 66 03 11 0B
{
	int num;
...
int func_44(Hash hParam0) // Position - 0x19BE Signature - 22 01 0A 00 00 66 00 2F 39 0A 0F 00 05 8B 04 00 2F 50 01 01 66 00 4B 03 03 09 00 4D 05 8B 04 00 2F 50 01 01 4B 03 27 01
{
	var unk;
...
BOOL func_45(Hash hParam0, int iParam1) // Position - 0x19E9 Signature - 22 02 08
{
	Hash hash;
	int num;
	int i;
...
BOOL func_46(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x1A56 Signature - 22 08
{
	return func_95(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_47(BOOL bParam0) // Position - 0x1A6C Signature - 22 01 03 00 00 39 29 26 00 08 15 17
{
	if (func_76() == -1)
	{
...
BOOL func_48(Hash hParam0, int iParam1) // Position - 0x1AAD Signature - 22 02 16
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_49(Hash hParam0) // Position - 0x1B55 Signature - 22 01 06
{
	int num;
	int num2;
	int num3;
...
BOOL func_50() // Position - 0x1C11 Signature - 22 00 02 00 00 85 00
{
	if (Global_1048576)
		return true;
...
struct<2> func_51(int iParam0) // Position - 0x1C69 Signature - 22 01 03 00 00 11
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_52(var uParam0, var uParam1) // Position - 0x1C7D Signature - 22 02 04 00 00 66 00 39 43
{
	if (!func_101(uParam0))
		return false;
...
int func_53(var uParam0, var uParam1) // Position - 0x1CB1 Signature - 22 02 04 00 00 66 00 50
{
	return uParam0;
}

BOOL func_54() // Position - 0x1CBB Signature - 22 00 02 00 00 03
{
...
BOOL func_55(Hash hParam0, Hash hParam1) // Position - 0x1CCF Signature - 22 02 04 00 00 66 00 2F 39 0A 0F 00 05 8B 0F
{
	if (!func_27(hParam0, 0))
...
void func_56(Hash hParam0, var uParam1, var uParam2) // Position - 0x1D10 Signature - 22 03 05 00 00 2F
{
	*uParam1 = 0;
	*uParam2 = 0;
...
BOOL func_57() // Position - 0x1F1C Signature - 22 00 02 00 00 85 64
{
	return !Global_1913444;
}

void func_58(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x1F29 Signature - 22 06 09
{
	int i;
...
var func_59(BOOL bParam0, var uParam1, var uParam2) // Position - 0x204C Signature - 22 03 05 00 00 66 00 8B 08
{
	if (bParam0)
		return uParam1;
...
BOOL func_60(Hash hParam0, int iParam1) // Position - 0x2063 Signature - 22 02 04 00 00 66 00 2F 39 0A 0F 00 05 8B 04
{
	if (!func_27(hParam0, 0))
		return false;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_61(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x2082 Signature - 22 06 2E
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_62(Hash hParam0) // Position - 0x2175 Signature - 22 01 03 00 00 66 00 37 D4
{
...
BOOL func_63(Hash hParam0) // Position - 0x2270 Signature - 22 01 03 00 00 66 00 37 DA
{
...
Hash func_64(Hash hParam0, BOOL bParam1) // Position - 0x22EF Signature - 22 02 05 00 00 66 00 2F 39 0A 0F 00 05 8B 04 00 2F 50 02 01 66 00 66
{
	Hash hash;
...
BOOL func_65(int iParam0) // Position - 0x231D Signature - 22 01 03 00 00 66 00 3C 03
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_66(Hash hParam0) // Position - 0x2344 Signature - 22 01 27
{
	var unk;
	int i;
...
Hash func_67(Hash hParam0) // Position - 0x23B2 Signature - 22 01 12 00 00 66
{
	int num;
	var unk;
	int collectionId;
...
BOOL func_68(Hash hParam0, Hash hParam1) // Position - 0x2437 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 01
{
	if (hParam0 == 0)
		return false;
...
int func_69(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x2468 Signature - 22 04 35
{
	var unk;
...
const char* func_70(const char* sParam0, int iParam1) // Position - 0x24C7 Signature - 22 02 04 00 00 6D
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_71(Hash hParam0, int iParam1) // Position - 0x24E1 Signature - 22 02 05 00 00 66 00 66 01 39
{
	 num;
...
BOOL func_72(Hash hParam0, char* sParam1) // Position - 0x24FF Signature - 22 02 15 00 00 66
{
...
const char* func_73(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x257C Signature - 22 10
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_74(const char* sParam0, int iParam1) // Position - 0x2590 Signature - 22 02 04 00 00 66 01 37
{
...
int func_75(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x25C6 Signature - 22 09 20
{
	int num;
	var unk13;
	int num2;
...
int func_76() // Position - 0x2629 Signature - 22 00 02 00 00 5D 17
{
	return Global_1572887.f_14;
}

struct<2> func_77(int iParam0) // Position - 0x2637 Signature - 22 01 05 00 00 66 00 67
{
	int num;
...
int func_78(Hash hParam0, BOOL bParam1) // Position - 0x2647 Signature - 22 02 18
{
	var unk;
	int num;
	int num2;
...
int func_79(Hash hParam0, int iParam1) // Position - 0x26A6 Signature - 22 02 04 00 00 66 01 2F 15 04 00 2F 50 02 01 66 00 39
{
	if (iParam1 == 0)
		return 0;
...
struct<4> func_80(Hash hParam0, BOOL bParam1) // Position - 0x26D2 Signature - 22 02 09 00 00 66 00 66
{
	var unk;
...
struct<18> func_81(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x26F7 Signature - 22 07 1B
{
	Hash hash;
...
void func_82(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x27D5 Signature - 22 05 07 00 00 4B
{
...
BOOL func_83(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x27F0 Signature - 22 04 06 00 00 66 03
{
...
BOOL func_84(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2815 Signature - 22 04 06 00 00 66 02 2F
{
	if (iParam2 < 0)
		return false;
...
BOOL func_85(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2850 Signature - 22 07 3A
{
	var unk;
	int num;
	var unk15;
...
int func_86(int iParam0) // Position - 0x296E Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 66 00 03 05 00 12
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_87(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x298F Signature - 22 05 6A
{
	int num;
	var unk;
	int num2;
...
BOOL func_88() // Position - 0x2AA7 Signature - 22 00 02 00 00 5D 1C
{
...
void func_89(int iParam0) // Position - 0x2B06 Signature - 22 01 03 00 00 66 00 5D 1C 9B 1D 6C 0B
{
	Global_1940252.f_11 = iParam0;
	return;
}

void func_90(int iParam0) // Position - 0x2B16 Signature - 22 01 03 00 00 66 00 5D 1C 9B 1D 6C 0A
{
	Global_1940252.f_10 = iParam0;
	return;
}

int func_91() // Position - 0x2B26 Signature - 22 00 02 00 00 37
{
...
int func_92(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2B43 Signature - 22 09 10
{
...
BOOL func_93(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x2BC2 Signature - 22 04 07 00 00 2F 39
{
	int inventoryId;
...
BOOL func_94(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x2C07 Signature - 22 03 05 00 00 66 02
{
...
BOOL func_95(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x2C3A Signature - 22 05 07 00 00 66 00 03
{
...
BOOL func_96(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x2C74 Signature - 22 05 07 00 00 66 04
{
...
BOOL func_97(Hash hParam0) // Position - 0x2C9B Signature - 22 01 03 00 00 66 00 03 05 00 6B
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_98(Hash hParam0) // Position - 0x2CB6 Signature - 22 01 03 00 00 66 00 3C 0F
{
	switch (hParam0)
	{
...
int func_99(var uParam0, int iParam1) // Position - 0x2D99 Signature - 22 02 05 00 00 2F
{
	int i;
...
int func_100(Hash hParam0) // Position - 0x2DD6 Signature - 22 01 04 00 00 66 00 39 BE
{
	int num;
...
BOOL func_101(int iParam0) // Position - 0x2E43 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21
{
	switch (iParam0)
	{
		case 2:
...
int func_102(int iParam0) // Position - 0x2E82 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 2E
{
	switch (iParam0)
	{
		case 2:
...
Hash func_103(Hash hParam0) // Position - 0x2F18 Signature - 22 01 03 00 00 66 00 50
{
	return hParam0;
}

BOOL func_104(Hash hParam0, Hash hParam1) // Position - 0x2F22 Signature - 22 02 04 00 00 66 00 11
{
...
BOOL func_105(Hash hParam0, Hash hParam1) // Position - 0x2F58 Signature - 22 02 04 00 00 66 01 2F 15 04 00 2F 50 02 01 66 00 66
{
	if (hParam1 == 0)
		return false;
...
Hash func_106(Hash hParam0, BOOL bParam1) // Position - 0x2F7F Signature - 22 02 04 00 00 66 00 3C
{
	switch (hParam0)
	{
...
int func_107(Hash hParam0) // Position - 0x3021 Signature - 22 01 0A 00 00 66 00 2F 39 0A 0F 00 05 8B 04 00 2F 50 01 01 4B
{
	var unk;
	int num;
...
struct<10> func_108(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x305B Signature - 22 09 15
{
	int num;
...
BOOL func_109(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x312F Signature - 22 0D
{
...
BOOL func_110(Hash hParam0) // Position - 0x3150 Signature - 22 01 03 00 00 66 00 2F 39
{
	!func_27(hParam0, 0);
...
int func_111(int iParam0) // Position - 0x3176 Signature - 22 01 03 00 00 66 00 2F 8A 04 00 2F 50 01 01 66 00 03 05 00 22
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_112(Hash hParam0, int iParam1) // Position - 0x3197 Signature - 22 02 04 00 00 66 00 2F 15 04 00 2F 50 02 01 66 00 66 01 03 09 00 3C
{
	if (hParam0 == 0)
		return false;
...
int func_113(Hash hParam0, int iParam1) // Position - 0x31B1 Signature - 22 02 30
{
	var unk;
	int num;
	int num2;
...
char* func_114(Hash hParam0) // Position - 0x31FF Signature - 22 01 04 00 00 66 00 2F 39 0A 0F 00 05 8B 06 00 6D 1B 04 50 01 01 66 00 2F
{
	Hash labelHash;
...
BOOL func_115(Hash hParam0) // Position - 0x3233 Signature - 22 01 03 00 00 66 00 39 BE
{
...
char* func_116(Hash hParam0) // Position - 0x3261 Signature - 22 01 04 00 00 66 00 2F 39 0A 0F 00 05 8B 06 00 6D 1B 04 50 01 01 66 00 39
{
	Hash labelHash;
...
void func_117(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x3294 Signature - 22 03 05 00 00 37
{
...
BOOL func_118(Hash hParam0) // Position - 0x32C5 Signature - 22 01 03 00 00 66 00 03 05 00 73
{
...
int func_119(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x32DB Signature - 22 03 06
{
	int num;
...
void func_120(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x3345 Signature - 22 12
{
	int i;
...
BOOL func_121(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x33C3 Signature - 22 06 08
{
	*uParam1 = 0;
...
struct<17> func_122(Hash hParam0, var uParam1) // Position - 0x3430 Signature - 22 02 15 00 00 4B
{
	var unk;
...
Ped func_123(int iParam0) // Position - 0x3483 Signature - 22 01 03 00 00 03
{
	return PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::GET_PLAYER_INDEX());
}

int func_124(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3493 Signature - 22 05 08
{
	int num;
...
void func_125(int iParam0) // Position - 0x34C8 Signature - 22 01 03 00 00 5D
{
...
int func_126(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x354D Signature - 22 04 06 00 00 66 00
{
...
BOOL func_127(Hash hParam0, Any* panParam1) // Position - 0x3580 Signature - 22 02 05 00 00 66 00 66 01 03
{
	int num;
...
BOOL func_128(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x3756 Signature - 22 03 05 00 00 66 00 66 01
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_129(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x376D Signature - 22 03 05 00 00 66 00 8B 21
{
	if (bParam0)
	{
...
int func_130(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x37B6 Signature - 22 03 05 00 00 66 00 8B 0E
{
	if (bParam0)
	{
		func_137(iParam1, 1, 0, 0);
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_131(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x37D2 Signature - 22 04 07 00 00 2F 66
{
	int i;
...
int func_132(Ped pedParam0, Hash hParam1) // Position - 0x38E9 Signature - 22 02 06 00 00 66 00 03
{
	int num;
	int i;
...
int func_133(Hash hParam0, BOOL bParam1) // Position - 0x3947 Signature - 22 02 04 00 00 66 01 05
{
	if (!bParam1 || func_141())
...
int func_134(Hash hParam0, int iParam1) // Position - 0x3976 Signature - 22 02 2F
{
	var unk;
	int num;
	int i;
...
BOOL func_135(Hash hParam0) // Position - 0x39C0 Signature - 22 01 03 00 00 66 00 03 05 00 2D
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_136(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x39CE Signature - 22 04 06 00 00 66 02 66
{
...
void func_137(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x39E6 Signature - 22 04 07 00 00 66 00 08 15 03 00 50 04 00 2F
{
	int i;
...
BOOL func_138(Any* panParam0) // Position - 0x3A84 Signature - 22 01 03 00 00 66 00 39 43
{
...
BOOL func_139(Hash hParam0) // Position - 0x3AA0 Signature - 22 01 03 00 00 66 00 37 2C
{
...
int func_140(int iParam0, Hash hParam1) // Position - 0x3ACB Signature - 22 02 09 00 00 66 01
{
	var guid;
	int inventoryItemCountWithGuid;
...
BOOL func_141() // Position - 0x3B09 Signature - 22 00 03 00 00 03
{
...
BOOL func_142(int iParam0, int iParam1) // Position - 0x3B58 Signature - 22 02 04 00 00 66 00 66
{
	return iParam0 && iParam1 != false;
}

void func_143(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3B67 Signature - 22 04 07 00 00 66 00 08 15 03 00 50 04 00 5D
{
	int i;
...
BOOL func_144(Any* panParam0) // Position - 0x3C43 Signature - 22 01 03 00 00 66 00 76
{
...
BOOL func_145(Hash hParam0, int iParam1) // Position - 0x3C79 Signature - 22 02 05 00 00 66 00 39
{
	int num;
...
struct<4> func_146(int iParam0, Hash hParam1) // Position - 0x3C98 Signature - 22 02 09 00 00 66 00 39
{
	var unk;
...
BOOL func_147(Vehicle veParam0) // Position - 0x3CBA Signature - 22 01 03 00 00 66 00 03 05 00 10
{
...
void func_148(int iParam0) // Position - 0x3CD9 Signature - 22 01 03 00 00 08
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
int func_149(Hash hParam0) // Position - 0x3CFC Signature - 22 01 04 00 00 66 00 4B
{
	int num;
...
struct<5> func_150(int iParam0) // Position - 0x3D16 Signature - 22 01 08
{
	var unk;
...
struct<4> func_151(int iParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6) // Position - 0x3D43 Signature - 22 07 0D 00 00 66 01
{
	var outGuid;
...
void func_152(var uParam0) // Position - 0x3D70 Signature - 22 01 03 00 00 2F
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
