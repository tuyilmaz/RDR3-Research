...
void main() // Position - 0x0 Signature - 22 00 02 00 00 62
{
...
void func_1() // Position - 0x3B Signature - 22 00 02 00 00 03 00 00 01
{
	MISC::NETWORK_SET_SCRIPT_IS_SAFE_FOR_NETWORK_GAME();
	return;
}

BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0x47 Signature - 22 02 05
{
	int i;
...
void func_3(var uParam0) // Position - 0x127 Signature - 22 01
{
	int i;
...
void func_4() // Position - 0x265 Signature - 22 00 02 00 00 03 00 00 03
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_5(int iParam0, var uParam1) // Position - 0x271 Signature - 22 02 04
{
	*uParam1 = iParam0;
	return;
}
