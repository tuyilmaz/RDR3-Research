...
void func_1() // Position - 0xE3 Signature - 22 00 03 00 00 2F
{
	int i;
...
BOOL func_2(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x12C Signature - 22 04 29
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_3() // Position - 0x261 Signature - 22 00 02 00 00 39 C7
{
...
BOOL func_4() // Position - 0x2B1 Signature - 22 00 02 00 00 09
{
	return func_20(1, 255);
}

BOOL func_5() // Position - 0x2C0 Signature - 22 00 02 00 00 85 EB
{
	return Global_1893611 & 2 != 0;
}

int func_6() // Position - 0x2D0 Signature - 22 00 02 00 00 5D C6
{
	return Global_1896646.f_41;
}

BOOL func_7(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2DE Signature - 22 03 05 00 00 5D 17
{
	if (Global_1572887.f_14 != -1)
	{
...
int func_8() // Position - 0x454 Signature - 22 00 02 00 00 5D EB
{
	return Global_1893611.f_2;
}

void func_9() // Position - 0x462 Signature - 22 00 0C
{
	int num;
	BOOL flag;
	int num2;
...
int func_10() // Position - 0x791 Signature - 22 00 02 00 00 39 D0
{
	return func_39(func_38(func_6()));
}

BOOL func_11(Ped pedParam0, int iParam1) // Position - 0x7A5 Signature - 22 02 05 00 00 66 00 2F
{
	int num;
...
void func_12(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8A4 Signature - 22 04 06 00 00 66 00 76
{
...
void func_13(Volume volParam0) // Position - 0x912 Signature - 22 01 03 00 00 66 00 03
{
...
BOOL func_14(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x929 Signature - 22 03 05 00 00 5D E7
{
...
int func_15() // Position - 0x9C7 Signature - 22 00 02 00 00 5D 9E
{
	return Global_1939102.f_4;
}

BOOL func_16(int iParam0, BOOL bParam1) // Position - 0x9D5 Signature - 22 02 04 00 00 66 00 39 7D 0F 00 05 8B 04 00 2F 50 02 01 66
{
	if (!func_34(iParam0))
		return false;
...
BOOL func_17(int iParam0, BOOL bParam1) // Position - 0xA11 Signature - 22 02 04 00 00 66 00 39 E8 11 00 05 8B 04 00 2F 50 02 01 66
{
	if (!func_42(iParam0))
		return false;
...
BOOL func_18(int iParam0) // Position - 0xA4D Signature - 22 01 03 00 00 66 00 39 40
{
	if (!func_44(iParam0))
		return false;
...
BOOL func_19() // Position - 0xA6E Signature - 22 00 03 00 00 39
{
	int num;
...
BOOL func_20(int iParam0, int iParam1) // Position - 0xAE4 Signature - 22 02 05 00 00 66 00 67
{
	int num;
...
BOOL func_21() // Position - 0xB58 Signature - 22 00 02 00 00 85 00
{
	if (Global_1048576)
		return true;
...
struct<2> func_22(int iParam0) // Position - 0xBB0 Signature - 22 01 03 00 00 11
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_23(var uParam0, var uParam1) // Position - 0xBC4 Signature - 22 02 04 00 00 66 00 39 52
{
	if (!func_50(uParam0))
		return false;
...
int func_24(var uParam0, var uParam1) // Position - 0xBF8 Signature - 22 02 04 00 00 66 00 50
{
	return uParam0;
}

float func_25(var uParam0) // Position - 0xC02 Signature - 22 01 03 00 00 66 00 39 27
{
	if (!func_52(uParam0))
		return 0f;
...
void func_26() // Position - 0xC34 Signature - 22 00 19
{
	var gameplayCamRot;
...
void func_27(var uParam0) // Position - 0xD09 Signature - 22 01 03 00 00 66 00 73
{
	func_56(uParam0, 0f);
	return;
}

BOOL func_28(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, float fParam9, float fParam10, int iParam11) // Position - 0xD18 Signature - 22 0C
{
	int num;
...
BOOL func_29(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE3D Signature - 22 06 12
{
	var unk;
	var unk6;
...
void func_30(var uParam0, int iParam1, BOOL bParam2) // Position - 0xE8A Signature - 22 03 05 00 00 2F
{
	uParam0->f_2 = 0;
...
void func_31() // Position - 0xEC5 Signature - 22 00 02 00 00 54 1E
{
...
void func_32() // Position - 0xF05 Signature - 22 00 02 00 00 54 1F
{
...
int func_33(Ped pedParam0, Ped pedParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0xF38 Signature - 22 05 07 00 00 66 00
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return 0;
...
BOOL func_34(int iParam0) // Position - 0xF7D Signature - 22 01 03 00 00 66 00 08 20 6A 8B 05
{
	return iParam0 > -1 && iParam0 < 6;
}

Vector3 func_35(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0xF92 Signature - 22 05 0B
{
	var unk;
	float endRange;
...
void func_36(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xFDA Signature - 22 07 09 00 00 66 01
{
...
float func_37(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1045 Signature - 22 04 06 00 00 66 00 03
{
...
int func_38(int iParam0) // Position - 0x108D Signature - 22 01 03 00 00 66 00 3C 11
{
	switch (iParam0)
	{
		case 0:
...
int func_39(int iParam0) // Position - 0x1148 Signature - 22 01 03 00 00 66 00 39 7D
{
	if (!func_34(iParam0))
		return 0;
...
BOOL func_40(int iParam0, int iParam1) // Position - 0x1194 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 04 00 00 66 00 39
{
	return iParam0 && iParam1 != false;
}

BOOL func_41(int iParam0, int iParam1) // Position - 0x11A3 Signature - 22 02 04 00 00 66 00 39 7D 0F 00 05 8B 04 00 2F 50 02 01 5D
{
	if (!func_34(iParam0))
		return false;
...
BOOL func_42(int iParam0) // Position - 0x11E8 Signature - 22 01 03 00 00 66 00 08 20 6A 8B 06
{
	return iParam0 > -1 && iParam0 < 17;
}

BOOL func_43(int iParam0, BOOL bParam1) // Position - 0x11FE Signature - 22 02 04 00 00 66 00 39 E8 11 00 05 8B 04 00 2F 50 02 01 5D
{
	if (!func_42(iParam0))
		return false;
...
BOOL func_44(int iParam0) // Position - 0x1240 Signature - 22 01 03 00 00 66 00 2F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_45(int iParam0, BOOL bParam1) // Position - 0x1256 Signature - 22 02 04 00 00 5D
{
	if (Global_1572887.f_14 == -1)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1287 Signature - 22 03 05 00 00 66 00 73
{
...
BOOL func_47(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x12B1 Signature - 22 07 09 00 00 66 00 03
{
...
BOOL func_48(Any* panParam0, int iParam1, int iParam2) // Position - 0x130C Signature - 22 03 07 00 00 66
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_49() // Position - 0x1343 Signature - 22 00 02 00 00 5D DD
{
	return Global_1102813.f_3672;
}

BOOL func_50(int iParam0) // Position - 0x1352 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 21
{
	switch (iParam0)
	{
		case 2:
...
int func_51(int iParam0) // Position - 0x1391 Signature - 22 01 03 00 00 66 00 3C 07 00 02 00 00 00 27 00 03 00 00 00 2E
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_52(var uParam0) // Position - 0x1427 Signature - 22 01 03 00 00 66 00 76 09
{
	return func_66(*uParam0, 1);
}

BOOL func_53(var uParam0) // Position - 0x1437 Signature - 22 01 03 00 00 66 00 76 11
{
	return func_66(*uParam0, 2);
}

float func_54() // Position - 0x1447 Signature - 22 00 03 00 00 03
{
...
BOOL func_55(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x1479 Signature - 22 04 06 00 00 66 02
{
...
void func_56(var uParam0, float fParam1) // Position - 0x14AF Signature - 22 02 04 00 00 39
{
...
void func_57(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, float fParam8, float fParam9, int iParam10) // Position - 0x14D5 Signature - 22 0B
{
	int num;
	int num2;
...
void func_58(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x22E3 Signature - 22 05 07 00 00 66 01
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_59(float fParam0, var uParam1, var uParam2) // Position - 0x2AA3 Signature - 22 03 07 00 00 1D
{
	float num;
	float num2;
...
Ped func_60(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x2AE2 Signature - 22 0D
{
	Ped ped;
...
void func_61(Ped pedParam0) // Position - 0x2B22 Signature - 22 01 03 00 00 66 00 11
{
...
Vector3 func_62(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2BAB Signature - 22 04 07 00 00 66 03
{
	float num;
...
Hash func_63(int iParam0) // Position - 0x2BE2 Signature - 22 01 08
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_64(Hash hParam0) // Position - 0x2C50 Signature - 22 01 04
{
	int i;
...
float func_65(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x2C7B Signature - 22 06 08
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_66(int iParam0, int iParam1) // Position - 0x2C99 Signature - 22 02 04 00 00 66 00 66 01 69 2F 1C 50 02 01 22 02 04 00 00 66 00 76
{
	return iParam0 && iParam1 != false;
}

void func_67(var uParam0, int iParam1) // Position - 0x2CA8 Signature - 22 02 04 00 00 66 00 76 66 01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_68(var uParam0, int iParam1) // Position - 0x2CB9 Signature - 22 02 04 00 00 66 00 76 66 00
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_69(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x2CCE Signature - 22 04 07 00 00 66 00
{
	float num;
...
int func_70(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2CF3 Signature - 22 04 07 00 00 39
{
	int num;
...
int func_71(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x2D41 Signature - 22 03 05 00 00 1D
{
	return func_75(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

void func_72(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2D57 Signature - 22 08
{
	BOOL flag;
...
struct<2> func_73(Player plParam0) // Position - 0x2E21 Signature - 22 01 05
{
	var gamerHandle;
...
int func_74(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2E35 Signature - 22 04 0B
{
	int num;
	int num2;
	int num3;
...
int func_75(Hash hParam0) // Position - 0x2EEC Signature - 22 01 03 00 00 66 00 3C 10
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
void func_76(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2FA6 Signature - 22 03 05 00 00 66 00 03
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_77(Ped pedParam0, BOOL bParam1) // Position - 0x2FEB Signature - 22 02 04 00 00 66 00 03
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_78(Ped pedParam0, int iParam1) // Position - 0x3030 Signature - 22 02 04 00 00 66 01
{
	if (iParam1 == 1)
...
int func_79(var uParam0, var uParam1, var uParam2) // Position - 0x3057 Signature - 22 03 06
{
	int num;
...
int func_80(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x3092 Signature - 22 07 09 00 00 66 00 66
{
	if (fParam0 < fParam3)
